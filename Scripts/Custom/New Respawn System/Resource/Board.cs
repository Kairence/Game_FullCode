...
namespace Server.Items
{
	...
	public class EbonyBoard : BaseWoodBoard
    {
        ...
        [Constructable]
        public EbonyBoard(int amount) : base(CraftResource.EbonyWood, amount) { }
    ...
    public class EthrnalBoard : BaseWoodBoard
    {
        [Constructable]
        public EthrnalBoard() : this(1) { }

        [Constructable]
        public EthrnalBoard(int amount) : base(CraftResource.EthrnalWood, amount) { }

        public EthrnalBoard(Serial serial) : base(serial) { }
