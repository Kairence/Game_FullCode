...
namespace Server.Items
{
    ...
    public class BaseFarmItem : Item
    {
        ...
        private void UpdateAppearance()
        {
			...
			else if (typeName.Contains("Cacao"))      ItemID = isHarvestable ? 0x0C77 : 0xC61; // 카카오 나무류
            else if (typeName.Contains("Vanilla"))    ItemID = isHarvestable ? 0x0C7A : 0xC61; // 바닐라 풀
        ...
        private string GetCropNameKor(Type type)
        {
            ...
            // 🌟 [추가] 200레벨 작물 한글명
            if (n.Contains("Cacao")) return "카카오";
            if (n.Contains("Vanilla")) return "바닐라";
