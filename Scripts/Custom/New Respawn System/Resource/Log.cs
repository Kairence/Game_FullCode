...
namespace Server.Items
{
    ...
    {
        protected override CraftResource DefaultResource { get { return CraftResource.EbonyWood; } }

        [Constructable]
        public EbonyLog() : this(1) { }

        [Constructable]
        public EbonyLog(int amount) : base(CraftResource.EbonyWood, amount) { }

        public EbonyLog(Serial serial) : base(serial) { }

        public override void Serialize(GenericWriter writer) { base.Serialize(writer); writer.Write((int)0); }
        public override void Deserialize(GenericReader reader) { base.Deserialize(reader); int version = reader.ReadInt(); }
        public override BaseWoodBoard GetBoard() { return new EbonyBoard(); }
    }

    public class EthrnalLog : BaseLog
    {
        protected override CraftResource DefaultResource { get { return CraftResource.EthrnalWood; } }

        [Constructable]
        public EthrnalLog() : this(1) { }

        [Constructable]
        public EthrnalLog(int amount) : base(CraftResource.EthrnalWood, amount) { }

        public EthrnalLog(Serial serial) : base(serial) { }

        public override void Serialize(GenericWriter writer) { base.Serialize(writer); writer.Write((int)0); }
        public override void Deserialize(GenericReader reader) { base.Deserialize(reader); int version = reader.ReadInt(); }
        public override BaseWoodBoard GetBoard() { return new EthrnalBoard(); }
    }
