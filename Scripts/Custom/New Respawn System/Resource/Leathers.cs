...
namespace Server.Items
{
	...
	[FlipableAttribute( 0x1081, 0x1082 )]
	public class DernedLeather : BaseLeather
	{
        protected override CraftResource DefaultResource { get { return CraftResource.DernedLeather; } }
		[Constructable]
		public DernedLeather() : this( 1 )
		{
		}

		[Constructable]
		public DernedLeather( int amount ) : base( CraftResource.DernedLeather, amount )
		{
		}

		public DernedLeather( Serial serial ) : base( serial )
		{
		}
	...
	[FlipableAttribute( 0x1081, 0x1082 )]
	public class RatnedLeather : BaseLeather
	{
        protected override CraftResource DefaultResource { get { return CraftResource.RatnedLeather; } }
		[Constructable]
		public RatnedLeather() : this( 1 )
		{
		}

		[Constructable]
		public RatnedLeather( int amount ) : base( CraftResource.RatnedLeather, amount )
		{
		}

		public RatnedLeather( Serial serial ) : base( serial )
		{
		}
	...
	[FlipableAttribute( 0x1081, 0x1082 )]
	public class SernedLeather : BaseLeather
	{
        protected override CraftResource DefaultResource { get { return CraftResource.SernedLeather; } }
		[Constructable]
		public SernedLeather() : this( 1 )
		{
		}

		[Constructable]
		public SernedLeather( int amount ) : base( CraftResource.SernedLeather, amount )
		{
		}

		public SernedLeather( Serial serial ) : base( serial )
		{
		}
    ...
    {
        protected override CraftResource DefaultResource { get { return CraftResource.PolarLeather; } }
    ...
    [FlipableAttribute(0x1081, 0x1082)]
    public class AbyssalLeather : BaseLeather
    {
        protected override CraftResource DefaultResource { get { return CraftResource.AbyssalLeather; } }

        [Constructable]
        public AbyssalLeather() : this(1) { }

        [Constructable]
        public AbyssalLeather(int amount) : base(CraftResource.AbyssalLeather, amount) { }

        public AbyssalLeather(Serial serial) : base(serial) { }
