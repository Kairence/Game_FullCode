...
namespace Server.Items
{
            ...
            else
			{
				...
				switch ( Resource )
				{
					...
					case CraftResource.PolarLeather:
						difficulty = 190.0;
						break;
					case CraftResource.AbyssalLeather:
						difficulty = 210.0; // 심연 가죽 가공 난이도
						break;
				}
	...
	[FlipableAttribute(0x1079, 0x1078)]
    public class PolarHides : BaseHides
    {
        ...
        public override BaseLeather GetLeather() { return new PolarLeather(); }
    ...
    [FlipableAttribute(0x1079, 0x1078)]
    public class AbyssalHides : BaseHides
    {
        protected override CraftResource DefaultResource { get { return CraftResource.AbyssalLeather; } }

        [Constructable]
        public AbyssalHides() : this(1) { }

        [Constructable]
        public AbyssalHides(int amount) : base(CraftResource.AbyssalLeather, amount) { }

        public AbyssalHides(Serial serial) : base(serial) { }

        public override BaseLeather GetLeather() { return new AbyssalLeather(); }
