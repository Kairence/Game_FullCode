...
namespace Server.Misc
{
	public class SlotMachineGump : Gump
	{
		...
		public SlotMachineGump(Mobile from, int[] final, int stage)
			: base(100, 100)
		{
		...
		private class SlotOpenTimer : Timer
		{
			...
			public SlotOpenTimer(Mobile from, int[] final)
				: base(TimeSpan.FromMilliseconds(700), TimeSpan.FromMilliseconds(700))
			{
				m_From = from;
				m_Final = final;
