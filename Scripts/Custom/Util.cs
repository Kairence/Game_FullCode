	...
	public class Util
	{
		...
		*/
		...
		public static int OPLPercentCheck(int number, int step = 1)
		{
			...
			if( number >= 1080585 && number <= 1080597 )
				...
				check = step;
			else if( number >= 1080664 && number <= 1080665 )
				check = step;
			else if( number >= 1080667 && number <= 1080669 )
				check = step;
			return check;
		}
		...
		*/
        ...
        public static readonly int[,,] NewEquipOption = new int[,,]
		{
			...
			{	1080659,	 	0,		1,		300	},
			{	1080659,	 	30,		10,		1000}},
			{{ 	1080660,		0,		10,		3000},	//109 방패 회복 속도 
			{	1080660,	 	0,		1,		300	},
			{	1080660,	 	30,		10,		1000}},
			...
			{	1080665,	 	0,		1,		300	},
			{	1080665,	 	30,		10,		1000}},
			{{ 	1080666,		0,		10,		3000},	//115 패링 기력 감소
			{	1080666,	 	0,		1,		300	},
			{	1080666,	 	30,		10,		1000}},
		...
		public static int[][] SetItemList =
		{
			...
			new int[]{ 6, 30000, 116, 2000, 114, 3000, 6, 70000, 8, 3500},	//5피혁 갑옷
			new int[]{ 51, 1000, 3, 50000, 114, 2000, 51, 1500, 3, 100000},	//6징가죽 갑옷
			new int[]{ 114, 1000, 35, 10000, 115, -100, 118, 6600},			//7뼈갑옷
			new int[]{ 114, 2000, 117, 2000, 4, 100000, 117, 3000},			//8적용갑옷
			new int[]{ 114, 2000, 117, 2000, 6, 100000, 117, 3000},			//9청용갑옷
			new int[]{ 114, 2000, 117, 2000, 111, -2500, 117, 3000},		//10녹용갑옷
			new int[]{ 114, 2000, 117, 2000, 117, 3000, 117, 5000},			//11황용갑옷
			new int[]{ 114, 2000, 45, 3000, 43, 1000, 45, 7000},			//12백용갑옷
			new int[]{ 114, 2000, 44, 3000, 42, 1000, 44, 7000},			//13흑용갑옷
			new int[]{ 114, 6600, 117, 6600, 4, -666600, 118, 6600},		//14마뼈갑옷
			new int[]{ 114, 2000, 4, 3500, 5, 3500}, 						//15링 갑옷
			new int[]{ 114, 1500, 4, 3000},			 						//16사슬 갑옷
			new int[]{ 114, 1200, 19, 500, 20, 500, 18, 3000, 17, 3000},	//17판금갑옷
			new int[]{ 114, 3600, 4, 30000, 100, 9000, 4, 70000, 106, 100}	//18산림갑옷
		};
