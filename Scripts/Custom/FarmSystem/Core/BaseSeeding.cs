...
namespace Server.Items
{
	public class Seeding : Item
	{
		...
		[Constructable]
		public Seeding(Mobile sower, Item seed, Point3D location, Map map)
			: base(0xCB5)
		{
			Movable = false;
			m_Location = location;
		...
		public class GrowTimer : Timer
		{
			...
			public GrowTimer(Item seeding, int crop)
