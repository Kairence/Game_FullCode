...
{
	public class AppleAddon : BaseAddon
	{
		//public override BaseAddonDeed Deed{ get{ return new SmallBedEastDeed(); } }

		private DateTime m_NextRecoveryTime = DateTime.Now + TimeSpan.FromHours( 120.0 );
		private int m_Life;
		...
		public AppleAddon()
		{
			AddComponent( new AddonComponent( 0xD98 ), 0, 0, 0 );
			AddComponent( new AddonComponent( 0xD9A ), 0, 0, 0 );
		}

		public AppleAddon( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
				case 1:
				{
					m_Life = reader.ReadInt();
					m_NextRecoveryTime = reader.ReadDateTime();
					break;
				}
			}
		}
	...
	public class AppleDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return new AppleAddon(); } }
		...
		public AppleDeed( Serial serial ) : base( serial )
		{
		}
