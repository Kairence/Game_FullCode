...
{
	public class PeachAddon : BaseAddon
	{
		//public override BaseAddonDeed Deed{ get{ return new SmallBedEastDeed(); } }

		private DateTime m_NextRecoveryTime = DateTime.Now + TimeSpan.FromHours( 180.0 );
		private int m_Life;
		...
		public PeachAddon()
		{
			AddComponent( new AddonComponent( 0xDA0 ), 0, 0, 0 );
			AddComponent( new AddonComponent( 0xDA2 ), 0, 0, 0 );
		}

		public PeachAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class PeachDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return new PeachAddon(); } }
		...
		public PeachDeed( Serial serial ) : base( serial )
		{
		}
