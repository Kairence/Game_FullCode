...
namespace Server.Gumps
{
	public class EquipMeltingGump : Gump
	{
		...
		public EquipMeltingGump(PlayerMobile pm)
			: base(50, 50)
		{
			AddPage(0);
			...
			AddHtml(50, 20, 150, 20, CenterGray("������ ��ü"), false, false); // <CENTER>HOUSE
			AddButton(10, 20, 4005, 4007, 1, GumpButtonType.Reply, 0);

			AddHtml(50, 50, 150, 20, CenterGray("�ɼ� ����"), false, false); // <CENTER>HOUSE
	...
	public class EquipMeltingOptionGump : Gump
	{
		...
		string[] rank = { "�Ϲ�", "���", "����", "����", "����", "��ȭ", "���" };
		string[] tier = { "0", "40", "80", "120", "160", "200", "240", "���" };
		string[] named = { "����", "����", "���" };
		string[] bag = { "��� ����", "���" };

		public EquipMeltingOptionGump(PlayerMobile pm)
			: base(50, 50)
		{
			AddPage(0);
			...
			AddHtml(0, 20, 800, 20, CenterGray("�ɼ� ����"), false, false); // <CENTER>HOUSE
			...
			for (int i = 1; i < 6; ++i)
			{
				...
				AddHtml(
					...
					20,
					LeftGreen(
						String.Format("{0:#,###}", acc.Point[860 + i] > 0 ? acc.Point[860 + i].ToString() : "0") + "��"
					),
					false,
					false
				);
