				   ...
				   if (m_from != null && m_InscriptionBodParent != null)
			{
				...
				if ( info.ButtonID == 2 )
				{
					if ( (int)m_from.Skills.ItemID.Value >= roll && m_InscriptionBodParent.Reward > 1000 )
					{
						...
						{
							m_from.SendMessage( 0x40, "�Ǹ��ϱ���! �ν�ũ���� ������ �߰��� {0} �� �帮�ھ��!", (int)( m_InscriptionBodParent.Reward * ( 1 + m_from.Skills.ItemID.Value / 200 * Event ) / 100 ) );
										pm.InscriptionPoint += (int)( m_InscriptionBodParent.Reward * ( 1 + m_from.Skills.ItemID.Value / 20 * Event ) / 100 );
						}
						else
						{
							m_from.SendMessage("�ν�ũ���� ���� ���差�� �ʹ� ���� �������� �۱ݵ˴ϴ�.");
					...
					else
					{
						...
						{
							m_from.SendMessage("�ν�ũ���� ������ {0} �����˴ϴ�.", (int)( ( m_InscriptionBodParent.Reward * Event ) / 100 ) );
