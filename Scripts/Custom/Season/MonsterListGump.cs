...
namespace Server.Misc
{
	public class MonsterDropHandlerGump : Gump
	{
		...
		public MonsterDropHandlerGump(Mobile from, int page)
			: base(50, 50)
		{
			m_From = from;
			m_Page = page;
			...
			AddHtml(
				...
				1150,
				30,
				"<BASEFONT SIZE=6 COLOR=#ffff00><CENTER>몬스터 시즌 토벌 기록</CENTER></BASEFONT>",
				false,
				false
			);
			...
			string pageText =
				$"<BASEFONT SIZE=5 COLOR=#ffff00><CENTER>페이지 {page + 1} / {totalPages}</CENTER></BASEFONT>";
		...
		private int GetKillCount(Mobile from, string className)
		{
			return 0;
		}
