...
namespace Server.Misc
{
    public class SeasonMainGump : Gump
    {
        ...
        public SeasonMainGump(Mobile from) : base(150, 150)
        {
            ...
            AddHtml(20, 32, 380, 25, "<BASEFONT SIZE=6 COLOR=#FFD700><CENTER>SEASON DASHBOARD</CENTER></BASEFONT>", false, false);
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            {
                case 1: from.SendGump(new ResourceAchievementGump(from)); break;
                case 2: from.SendGump(new MonsterDropHandlerGump(from, 0)); break;
                case 3: from.SendGump(new SkillAchievementGump(from)); break;
            }
        }
    }
}
