...
namespace Server.Misc
{
	public class Weather
	{
		...
		public int Temperature
		{
			...
			set { this.m_Temperature = value; }
		}
		public int ChanceOfPercipitation
		{
			get { return this.m_ChanceOfPercipitation; }
			set { this.m_ChanceOfPercipitation = value; }
		}
		public int ChanceOfExtremeTemperature
		{
			get { return this.m_ChanceOfExtremeTemperature; }
			set { this.m_ChanceOfExtremeTemperature = value; }
		}
		...
		{
			get { return this.m_MoveAngleX; }
			set { this.m_MoveAngleX = value; }
		}
		public int MoveAngleY
		{
			get { return this.m_MoveAngleY; }
			set { this.m_MoveAngleY = value; }
		}
		...
		public virtual void Reposition()
		{
			...
			{
				area = new Rectangle2D(
					this.m_Bounds.X + Utility.Random(this.m_Bounds.Width - width),
					this.m_Bounds.Y + Utility.Random(this.m_Bounds.Height - height),
					width,
					height
				);
