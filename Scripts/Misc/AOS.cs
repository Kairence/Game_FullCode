...
namespace Server
{
	...
	public class AOS
	{
		...
		)
		{
			return Damage(
				...
				direct,
				keepAlive,
				archer ? DamageType.Ranged : DamageType.Melee
			); // old deathStrike damage, kept for compatibility
		}
		...
		)
		{
			...
			int physDamage =
				damage * phys + SAAbsorptionAttributes.GetValue(from, SAAbsorptionAttribute.EaterDamage) / 100;
			int fireDamage =
				damage * fire + SAAbsorptionAttributes.GetValue(from, SAAbsorptionAttribute.EaterFire) / 100;
			int coldDamage =
				damage * cold + SAAbsorptionAttributes.GetValue(from, SAAbsorptionAttribute.EaterCold) / 100;
			int poisonDamage =
				damage * pois + SAAbsorptionAttributes.GetValue(from, SAAbsorptionAttribute.EaterPoison) / 100;
			int energyDamage =
				damage * nrgy + SAAbsorptionAttributes.GetValue(from, SAAbsorptionAttribute.EaterEnergy) / 100;
			...
			if (!ignoreArmor)
			{
				...
				if (from is PlayerMobile)
				{
					...
					fireDamage = (int)(
						...
						* (
							1
							+ pm.SilverPoint[11] * 0.1
							+ SAAbsorptionAttributes.GetValue(pm, SAAbsorptionAttribute.ResonanceFire) * 0.001
						)
					);
					coldDamage = (int)(
						coldDamage
						* (
							1
							+ pm.SilverPoint[12] * 0.1
							+ SAAbsorptionAttributes.GetValue(pm, SAAbsorptionAttribute.ResonanceCold) * 0.001
						)
					);
					poisonDamage = (int)(
						poisonDamage
						* (
							1
							+ pm.SilverPoint[13] * 0.1
							+ SAAbsorptionAttributes.GetValue(pm, SAAbsorptionAttribute.ResonancePoison) * 0.001
						)
					);
					energyDamage = (int)(
						energyDamage
						* (
							1
							+ pm.SilverPoint[14] * 0.1
							+ SAAbsorptionAttributes.GetValue(pm, SAAbsorptionAttribute.ResonanceEnergy) * 0.001
						)
					);
				}
			...
			*/
			...
			totalDamage =
				physDamage + fireDamage + coldDamage + poisonDamage + energyDamage + chaosDamage + directDamage;
			totalDamage /= 10000;
				...
				if (bc.ControlMaster == null && bc.SummonMaster == null)
				{
					...
					if (Utility.RandomDouble() < 0.1 * CreatureBalancer.MonsterGrade(bc.Grade))
					{
						...
						if (
							bc.Fame > 0
							&& from.Fame < bc.Fame
							&& bc.Fame < 17500 + CreatureBalancer.MonsterGrade(bc.Grade) * 2500
						)
							bc.Fame++;
					}
					...
					if (m is BaseCreature)
					{
						...
						if (monster.ControlMaster == null && monster.SummonMaster == null)
						{
							if (bc.ControlSlots > 0)
							{
								...
								int maxHits = (int)(
									bc.ControlMaster.Skills.AnimalLore.Value * 20 + bc.ControlSlots * 1000
								);
			...
			if (from != null && !from.Deleted && from.Alive && !from.IsDeadBondedPet)
			{
				if (!ignoreArmor && from != m)
				{
					...
					{
						if (
							from is ExodusMinion && ((ExodusMinion)from).FieldActive
		...
		public static void DoLeech(int damageGiven, Mobile from, Mobile target)
		{
			...
			if (lifeLeech != 0)
			{
				...
				Effects.SendPacket(
					target.Location,
					target.Map,
					new Network.ParticleEffect(
						Network.EffectType.FixedFrom,
						target.Serial,
						Serial.Zero,
						0x377A,
						target.Location,
		...
		public static int GetStatus(Mobile from, int index)
		{
			...
			{
				case 0:
					return from.GetMaxResistance(ResistanceType.Physical);
				case 1:
					return from.GetMaxResistance(ResistanceType.Fire);
				case 2:
					return from.GetMaxResistance(ResistanceType.Cold);
				case 3:
					return from.GetMaxResistance(ResistanceType.Poison);
				case 4:
					return from.GetMaxResistance(ResistanceType.Energy);
				case 5:
					return Math.Min(75, AosAttributes.GetValue(from, AosAttribute.DefendChance) / 100);
				case 6:
					return 75;
				case 7:
					return Math.Min(75, AosAttributes.GetValue(from, AosAttribute.AttackChance) / 100);
				case 8:
					return Math.Min(
						150,
						(
							AosAttributes.GetValue(from, AosAttribute.WeaponSpeed)
							+ AosWeaponAttributes.GetValue(from, AosWeaponAttribute.MageWeapon)
						) / 100
					);
				case 9:
					return Math.Min(
						...
						(
							...
							+ AosWeaponAttributes.GetValue(from, AosWeaponAttribute.UseBestSkill)
						) / 100
					);
				case 10:
					return Math.Min(100, AosAttributes.GetValue(from, AosAttribute.LowerRegCost) / 100);
				case 11:
					return Math.Min(
						175,
						(
				...
				case 12:
					return Math.Min(150, AosAttributes.GetValue(from, AosAttribute.CastRecovery) / 100);
				case 13:
					return Math.Min(
						150,
						(
				...
				case 14:
					return Math.Min(80, AosAttributes.GetValue(from, AosAttribute.LowerManaCost) / 100); // + BaseArmor.GetInherentLowerManaCost(from);

				case 15:
					return (int)RegenRates.Mobile_HitsRegenRate(from); // HP   REGEN
				case 16:
					return (int)RegenRates.Mobile_StamRegenRate(from); // Stam REGEN
				case 17:
					return (int)RegenRates.Mobile_ManaRegenRate(from); // MANA REGEN
				case 18:
					return Math.Min(100, AosAttributes.GetValue(from, AosAttribute.ReflectPhysical) / 100); // reflect phys
				case 19:
					return Math.Min(100, AosAttributes.GetValue(from, AosAttribute.EnhancePotions) / 100); // enhance pots

				case 20:
					return AosAttributes.GetValue(from, AosAttribute.BonusStr) + from.GetStatOffset(StatType.Str); // str inc
				case 21:
					return AosAttributes.GetValue(from, AosAttribute.BonusDex) + from.GetStatOffset(StatType.Dex); // dex inc
				case 22:
					return AosAttributes.GetValue(from, AosAttribute.BonusInt) + from.GetStatOffset(StatType.Int); // int inc
				...
				case 26:
					return AosAttributes.GetValue(from, AosAttribute.BonusHits); // hits inc
				case 27:
					return AosAttributes.GetValue(from, AosAttribute.BonusStam); // stam inc
				case 28:
					return AosAttributes.GetValue(from, AosAttribute.BonusMana); // mana inc
				default:
					return 0;
			}
		}
	...
	public sealed class AosAttributes : BaseAttributes
	{
		...
		public static int GetValue(Mobile m, AosAttribute attribute)
		{
			...
			if (
				attribute == AosAttribute.Luck
				|| attribute == AosAttribute.RegenMana
				|| attribute == AosAttribute.DefendChance
				|| attribute == AosAttribute.EnhancePotions
			)
			...
			if (
				!(
					attribute == AosAttribute.BonusStr
					|| attribute == AosAttribute.BonusDex
					|| attribute == AosAttribute.BonusInt
				)
			)
				value /= 100;
		...
		public int Brittle
		{
			get { return this[AosAttribute.Brittle]; }
		...
		{
			get { return this[AosAttribute.BalancedWeapon]; }
		...
		{
			get { return this[AosAttribute.WeaponDamageBonus]; }
			set { this[AosAttribute.WeaponDamageBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SpellDamageBonus
		{
			get { return this[AosAttribute.SpellDamageBonus]; }
			set { this[AosAttribute.SpellDamageBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int HealBonus
		{
			get { return this[AosAttribute.HealBonus]; }
			set { this[AosAttribute.HealBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int WeaponCritical
		{
			get { return this[AosAttribute.WeaponCritical]; }
			set { this[AosAttribute.WeaponCritical] = value; }
		}
	}
	...
	public sealed class AosWeaponAttributes : BaseAttributes
	{
		...
		public void ScaleLeech(int weaponSpeed)
		{
			...
			if (HitLeechHits > 0)
			{
				double postcap =
					(double)HitLeechHits
					/ (double)ItemPropertyInfo.GetMaxIntensity(wep, AosWeaponAttribute.HitLeechHits);
				if (postcap < 1.0)
					postcap = 1.0;
			...
			if (HitLeechMana > 0)
			{
				double postcap =
					(double)HitLeechMana
					/ (double)ItemPropertyInfo.GetMaxIntensity(wep, AosWeaponAttribute.HitLeechMana);
				if (postcap < 1.0)
					postcap = 1.0;
		...
		{
			get { return this[AosWeaponAttribute.ReactiveParalyze]; }
	...
	public sealed class ExtendedWeaponAttributes : BaseAttributes
	{
		...
		{
			get { return this[ExtendedWeaponAttribute.BoneBreaker]; }
		...
		public int HitSwarm
		{
			get { return this[ExtendedWeaponAttribute.HitSwarm]; }
		...
		{
			get { return this[ExtendedWeaponAttribute.HitSparks]; }
		...
		public int Bane
		{
			get { return this[ExtendedWeaponAttribute.Bane]; }
		...
		{
			get { return this[ExtendedWeaponAttribute.MysticWeapon]; }
		...
		{
			get { return this[ExtendedWeaponAttribute.AssassinHoned]; }
		...
		public int Focus
		{
			get { return this[ExtendedWeaponAttribute.Focus]; }
		...
		{
			get { return this[ExtendedWeaponAttribute.HitExplosion]; }
		...
		public int Freezing
		{
			get { return this[ExtendedWeaponAttribute.Freezing]; }
			set { this[ExtendedWeaponAttribute.Freezing] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int LightningBonus
		{
			get { return this[ExtendedWeaponAttribute.LightningBonus]; }
			set { this[ExtendedWeaponAttribute.LightningBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int InfectionBonus
		{
			get { return this[ExtendedWeaponAttribute.InfectionBonus]; }
			set { this[ExtendedWeaponAttribute.InfectionBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ChaosDamage
		{
			get { return this[ExtendedWeaponAttribute.ChaosDamage]; }
			set { this[ExtendedWeaponAttribute.ChaosDamage] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int DirectDamage
		{
			get { return this[ExtendedWeaponAttribute.DirectDamage]; }
			set { this[ExtendedWeaponAttribute.DirectDamage] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ChaosPlus
		{
			get { return this[ExtendedWeaponAttribute.ChaosPlus]; }
			set { this[ExtendedWeaponAttribute.ChaosPlus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int DirectPlus
		{
			get { return this[ExtendedWeaponAttribute.DirectPlus]; }
			set { this[ExtendedWeaponAttribute.DirectPlus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int AggroPoint
		{
			get { return this[ExtendedWeaponAttribute.AggroPoint]; }
			set { this[ExtendedWeaponAttribute.AggroPoint] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int AggroPointBonus
		{
			get { return this[ExtendedWeaponAttribute.AggroPointBonus]; }
			set { this[ExtendedWeaponAttribute.AggroPointBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SPMAllBonus
		{
			get { return this[ExtendedWeaponAttribute.SPMAllBonus]; }
			set { this[ExtendedWeaponAttribute.SPMAllBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SPMFirstBonus
		{
			get { return this[ExtendedWeaponAttribute.SPMFirstBonus]; }
			set { this[ExtendedWeaponAttribute.SPMFirstBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SPMSecondBonus
		{
			get { return this[ExtendedWeaponAttribute.SPMSecondBonus]; }
			set { this[ExtendedWeaponAttribute.SPMSecondBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SPMSwordBonus
		{
			get { return this[ExtendedWeaponAttribute.SPMSwordBonus]; }
			set { this[ExtendedWeaponAttribute.SPMSwordBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SPMMaceBonus
		{
			get { return this[ExtendedWeaponAttribute.SPMMaceBonus]; }
			set { this[ExtendedWeaponAttribute.SPMMaceBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SPMFancingBonus
		{
			get { return this[ExtendedWeaponAttribute.SPMFancingBonus]; }
			set { this[ExtendedWeaponAttribute.SPMFancingBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SPMBowBonus
		{
			get { return this[ExtendedWeaponAttribute.SPMBowBonus]; }
			set { this[ExtendedWeaponAttribute.SPMBowBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SPMWrestling
		{
			get { return this[ExtendedWeaponAttribute.SPMWrestling]; }
			set { this[ExtendedWeaponAttribute.SPMWrestling] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int BaseWeaponDamage
		{
			get { return this[ExtendedWeaponAttribute.BaseWeaponDamage]; }
			set { this[ExtendedWeaponAttribute.BaseWeaponDamage] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int BaseSpellDamage
		{
			get { return this[ExtendedWeaponAttribute.BaseSpellDamage]; }
			set { this[ExtendedWeaponAttribute.BaseSpellDamage] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int BaseAllDamage
		{
			get { return this[ExtendedWeaponAttribute.BaseAllDamage]; }
			set { this[ExtendedWeaponAttribute.BaseAllDamage] = value; }
		}
	}
	...
	public sealed class AosArmorAttributes : BaseAttributes
	{
		...
		{
			get { return this[AosArmorAttribute.PierceResist]; }
			set { this[AosArmorAttribute.PierceResist] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ShockResist
		{
			get { return this[AosArmorAttribute.ShockResist]; }
			set { this[AosArmorAttribute.ShockResist] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int BleedResist
		{
			get { return this[AosArmorAttribute.BleedResist]; }
			set { this[AosArmorAttribute.BleedResist] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int WeaponDefense
		{
			get { return this[AosArmorAttribute.WeaponDefense]; }
			set { this[AosArmorAttribute.WeaponDefense] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicDefense
		{
			get { return this[AosArmorAttribute.MagicDefense]; }
			set { this[AosArmorAttribute.MagicDefense] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int StunDefense
		{
			get { return this[AosArmorAttribute.StunDefense]; }
			set { this[AosArmorAttribute.StunDefense] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ShieldRecovery
		{
			get { return this[AosArmorAttribute.ShieldRecovery]; }
			set { this[AosArmorAttribute.ShieldRecovery] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int AllDefenseBonus
		{
			get { return this[AosArmorAttribute.AllDefenseBonus]; }
			set { this[AosArmorAttribute.AllDefenseBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ElementalResist
		{
			get { return this[AosArmorAttribute.ElementalResist]; }
			set { this[AosArmorAttribute.ElementalResist] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int AllResist
		{
			get { return this[AosArmorAttribute.AllResist]; }
			set { this[AosArmorAttribute.AllResist] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int DefenseStam
		{
			get { return this[AosArmorAttribute.DefenseStam]; }
			set { this[AosArmorAttribute.DefenseStam] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicAllBonus
		{
			get { return this[AosArmorAttribute.MagicAllBonus]; }
			set { this[AosArmorAttribute.MagicAllBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicOneCircleBonus
		{
			get { return this[AosArmorAttribute.MagicOneCircleBonus]; }
			set { this[AosArmorAttribute.MagicOneCircleBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicTwoCircleBonus
		{
			get { return this[AosArmorAttribute.MagicTwoCircleBonus]; }
			set { this[AosArmorAttribute.MagicTwoCircleBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicThreeCircleBonus
		{
			get { return this[AosArmorAttribute.MagicThreeCircleBonus]; }
			set { this[AosArmorAttribute.MagicThreeCircleBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicFourCircleBonus
		{
			get { return this[AosArmorAttribute.MagicFourCircleBonus]; }
			set { this[AosArmorAttribute.MagicFourCircleBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicFiveCircleBonus
		{
			get { return this[AosArmorAttribute.MagicFiveCircleBonus]; }
			set { this[AosArmorAttribute.MagicFiveCircleBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicSixCircleBonus
		{
			get { return this[AosArmorAttribute.MagicSixCircleBonus]; }
			set { this[AosArmorAttribute.MagicSixCircleBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicSevenCircleBonus
		{
			get { return this[AosArmorAttribute.MagicSevenCircleBonus]; }
			set { this[AosArmorAttribute.MagicSevenCircleBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicEightCircleBonus
		{
			get { return this[AosArmorAttribute.MagicEightCircleBonus]; }
			set { this[AosArmorAttribute.MagicEightCircleBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicNecromancyBonus
		{
			get { return this[AosArmorAttribute.MagicNecromancyBonus]; }
			set { this[AosArmorAttribute.MagicNecromancyBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicElementalismBonus
		{
			get { return this[AosArmorAttribute.MagicElementalismBonus]; }
			set { this[AosArmorAttribute.MagicElementalismBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicMysticismBonus
		{
			get { return this[AosArmorAttribute.MagicMysticismBonus]; }
			set { this[AosArmorAttribute.MagicMysticismBonus] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MagicChivalryBonus
		{
			get { return this[AosArmorAttribute.MagicChivalryBonus]; }
			set { this[AosArmorAttribute.MagicChivalryBonus] = value; }
		}
	}
	...
	public sealed class AosSkillBonuses : BaseAttributes
	{
		...
		public void CheckCancelMorph(Mobile m)
		{
			...
			if (acontext != null)
			{
				...
				else
				{
					...
					if (
						i < AnimalForm.Entries.Length
						&& m.Skills[SkillName.Ninjitsu].Value < AnimalForm.Entries[i].ReqSkill
					)
					{
						AnimalForm.RemoveContext(m, true);
					}
		...
		{
			get { return GetBonus(5); }
			set { SetBonus(5, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public SkillName Skill_6_Name
		{
			get { return GetSkill(5); }
			set { SetSkill(5, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public double Skill_7_Value
		{
			get { return GetBonus(6); }
			set { SetBonus(6, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public SkillName Skill_7_Name
		{
			get { return GetSkill(6); }
			set { SetSkill(6, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public double Skill_8_Value
		{
			get { return GetBonus(7); }
			set { SetBonus(7, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public SkillName Skill_8_Name
		{
			get { return GetSkill(7); }
			set { SetSkill(7, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public double Skill_9_Value
		{
			get { return GetBonus(8); }
			set { SetBonus(8, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public SkillName Skill_9_Name
		{
			get { return GetSkill(8); }
			set { SetSkill(8, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public double Skill_10_Value
		{
			get { return GetBonus(9); }
			set { SetBonus(9, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public SkillName Skill_10_Name
		{
			get { return GetSkill(9); }
			set { SetSkill(9, value); }
		}
	}
	...
	public sealed class SAAbsorptionAttributes : BaseAttributes
	{
		...
		{
			get { return this[SAAbsorptionAttribute.EaterFire]; }
		...
		{
			get { return this[SAAbsorptionAttribute.EaterCold]; }
		...
		{
			get { return this[SAAbsorptionAttribute.EaterPoison]; }
		...
		{
			get { return this[SAAbsorptionAttribute.EaterEnergy]; }
		...
		{
			get { return this[SAAbsorptionAttribute.EaterKinetic]; }
		...
		{
			get { return this[SAAbsorptionAttribute.EaterDamage]; }
		...
		{
			get { return this[SAAbsorptionAttribute.ResonanceFire]; }
		...
		{
			get { return this[SAAbsorptionAttribute.ResonanceCold]; }
		...
		{
			get { return this[SAAbsorptionAttribute.ResonancePoison]; }
		...
		{
			get { return this[SAAbsorptionAttribute.ResonanceEnergy]; }
		...
		{
			get { return this[SAAbsorptionAttribute.ResonanceKinetic]; }
		...
		{
			get { return this[SAAbsorptionAttribute.SoulChargeFire]; }
			set { this[SAAbsorptionAttribute.SoulChargeFire] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SoulChargeCold
		{
			get { return this[SAAbsorptionAttribute.SoulChargeCold]; }
			set { this[SAAbsorptionAttribute.SoulChargeCold] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SoulChargePoison
		{
			get { return this[SAAbsorptionAttribute.SoulChargePoison]; }
			set { this[SAAbsorptionAttribute.SoulChargePoison] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SoulChargeEnergy
		{
			get { return this[SAAbsorptionAttribute.SoulChargeEnergy]; }
			set { this[SAAbsorptionAttribute.SoulChargeEnergy] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SoulChargeKinetic
		{
			get { return this[SAAbsorptionAttribute.SoulChargeKinetic]; }
			set { this[SAAbsorptionAttribute.SoulChargeKinetic] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int CastingFocus
		{
			get { return this[SAAbsorptionAttribute.CastingFocus]; }
		...
		{
			get { return this[SAAbsorptionAttribute.EaterPierce]; }
			set { this[SAAbsorptionAttribute.EaterPierce] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ResonancePierce
		{
			get { return this[SAAbsorptionAttribute.ResonancePierce]; }
			set { this[SAAbsorptionAttribute.ResonancePierce] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int EaterBleed
		{
			get { return this[SAAbsorptionAttribute.EaterBleed]; }
			set { this[SAAbsorptionAttribute.EaterBleed] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ResonanceBleed
		{
			get { return this[SAAbsorptionAttribute.ResonanceBleed]; }
			set { this[SAAbsorptionAttribute.ResonanceBleed] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int HumanoidDamage
		{
			get { return this[SAAbsorptionAttribute.HumanoidDamage]; }
			set { this[SAAbsorptionAttribute.HumanoidDamage] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int UndeadDamage
		{
			get { return this[SAAbsorptionAttribute.UndeadDamage]; }
			set { this[SAAbsorptionAttribute.UndeadDamage] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ElementalDamage
		{
			get { return this[SAAbsorptionAttribute.ElementalDamage]; }
			set { this[SAAbsorptionAttribute.ElementalDamage] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int AbyssDamage
		{
			get { return this[SAAbsorptionAttribute.AbyssDamage]; }
			set { this[SAAbsorptionAttribute.AbyssDamage] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ArachnidDamage
		{
			get { return this[SAAbsorptionAttribute.ArachnidDamage]; }
			set { this[SAAbsorptionAttribute.ArachnidDamage] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ReptilianDamage
		{
			get { return this[SAAbsorptionAttribute.ReptilianDamage]; }
			set { this[SAAbsorptionAttribute.ReptilianDamage] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int FeyDamage
		{
			get { return this[SAAbsorptionAttribute.FeyDamage]; }
			set { this[SAAbsorptionAttribute.FeyDamage] = value; }
		}
	}
	#endregion
	...
	public sealed class NegativeAttributes : BaseAttributes
	{
				...
				else
				{
					if (dur.MaxHitPoints > 1)
					{
						...
						if (item.Parent is Mobile)
							((Mobile)item.Parent).LocalOverheadMessage(
		...
		public int Brittle
		{
			get { return this[NegativeAttribute.Brittle]; }
		...
		public int Prized
		{
			get { return this[NegativeAttribute.Prized]; }
		...
		public int Massive
		{
			get { return this[NegativeAttribute.Massive]; }
			set { this[NegativeAttribute.Massive] = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int Unwieldly
		{
			get { return this[NegativeAttribute.Unwieldly]; }
		...
		public int Antique
		{
			get { return this[NegativeAttribute.Antique]; }
		...
		public int NoRepair
		{
			get { return this[NegativeAttribute.NoRepair]; }
	...
	public abstract class BaseAttributes
	{
		...
		public virtual void SetValue(int bitmask, int value)
		{
			...
			if (m_Owner != null && m_Owner.Parent is Mobile)
			{
				...
				m.UpdateResistances();
				m.Delta(
					MobileDelta.Stat | MobileDelta.WeaponDamage | MobileDelta.Hits | MobileDelta.Stam | MobileDelta.Mana
				);
			}
