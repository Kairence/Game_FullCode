...
namespace Server.Items
{
	public class ToggleItem : Item
	{
		...
		{
			get { return this.m_InactiveItemID; }
			set { this.m_InactiveItemID = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ActiveItemID
		{
			get { return this.m_ActiveItemID; }
			set { this.m_ActiveItemID = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public bool PlayersCanToggle
		{
			get { return this.m_PlayersCanToggle; }
			set { this.m_PlayersCanToggle = value; }
		}
