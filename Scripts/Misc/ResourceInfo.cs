...
namespace Server.Items
{
    ...
    public class CraftResources
    {
        ...
        private static readonly CraftResourceInfo[] m_LeatherInfo = new CraftResourceInfo[]
        {
            ...
            new CraftResourceInfo(0x283, 0, "질긴 가죽", CraftAttributeInfo.Derned, CraftResource.DernedLeather,	typeof(DernedLeather),	typeof(DernedHides)),
            new CraftResourceInfo(0x227, 0, "거친 가죽", CraftAttributeInfo.Ratned, CraftResource.RatnedLeather,	typeof(RatnedLeather),	typeof(RatnedHides)),
            new CraftResourceInfo(0x1C1, 0, "경화 가죽", CraftAttributeInfo.Serned, CraftResource.SernedLeather,	typeof(SernedLeather),	typeof(SernedHides)),
