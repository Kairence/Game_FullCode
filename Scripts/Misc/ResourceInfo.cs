...
namespace Server.Items
{
	...
	public class CraftAttributeInfo
	{
		...
		{
			get { return m_WeaponHitChance; }
			set { m_WeaponHitChance = value; }
		}
		public int WeaponHitLifeLeech
		{
			get { return m_WeaponHitLifeLeech; }
			set { m_WeaponHitLifeLeech = value; }
		}
		public int WeaponRegenHits
		{
			get { return m_WeaponRegenHits; }
			set { m_WeaponRegenHits = value; }
		}
		public int WeaponSwingSpeed
		{
			get { return m_WeaponSwingSpeed; }
			set { m_WeaponSwingSpeed = value; }
		}
		...
		{
			get { return m_ArmorDamage; }
			set { m_ArmorDamage = value; }
		}
		public int ArmorHitChance
		{
			get { return m_ArmorHitChance; }
			set { m_ArmorHitChance = value; }
		}
		public int ArmorRegenHits
		{
			get { return m_ArmorRegenHits; }
			set { m_ArmorRegenHits = value; }
		}
		public int ArmorMage
		{
			get { return m_ArmorMage; }
			set { m_ArmorMage = value; }
		}
		...
		{
			get { return m_ShieldFireResist; }
			set { m_ShieldFireResist = value; }
		}
		public int ShieldColdResist
		{
			get { return m_ShieldColdResist; }
			set { m_ShieldColdResist = value; }
		}
		public int ShieldPoisonResist
		{
			get { return m_ShieldPoisonResist; }
			set { m_ShieldPoisonResist = value; }
		}
		public int ShieldEnergyResist
		{
			get { return m_ShieldEnergyResist; }
			set { m_ShieldEnergyResist = value; }
		}
		...
		public int ShieldColdRandom
		{
			get { return m_ShieldColdRandom; }
			set { m_ShieldColdRandom = value; }
		}
		...
		public int ShieldLuck
		{
			get { return m_ShieldLuck; }
			set { m_ShieldLuck = value; }
		}
		...
		public int ShieldRegenHits
		{
			get { return m_ShieldRegenHits; }
			set { m_ShieldRegenHits = value; }
		}
		public int ShieldBonusDex
		{
			get { return m_ShieldBonusDex; }
			set { m_ShieldBonusDex = value; }
		}
		public int ShieldBonusStr
		{
			get { return m_ShieldBonusStr; }
			set { m_ShieldBonusStr = value; }
		}
		public int ShieldReflectPhys
		{
			get { return m_ShieldReflectPhys; }
			set { m_ShieldReflectPhys = value; }
		}
		public int ShieldSelfRepair
		{
			get { return m_SelfRepair; }
			set { m_SelfRepair = value; }
		}
		...
		public int OtherLuck
		{
			get { return m_OtherLuck; }
			set { m_OtherLuck = value; }
		}
		public int OtherRegenHits
		{
			get { return m_OtherRegenHits; }
			set { m_OtherRegenHits = value; }
		}
		...
		public static readonly CraftAttributeInfo DullCopper,
			...
			Verite,
			Valorite;
		public static readonly CraftAttributeInfo Derned,
			Ratned,
			Serned,
			Spined,
			Horned,
	...
	public class CraftResourceInfo
	{
		...
		{
			get { return this.m_AttributeInfo; }
		}
		...
		{
			get { return this.m_ResourceTypes; }
		}
	...
	public class CraftResources
	{
		...
		private static readonly CraftResourceInfo[] m_LeatherInfo = new CraftResourceInfo[]
		{
			...
			new CraftResourceInfo(
				...
				0,
				"질긴 가죽",
				CraftAttributeInfo.Derned,
				CraftResource.DernedLeather,
				typeof(DernedLeather),
				typeof(DernedHides)
			),
			new CraftResourceInfo(
				0x227,
				0,
				"거친 가죽",
				CraftAttributeInfo.Ratned,
				CraftResource.RatnedLeather,
				typeof(RatnedLeather),
				typeof(RatnedHides)
			),
			new CraftResourceInfo(
				0x1C1,
				0,
				"경화 가죽",
				CraftAttributeInfo.Serned,
				CraftResource.SernedLeather,
				typeof(SernedLeather),
				typeof(SernedHides)
			),
			new CraftResourceInfo(
				0x8AC,
		...
		*/
		...
		public static CraftResource GetFromOreInfo(OreInfo info)
		{
			...
			else if (info.Name.IndexOf("질긴 가죽") >= 0)
				return CraftResource.DernedLeather;
			else if (info.Name.IndexOf("거친 가죽") >= 0)
				return CraftResource.RatnedLeather;
			else if (info.Name.IndexOf("경화 가죽") >= 0)
				return CraftResource.SernedLeather;
