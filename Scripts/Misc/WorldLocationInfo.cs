	...
	public class WorldLocationInfo
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(GetLocation_OnCommand)
			);
		}
		...
		public static WorldLocationInfo[][] Locations
		{
		...
		private static WorldLocationInfo[][] m_Locations = new WorldLocationInfo[][]
		{
			...
			{
				new WorldLocationInfo(
					"an island southeast of Britain",
					new Rectangle2D(1620, 1900, 594, 150),
				...
				new WorldLocationInfo(
					"a frozen tundra of the Lost Lands",
					new Rectangle2D(5120, 2300, 500, 130),
