...
namespace Server
{
    public class Loot
    {
        ...
        private static readonly Type[] m_WeaponTypes = new[]
		{
			...
			typeof(Bardiche), typeof(Halberd), typeof(Spear), typeof(ShortSpear), typeof(Pitchfork), typeof(WarFork), typeof(Pike), 
			...
			/* typeof(DiscMace), typeof(GargishTalwar), typeof(Shortblade), typeof(DualPointedSpear), typeof(GlassStaff),
			typeof(StoneWarSword), typeof(DualShortAxes), typeof(GlassSword), typeof(GargishDagger), */
			typeof(AssassinSpike), typeof(ElvenSpellblade), /* typeof(DiamondMace), typeof(ElvenMachete),  typeof(Leafblade), */
        ...
        private static readonly Type[] m_AosRangedWeaponTypes = new[] { typeof(CompositeBow), typeof(RepeatingCrossbow), typeof(ElvenCompositeLongbow), typeof(MagicalShortbow) };

        public static Type[] AosRangedWeaponTypes { get { return m_AosRangedWeaponTypes; } }

		//원거리
        private static readonly Type[] m_RangedWeaponTypes = new[] { typeof(Bow), typeof(Crossbow), typeof(HeavyCrossbow), /* typeof(Boomerang), typeof(Cyclone), typeof(SoulGlaive), */
		typeof(CompositeBow), typeof(RepeatingCrossbow), typeof(ElvenCompositeLongbow), typeof(MagicalShortbow), typeof( Yumi )
		};
        ...
        private static readonly Type[] m_MLResources =
{
        ...
        private static readonly Type[] m_JewelryTypes = new[]
		{
            ...
            typeof(GoldEarrings),typeof(SilverEarrings), typeof(GoldNecklace), typeof(SilverNecklace) //, typeof(GargishRing), typeof(GargishBracelet) 
        ...
        public static Type[] AosSpellbookTypes { get { return m_SpellbookTypes; } }
        ...
        private static readonly Type[] m_ClothingTypes = new[]
		{
			...
			typeof(Bonnet), typeof(Cap), typeof(FeatheredHat), typeof(FloppyHat), typeof(JesterHat),
			typeof(SkullCap), typeof(StrawHat), typeof(TallStrawHat), typeof(TricorneHat), typeof(WideBrimHat), typeof(WizardsHat), typeof(ShortPants), typeof(LongPants)
			
			
		};

		public static Type[] SpellbookTypes { get { return m_SpellbookTypes; } }
        ...
        {
            return Construct(m_WeaponTypes, m_RangedWeaponTypes, m_ArmorTypes, m_ClothingTypes, m_JewelryTypes, m_SpellbookTypes, m_ShieldTypes);
           #region Stygian Abyss
            if (Core.SA && isStygian)
            {
        ...
        {
            return Construct(m_ArmorTypes, m_ClothingTypes, m_WeaponTypes, m_RangedWeaponTypes, m_JewelryTypes, m_SpellbookTypes);
        }
        #endregion
