...
namespace Server
{
	public class Loot
	{
		...
		{
			typeof(DiscMace),
			typeof(GargishTalwar),
			typeof(Shortblade),
			typeof(DualPointedSpear),
			typeof(GlassStaff),
			typeof(StoneWarSword),
		...
		{
			get { return m_SAWeaponTypes; }
		}

		private static readonly Type[] m_SARangedWeaponTypes = new[]
		{
			typeof(Boomerang),
			typeof(Cyclone),
			typeof(SoulGlaive),
		...
		{
			get { return m_SARangedWeaponTypes; }
		}

		private static readonly Type[] m_SAArmorTypes = new[]
		{
			typeof(GargishLeatherChest),
			typeof(GargishLeatherLegs),
			typeof(GargishLeatherArms),
			typeof(GargishLeatherKilt),
			typeof(GargishStoneChest),
			typeof(GargishStoneLegs),
			typeof(GargishStoneArms),
			typeof(GargishStoneKilt),
			typeof(GargishPlateChest),
			typeof(GargishPlateLegs),
			typeof(GargishPlateArms),
			typeof(GargishPlateKilt),
			typeof(GargishNecklace),
			typeof(GargishEarrings),
		};

		public static Type[] SAArmorTypes
		{
			get { return m_SAArmorTypes; }
		}

		private static readonly Type[] m_SAClothingTypes = new[]
		{
			typeof(GargishClothChestArmor),
			typeof(GargishClothArmsArmor),
			typeof(GargishClothKiltArmor),
			typeof(GargishClothLegsArmor),
		};
		public static Type[] SAClothingTypes
		{
			get { return m_SAClothingTypes; }
		}
		#endregion
		...
		{
			get { return m_MLWeaponTypes; }
		}

		private static readonly Type[] m_MLRangedWeaponTypes = new[]
		{
		...
		{
			get { return m_MLRangedWeaponTypes; }
		}
		...
		private static readonly Type[] m_WeaponTypes = new[]
		{
			...
			typeof(BattleAxe),
			typeof(DoubleAxe),
			typeof(ExecutionersAxe), /* typeof(Hatchet),*/
			...
			typeof(Longsword),
			typeof(Scimitar),
			typeof(VikingSword), /* typeof(Pickaxe), */
			typeof(HammerPick),
			...
			typeof(AssassinSpike),
			typeof(ElvenSpellblade), /* typeof(DiamondMace), typeof(ElvenMachete),  typeof(Leafblade), */
			typeof(OrnateAxe), // typeof(RadiantScimitar), typeof(RuneBlade), typeof(WarCleaver), typeof(WildStaff), /* typeof(Kama), */
			typeof(Scythe),
			typeof(BoneHarvester),
			typeof(Scepter),
			typeof(BladedStaff),
		...
		private static readonly Type[] m_AosRangedWeaponTypes = new[]
		{
			typeof(CompositeBow),
		...
		private static readonly Type[] m_RangedWeaponTypes = new[]
		{
			typeof(Bow),
			typeof(Crossbow),
			typeof(HeavyCrossbow), /* typeof(Boomerang), typeof(Cyclone), typeof(SoulGlaive), */
			typeof(CompositeBow),
			typeof(RepeatingCrossbow),
			typeof(ElvenCompositeLongbow),
			typeof(MagicalShortbow),
		...
		private static readonly Type[] m_ArmorTypes = new[]
		{
			...
			typeof(HideGorget),
			typeof(HidePants),
			typeof(HidePauldrons), /* typeof(GargishNecklace), typeof( GargishEarrings ) */
		};
		...
		private static readonly Type[] m_ShieldTypes = new[]
		{
			...
			typeof(WoodenShield),
			//typeof(GargishKiteShield), typeof(GargishWoodenShield),
		...
		{
			typeof(GargishChaosShield),
			typeof(GargishKiteShield),
			typeof(GargishOrderShield),
			typeof(GargishWoodenShield),
			typeof(LargeStoneShield),
		};

		public static Type[] SAShieldTypes
		{
			get { return m_SAShieldTypes; }
		}
		...
		public static Type[] RareGemTypes
		{
			get { return m_RareGemTypes; }
		}
		...
		public static Type[] MLResources
		{
			get { return m_MLResources; }
		}
		...
		private static readonly Type[] m_JewelryTypes = new[]
		{
			...
			typeof(GoldNecklace),
			typeof(SilverNecklace), //, typeof(GargishRing), typeof(GargishBracelet)
		...
		{
			typeof(GargishRing),
			typeof(GargishBracelet), //,
			//typeof(GargishNecklace), typeof( GargishEarrings )
		};

		public static Type[] SAJewelryTypes
		{
			get { return m_SAJewelryTypes; }
		}
		...
		private static readonly Type[] m_NecroRegTypes = new[]
		{
			typeof(BatWing),
			typeof(GraveDust),
			typeof(DaemonBlood),
		...
		public static Type[] ImbuingEssenceIngreds
		{
			get { return m_ImbuingEssenceIngreds; }
		}
		...
		private static readonly Type[] m_InstrumentTypes = new[]
		{
			typeof(Drums),
			typeof(Harp),
			typeof(LapHarp),
		...
		public static Type[] MysticScrollTypes
		{
			get { return m_MysticScrollTypes; }
		}

		#region Mondain's Legacy
		private static readonly Type[] m_ArcanistScrollTypes = new[]
		{
			typeof(ArcaneCircleScroll),
			typeof(GiftOfRenewalScroll),
			typeof(ImmolatingWeaponScroll),
			...
			typeof(ReaperFormScroll),
			typeof(WildfireScroll),
			typeof(EssenceOfWindScroll),
			typeof(DryadAllureScroll),
			typeof(EtherealVoyageScroll),
			typeof(WordOfDeathScroll),
			typeof(GiftOfLifeScroll),
		...
		{
			get { return m_SENecromancyScrollTypes; }
		}
		...
		{
			get { return m_MysticismScrollTypes; }
		}

		#region Mondain's Legacy
		public static Type[] ArcanistScrollTypes
		{
			get { return m_ArcanistScrollTypes; }
		}
		#endregion

		private static readonly Type[] m_GrimmochJournalTypes = new[]
		{
			typeof(GrimmochJournal1),
			typeof(GrimmochJournal2),
			typeof(GrimmochJournal3),
			typeof(GrimmochJournal6),
			typeof(GrimmochJournal7),
			typeof(GrimmochJournal11),
			typeof(GrimmochJournal14),
			typeof(GrimmochJournal17),
			typeof(GrimmochJournal23),
		};

		public static Type[] GrimmochJournalTypes
		{
			get { return m_GrimmochJournalTypes; }
		}

		private static readonly Type[] m_LysanderNotebookTypes = new[]
		{
			typeof(LysanderNotebook1),
			typeof(LysanderNotebook2),
			typeof(LysanderNotebook3),
			typeof(LysanderNotebook7),
			typeof(LysanderNotebook8),
			typeof(LysanderNotebook11),
		};

		public static Type[] LysanderNotebookTypes
		{
			get { return m_LysanderNotebookTypes; }
		}

		private static readonly Type[] m_TavarasJournalTypes = new[]
		{
			typeof(TavarasJournal1),
			typeof(TavarasJournal2),
			typeof(TavarasJournal3),
			typeof(TavarasJournal6),
			typeof(TavarasJournal7),
			typeof(TavarasJournal8),
			typeof(TavarasJournal9),
			typeof(TavarasJournal11),
			typeof(TavarasJournal14),
			typeof(TavarasJournal16),
			typeof(TavarasJournal16b),
			typeof(TavarasJournal17),
			typeof(TavarasJournal19),
		};

		public static Type[] TavarasJournalTypes
		{
			get { return m_TavarasJournalTypes; }
		}
		...
		private static readonly Type[] m_WandTypes = new[]
		{
			typeof(ClumsyWand),
			typeof(FeebleWand),
		...
		public static Type[] AosSpellbookTypes
		{
			get { return m_SpellbookTypes; }
		}

		//마법책
		private static readonly Type[] m_SpellbookTypes = new[]
		{
			typeof(Magerybook), //, typeof(MysticBook), typeof(NecromancerSpellbook), typeof(SpellweavingBook)
		};
		...
		{
			/*typeof(Cloak), typeof(Sandals), typeof(Tunic), typeof(Shoes), typeof(Shirt), typeof(Kilt), typeof(Skirt), typeof(FancyShirt), typeof(FancyDress), typeof(ThighBoots), typeof(LongPants), typeof(PlainDress), typeof(Robe), typeof(ShortPants),
			typeof(HalfApron),
			typeof(MaleElvenRobe), typeof(FemaleElvenRobe), typeof(ElvenPants), typeof(ElvenShirt), typeof(ElvenDarkShirt),
			typeof(ElvenBoots), typeof(WoodlandBelt), typeof(BodySash), typeof(Doublet), typeof(Boots), typeof(FullApron), typeof(JesterSuit), typeof(Surcoat), */
			typeof(Bonnet),
			typeof(Cap),
			typeof(FeatheredHat),
			typeof(FloppyHat),
		...
		public static Type[] SpellbookTypes
		{
			get { return m_SpellbookTypes; }
		}
		...
		{
			typeof(GrammarOfOrcish),
			typeof(CallToAnarchy),
			typeof(ArmsAndWeaponsPrimer),
			typeof(SongOfSamlethe),
			typeof(TaleOfThreeTribes),
			typeof(GuideToGuilds),
			typeof(BirdsOfBritannia),
			typeof(BritannianFlora),
			typeof(ChildrenTalesVol2),
			typeof(TalesOfVesperVol1),
			typeof(DeceitDungeonOfHorror),
			typeof(DimensionalTravel),
			typeof(EthicalHedonism),
			typeof(MyStory),
			typeof(DiversityOfOurLand),
			typeof(QuestOfVirtues),
			typeof(RegardingLlamas),
			typeof(TalkingToWisps),
			typeof(TamingDragons),
			typeof(BoldStranger),
			typeof(BurningOfTrinsic),
			typeof(TheFight),
			typeof(LifeOfATravellingMinstrel),
			typeof(MajorTradeAssociation),
			typeof(RankingsOfTrades),
			typeof(WildGirlOfTheForest),
			typeof(TreatiseOnAlchemy),
			typeof(VirtueBook),
		};
		...
		{
			return Construct(m_SpellbookTypes) as Spellbook;
		}
		...
		public static BaseWeapon RandomRangedWeapon(
			bool inTokuno = false,
			bool isMondain = false,
			bool isStygian = false
		)
		{
		...
		public static Item RandomWeaponOrJewelry(bool inTokuno = false, bool isMondain = false, bool isStygian = false)
		{
			...
			#region Stygian Abyss
			if (Core.SA && isStygian)
				return Construct(m_JewelryTypes, m_WeaponTypes);
			#endregion
		...
		{
			return Construct(m_ArmorTypes, m_ClothingTypes, m_JewelryTypes);
			#region Stygian Abyss
			if (Core.SA && isStygian)
		...
		{
			return Construct(m_WeaponTypes, m_RangedWeaponTypes, m_ArmorTypes, m_ClothingTypes, m_SpellbookTypes);
			#region Stygian Abyss
			if (Core.SA && isStygian)
