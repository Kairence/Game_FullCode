...
namespace Server.Misc
{
	...
	public class InhumanSpeech
	{
		...
		{
			get { return this.m_Syllables; }
			set { this.m_Syllables = value; }
		}
		public string[] Keywords
		{
			...
			set
			{
				...
				this.m_KeywordHash = new Dictionary<string, string>(
					this.m_Keywords.Length,
		...
		{
			if (
				(this.m_Flags & IHSFlags.OnSpeech) == 0
				|| this.m_Keywords == null
				|| this.m_Responses == null
				|| this.m_KeywordHash == null
			)
