    ...
    public class RegenRates
    {
        ...
        public static int Mobile_HitsRegenRate(Mobile from)
        {
			if( from is PlayerMobile )
			{
				...
				if( pm.TimerList[65] != 0 || pm.TimerList[64] != 0 )
				{
					if( pm.UseBandage >= 1 )
						pm.UseBandage--;
				}
			...
			else if( from is BaseCreature )
			{
				...
				if( bc.ControlMaster == null && bc.SummonMaster == null )
				{
					if( bc.Boss )
					{
						from.HitsRegenBonus = bc.Fame / 50;
					}
					switch(bc.Grade)
					{
						case 1: from.HitsRegenBonus = bc.Fame / 1000;
						break;
						case 2: from.HitsRegenBonus = bc.Fame / 500;
						break;
						case 3: from.HitsRegenBonus = bc.Fame / 500;
						break;
						case 4: from.HitsRegenBonus = bc.Fame / 500;
						break;
						case 5: from.HitsRegenBonus = bc.Fame / 500;
						break;
						case 6: from.HitsRegenBonus = bc.Fame / 250;
						break;
        ...
        public static int Mobile_StamRegenRate(Mobile from)
        {
			...
			else if( from is BaseCreature )
			{
				...
				{
					if( bc.Boss )
						from.StamRegenBonus = bc.Fame / 50;
					switch(bc.Grade)
					{
						case 1: from.StamRegenBonus = bc.Fame / 1000;
						break;
						case 2: from.StamRegenBonus = bc.Fame / 500;
						break;
						case 3: from.StamRegenBonus = bc.Fame / 500;
						break;
						case 4: from.StamRegenBonus = bc.Fame / 500;
						break;
						case 5: from.StamRegenBonus = bc.Fame / 500;
						break;
						case 6: from.StamRegenBonus = bc.Fame / 250;
						break;
						case 7: from.StamRegenBonus = bc.Fame / 100;
						break;
					}
					//return regenBonus;
				}
        ...
        public static int Mobile_ManaRegenRate(Mobile from)
        {
			...
			else if( from is BaseCreature )
			{
				...
				{
					if( bc.Boss )
						from.ManaRegenBonus = bc.Fame / 50;
					switch(bc.Grade)
					{
						case 1: from.ManaRegenBonus = bc.Fame / 1000;
						break;
						case 2: from.ManaRegenBonus = bc.Fame / 500;
						break;
						case 3: from.ManaRegenBonus = bc.Fame / 500;
						break;
						case 4: from.ManaRegenBonus = bc.Fame / 500;
						break;
						case 5: from.ManaRegenBonus = bc.Fame / 500;
						break;
						case 6: from.ManaRegenBonus = bc.Fame / 250;
						break;
						case 7: from.ManaRegenBonus = bc.Fame / 100;
						break;
					}
					//return regenBonus;
				}
