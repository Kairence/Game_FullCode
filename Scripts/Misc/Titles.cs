...
namespace Server.Misc
{
	public class Titles
	{
			...
			for (int i = 0; i < m_FameEntries.Length; ++i)
			{
				...
				if (fame >= fe.m_Fame)
				{
					...
					for (int j = 0; j < karmaEntries.Length; ++j)
					{
						...
						if (
							(karma >= 0 && ke.m_Karma >= 0 && karma >= ke.m_Karma)
							|| (karma < 0 && ke.m_Karma < 0 && karma < ke.m_Karma)
						)
						{
		...
		public static string ComputeTitle(Mobile beholder, Mobile beheld)
		{
			...
			if (
				Core.SA
				&& beheld.ShowFameTitle
				&& beheld is PlayerMobile
				&& ((PlayerMobile)beheld).FameKarmaTitle != null
			)
			{
		...
		private static readonly FameEntry[] m_FameEntries = new FameEntry[]
		{
			new FameEntry(
				...
				new KarmaEntry[]
				{
					new KarmaEntry(-100000, "The Outcast {0}"),
					new KarmaEntry(-15000, "The Despicable {0}"),
					new KarmaEntry(-10000, "The Scoundrel {0}"),
					new KarmaEntry(-5000, "The Unsavory {0}"),
					new KarmaEntry(-2500, "The Rude {0}"),
					new KarmaEntry(2499, "{0}"),
					new KarmaEntry(4999, "The Fair {0}"),
					new KarmaEntry(9999, "The Kind {0}"),
					new KarmaEntry(14999, "The Good {0}"),
					new KarmaEntry(24999, "The Honest {0}"),
			...
			new FameEntry(
				...
				new KarmaEntry[]
				{
					new KarmaEntry(-100000, "The Wretched {0}"),
					new KarmaEntry(-15000, "The Dastardly {0}"),
					new KarmaEntry(-10000, "The Malicious {0}"),
					new KarmaEntry(-5000, "The Dishonorable {0}"),
					new KarmaEntry(-2500, "The Disreputable {0}"),
					new KarmaEntry(2499, "The Notable {0}"),
					new KarmaEntry(4999, "The Upstanding {0}"),
					new KarmaEntry(9999, "The Respectable {0}"),
					new KarmaEntry(14999, "The Honorable {0}"),
					new KarmaEntry(24999, "The Commendable {0}"),
			...
			new FameEntry(
				...
				new KarmaEntry[]
				{
					new KarmaEntry(-100000, "The Nefarious {0}"),
					new KarmaEntry(-15000, "The Wicked {0}"),
					new KarmaEntry(-10000, "The Vile {0}"),
					new KarmaEntry(-5000, "The Ignoble {0}"),
					new KarmaEntry(-2500, "The Notorious {0}"),
					new KarmaEntry(2499, "The Prominent {0}"),
					new KarmaEntry(4999, "The Reputable {0}"),
					new KarmaEntry(9999, "The Proper {0}"),
					new KarmaEntry(14999, "The Admirable {0}"),
					new KarmaEntry(24999, "The Famed {0}"),
			...
			new FameEntry(
				...
				new KarmaEntry[]
				{
					new KarmaEntry(-100000, "The Dread {0}"),
					new KarmaEntry(-15000, "The Evil {0}"),
					new KarmaEntry(-10000, "The Villainous {0}"),
					new KarmaEntry(-5000, "The Sinister {0}"),
					new KarmaEntry(-2500, "The Infamous {0}"),
					new KarmaEntry(2499, "The Renowned {0}"),
					new KarmaEntry(4999, "The Distinguished {0}"),
					new KarmaEntry(9999, "The Eminent {0}"),
					new KarmaEntry(14999, "The Noble {0}"),
					new KarmaEntry(24999, "The Illustrious {0}"),
			...
			new FameEntry(
				...
				new KarmaEntry[]
				{
					new KarmaEntry(-25000, "The Dread {1} {0}"),
					new KarmaEntry(-15000, "The Evil {1} {0}"),
					new KarmaEntry(-10000, "The Dark {1} {0}"),
					new KarmaEntry(-5000, "The Sinister {1} {0}"),
					new KarmaEntry(-2500, "The Dishonored {1} {0}"),
					new KarmaEntry(2499, "{1} {0}"),
					new KarmaEntry(4999, "The Distinguished {1} {0}"),
					new KarmaEntry(9999, "The Eminent {1} {0}"),
					new KarmaEntry(14999, "The Noble {1} {0}"),
					new KarmaEntry(24999, "The Illustrious {1} {0}"),
					new KarmaEntry(25000, "The Glorious {1} {0}"),
				}
			),
		};
