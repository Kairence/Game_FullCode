...
namespace Server.Mobiles
{
	...
	{
		public static int MutateCheck
		{
			get { return Utility.RandomMinMax(30, 120); }
		}

		public static bool RemoveFromSpawners
		{
			get { return true; }
		}
		...
		public virtual int GroupAmount
		{
			get { return 2; }
		}
		public virtual VoidEvolution Evolution
		{
			get { return VoidEvolution.None; }
		}
		...
		public bool BuddyMutate
		{
			get { return m_BuddyMutate; }
			set { m_BuddyMutate = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public DateTime NextMutate
		{
			get { return m_NextMutate; }
			set { m_NextMutate = value; }
		}

		public override bool PlayerRangeSensitive
		{
			get { return Evolution != VoidEvolution.Killing && Stage < 3; }
		}
		...
		public BaseVoidCreature(Serial serial)
			: base(serial) { }
		...
		public static void RemoveVoidSpawners()
		{
			...
			foreach (XmlSpawner spawner in World.Items.Values.OfType<XmlSpawner>())
			{
				...
				foreach (XmlSpawner.SpawnObject obj in spawner.SpawnObjects)
				{
					...
					if (
						t != null && t.IsSubclassOf(typeof(BaseVoidCreature))
						|| obj.TypeName.ToLower().StartsWith("korpre")
					)
					{
						list.Add(spawner);
						break;
