...
namespace Server.Engines.Quests
{
	public class ThievesBeAfootQuest : BaseQuest
	{
		...
		{
			get { return 1094960; }
		} /*Travel into the Underworld and search for the stolen
		...
		{
			get { return 1094961; }
		} /*Fine then, be on yar way but be warned!  Ol' Flint makes
		...
		{
			get { return 1094962; }
		} /*What?  Back so soon and narry a barrel in sight?  Be y
		...
		{
			get { return 1094965; }
		} /*Ah, thar she is!  That's me barrel all right, I knew
		...
		{
			get { return QuestChain.FlintTheQuartermaster; }
		}
		public override Type NextQuest
		{
			get { return typeof(BibliophileQuest); }
		}
	...
	public class BibliophileQuest : BaseQuest
	{
		...
		{
			get { return 1094970; }
		} /*Travel into the Underworld and find the Flint's stolen
		...
		{
			get { return 1094971; }
		} /*'Tis a fine thing to do to a friend in need!  But so be it.
		...
		{
			get { return 1094972; }
		} /*'Ave ye laid hold to ol' Flint's log book yet?  Oh, I'm sorry, 
                                                                         * I jes' figured ye would have it back by now... Carry on then!*/

		public override object Complete
		{
			get { return 1094975; }
		} /*'Ave ye laid hold to ol' Flint's log book did ye?  Let me
	...
	public class QuartermasterFlint : MondainQuester
	{
		...
		{
			get { return new Type[] { typeof(ThievesBeAfootQuest) }; }
		}
