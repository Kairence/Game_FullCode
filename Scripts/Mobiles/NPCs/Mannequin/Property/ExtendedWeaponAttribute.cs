...
namespace Server.Mobiles.MannequinProperty
{
	...
	public class FocusProperty : ExtendedWeaponAttr
	{
		...
		{
			get { return 1152465; }
		} // This property provides increased weapon damage with each successful hit to the same target.  The damage modified by this property cycles from a negative value to a positive value.  The initial damage inflicted by this property is -40% of the items base damage; however the latter damage inflicted by this property is +20% of the items base damage.  When the user switches to a new target the damage increase resets back to the negative value and the cycling begins again.
		public override ExtendedWeaponAttribute Attribute
		{
			get { return ExtendedWeaponAttribute.Focus; }
		}
		public override int Hue
		{
			get { return 0x43FF; }
	...
	public class BoneBreakerProperty : ExtendedWeaponAttr
	{
		...
		{
			get { return 1157319; }
		} // This property provides a chance to cause a loss of stamina over time and prevent the use of refreshment potions for a period of time to the target.  This property can be found on select artifacts.
		public override ExtendedWeaponAttribute Attribute
		{
			get { return ExtendedWeaponAttribute.BoneBreaker; }
		}
		public override int Hue
		{
			get { return 0x43FF; }
