...
namespace Server.Mobiles.MannequinProperty
{
	public abstract class AosArmorAttr : ValuedProperty
	{
		...
		public double GetPropertyValue(Item item)
		{
			...
			{
				return ((BaseClothing)item).ArmorAttributes[Attribute];
			}
	...
	public class ArmorSelfRepairProperty : AosArmorAttr
	{
		...
		public override AosArmorAttribute Attribute
		{
			get { return AosArmorAttribute.SelfRepair; }
		}
	}
	...
	public class ArmorReactiveParalyzeProperty : AosArmorAttr
	{
		...
		public override AosArmorAttribute Attribute
		{
			get { return AosArmorAttribute.ReactiveParalyze; }
		}
	...
	public class SoulChargeProperty : AosArmorAttr
	{
		...
		{
			get { return 1152382; }
		} // This property converts a percentage of the damage inflicted to a player into mana replenishment.  This effect can only be triggered once every 40 seconds.  This property is only found on shields.
		public override AosArmorAttribute Attribute
		{
			get { return AosArmorAttribute.SoulCharge; }
		}
		public override int Hue
		{
			get { return 0x1FF; }
