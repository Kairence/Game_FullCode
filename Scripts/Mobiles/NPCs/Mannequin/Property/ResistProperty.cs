...
namespace Server.Mobiles.MannequinProperty
{
	...
	public class PhysicalResistProperty : ResistAttr
	{
		...
		public override ResistanceType Resist
		{
			get { return ResistanceType.Physical; }
		}
		public override int Description
		{
			get { return 1115226; }
		} // This property reduces the damage taken from attacks that cause physical damage.  This property can be found on all armor, shields, accessories or weapons.
	...
	public class FireResistProperty : ResistAttr
	{
		...
		public override ResistanceType Resist
		{
			get { return ResistanceType.Fire; }
		}
		public override int Description
		{
			get { return 1115227; }
		} // This property reduces the damage taken from attacks that cause fire damage.  This property can be found on all armor, shields, accessories or weapons.
		public override int SpriteW
		{
			get { return 150; }
		}
	...
	public class ColdResistProperty : ResistAttr
	{
		...
		public override ResistanceType Resist
		{
			get { return ResistanceType.Cold; }
		}
		public override int Description
		{
			get { return 1115228; }
		} // This property reduces the damage taken from attacks that cause cold damage.  This property can be found on all armor, shields, accessories or weapons.
		public override int SpriteW
		{
			get { return 0; }
		}
	...
	public class PoisonResistProperty : ResistAttr
	{
		...
		public override ResistanceType Resist
		{
			get { return ResistanceType.Poison; }
		}
		public override int Description
		{
			get { return 1115229; }
		} // This property reduces the damage taken from attacks that cause poison damage.  This property can be found on all armor, shields, accessories or weapons.
		public override int SpriteW
		{
			get { return 60; }
		}
	...
	public class EnergyResistProperty : ResistAttr
	{
		...
		public override ResistanceType Resist
		{
			get { return ResistanceType.Energy; }
		}
		public override int Description
		{
			get { return 1115230; }
		} // This property reduces the damage taken from attacks that cause energy damage.  This property can be found on all armor, shields, accessories or weapons.
		public override int SpriteW
		{
			get { return 120; }
		}
