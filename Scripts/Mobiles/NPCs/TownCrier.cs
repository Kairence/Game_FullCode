...
namespace Server.Mobiles
{
	...
	public class GlobalTownCrierEntryList : ITownCrierEntryList
	{
		...
		public bool IsEmpty
		{
			get { return (m_Entries == null || m_Entries.Count == 0); }
		}
	...
	public class TownCrierEntry
	{
		...
		public bool Expired
		{
			get { return (DateTime.UtcNow >= m_ExpireTime); }
		}
	...
	public class TownCrierLinesPrompt : Prompt
	{
		...
		public TownCrierLinesPrompt(
			ITownCrierEntryList owner,
			...
			: base(50, 50)
		{
			...
			if (owner is GlobalTownCrierEntryList)
			{
				AddHtml(
					...
					300 - 8 - 30,
					20,
					"<basefont color=#FFFFFF><center>GLOBAL TOWN CRIER MESSAGES</center></basefont>",
					false,
					false
				);
			}
			else
			{
				AddHtml(
					...
					300 - 8 - 30,
					20,
					"<basefont color=#FFFFFF><center>TOWN CRIER MESSAGES</center></basefont>",
					false,
					false
				);
			}
	...
	public class TownCrier : Mobile, ITownCrierEntryList
	{
		...
		public void ForceBeginAutoShout()
		{
			if (m_AutoShoutTimer == null)
				m_AutoShoutTimer = Timer.DelayCall(
					TimeSpan.FromMinutes(1.0),
					TimeSpan.FromMinutes(5.0),
					new TimerCallback(AutoShout_Callback)
				);
		}
