...
namespace Server.Mobiles
{
	...
	public class ChangeHairstyleEntry
	{
		...
		public int ItemID_Male
		{
			get { return m_ItemID_Male; }
		}
		public int ItemID_Female
		{
			get { return m_ItemID_Female; }
		}
		public int GumpID_Male
		{
			get { return m_GumpID_Male; }
		}
		public int GumpID_Female
		{
			get { return m_GumpID_Female; }
		}
		public int X
		{
			get { return m_X; }
	...
	public class ChangeHairstyleGump : Gump
	{
			...
			: base(50, 50)
		{
			...
			AddButton(
				90 + (tableWidth * offsetWidth) - 180,
				85 + (tableHeight * offsetHeight),
				4005,
				4007,
				0,
				...
				if (info.ButtonID == 1)
				{
					...
					if (switches.Length > 0)
					{
						...
						if (index >= 0 && index < m_Entries.Length)
						{
							...
							{
								bool invalid = m_FacialHair
									? facialHairID > 0 && facialHairID == itemID
									: hairID > 0 && hairID == itemID;
