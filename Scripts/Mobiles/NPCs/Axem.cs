...
namespace Server.Engines.Quests
{
	public class ABrokenVaseQuest : BaseQuest
	{
		...
		{
			AddObjective(
				new ObtainObjective(typeof(AncientPotteryFragments), "Ancient Pottery Fragments", 10, 0x223B, 0, 2108)
			);
	...
	public class YeOldeGargishQuest : BaseQuest
	{
		...
		{
			AddObjective(
				new ObtainObjective(typeof(UntranslatedAncientTome), "Untranslated Ancient Tome", 1, 0xFF2, 0, 2405)
			);
