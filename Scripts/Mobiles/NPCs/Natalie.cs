...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        /* I was born and raised in Buc뭩 Den. Have you been there? Then you know what a lawless place it is. Five years 
        ago, my mother and father were killed by brigands there. I was only a child, and so I was sent here to live with 
        my uncle.<br>Recently, a man moved into town, and I뭢 sure this man is the one who killed my parents. The sheriff 
        will do nothing, he doesn뭪 believe me. What can I do? I뭢 no warrior. I can뭪 use magic. I don뭪 have the courage 
