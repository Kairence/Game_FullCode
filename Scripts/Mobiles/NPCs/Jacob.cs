...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        /* Couldn뭪 find my iron mine, could ya? Well, neither can I!<br><br>*Jacob laughs*<br><br>Oh, ya don뭪 wanna find it? 
        Well, allrighty then, ya might as well head on back down to town then and stop cluttering up my camp. Come back and 
        talk to me if you뭨e interested in learnin?멳out minin? */
        ...
        /* Where ya been off a gallivantin?all day, pilgrim? You ain뭪 seen no hard work yet! Get yer arse back out there to 
        my mine and dig up some more iron. Don뭪 forget to take a pickaxe or shovel, and if you뭨e so inclined, a packhorse too. */
        ...
        /* Dang gun it! If that don't beat all! Ya went and did it, didn뭪 ya? What we got ourselves here is a mighty fine brand 
        spankin?new Apprentice Miner!<br><br>I can see ya put some meat on them bones too while you were at it!<br><br>Here뭩 
        that little somethin?I told ya I had for ya. It뭩 a pickaxe with some high falutin?magic inside that뭠l help you find 
        the good stuff when you뭨e off minin? It wears out fast, though, so you can only use it a few times a day.<br><br>Welp, 
        I뭭e got some smeltin?to do, so off with ya. Good luck, pilgrim! */
