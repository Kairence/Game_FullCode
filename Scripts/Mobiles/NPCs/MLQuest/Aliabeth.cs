...
namespace Server.Engines.Quests
{
    public class TheExchangeQuest : BaseQuest
    {
        ...
        //soon, and I haven뭪 seen them in quite awhile, so I want to present them both with a
        //surprise when they arrive.<br><br>My sister absolutely adores white chocolate, but 
        //gargoyles don뭪 seem to care for it much, so I haven뭪 been able to find any here.
        //It was recently my mother뭩 birthday, and I know that she would love some finely 
        //crafted gargish jewelry, but the jeweler hasn뭪 had her favorite jewel in stock for 
        ...
        //these presents. Here is your reward. You뭠l have to excuse me while I set this dark
    ...
    public class AWorthyPropositionQuest : BaseQuest
    {
        ...
        //imbuing ingredients I뭠l give you in exchange. What do you say?
        public override object Description
        {
            get
            {
        ...
        //Well, if you change your mind, I뭠l be here.
        public override object Refuse
        {
            get
            {
        ...
        //basket. What뭩 that? Did I say basket? I meant, bakery! Yes, I am inventing a, um, floor 
