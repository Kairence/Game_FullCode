...
namespace Server.Engines.Quests
{
	public class Fish1_Quest : BaseQuest
	{
		...
		{
			get { return "근처의 바다나 강에서 송어를 조금 낚아오게"; }
		}
	...
	public class Fish4_Quest : BaseQuest
	{
		...
		public override object Title
		{
			get { return "4. 본격적인 낚시"; }
		}

		public override object Description
		{
			get { return "근처의 바다나 강에서 송어와 배스를 조금 낚아오게"; }
		}
	...
	public class Fish5_Quest : BaseQuest
	{
		...
		public override object Title
		{
			get { return "5. 비늘의 아름다움"; }
		}

		public override object Description
		{
			get { return "근처의 바다나 강에서 배스와 은어를 조금 낚아오게"; }
		}
	...
	public class Fish6_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 바다나 강에서 붕어를 조금 낚아오게"; }
		}
	...
	public class Fish7_Quest : BaseQuest
	{
		...
		public override object Title
		{
			get { return "7. 마스터 낚시꾼"; }
		}

		public override object Description
		{
			get { return "근처의 바다와 숲에서 송어와 메기를 조금 낚아오게"; }
		}
	...
	public class Fish8_Quest : BaseQuest
	{
		...
		public override object Title
		{
			get { return "8. 깊은 바다로의 여정"; }
		}

		public override object Description
		{
			get { return "근처의 바다나 강에서 송어와 대구를 조금 낚이오게"; }
		}
	...
	public class Fish9_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 바다나 강에서 농어를 조금 낚아오게"; }
		}
	...
	public class Freddy : MondainQuester
	{
		...
		{
			get { return new Type[] { typeof(Fish1_Quest) }; }
		}
