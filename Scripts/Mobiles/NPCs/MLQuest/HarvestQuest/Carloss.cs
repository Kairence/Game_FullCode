...
namespace Server.Engines.Quests
{
	public class Ore1_Quest : BaseQuest
	{
		...
		{
			get { return "근처의 광산이나 바위에서 철을 조금 캐와주게"; }
		}
	...
	public class Ore2_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 광산이나 바위에서 철을 적당히 캐와주게"; }
		}
	...
	public class Ore3_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 광산이나 바위에서 철과 구리를 적당히 캐와주게"; }
		}
	...
	public class Ore4_Quest : BaseQuest
	{
		...
		public override object Title
		{
			get { return "4. 본격적인 채광"; }
		}

		public override object Description
		{
			get { return "근처의 광산이나 바위에서 철과 구리, 청동을 적당히 캐와주게"; }
		}
	...
	public class Ore5_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 광산이나 바위에서 구리와 청동을 많이 캐와주게"; }
		}
	...
	public class Ore6_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 광산이나 바위에서 금을 많이 캐와주게"; }
		}
	...
	public class Ore7_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 광산이나 바위에서 아가파이트를 많이 캐와주게"; }
		}
	...
	public class Ore8_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 광산이나 바위에서 베라이트를 많이 캐와주게"; }
		}
	...
	public class Ore9_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 광산이나 바위에서 발로라이트를 많이 캐와주게"; }
		}
	...
	public class Carloss : MondainQuester
	{
		...
		{
			get { return new Type[] { typeof(Ore1_Quest) }; }
		}
