...
namespace Server.Engines.Quests
{
	public class Hide1_Quest : BaseQuest
	{
		...
		{
			get { return "1. 무두질의 시작"; }
		}

		public override object Description
		{
			get { return "근처의 숲에서 통가죽을 조금 가져와 주게"; }
		}
	...
	public class Hide4_Quest : BaseQuest
	{
		...
		public override object Title
		{
			get { return "4. 본격적인 무두질"; }
		}

		public override object Description
		{
			get { return "근처의 숲에서 통가죽과 질긴 통가죽을 조금 모아오게"; }
		}
	...
	public class Hide5_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 숲에서 질긴 통가죽과 거친 통가죽을 조금 모아오게"; }
		}
	...
	public class Hide6_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 숲에서 경화 통가죽을 조금 모아오게"; }
		}
	...
	public class Hide7_Quest : BaseQuest
	{
		...
		public override object Title
		{
			get { return "7. 마스터 무두장이"; }
		}

		public override object Description
		{
			get { return "근처의 숲에서 가시 통가죽을 조금 모아오게"; }
		}
	...
	public class Hide8_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 숲에서 뿔 통가죽을 조금 모아오게"; }
		}
	...
	public class Hide9_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 숲에서 미늘 통가죽을 조금 모아오게"; }
		}
	...
	public class John : MondainQuester
	{
		...
		{
			get { return new Type[] { typeof(Hide1_Quest) }; }
		}
