...
namespace Server.Engines.Quests
{
	public class Log1_Quest : BaseQuest
	{
		...
		{
			get { return "근처의 나무나 숲에서 통나무를 조금 캐와주게"; }
		}
	...
	public class Log4_Quest : BaseQuest
	{
		...
		public override object Title
		{
			get { return "4. 본격적인 벌목"; }
		}

		public override object Description
		{
			get { return "근처의 나무나 숲에서 통나무와 떡갈나무를 조금 캐와주게"; }
		}
	...
	public class Log5_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 나무나 숲에서 떡갈나무와 물푸레나무를 조금 캐와주게"; }
		}
	...
	public class Log6_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 나무나 숲에서 주목나무를 조금 캐와주게"; }
		}
	...
	public class Log7_Quest : BaseQuest
	{
		...
		public override object Title
		{
			get { return "7. 마스터 나무꾼"; }
		}

		public override object Description
		{
			get { return "근처의 나무나 숲에서 통나무와 심재 나무를 조금 캐와주게"; }
		}
	...
	public class Log8_Quest : BaseQuest
	{
		...
		public override object Title
		{
			get { return "8. 살아있는 나무"; }
		}

		public override object Description
		{
			get { return "근처의 나무나 숲에서 통나무와 피나무를 조금 캐와주게"; }
		}
	...
	public class Log9_Quest : BaseQuest
	{
		...
		public override object Description
		{
			get { return "근처의 나무나 숲에서 통나무와 서리나무를 조금 캐와주게"; }
		}
	...
	public class Tom : MondainQuester
	{
		...
		{
			get { return new Type[] { typeof(Log1_Quest) }; }
		}
