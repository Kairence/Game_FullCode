...
{
    public class Despise2_1Quest : BaseQuest
    { 
        //public override QuestChain ChainID { get { return QuestChain.Despise2; } }
        public override Type NextQuest { get { return typeof(Despise2_2Quest); } }
        public Despise2_1Quest()
            : base()
        {
            this.AddObjective(new SlayObjective(typeof(Lizardman), "Lizardmans", 100, "Despise"));
			/*
            this.AddObjective(new SlayObjective(typeof(LizardmanDefender), "Lizardman Defenders", 30, "Despise"));
            this.AddObjective(new SlayObjective(typeof(Ettin), "Ettins", 30, "Despise"));
            this.AddObjective(new SlayObjective(typeof(HeadlessOne), "HeadlessOne", 30, "Despise"));
            this.AddObjective(new SlayObjective(typeof(Troll), "Trolls", 30, "Despise"));
            this.AddObjective(new SlayObjective(typeof(Cyclops), "Cyclopses", 5, "Despise"));
			*/
            this.AddReward(new BaseReward(typeof(Despise1RewardBag), "활동 포인트 200점"));
            this.AddReward(new BaseReward(typeof(Despise1RewardBag), "골드 1000"));
        }
        ...
        public override object Description
        {
            get
            {
                return "빌어먹을 도마뱀놈들은 너무 빠르게 개체수가 늘어난다오! 서둘러 데스파이즈 2층으로 가서 냄새나는 파충류들을 최대한 잡아주시오!";
            }
        }
        ...
        {
			Owner.EquipPoint[0] += 200;
			Owner.SendMessage("활동 포인트를 200점 획득합니다.");
			/*
    ...
    public class Despise2_2Quest : BaseQuest
    { 
        //public override QuestChain ChainID { get { return QuestChain.Despise2; } }
        public Despise2_2Quest()
            : base()
        {
            this.AddObjective(new SlayObjective(typeof(LizardmanDefender), "Lizardman Defenders", 1, "Despise"));
			/*
            this.AddObjective(new SlayObjective(typeof(Lizardman), "Lizardmans", 100, "Despise"));
            this.AddObjective(new SlayObjective(typeof(Ettin), "Ettins", 30, "Despise"));
            this.AddObjective(new SlayObjective(typeof(HeadlessOne), "HeadlessOne", 30, "Despise"));
        ...
        public override object Description
        {
            get
            {
                return "호 아주 좋아요! 하지만 저 빌어먹을 단단한 도마뱀놈들은 잡기가 쉽지 않군! 계속해서 날 도와주시오. 저 파충류들을 모두 쓸어버립시다!";
            }
        }
        /* I do not fault your decision. */
        public override object Refuse
    ...
    { 
        public OverpopulationQuest()
            : base()
        { 
            this.AddObjective(new SlayObjective(typeof(Hind), "hinds", 10, 3600));
    ...
    { 
        public NewLeadershipQuest()
            : base()
        {
            this.AddObjective(new SlayObjective(typeof(Lizardman), "Lizardmans", 30, "Despise"));
            this.AddObjective(new SlayObjective(typeof(LizardmanDefender), "Lizardman Defenders", 30, "Despise"));
            this.AddObjective(new SlayObjective(typeof(Ettin), "Ettins", 30, "Despise"));
            this.AddObjective(new SlayObjective(typeof(HeadlessOne), "HeadlessOne", 30, "Despise"));
            this.AddObjective(new SlayObjective(typeof(Troll), "Trolls", 30, "Despise"));
        ...
        public override object Description
        {
            get
            {
                return "당신에게 줄 임무가 있습니다, 모험가여. 큰 명성을 얻기 위해 어떤 모험이든 하겠소? 최근 데스파이즈 2층에 위험한 몬스터들이 너무 많아졌소. 이 몬스터들을 정리한다면 큰 명성을 얻을 수 있을 것이오!";
            }
        }
        /* I do not fault your decision. */
        public override object Refuse
    ...
    { 
        public ExAssassinsQuest()
            : base()
        { 
            this.AddObjective(new SlayObjective(typeof(Bogling), "Boglings", 50, "Despise"));
            this.AddObjective(new SlayObjective(typeof(Corpser), "Corpsers", 50, "Despise"));
            this.AddObjective(new SlayObjective(typeof(Treefellow), "Treefellows", 50, "Despise"));
            this.AddObjective(new SlayObjective(typeof(Reaper), "Reapers", 5, "Despise"));
    ...
    { 
        ...
        { 
            get
            {
                return new Type[] 
                {
					typeof(Despise2_1Quest)
					/*
					typeof(Despise2_2Quest)
