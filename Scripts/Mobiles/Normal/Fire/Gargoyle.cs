...
namespace Server.Mobiles
{
    ...
    public class Gargoyle : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.EvalInt, 10.1, 18.0);
            this.SetSkill(SkillName.Magery, 10.1, 18.0);
            this.SetSkill(SkillName.MagicResist, 10.1, 18.0);
            this.SetSkill(SkillName.Tactics, 10.1, 17.0);
            this.SetSkill(SkillName.Wrestling, 14.1, 18.0);
