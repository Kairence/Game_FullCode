...
namespace Server.Engines.Despise
{
	public class DespiseCreature : BaseCreature
	{
		...
		public virtual int TightLeashLength
		{
			get { return 1; }
		}
		public virtual int ShortLeashLength
		{
			get { return 1; }
		}
		public virtual int LongLeashLength
		{
			get { return 10; }
		}

		public virtual int StatRatio
		{
			get { return Utility.RandomMinMax(35, 60); }
		}

		public virtual double SkillStart
		{
			get { return Utility.RandomMinMax(80.0, 130.0); }
		}
		public virtual double SkillMax
		{
			get { return m_MaxPower == 15 ? 130.0 : 110.0; }
		}

		public virtual int StrStart
		{
			get { return Utility.RandomMinMax(91, 100); }
		}
		public virtual int DexStart
		{
			get { return Utility.RandomMinMax(91, 100); }
		}
		public virtual int IntStart
		{
			get { return Utility.RandomMinMax(91, 100); }
		}
		...
		public virtual int HitsStart
		{
			get { return StrStart + (int)((double)StrStart * ((double)StatRatio / 100.0)); }
		}
		public virtual int StamStart
		{
			get { return DexStart + (int)((double)DexStart * ((double)StatRatio / 100.0)); }
		}
		public virtual int ManaStart
		{
			get { return IntStart + (int)((double)IntStart * ((double)StatRatio / 100.0)); }
		}
		...
		public virtual int MinDamStart
		{
			get { return 8; }
		}
		public virtual int MaxDamStart
		{
			get { return 13; }
		}

		public virtual int MinDamMax
		{
			get { return 12; }
		}
		public virtual int MaxDamMax
		{
			get { return 17; }
		}

		public virtual bool RaiseDamage
		{
			get { return false; }
		}
		public virtual double RaiseDamageFactor
		{
			get { return 0.33; }
		}

		public virtual int GetFame
		{
			get { return m_Power * 500; }
		}
		public virtual int GetKarmaGood
		{
			get { return m_Power * 500; }
		}
		public virtual int GetKarmaEvil
		{
			get { return m_Power * -500; }
		}
		...
		{
			get { return Alignment < Alignment.Evil; }
		}
		...
		public override bool GivesFameAndKarmaAward
		{
			get { return false; }
		}
		...
		public override void GetContextMenuEntries(
			Mobile from,
			System.Collections.Generic.List<Server.ContextMenus.ContextMenuEntry> list
		) { }
		...
		public int GetLeashLength()
		{
			...
			{
				default:
				case LeashLength.Short:
					return ShortLeashLength;
				case LeashLength.Long:
					return LongLeashLength;
			}
		}
		...
		public static int GetPowerLabel(int power)
		{
			switch (power)
			{
				...
				case 1:
				case 3:
					return 1153298; // Normal
				case 4:
				case 5:
				case 6:
					return 1153299; // Improved
				case 7:
				case 8:
					return 1153300; // Heightened
				case 9:
				case 10:
					return 1153301; // Magnified
				case 11:
				case 12:
					return 1153302; // Amplified
				case 13:
				case 14:
					return 1153307; // Inspired
				case 15:
					return 1153308; // Galvanized
			}
		}
