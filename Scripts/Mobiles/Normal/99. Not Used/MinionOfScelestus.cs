...
namespace Server.Mobiles
{
	...
	public class MinionOfScelestus : BaseCreature
	{
		...
		public override bool AcquireOnApproach
		{
			get { return true; }
		}
		public override int AcquireOnApproachRange
		{
			get { return 12; }
		}
		...
		public override void OnThink()
		{
			...
			if (
				this.GetDistanceToSqrt(Home) > MaxWanderDistance
		...
		{
			typeof(ChallengeRite),
			typeof(AnthenaeumDecree),
			typeof(LetterFromTheKing),
			typeof(OnTheVoid),
			typeof(ShilaxrinarsMemorial),
			typeof(ToTheHighScholar),
			typeof(ToTheHighBroodmother),
			typeof(ReplyToTheHighScholar),
			typeof(AccessToTheIsle),
			typeof(InMemory),
		};
