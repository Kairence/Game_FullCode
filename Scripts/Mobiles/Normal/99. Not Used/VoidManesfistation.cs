...
namespace Server.Mobiles
{
	...
	public class VoidManifestation : BaseCreature
	{
		...
		[Constructable]
		public VoidManifestation()
			: this(0) { }

		[Constructable]
		public VoidManifestation(int type)
		...
		public override void OnDeath(Container c)
		{
			...
			switch (m_Type)
			{
				default:
					break;
				case 1:
					c.DropItem(new VoidCrystalOfCorruptedArcaneEssence());
					break;
				case 2:
					c.DropItem(new VoidCrystalOfCorruptedSpiritualEssence());
					break;
				case 3:
					c.DropItem(new VoidCrystalOfCorruptedMysticalEssence());
					break;
			}
		}

		public VoidManifestation(Serial serial)
			: base(serial) { }
