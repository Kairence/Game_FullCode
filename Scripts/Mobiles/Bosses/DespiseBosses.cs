...
namespace Server.Engines.Despise
{
	public class DespiseBoss : BaseCreature
	{
		...
		public virtual BaseCreature SummonWisp
		{
			get { return null; }
		}
		public virtual double WispScalar
		{
			get { return 0.33; }
		}
		...
		public BaseCreature Wisp
		{
			get { return m_Wisp; }
		}

		public DespiseBoss(AIType ai, FightMode fightmode)
			: base(ai, fightmode, 10, 1, .1, .2)
		{
		...
		public override void OnThink()
		{
			...
			{
				m_SummonTimer = Timer.DelayCall(
					TimeSpan.FromSeconds(Utility.RandomMinMax(40, 60)),
					new TimerCallback(SummonWisp_Callback)
				);
			}
		}
		...
		public DespiseBoss(Serial serial)
			: base(serial) { }
	...
	public class AdrianTheGloriousLord : DespiseBoss
	{
		...
		public override BaseCreature SummonWisp
		{
			get { return new EnsorcledWisp(); }
		}
		...
		public AdrianTheGloriousLord(Serial serial)
			: base(serial) { }
	...
	public class EnsorcledWisp : BaseCreature
	{
		...
		public EnsorcledWisp(Serial serial)
			: base(serial) { }
	...
	public class CorruptedWisp : BaseCreature
	{
		...
		public CorruptedWisp(Serial serial)
			: base(serial) { }
