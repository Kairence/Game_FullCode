...
namespace Server.Mobiles
{
	...
	public class AbyssalInfernal : BaseChampion
	{
		...
		public override Type[] SharedList
		{
			get
			{
				return new Type[] { typeof(RoyalGuardInvestigatorsCloak), typeof(DetectiveBoots), typeof(JadeArmband) };
			}
		}
		public override Type[] DecorativeList
		{
			get { return new Type[] { typeof(MagicalDoor) }; }
		}
		public override MonsterStatuetteType[] StatueTypes
		{
			get
			{
				...
				{
					MonsterStatuetteType.AbyssalInfernal,
					MonsterStatuetteType.ArchDemon,
				};
			}
		}
		...
		public void DoCondemn()
		{
			...
			if (map != null)
			{
				...
				if (toCondemn != null && !m_Table.ContainsKey(toCondemn))
				{
					...
					BuffInfo.AddBuff(
						toCondemn,
						new BuffInfo(BuffIcon.TrueFear, 1153791, 1153827, TimeSpan.FromSeconds(seconds), toCondemn)
					);
