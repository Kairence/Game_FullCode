...
namespace Server.Mobiles
{
	...
	public class Travesty : BasePeerless
	{
		...
		{
			get { return _CanDiscord; }
		}
		public override bool CanPeace
		{
			get { return _CanPeace; }
		}
		public override bool CanProvoke
		{
			get { return _CanProvoke; }
		}
		...
		public void ChangeBody()
		{
			...
			if (
				attacker.Skills[SkillName.Swords].Value >= 50.0
				|| attacker.Skills[SkillName.Fencing].Value >= 50.0
