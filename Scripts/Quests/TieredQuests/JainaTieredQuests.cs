...
namespace Server.Engines.Quests
{
	...
	public class OrcCaveTierQuest1 : BaseQuest, ITierQuest
	{
		...
		{
			get { return "오크 던전 청소하기!"; }
		}
		public override object Description
		{
			get { return "오크 던전을 청소합시다."; }
		}
	...
	public class OrcCaveTierQuest2 : BaseQuest, ITierQuest
	{
		...
		public override object Title
		{
			get { return "오크 잔당 처리하기!"; }
		}
		public override object Description
		{
			get { return "이제 본격적으로 처리할 시간이야."; }
		}
		public override object Refuse
		{
			get { return "다른 사람을 구해야겠군..."; }
	...
	public class OrcCaveTierQuest3 : BaseQuest, ITierQuest
	{
		...
		public override object Title
		{
			get { return "오크 던전 마지막 층"; }
		}
		public override object Description
		{
			get { return "타이탄과 오크 로드들이 마지막 발악을 하고 있네. 가서 처단해버려."; }
		}
		public override object Refuse
		{
			get { return "다른 사람을 구해야겠군..."; }
