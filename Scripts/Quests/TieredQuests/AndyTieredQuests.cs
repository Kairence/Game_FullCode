...
namespace Server.Engines.Quests
{
	...
	public class DespiseTierQuest1 : BaseQuest, ITierQuest
	{
		...
		{
			get { return "몸 좀 풀어보게나!"; }
		}
		public override object Description
		{
			get { return "데스파이즈에 몬스터가 너무 많아졌어..."; }
		}
		public override object Refuse
		{
			get { return "다른 사람을 구해야겠군..."; }
		}
		public override object Uncomplete
		{
			get { return "주로 1층에 몬스터가 있을꺼야"; }
		}
	...
	public class DespiseTierQuest2 : BaseQuest, ITierQuest
	{
			...
			: base()
		{
			switch (Utility.Random(3))
			{
				...
				{
					AddObjective(
						new SlayObjective(typeof(LizardmanDefender), "Lizardman Defender", 15, 3600, "Despise")
					);
					break;
				}
				case 1:
		...
		public override object Description
		{
			get
			{
				return "좀 익숙해졌나? 하지만 잡아도잡아도 거미는 계속 나온다네. 이번엔 거미들을 퇴치해줬으면 좋겠구만.";
			}
		}
		public override object Refuse
		{
	...
	public class DespiseTierQuest3 : BaseQuest, ITierQuest
	{
		...
		public override object Description
		{
			get
			{
				return "3층은 접근을 금지하는 석상이 있지. 그래서 그런지 안에 무서운 언데드들이 바글바글하더군. 이 몬스터들을 청소할 시간이야.";
			}
		}
		public override object Refuse
		{
