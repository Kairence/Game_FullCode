...
namespace Server.Engines.Quests
{
	...
	public class ShameTierQuest1 : BaseQuest, ITierQuest
	{
		...
		{
			get { return TierQuestInfo.Steve; }
		}
	...
	public class ShameTierQuest2 : BaseQuest, ITierQuest
	{
		...
		public override object Title
		{
			get { return "피의 탑 청소하기!"; }
		}
		public override object Description
		{
			get { return "쉐임 안에는 인간임을 거부한 사악한 인간들과 게이저들이 살고 있지. 이들을 처치해 주게나."; }
		}
		public override object Refuse
		{
			get { return "다른 사람을 구해야겠군..."; }
	...
	public class ShameTierQuest3 : BaseQuest, ITierQuest
	{
		...
		public override object Title
		{
			get { return "쉐임의 가장 깊은 곳"; }
		}
		public override object Description
		{
			get { return "4층은 피 정령이 나오는 구간이지. 보이기만 해도 피가 모두 빨리고 말거야... 조심해야 해."; }
		}
		public override object Refuse
		{
			get { return "다른 사람을 구해야겠군..."; }
