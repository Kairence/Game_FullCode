...
namespace Server.Engines.Quests
{
	...
	public class DeceitTierQuest1 : BaseQuest, ITierQuest
	{
			...
			: base()
		{
			switch (Utility.Random(6))
			{
				...
				{
					AddObjective(
						new SlayObjective(typeof(PatchworkSkeleton), "Patchwork Skeleton", 30, "Deceit", 3600)
					);
					break;
				}
				case 1:
		...
		{
			get { return TierQuestInfo.Maloth; }
		}
	...
	public class DeceitTierQuest2 : BaseQuest, ITierQuest
	{
		...
		public override object Description
		{
			get
			{
				return "좀 익숙해졌나? 하지만 잡아도잡아도 망령은 계속 나온다네. 이번엔 망령들을 퇴치해줬으면 좋겠구만.";
			}
		}
		public override object Refuse
		{
	...
	public class DeceitTierQuest3 : BaseQuest, ITierQuest
	{
		...
		public override object Description
		{
			get { return "4층은 리치 로드가 나오는 구간이지. 이곳은 함부로 이동해선 안되네."; }
		}
		public override object Refuse
		{
			get { return "다른 사람을 구해야겠군..."; }
