...
namespace Server.Engines.Quests
{
	public class AllThatGlitters : BaseQuest, ITierQuest
	{
			...
			: base()
		{
			...
			AddObjective(
				new ObtainObjective(typeof(PileofInspectedGoldIngots), "Pile of Inspected Gold Ingots", 1, 0x1BEA)
			);
		...
		{
			get { return TierQuestInfo.Thepem; }
		}
		public override TimeSpan RestartDelay
		{
			get { return TierQuestInfo.GetCooldown(TierInfo, GetType()); }
		}
	...
	public class MetalHead : BaseQuest, ITierQuest
	{
		...
		{
			AddObjective(
				new ObtainObjective(typeof(UndamagedIronBeetleScale), "Undamaged IronBeetle Scale", 10, 0x5742)
			);
			AddObjective(
				new ObtainObjective(
					typeof(PileofInspectedDullCopperIngots),
					"Pile of Inspected DullCopper Ingots",
					1,
					0x1BEA
				)
			);
			AddObjective(
				new ObtainObjective(
					typeof(PileofInspectedShadowIronIngots),
					"Pile of Inspected ShadowIron Ingots",
					1,
					0x1BEA
				)
			);
			AddObjective(
				new ObtainObjective(typeof(PileofInspectedCopperIngots), "Pile of Inspected Copper Ingots", 1, 0x1BEA)
			);
			AddObjective(
				new ObtainObjective(typeof(PileofInspectedBronzeIngots), "Pile of Inspected Bronze Ingots", 1, 0x1BEA)
			);
	...
	public class PinkistheNewBlack : BaseQuest, ITierQuest
	{
			...
			: base()
		{
			...
			AddObjective(
				new ObtainObjective(typeof(PileofInspectedAgapiteIngots), "Pile of Inspected Agapite Ingots", 1, 0x1BEA)
			);
