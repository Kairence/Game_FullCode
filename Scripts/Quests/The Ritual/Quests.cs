...
namespace Server.Engines.Quests.RitualQuest
{
	public class ScalesOfADreamSerpentQuest : BaseQuest
	{
		...
		{
			get { return QuestChain.Ritual; }
		}
		public override Type NextQuest
		{
			get { return typeof(TearsOfASoulbinderQuest); }
		}
		...
		{
			get { return 1151125; }
		} // Were you able to acquire the scales? Please do not dally, adventurer!
	...
	public class TearsOfASoulbinderQuest : BaseQuest
	{
		...
		public override Type NextQuest
		{
			get { return typeof(PristineCrystalLotusQuest); }
		}
		...
		{
			get { return 1151133; }
		} // Were you able to obtain the Soulbinder's Tear?
	...
	public class PristineCrystalLotusQuest : BaseQuest
	{
		...
		{
			get { return 1151137; }
		} // Have you solved the secret of the lotus, my friend?
		...
		{
			AddObjective(
				new ObtainObjective(typeof(PristineCrystalLotus), "Pristine Crystal Lotus", 1, 0x283B, 0, 1152)
			);
	...
	public class CatchMeIfYouCanQuest : BaseQuest
	{
		...
		{
			get { return 1151146; }
		} // You don’t want to play? Boo! Go away!

		public override object Uncomplete
		{
			get { return 1151147; }
		} // Ah ha! Looks like you are not very fast. Want to play again?
		...
		public class InternalObjective : BaseObjective
		{
			...
			{
				get { return 1151213; }
			} // Hit the Dream Serpent 6 times before the time is up.
	...
	public class FilthyLifeStealersQuest : BaseQuest
	{
		...
		{
			get { return 1151157; }
		} // Have you killed the Lifestealers yet? Don’t try my patience, or I will eat you!
