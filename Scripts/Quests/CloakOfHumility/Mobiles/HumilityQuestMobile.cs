...
namespace Server.Engines.Quests
{
	public class HumilityQuestMobile : BaseVendor
	{
		...
		public HumilityQuestMobile(string name)
			: base(null)
		{
			Name = name;
		...
		public HumilityQuestMobile(string name, string title)
			: base(title)
		{
			Name = name;
			m_NextGreet = DateTime.UtcNow;
		...
		public static List<HumilityQuestMobile> Instance
		{
			get { return m_Instances; }
		}
		private static List<HumilityQuestMobile> m_Instances = new List<HumilityQuestMobile>();

		public HumilityQuestMobile(Serial serial)
			: base(serial) { }
							...
							if (nextItem != null)
							{
								...
								if (this is Sean)
									...
									SayTo(
										...
										String.Format(
											"#{0}\t#{1}",
											quest.Infos[idx].NeedsLoc,
											quest.Infos[idx].GivesLoc
										)
									);
							}
						}
	...
	public class HumilityQuestMobileInfo
	{
		...
		public int NeedsLoc
		{
			get { return m_NeedsLoc; }
		}
		public int GivesLoc
		{
			get { return m_GivesLoc; }
		}
		...
		public static int[] ItemLocs
		{
			get { return m_ItemLocs; }
		}
		...
		public static Type[] MobileTypes
		{
			get { return m_MobileTypes; }
		}
