...
namespace Server.Engines.Quests
{
    public class TheQuestionsQuest : BaseQuest
    {
        ...
        public static void Configure()
        {
            ...
            m_EntryTable[6] = new QuestionAndAnswerEntry(1075703, new object[] { 1075705 }, new object[] { 1075704, 1075706, 1075707 });  //<center>By name, which den of evil challenges one뭩 humility?</center>
        }
    ...
    public class CommunityServiceLibraryQuest : BaseQuest
    {
         ...
         * a special printing of 멫irtue? by Lord British. Once in hand, bring the book back with ye. Art thou ready?*/
