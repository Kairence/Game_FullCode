...
namespace Server.Engines.Quests
{
	public class TheQuestionsQuest : BaseQuest
	{
		...
		{
			get { return QuestChain.CloakOfHumility; }
		}
		public override Type NextQuest
		{
			get { return typeof(CommunityServiceMuseumQuest); }
		}
		 ...
		 * learned.<br>*/
		public override object FailedMsg
		{
			get { return 1075713; }
		}
		...
		public override bool RenderObjective(MondainQuestGump g, bool offer)
		{
			...
			foreach (QuestionAndAnswerObjective obj in Objectives.OfType<QuestionAndAnswerObjective>())
			{
				if (offer)
					...
					str = String.Format(
						"Answer {0}/{1} questions answered correctly.",
						obj.CurProgress,
						obj.MaxProgress
					);
		...
		{
			m_EntryTable[0] = new QuestionAndAnswerEntry(
				1075708,
				new object[] { 1075709 },
				new object[] { 1075710, 1075711, 1075712 }
			); //<center>Finish this truism: Humility shows us...</center>
			m_EntryTable[1] = new QuestionAndAnswerEntry(
				1075678,
				new object[] { 1075679 },
				new object[] { 1075680, 1075681, 1075682 }
			); //<center>What is the symbol of Humility?</center>
			m_EntryTable[2] = new QuestionAndAnswerEntry(
				1075683,
				new object[] { 1075685 },
				new object[] { 1075684, 1075686, 1075687 }
			); //<center>What opposes Humility?</center>
			m_EntryTable[3] = new QuestionAndAnswerEntry(
				1075688,
				new object[] { 1075691 },
				new object[] { 1075689, 1075690, 1075692 }
			); //<center>What is the color of Humility?</center>
			m_EntryTable[4] = new QuestionAndAnswerEntry(
				1075693,
				new object[] { 1075697 },
				new object[] { 1075694, 1075695, 1075696 }
			); //<center>How doth one find Humility?</center>
			m_EntryTable[5] = new QuestionAndAnswerEntry(
				1075698,
				new object[] { 1075700 },
				new object[] { 1075699, 1075601, 1075602 }
			); //<center>Which city embodies the need for Humility?</center>
			m_EntryTable[6] = new QuestionAndAnswerEntry(
				1075703,
				new object[] { 1075705 },
				new object[] { 1075704, 1075706, 1075707 }
			); //<center>By name, which den of evil challenges one�s humility?</center>
		}

		private static QuestionAndAnswerEntry[] m_EntryTable = new QuestionAndAnswerEntry[7];
		public static QuestionAndAnswerEntry[] EntryTable
		{
			get { return m_EntryTable; }
		}

		private static Dictionary<Mobile, DateTime> m_CooldownTable = new Dictionary<Mobile, DateTime>();
		public static Dictionary<Mobile, DateTime> CooldownTable
		{
			get { return m_CooldownTable; }
		}
	}
	...
	public class CommunityServiceMuseumQuest : BaseQuest
	{
		...
		{
			AddObjective(
				new CollectionsObtainObjective(typeof(ShepherdsCrookOfHumility), "Shepherd's Crook of Humility", 1)
			);
		}
		...
		public override Type NextQuest
		{
			get { return typeof(CommunityServiceZooQuest); }
		}
	...
	public class CommunityServiceZooQuest : BaseQuest
	{
		...
		{
			AddObjective(
				new CollectionsObtainObjective(typeof(ForTheLifeOfBritanniaSash), "Life of Britannia Sash", 1)
			);
		}
		...
		public override Type NextQuest
		{
			get { return typeof(CommunityServiceLibraryQuest); }
		}
	...
	public class CommunityServiceLibraryQuest : BaseQuest
	{
		...
		{
			AddObjective(
				new CollectionsObtainObjective(typeof(SpecialPrintingOfVirtue), "Special Painint of 'Virtue' Book", 1)
			);
		}
		...
		public override Type NextQuest
		{
			get { return typeof(WhosMostHumbleQuest); }
		}
	...
	public class WhosMostHumbleQuest : BaseQuest
	{
		...
		public Dictionary<int, HumilityQuestMobileInfo> Infos
		{
			get { return m_Infos; }
		}

		public override bool CanRefuseReward
		{
			get { return true; }
		}
		...
		public override void OnAccept()
		{
			...
			for (int i = 0; i < mobTypes.Count; i++)
			{
				...
				m_Infos[mobIndex] = new HumilityQuestMobileInfo(
					needs,
					gives,
					HumilityQuestMobileInfo.GetLoc(needs),
					HumilityQuestMobileInfo.GetLoc(gives)
				);
			}
		}
