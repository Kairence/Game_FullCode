...
namespace Server.Engines.Quests.Doom
{
	public class CollectBonesObjective : QuestObjective
	{
		...
		public override void OnComplete()
		{
			...
			else
			{
				...
				if (altar == null)
				{
					this.System.From.SendMessage(
						"Internal error: unable to find summoning altar. Quest unable to continue."
					);
					this.System.Cancel();
				}
	...
	public class VanquishDaemonObjective : QuestObjective
	{
		...
		{
			get { return this.m_CorpseWithSkull; }
			set { this.m_CorpseWithSkull = value; }
		}
		public override object Message
		{
			get
