...
namespace Server.Engines.Quests.Hag
{
	public class FindApprenticeObjective : QuestObjective
	{
		...
		public override void CheckProgress()
		{
			...
			if (
				(this.m_Corpse == null || this.m_Corpse.Deleted)
				&& (map == Map.Trammel || map == Map.Felucca)
				&& player.InRange(this.m_CorpseLocation, 8)
			)
			{
	...
	public class FindIngredientObjective : QuestObjective
	{
		...
		{
			get { return this.m_Ingredients[this.m_Ingredients.Length - 1]; }
		}
		public int Step
		{
			get { return this.m_Ingredients.Length; }
		}
		public bool BlackheartMet
		{
			get { return this.m_BlackheartMet; }
		}
