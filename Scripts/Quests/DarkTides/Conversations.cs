    ...
    public class MaabasConversation : QuestConversation
    {
        ...
        public override object Message
        {
            get
            {
                ...
                * 
                * Well, why didn뭪 you say so?  If you뭨e going to raise Kronus from
    ...
    public class HorusConversation : QuestConversation
    {
        ...
        public override object Message
        {
            get
            {
                ...
                * into the cave?<BR><BR>
                * 
                * Please don뭪 think ill of me for this, but I뭢 just a blind, old man looking
                ...
                * city of Light.  It뭩 the only way that I can be sure you are who you claim to be,
    ...
    public class MardothVaultConversation : QuestConversation
    {
        ...
        public override object Message
        {
            get
            {
                ...
                * the paladin뭩 Vault of Secrets, eh?  Well, you won't be able to get in
    ...
    public class SecondHorusConversation : QuestConversation
    {
        ...
        public override object Message
        {
            get
            {
                ...
                * 
                * Be careful, however ?I뭭e heard that the cave has been
                ...
                * understand if you were, don뭪 bother with the vermin.<BR><BR>
                * 
