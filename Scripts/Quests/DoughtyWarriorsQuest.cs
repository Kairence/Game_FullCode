...
namespace Server.Engines.Quests
{
    public class DoughtyWarriorsQuest : BaseQuest
    {
        ...
        /*Youngsters these days! Sorry, I didn뭪 introduce myself. I뭢 Kane,
         * the Master of Arms for this city. This lot of trainees I got, they뭨e
         * not worth a bucket of sour spit. You know the invasion some years back?
         * Well, some of these pups weren뭪 even born then! What I need is an example,
        ...
        /* You뭠l find mongbats all over the place. They뭨e a real pest.
         * Once you뭭e killed ten of them, come back and see me again. */
    ...
    public class DoughtyWarriors2Quest : BaseQuest
    {
         ...
         * I think they could actually take a mongbat now. I뭢 still worried they뭠l 
        ...
        /* You뭨e pretty sad. When I was a young warrior, I wasn뭪 one to walk away from a challenge. */
        public override object Refuse { get { return 1075407; } }

        /* You won뭪 find many imps on this continent. Mostly, they뭨e native to Ilshenar. Might be a
    ...
    public class DoughtyWarriors3Quest : BaseQuest
    {
        ...
        /* You뭭e really inspired my trainees. They뭨e working harder than ever. I뭭e got 
         * one more request for you, and it뭩 a big one. Those mongbats didn뭪 pose a problem.
        ...
        /* What? You뭨e not scared of a couple of lousy daemons, are you? */
        public override object Refuse { get { return 1075413; } }

        /* There뭩 all kinds of daemons you can kill. There are some near the hedge maze,
         * and some really powerful ones in Dungeon Doom. */
        public override object Uncomplete { get { return 1075414; } }

        /* Thanks for helping me out. You뭨e a real hero to my guards. Valor is its own reward,
         * but maybe you wouldn뭪 mind wearing this sash. We don뭪 give these out to just 
         * anyone, you know! */
