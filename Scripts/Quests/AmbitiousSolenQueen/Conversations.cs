...
namespace Server.Engines.Quests.Ambitious
{
	...
	public class EndConversation : QuestConversation
	{
		...
		public override void OnRead()
		{
			...
			{
				this.System.AddConversation(
					new FullBackpackConversation(true, bagOfSending, powderOfTranslocation, gold)
				);
			}
		}
	}
	...
	public class FullBackpackConversation : QuestConversation
	{
		...
		{
			if (this.m_Logged)
				this.System.AddObjective(
					new GetRewardObjective(this.m_BagOfSending, this.m_PowderOfTranslocation, this.m_Gold)
				);
		}
