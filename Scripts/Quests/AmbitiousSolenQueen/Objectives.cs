...
namespace Server.Engines.Quests.Ambitious
{
		...
		public override void RenderProgress(BaseQuestGump gump)
		{
			if (!this.Completed)
			{
				...
				gump.AddHtmlLocalized(
					...
					270,
					100,
					((AmbitiousQueenQuest)this.System).RedSolen ? 1054064 : 1054065,
					BaseQuestGump.Blue,
					false,
					false
				);
	...
	public class GetRewardObjective : QuestObjective
	{
		...
		{
			get { return this.m_BagOfSending; }
			set { this.m_BagOfSending = value; }
		}
		public bool PowderOfTranslocation
		{
			get { return this.m_PowderOfTranslocation; }
			set { this.m_PowderOfTranslocation = value; }
		}
		public bool Gold
		{
