...
namespace Server.Engines.Quests
{
    public class HonorOfDeBoorsQuest : BaseQuest
    {
		...
		To survive, I have had to sell much of my family뭩 property. Most of it was meaningless, but I regret that a
		few years ago I made a terrible mistake. I pawned a shield bearing my family뭩 coat of arms to a loan shark.
		That shield was borne into battle by Jaan de Boors, the founder of our house! It has no value to anyone, but
		that blackguard won뭪 believe I have no money. He wants a fortune in jewels before he will return it.
        ...
        /* I know how much I am asking. Please, can you not help a dying man restore his family뭩 honor? */
    ...
    public class SavedHonorQuest : BaseQuest
    {
        ...
        /* That idiot! This beat up piece of junk isn뭪 worth more than three gold coins, four at most!
         * Oh, well, a deal뭩 a deal! */
        public override object Description { get { return 1075429; } }

        /* I don뭪 care what you do! */
        public override object Refuse { get { return 1075431; } }

        /* Go away and never come back. */
        public override object Uncomplete { get { return 1075432; } }

        /* My shield! My family뭩 honor! You have my gratitude. Please, take this goblet.
         * It is small enough repayment for all you have done for me, but it is the only
         * thing of my family뭩 that I have left. */
