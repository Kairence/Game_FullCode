...
namespace Server.Engines.Quests.Ninja
{
    ...
    public class EnterCaveConversation : QuestConversation
    {
        ...
        public override object Message
        {
            get
            {
                ...
                * 
                * No matter, we뭠l finish you off and clean it all at once, eh? <BR><BR>
                * 
    ...
    public class NeedToHideConversation : QuestConversation
    {
        ...
        public override object Message
        {
            get
            {
                /* You뭠l need to hide in order to pass through the door. <BR><BR>
                * 
    ...
    public class GiveZoelNoteConversation : QuestConversation
    {
        ...
        public override object Message
        {
            get
            {
                ...
                * 
                * I see that you have survived both the first trial and Zoel뭩 temper. <BR><BR>
                * 
    ...
    public class GainInnInformationConversation : QuestConversation
    {
        ...
        public override object Message
        {
            get
            {
                ...
                * 
                * Still alive then? You뭠l have to impress me 
                ...
                * 
                * The Blue Teleporter Tile in Daimyo Emino뭩
    ...
    public class ReturnFromInnConversation : QuestConversation
    {
        ...
        public override object Message
        {
            get
            {
                ...
                * 
                * Jedah뭩 brash voice permeates the air:<I><BR><BR> 
                * 
                * Now that it is hidden, we뭠l hide out here 
                * until Daimyo Emino forgets about us. 
                * Once he realizes his beloved sword is missing, 
                * he뭠l surely start looking for the thieves. 
    ...
    public class SearchForSwordConversation : QuestConversation
    {
        ...
        public override object Message
        {
            get
            {
                ...
                * 
                * I뭢 counting on you to find it. She would have kept it 
                ...
                * doubt she뭩 protecting the sword with them. <BR><BR>
                * 
                * If you find a trap, try timing it and you may be able 
                * to avoid damage. <BR><BR>
                * 
                * I뭭e provided you with several heal potions in case you 
    ...
    public class SlayHenchmenConversation : QuestConversation
    {
        ...
        public override object Message
        {
            get
            {
                ...
                * away from the chest. Jedah뭩 Henchmen have 
