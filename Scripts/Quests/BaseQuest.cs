...
namespace Server.Engines.Quests
{
	public class BaseQuest
	{
		...
		{
			get { return DateTime.Now.Date + TimeSpan.FromDays(1) - DateTime.Now; }
		}
		...
		public virtual object FailedMsg
		{
			get { return null; }
		}
		...
		public virtual bool ShowRewards
		{
			get { return true; }
		}
		public virtual bool CanRefuseReward
		{
			get { return false; }
		}
		...
		public virtual void AllRemoveQuest()
		{
			// remove quest
			if (NextQuest == null)
				RemoveQuest(true);
		...
		public virtual void RemoveQuest(bool removeChain)
		{
			...
			if (
				Completed
				&& (RestartDelay > TimeSpan.Zero || ForceRemember || DoneOnce)
				&& NextQuest == null
