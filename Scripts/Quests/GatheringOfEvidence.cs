...
namespace Server.Engines.Quests
{
	public class GatheringOfEvidence : BaseQuest
	{
			...
			: base()
		{
			this.AddObjective(
				new ObtainObjective(
					typeof(VoidCrystalOfCorruptedArcaneEssence),
					"Void Crystal of Corrupted Arcane Essence",
					1
				)
			);
			this.AddObjective(
				new ObtainObjective(
					typeof(VoidCrystalOfCorruptedSpiritualEssence),
			...
			this.AddObjective(
				new ObtainObjective(
					typeof(VoidCrystalOfCorruptedMysticalEssence),
	...
	public class Xeninlor : MondainQuester
	{
		...
		{
			get { return new Type[] { typeof(GatheringOfEvidence) }; }
		}
	...
	public class Prassel : MondainQuester
	{
		...
		public override Type[] Quests
		{
			get { return new Type[] { typeof(GatheringProof) }; }
		}
