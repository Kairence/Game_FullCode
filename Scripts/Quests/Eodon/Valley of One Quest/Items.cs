...
namespace Server.Items
{
	public class KingBlackthornOrders : BaseQuestItem
	{
		...
		{
			get { return new Type[] { typeof(TimeIsOfTheEssenceQuest) }; }
		}
		...
		public KingBlackthornOrders(Serial serial)
			: base(serial) { }
	...
	public class TigerRugAddon : BaseAddon
	{
		...
		{
			get { return new TigerRugAddonDeed(this.RugType); }
		}
		...
		public TigerRugAddon(Serial serial)
			: base(serial) { }
	...
	public class TigerRugAddonDeed : BaseAddonDeed
	{
		...
		{
			get { return new TigerRugAddon(this.RugType, SouthFacing); }
		}
	...
	public class BananaHoardAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get { return new BananaHoardAddonDeed(); }
		}
	...
	public class BananaHoardAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get { return new BananaHoardAddon(BananaHoardSize); }
		}
		public override int LabelNumber
		{
			get { return 1156556; }
		} // Great Ape's Banana Hoard
		...
		private class InternalGump : Gump
		{
			...
			public InternalGump(PlayerMobile p, Action<BananaHoardSize> callback)
				: base(50, 50)
			{
				Callback = callback;
				User = p;
		...
		public BananaHoardAddonDeed(Serial serial)
			: base(serial) { }
	...
	public class DinosaurHunterRewardTitleDeed : BaseRewardTitleDeed
	{
		...
		{
			get { return new TextDefinition("Dinosaur Hunter"); }
		}
	...
	public class DragonTurtleFountainAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get { return new DragonTurtleFountainAddonDeed(); }
		}
	...
	public class DragonTurtleFountainAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get { return new DragonTurtleFountainAddon(SouthFacing); }
		}
		public override int LabelNumber
		{
			get { return 1156488; }
		...
		public UniqueTreasureBag()
		{
			switch (Utility.Random(6))
			{
				...
				case 1:
					...
					break;
				case 2:
					DropItem(new BananaHoardAddonDeed());
					break;
				case 3:
					DropItem(new DragonTurtleFountainAddonDeed());
					break;
				case 4:
					DropItem(new DinosaurHunterRewardTitleDeed());
					break;
				case 5:
					DropItem(new PetTigerCubStatuette());
					break;
			}
		}
