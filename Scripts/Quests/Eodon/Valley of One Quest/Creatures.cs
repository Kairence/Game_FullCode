...
namespace Server.Mobiles
{
	...
	public class TRex : BaseCreature
	{
		...
		public override bool AttacksFocus
		{
			get { return true; }
		}
	...
	public class GreatApe : BaseCreature
	{
		...
		private Point3D[] _PlayerTeleList = { new Point3D(875, 1380, -20), new Point3D(855, 1442, -20) };

		private int[] _BarrelIDs = { 3703, 4014, 5453, 7861, 17650 };
			...
			if (_NextSpecial < DateTime.UtcNow)
			{
				...
				switch (Utility.Random(Teleports ? 3 : 2))
				{
					...
					case 1:
						...
						if (mobiles.Count > 0)
						{
							...
							Effects.SendLocationParticles(
								EffectItem.Create(old2, Map, EffectItem.DefaultDuration),
								0x3728,
								10,
								10,
								2023
							...
							Effects.SendLocationParticles(
								EffectItem.Create(p2, Map, EffectItem.DefaultDuration),
								0x3728,
								10,
								10,
								5023
					...
					case 2:
						...
						Effects.SendLocationParticles(
							EffectItem.Create(old, Map, EffectItem.DefaultDuration),
							0x3728,
							10,
							10,
							2023
	...
	public class TigerCub : BaseCreature
	{
		...
		public override void OnThink()
		{
			...
			{
				PrideOfTheAmbushQuest quest =
					QuestHelper.GetQuest((PlayerMobile)Protector, typeof(PrideOfTheAmbushQuest))
					as PrideOfTheAmbushQuest;
