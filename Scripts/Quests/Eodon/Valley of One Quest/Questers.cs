...
namespace Server.Mobiles
{
	...
	public class SirGeoffery : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(UnitingTheTribesQuest) }; }
		}
		...
		public override void OnTalk(PlayerMobile player)
		{
			TimeIsOfTheEssenceQuest q =
				QuestHelper.GetQuest(player, typeof(TimeIsOfTheEssenceQuest)) as TimeIsOfTheEssenceQuest;

			if (
				QuestHelper.HasQuest(player, typeof(TimeIsOfTheEssenceQuest))
				|| QuestHelper.HasQuest(player, typeof(UnitingTheTribesQuest))
			)
			{
				base.OnTalk(player);
			}
	...
	public class SakkhraHighChieftess : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(TheGreatHuntQuest) }; }
		}
	...
	public class UraliHighChieftess : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(EmptyNestQuest) }; }
		}
	...
	public class JukariHighChief : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(TheGreatVolcanoQuest) }; }
		}
	...
	public class KurakHighChief : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(PrideOfTheAmbushQuest) }; }
		}
	...
	public class BarakoHighChief : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(TheGreatApeQuest) }; }
		}
