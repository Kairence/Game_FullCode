...
namespace Server.Items
{
	public class NestWithEgg : BaseAddon
	{
		...
		{
			get { return TimeSpan.FromSeconds(Utility.RandomMinMax(120, 360)); }
		}
		...
		{
			get { return Components.FirstOrDefault(c => c.ItemID == 16831); }
		}

		public bool IsInCooldown
		{
			get { return CooldownEnds != DateTime.MinValue && DateTime.UtcNow < CooldownEnds; }
		}
		...
		public override void OnMovement(Mobile m, Point3D oldLocation)
		{
			if (
				...
				&& (!FocusList.Contains(m) || 0.015 > Utility.RandomDouble())
			)
			{
		...
		private void OnComplete(object o)
		{
			...
			{
				EmptyNestQuest quest =
					QuestHelper.GetQuest((PlayerMobile)focus, typeof(EmptyNestQuest)) as EmptyNestQuest;
