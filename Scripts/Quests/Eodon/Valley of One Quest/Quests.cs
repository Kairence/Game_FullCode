...
namespace Server.Engines.Quests
{
	public class TimeIsOfTheEssenceQuest : BaseQuest
	{
		...
		{
			get { return QuestChain.ValleyOfOne; }
		}
		public override Type NextQuest
		{
			get { return typeof(UnitingTheTribesQuest); }
		}
		...
		{
			get { return 1156460; }
		} /* Tis unfortunate, in this time of great need we must look to our inner courage... */

		public override object Uncomplete
		{
			get { return 1156461; }
		} /*There is little time to delay. Deliver the orders to Sir Geoffrey at his camp near 
																		the Barrab Tribe in the Valley of Eodon.*/

		public override object Complete
		{
			get { return 1156462; }
		} /* Ahh, King Blackthorn sent you did he? */
			...
			: base()
		{
			AddObjective(
				new DeliverObjective(
					typeof(KingBlackthornOrders),
					"Orders from King Blackthorn to Sir Geoffrey",
					1,
					typeof(SirGeoffery),
					"Sir Geoffery",
					360
	...
	public class UnitingTheTribesQuest : BaseQuest
	{
		...
		{
			get { return 1156464; }
		} /* *Sir Geoffrey looks up at you* What's this? Ah! Here to join the effort then?
		...
		{
			get { return 1156472; }
		} /* Well then stop wasting my bloody time! Haven't you see we've got a war to win?! */

		public override object Uncomplete
		{
			get { return 1156518; }
		} /* These tribes aren't going to unite themselves, best get on with it and visit the Sakkhra, 
																		Urali, Jukari, Kurak, and Barako tribes!  We've got a war to win! */

		public override object Complete
		{
			get { return 1156519; }
		} /*Well done! I don't know how you managed to pull it off but this is the break we've 
	...
	public class TheGreatHuntQuest : BaseQuest
	{
		...
		{
			get { return 1156522; }
		} /* *The Sakkhra High Chieftess looks at you apprehensively, 
		...
		{
			get { return 1156550; }
		} /* *The Chieftess looks at you...* */

		public override object Uncomplete
		{
			get { return 1156531; }
		} /* You not kill giant dino yet? Sakkhra will not help until you kill big dino! */

		public override object Complete
		{
			get { return 1156557; }
		} /* Ahh-Ooo! Ahh-Ooo!  Britainnian kill big dino! Show courage and strength!  Sakkrah trust you now! */
	...
	public class EmptyNestQuest : BaseQuest
	{
		...
		{
			get { return 1156524; }
		} /* *The Urali High Chieftess looks at you apprehensively, as the greeting Professor 
		...
		{
			get { return 1156536; }
		} /* You not save Dragon Turtle Hatchlings yet? Urali will not help until you save Dragon Turtle Hatchlings! */

		public override object Complete
		{
			get { return 1156537; }
		} /* Ahhh-OOO! Ahhh-OOO!  Dragon Turtle dig-dig and swim-swim! You good to Urali! Urali trust you! */
		...
		public void Update(object o)
		{
			foreach (BaseObjective obj in Objectives)
			{
				...
				if (!Completed)
				{
					...
					Owner.SendLocalizedMessage(
						1156535,
						String.Format("{0}\t{1}", obj.CurProgress.ToString(), obj.MaxProgress.ToString())
					); // You have rescued ~1_count~ of ~2_max~ Dragon Turtle Hatchlings.
				}
				else
				{
					OnCompleted();
	...
	public class TheGreatVolcanoQuest : BaseQuest
	{
		...
		{
			get { return 1156526; }
		} /* *The Jukari High Chief looks at you apprehensively, as the greeting Professor 
		...
		{
			get { return 1156532; }
		} /* *The Chief looks at you...* */

		public override object Uncomplete
		{
			get { return 1156540; }
		} /* You afraid of Great Volcano? Ha Ha! Britannian afraid! */

		public override object Complete
		{
			get { return 1156541; }
		} /* OOO!  You bring Jukari lava rock, mean Volcano no like your taste HA HA! Jukari help you! */
		...
		public static bool OnHarvest(Mobile m, Item tool)
		{
			...
			if ((pm.ToggleMiningStone || pm.ToggleStoneOnly) && VolcanoMineBounds.Contains(m.Location))
			{
				...
				Timer.DelayCall(
					Mining.System.OreAndStone.EffectSoundDelay,
					() =>
					{
				...
				Timer.DelayCall(
					Mining.System.OreAndStone.EffectDelay,
					() =>
					{
						TheGreatVolcanoQuest quest =
							QuestHelper.GetQuest(pm, typeof(TheGreatVolcanoQuest)) as TheGreatVolcanoQuest;
			...
			foreach (BaseObjective obj in Objectives)
			{
				...
				if (!Completed)
				{
					...
					Owner.SendLocalizedMessage(
						1156539,
						String.Format("{0}\t{1}", obj.CurProgress.ToString(), obj.MaxProgress.ToString())
					); // You have recovered ~1_count~ of ~2_max~ Lava Rocks.
				}
				else
				{
					OnCompleted();
	...
	public class PrideOfTheAmbushQuest : BaseQuest
	{
		...
		{
			get { return 1156528; }
		} /* *The Kurak High Chief looks at you apprehensively, as the greeting Professor 
		...
		{
			get { return 1156545; }
		} /* You save tiger cubs! They little and helpless! Kurak will not help until you save tiger cubs! */

		public override object Complete
		{
			get { return 1156546; }
		} /* You save tiger cubs! Kurak thank you and help you! */
			...
			foreach (BaseObjective obj in Objectives)
			{
				...
				if (!Completed)
				{
					...
					Owner.SendLocalizedMessage(
						1156543,
						String.Format("{0}\t{1}", obj.CurProgress.ToString(), obj.MaxProgress.ToString())
					); // You have rescued ~1_count~ of ~2_max~ tiger cubs.
				}
				else
				{
					OnCompleted();
	...
	public class TheGreatApeQuest : BaseQuest
	{
		...
		{
			get { return 1156530; }
		} /* *The Barako High Chief looks at you apprehensively, as the greeting 
		...
		{
			get { return 1156548; }
		} /* *Thumps chest!* You battle Great Ape or Barako will not trust you! */

		public override object Complete
		{
			get { return 1156549; }
		} /* *Thumps chest* You battle Great Ape and win! You strong and Barako respect and trust you! */
