...
namespace Server.Engines.Quests.TimeLord
{
	public class TimeForLegendsObjective : QuestObjective
	{
		...
		{
			get { return 1156341; }
		} // Prove yourself to Hawkwind, defeat thy foe in order to begin your journey among the Legendary.
			...
			if (System is TimeForLegendsQuest)
			{
				...
				if (q.ToSlay == null)
					gump.AddHtmlObject(
						...
						270,
						100,
						this.Completed ? 1049077 : 1049078,
						BaseQuestGump.Blue,
						false,
						false
					);
				else
				{
					...
					gump.AddHtmlObject(
						...
						150,
						100,
						index <= 13 ? 1156324 + index : 1156354 + (index - 14),
						BaseQuestGump.Blue,
						false,
						false
					);
					...
					gump.AddHtmlObject(
						...
						150,
						100,
						this.Completed ? 1046033 : 1046034,
						BaseQuestGump.Blue,
						false,
						false
					);
