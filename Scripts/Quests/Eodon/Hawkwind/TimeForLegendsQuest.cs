...
namespace Server.Engines.Quests.TimeLord
{
	...
	{
		private Type[] _TypeReferenceTable = new Type[] { typeof(TimeForLegendsObjective) };

		public override Type[] TypeReferenceTable
		{
			get { return _TypeReferenceTable; }
		}
		...
		{
			get { return 1156339; }
		} /*Greetings Brave Traveler!<br><br>Throughout my travels in time I have forever 
		...
		private static Type[] _Targets = new Type[]
		{
			...
			typeof(CorgulTheSoulBinder) /*dragon turtle*/
			,
			typeof(DreadHorn),
			typeof(Travesty),
	...
	public class ChooseMasteryGump : Gump
	{
			...
			: base(50, 50)
		{
			...
			foreach (SkillName skName in MasteryInfo.Skills)
			{
				...
				if (
					sk == null
					|| skName == SkillName.Discordance
					|| skName == SkillName.Provocation
					|| skName == SkillName.Peacemaking
				)
					continue;
