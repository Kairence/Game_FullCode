...
namespace Server.Mobiles
{
	public class Yar : MondainQuester
	{
		...
		{
			get { return new Type[] { typeof(TheZealotryOfZipactriotlQuest) }; }
		}
	...
	public class Carroll : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(HiddenTreasuresQuest) }; }
		}
	...
	public class Bront : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(TheSaltySeaQuest) }; }
		}
	...
	public class Eriathwen : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(ATinkersTaskQuest) }; }
		}
		...
		[Constructable]
		public Eriathwen()
			: base("Eriathwen", "the Golem Maker") { }
		...
		public Eriathwen(Serial serial)
			: base(serial) { }
	...
	public class CollectorOfOddities : BaseVendor
	{
		...
		[Constructable]
		public CollectorOfOddities()
			: base("the collector of oddities") { }
		...
		public CollectorOfOddities(Serial serial)
			: base(serial) { }
	...
	public class EllieRafkin : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(ExterminatingTheInfestationQuest) }; }
		}
		...
		[Constructable]
		public EllieRafkin()
			: base("Ellie Rafkin", "the Professor") { }
		...
		private class InternalSB : SBInfo
		{
			...
			public class InternalBuyInfo : List<GenericBuyInfo>
			{
				public InternalBuyInfo(BaseVendor owner)
				{
					Add(
						new GenericBuyInfo(
							"Unabridged Map of Eodon",
							typeof(UnabridgedAtlasOfEodon),
							62500,
							500,
							7185,
							0
		...
		public EllieRafkin(Serial serial)
			: base(serial) { }
	...
	public class Foxx : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(PestControlQuest) }; }
		}
	...
	public class Yero : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(GettingEvenQuest) }; }
		}
	...
	public class Alida : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(OfVorpalsAndLettacesTheGardnerQuest) }; }
		}
