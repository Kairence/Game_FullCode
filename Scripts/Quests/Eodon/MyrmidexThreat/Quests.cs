...
namespace Server.Engines.Quests
{
	public class TheZealotryOfZipactriotlQuest : BaseQuest
	{
		...
		{
			get { return QuestChain.MyrmidexAlliance; }
		}
		public override Type NextQuest
		{
			get { return typeof(DestructionOfZipactriotlQuest); }
		}
		...
		{
			get { return 1156752; }
		} /*All hail our Myrmidex Overlords! Now that the Britannians and the rest of Eodon 
		...
		{
			get { return 1156753; }
		} /*I must question your commitment to the Myrmidex - are you satisfied with these 
																	   Britannian invaders and their Eodonian allies?*/

		public override object Uncomplete
		{
			get { return 1156754; }
		} /*You must acquire the Activator from the Gemologist at the Shimmering Jewel in 
		...
		/**Eyes widen with excitement!*  All hail the Myrmidex! All hail the Barrab!
	...
	public class DestructionOfZipactriotlQuest : BaseQuest
	{
		...
		{
			get { return 1156757; }
		} // The Destruction of Zipactriotl

		public override object Description
		{
			get { return 1156758; }
		} /*All Hail the Myrmidex! All Hail the Barrab! Muwahahah! With these components 
		...
		{
			get { return 1156760; }
		} /*Only those warriors brave enough to join in the destruction of Zipactriotl 
																		will reap in the glory!  All hail the Myrmidex! All hail the Barrab!*/

		public override object Uncomplete
		{
			get { return 1156761; }
		} /*Zipactriotl must be destroyed...the time is NOW! Go to the Antechamber in the 
																		Great Pyramid and restore glory to the Myrmidex!*/

		public override object Complete
		{
			get { return 1156762; }
		} /*MUWAHAHA! ZIPACTRIOTL IS DESTROYED! THE MYRMIDEX ARE FREE TO RECLAIM EODON! 
	...
	public class HiddenTreasuresQuest : BaseQuest
	{
		...
		{
			get { return 1156801; }
		} /*Hello there, looking to buy? Sell? Perhaps a pearl necklace for your lover - 
		...
		{
			get { return 1156804; }
		} // Well if you don't want to do it, you shouldn't have asked. Hrmph.

		public override object Uncomplete
		{
			get { return 1156803; }
		} /*Acquire the gemstones I've asked for and I'll give you a map that will take you to 
																	 the item you seek.  It's very simple - now move along I've got customers to tend to!*/

		public override object Complete
		{
			get { return 1156805; }
		} // *Examines the stones closely* Ahh yes, these will do quite nicely!  As promised here's your map - good luck!
	...
	public class TheSaltySeaQuest : BaseQuest
	{
		...
		{
			get { return 1156808; }
		} /*Arr!  The seas have become a wretched and dangerous place - a myriad o' creatures
		...
		{
			get { return 1156812; }
		} // What's the matter, aint got yer sea legs? Har Har Har!

		public override object Uncomplete
		{
			get { return 1156813; }
		} /*Ye needin' to make the seas safe for Captains like me!  Make sure ye killin' the 
		...
		{
			get { return 1156814; }
		} // Shiver me timbers!  The sea be safe again!  As promised here's the Message in a Bottle!
	...
	public class ATinkersTaskQuest : BaseQuest
	{
		...
		{
			get { return 1156816; }
		} /*Ha ha...he he...hoo hoo...yes yes...its all coming together now if only...*the 
		...
		{
			get { return 1156817; }
		} // No time to waste on those uncommitted to the cause - be gone with you!

		public override object Uncomplete
		{
			get { return 1156818; }
		} /*Acquire the items I require to begin work on my Automaton and I'll give you the Stator.
																	 Don't come back until you've got everything!*/

		public override object Complete
		{
			get { return 1156819; }
		} /*Ha ha! He he! Hoo hoo! These are just what I needed - the Automaton won't take long now, 
	...
	public class ExterminatingTheInfestationQuest : BaseQuest
	{
		public override QuestChain ChainID
		{
			get { return QuestChain.EodonianAlliance; }
		}
		public override Type NextQuest
		{
			get { return typeof(InsecticideAndRegicideQuest); }
		}
		...
		{
			get { return 1156764; }
		} /*It is unfortunate it had to come to this.  My hope was the knowledge gained from 
		...
		{
			get { return 1156767; }
		} /*I must question your commitment to our cause - are you satisfied with these Myrmidex 
																     invaders and their Barrabian allies?*/

		public override object Uncomplete
		{
			get { return 1156768; }
		} /*You must obtain the Insecticide from the Gambler at the Modest Damsel in New 
		...
		{
			get { return 1156769; }
		} /*I should be excited but I cannot help but grimace at the destruction of an entire
		...
		public ExterminatingTheInfestationQuest()
		{
			...
			AddObjective(
				new ObtainObjective(typeof(BottleOfConcentratedInsecticide), "Bottle of Concentrated Insecticide", 1)
			);
	...
	public class InsecticideAndRegicideQuest : BaseQuest
	{
		...
		{
			get { return 1156770; }
		} // Insecticide and Regicide

		public override object Description
		{
			get { return 1156771; }
		} /*Everything is in place.  In the depths of the Myrmidex Pits are the Queen's 
		...
		{
			get { return 1156773; }
		} /*You must go into the depths of the Myrmidex Pits and find the Queen - she must 
		...
		{
			get { return 1156774; }
		} /*You are brave and courageous - the Valley of Eodon is now safe from the Myrmidex threat!;*/
	...
	public class PestControlQuest : BaseQuest
	{
		...
		{
			get { return 1156776; }
		} /*A significant portion of the Myrmidex population has been quelled in the surface
		...
		{
			get { return 1156787; }
		} // I knew it, you must be yellar!  Get out of my sight!

		public override object Uncomplete
		{
			get { return 1156788; }
		} /*You've got to kill enough Myrmidex Larvae, Drones, and Warriors in the Valley in
		...
		{
			get { return 1156789; }
		} /*Well color me surprised, you did it!  Now that we've gotten rid of enough of these
	...
	public class GettingEvenQuest : BaseQuest
	{
		...
		{
			get { return 1156791; }
		} /* *Sobs* Whyyyyy couldn't I just stop, no just had to be one more hand - I knew if 
		...
		{
			get { return 1156796; }
		} // Can't even be bothered to help a guy down on his luck? *sigh*

		public override object Uncomplete
		{
			get { return 1156797; }
		} /*You need to go to the Fortune's Fire Casino on Fire Island and show those dealers 
		...
		{
			get { return 1156798; }
		} /*Luck be a lady tonight! Winner-winner chicken dinner! I'm back in the game, don't 
		...
		public class InternalObjective : BaseObjective
		{
			...
			public override bool Update(object o)
			{
				...
				if (
					...
					&& Quest != null
					&& Quest.Owner != null
					&& Quest.Owner.Region.IsPartOf("FireIsleCasino")
				)
				{
					if (t == typeof(ChucklesLuck))
					{
						...
						if (CurProgress <= MaxProgress)
							Quest.Owner.SendLocalizedMessage(
								1156795,
								String.Format(
									"{0}\t{1}\t{2}",
									CurProgress.ToString(),
									MaxProgress.ToString(),
									"Chuckles' Luck"
								)
							); // [Quest Event: Getting Even] You have won ~1_count~ of ~2_req~ games of ~3_game~!
					}
	...
	public class OfVorpalsAndLettacesTheGardnerQuest : BaseQuest
	{
		...
		{
			get { return 1156780; }
		} // Of Vorpals and Lettuces

		public override object Description
		{
			get { return 1156781; }
		} /*I cannot believe these wretched pests!  I can't even manage to plant a single head of lettuce
		...
		{
			get { return 1156782; }
		} // Well if you're afraid of a little bunny then you haven't much business tackling a Myrmidex.  Hrmph!

		public override object Uncomplete
		{
			get { return 1156783; }
		} /*There's no time to lose!  My lettuces won't grow until you deal with the dastardly 
		...
		{
			get { return 1156784; }
		} /*Well done! With these pests out of my gardens I can finally get on with growing a prized lettuce! 
