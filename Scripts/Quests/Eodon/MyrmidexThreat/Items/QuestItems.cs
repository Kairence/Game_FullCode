...
namespace Server.Items
{
	...
	{
		[Constructable]
		public HiddenTreasuresTreasureMap()
			: this(2, GetMap()) { }
		...
		public HiddenTreasuresTreasureMap(Serial serial)
			: base(serial) { }
	...
	public class SaltySeaMIB : MessageInABottle
	{
		[Constructable]
		public SaltySeaMIB()
			: this(Utility.RandomBool() ? Map.Trammel : Map.Felucca, 3) { }
		...
		public SaltySeaMIB(Serial serial)
			: base(serial) { }
	...
	{
		[Constructable]
		public SaltySeaSOS(Map map, int level)
			: base(map, level)
		{
			//AssignLocation();
		}
		...
		public SaltySeaSOS(Serial serial)
			: base(serial) { }
	...
	public class MyrmidexIdol : Item
	{
		...
		public override void OnDoubleClick(Mobile from)
		{
			...
			DestructionOfZipactriotlQuest q =
				QuestHelper.GetQuest((PlayerMobile)from, typeof(DestructionOfZipactriotlQuest))
				as DestructionOfZipactriotlQuest;
			...
			if (q != null || from.AccessLevel > AccessLevel.Player)
			{
				...
				Effects.SendLocationParticles(
					EffectItem.Create(from.Location, Map.TerMur, EffectItem.DefaultDuration),
					0x3728,
					10,
					10,
					2023
				...
				Effects.SendLocationParticles(
					EffectItem.Create(_Destination, Map.TerMur, EffectItem.DefaultDuration),
					0x3728,
					10,
					10,
					5023
		...
		public MyrmidexIdol(Serial serial)
			: base(serial) { }
	...
	public class StasisChamberPowerCore : Item
	{
		...
		public StasisChamberPowerCore(Serial serial)
			: base(serial) { }
