...
namespace Server.Items
{
	public class MyrmidexRewardBag : Backpack
	{
		public MyrmidexRewardBag()
		{
			...
			switch (Utility.Random(4))
			{
				default:
				case 0:
					DropItem(new RecipeScroll(Utility.RandomMinMax(900, 905)));
					break;
				case 1:
					DropItem(new EodonTribeRewardTitleToken());
					break;
				case 2:
					DropItem(new RecipeScroll(455));
					break;
				case 3:
					DropItem(new MoonstoneCrystal());
					break;
			}
		}
	...
	public class EodonianRewardBag : Backpack
	{
		public EodonianRewardBag()
		{
			...
			switch (Utility.Random(4))
			{
				default:
				case 0:
					DropItem(new MonsterStatuette(MonsterStatuetteType.SakkhranBirdOfPrey));
					break;
				case 1:
					DropItem(new EodonTribeRewardTitleToken());
					break;
				case 2:
					DropItem(new RecipeScroll(1000));
					break;
				case 3:
	...
	public class MoonstoneCrystal : Item, ISecurable
	{
		...
		{
			get { return this.m_SecureLevel; }
			set { this.m_SecureLevel = value; }
		}
		...
		private class InternalGump : Gump
		{
			...
			public InternalGump(PlayerMobile pm, Item moonstone)
				: base(75, 75)
			{
				Moonstone = moonstone;
				User = pm;
			...
			public void AddGumpLayout()
			{
				...
				ColUtility.For<int, Point3D>(
					MoonstoneCrystal.Locations,
					(i, key, value) =>
					{
		...
		public MoonstoneCrystal(Serial serial)
			: base(serial) { }
	...
	public class KotlPowerCore : Item
	{
		...
		public KotlPowerCore(Serial serial)
			: base(serial) { }
	...
	public class EodonianWallMap : Item
	{
		...
		public EodonianWallMap(Serial serial)
			: base(serial) { }
	...
	public class RawMoonstoneLargeAddon : BaseAddon
	{
		...
		{
			get { return new RawMoonstoneLargeAddonDeed(); }
		}
	...
	public class RawMoonstoneLargeAddonDeed : BaseAddonDeed
	{
		...
		{
			get { return new RawMoonstoneLargeAddon(); }
		}
	...
	public class RawMoonstoneSmallAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get { return new RawMoonstoneSmallAddonDeed(); }
		}
	...
	public class RawMoonstoneSmallAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get { return new RawMoonstoneSmallAddon(); }
		}
