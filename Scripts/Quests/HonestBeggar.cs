...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        { 
            ...
            this.AddReward(new BaseReward(1075394)); // Find the ring뭩 owner.
        }
        ...
        Someone뭩 bound to recognize it. */
    ...
    { 
        ...
        /* What뭩 that you say? It was a humble beggar that found my ring? Such honesty must be rewarded. Here, take this packet 
