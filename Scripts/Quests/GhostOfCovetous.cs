...
namespace Server.Engines.Quests
{
	...
	public class SaveHisDadQuest : BaseQuest
	{
		...
		{
			this.AddObjective(
				new DeliverObjective(typeof(DreadSpiderSilk), "dread spider silk", 1, typeof(Leon), "Leon", 600)
			);
	...
	public class FathersGratitudeQuest : BaseQuest
	{
		...
		{
			this.AddObjective(
				new DeliverObjective(typeof(AlchemistsBandage), "alchemist's bandage", 1, typeof(Andros), "Andros")
			);
