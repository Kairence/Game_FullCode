...
namespace Server.Engines.Quests
{
    ...
    { 
        ...
        spider. I came here to get some, but I was careless, and succumbed to their poison. Please, won뭪 you help my father? */
        public override object Description
        {
            get
            {
        ...
        /* Oh . . . that뭩 your decision . . . OooOoooOOoo . . . */
        public override object Refuse
        {
            get
            {
    ...
    { 
        ...
        /* That is simply terrible. First Andros, and now his son. Well, let뭩 make sure Frederic뭩 sacrifice wasn뭪 in vain. Will you take 
        the bandages to his father? You can probably deliver them faster than I can, can뭪 you? */
        public override object Description
        {
            get
            {
        ...
        /* Well I뭢 sorry to hear you say that. Without your help, I don뭪 know if I can get these to Andros quickly enough to help him. */
        public override object Refuse
        {
            get
            {
        ...
        /* I don뭪 know how much longer Andros will survive. You뭗 better get this to him as quick as you can. Every second counts! */
        public override object Uncomplete
        {
            get
            {
        ...
        /* Sorry, I뭢 not accepting commissions at the moment. What? You have the bandage I need from Leon? Thank you so much! But why didn뭪 
