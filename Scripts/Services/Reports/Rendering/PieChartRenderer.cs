...
namespace Server.Engines.Reports
{
	...
	public class PieChartRenderer : ChartRenderer
	{
		...
		{
			get { return this._showPercents; }
			set { this._showPercents = value; }
		}
			...
			try
			{
				...
				using (Pen pen1 = new Pen(this._borderColor, 1))
					grp.DrawRectangle(
						...
						10,
						220,
						this._chartItems.Count * this._legendFontHeight + 25
					);
				...
				using (Font fntb = new Font(this._legendFontStyle, this._legendFontSize, FontStyle.Bold))
				{
					grp.DrawString(
						...
						(this._chartItems.Count + 1) * this._legendFontHeight,
						sf
					);
					grp.DrawString(
