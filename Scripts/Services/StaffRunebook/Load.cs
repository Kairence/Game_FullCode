	...
	public class SR_Load
	{
		...
		public static SR_Rune ReadRuneNode(XmlElement parent)
		{
			...
			return new SR_Rune(
				...
				Map.Parse(parent.GetAttribute("TargetMap")),
				new Point3D(
					Utility.ToInt32(parent.GetAttribute("X")),
					Utility.ToInt32(parent.GetAttribute("Y")),
					Utility.ToInt32(parent.GetAttribute("Z"))
				)
			);
		}
