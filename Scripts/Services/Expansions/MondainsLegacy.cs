...
namespace Server
{
	...
	public static class MondainsLegacy
	{
		private static readonly Type[] m_Artifacts = new Type[]
		{
			typeof(AegisOfGrace),
			typeof(BladeDance),
			typeof(BloodwoodSpirit),
			typeof(Bonesmasher),
			typeof(Boomstick),
			typeof(BrightsightLenses),
			typeof(FeyLeggings),
			typeof(FleshRipper),
			typeof(HelmOfSwiftness),
		...
		public static void Initialize()
		{
			...
			CommandSystem.Register(
				...
				new CommandEventHandler(DecorateML_OnCommand)
			);
			CommandSystem.Register(
				"DecorateMLDelete",
				AccessLevel.Administrator,
				new CommandEventHandler(DecorateMLDelete_OnCommand)
			);
			CommandSystem.Register(
				"SettingsML",
				AccessLevel.Administrator,
				new CommandEventHandler(SettingsML_OnCommand)
			);
		...
		public static void OnKilledBy(OnKilledByEventArgs e)
		{
			...
			if (
				...
				&& killer != null
				&& killer.Alive
				&& killed.GivesMLMinorArtifact
				&& CheckArtifactChance(killer, killed)
			)
			{
	...
	public class MondainsLegacyGump : Gump
	{
			...
			: base(50, 50)
		{
			...
			this.AddButton(
				20,
				60,
				MondainsLegacy.PalaceOfParoxysmus ? 0x939 : 0x938,
				MondainsLegacy.PalaceOfParoxysmus ? 0x939 : 0x938,
				1,
			...
			this.AddButton(
				20,
				85,
				MondainsLegacy.TwistedWeald ? 0x939 : 0x938,
				MondainsLegacy.TwistedWeald ? 0x939 : 0x938,
				2,
				GumpButtonType.Reply,
				0
			...
			this.AddButton(
				20,
				110,
				MondainsLegacy.BlightedGrove ? 0x939 : 0x938,
				MondainsLegacy.BlightedGrove ? 0x939 : 0x938,
				3,
				GumpButtonType.Reply,
				0
			...
			this.AddButton(
				20,
				135,
				MondainsLegacy.Bedlam ? 0x939 : 0x938,
				MondainsLegacy.Bedlam ? 0x939 : 0x938,
				4,
				GumpButtonType.Reply,
				0
			...
			this.AddButton(
				20,
				160,
				MondainsLegacy.PrismOfLight ? 0x939 : 0x938,
				MondainsLegacy.PrismOfLight ? 0x939 : 0x938,
				5,
				GumpButtonType.Reply,
				0
			...
			this.AddButton(
				20,
				185,
				MondainsLegacy.Citadel ? 0x939 : 0x938,
				MondainsLegacy.Citadel ? 0x939 : 0x938,
				6,
				GumpButtonType.Reply,
				0
			...
			this.AddButton(
				20,
				210,
				MondainsLegacy.PaintedCaves ? 0x939 : 0x938,
				MondainsLegacy.PaintedCaves ? 0x939 : 0x938,
				7,
				GumpButtonType.Reply,
				0
			...
			this.AddButton(
				20,
				235,
				MondainsLegacy.Labyrinth ? 0x939 : 0x938,
				MondainsLegacy.Labyrinth ? 0x939 : 0x938,
				8,
				GumpButtonType.Reply,
				0
			...
			this.AddButton(
				20,
				260,
				MondainsLegacy.Sanctuary ? 0x939 : 0x938,
				MondainsLegacy.Sanctuary ? 0x939 : 0x938,
				9,
				GumpButtonType.Reply,
				0
			...
			this.AddButton(
				20,
				285,
				MondainsLegacy.StygianDragonLair ? 0x939 : 0x938,
				MondainsLegacy.StygianDragonLair ? 0x939 : 0x938,
				10,
				GumpButtonType.Reply,
				0
			...
			this.AddButton(
				20,
				310,
				MondainsLegacy.MedusasLair ? 0x939 : 0x938,
				MondainsLegacy.MedusasLair ? 0x939 : 0x938,
				11,
				GumpButtonType.Reply,
				0
			...
			this.AddButton(
				20,
				335,
				MondainsLegacy.Spellweaving ? 0x939 : 0x938,
				MondainsLegacy.Spellweaving ? 0x939 : 0x938,
				12,
				GumpButtonType.Reply,
				0
			...
			this.AddButton(
				20,
				360,
				MondainsLegacy.PublicDonations ? 0x939 : 0x938,
				MondainsLegacy.PublicDonations ? 0x939 : 0x938,
				13,
				GumpButtonType.Reply,
				0
