...
namespace Server.Mobiles
{
	public class BaseSeaChampion : BaseChampion
	{
		...
		{
			get { return ChampionSkullType.None; }
		}
		...
		public virtual bool CanDamageBoats
		{
			get { return false; }
		}
		public virtual TimeSpan BoatDamageCooldown
		{
			get { return TimeSpan.MaxValue; }
		}
		public virtual DateTime NextBoatDamage
		{
			get { return m_NextBoatDamage; }
		}
		public virtual int MinBoatDamage
		{
			get { return 0; }
		}
		public virtual int MaxBoatDamage
		{
			get { return 0; }
		}
		...
		public void TryDamageBoat()
		{
			...
			if (
				...
				|| !InRange(focusMob.Location, DamageRange)
				|| BaseBoat.FindBoatAt(focusMob, focusMob.Map) == null
			)
				return;
		...
		public Point3D GetValidPoint(BaseBoat boat, Map map, int distance)
		{
			...
			switch (boat.Facing)
			{
				...
				case Direction.North:
					x = Utility.RandomBool()
						? Utility.RandomMinMax(x -= distance, x -= (distance - range))
						: Utility.RandomMinMax(x += (distance - range), x += distance);
				...
				case Direction.West:
					...
					y = Utility.RandomBool()
						? Utility.RandomMinMax(y -= distance, y -= (distance - range))
						: Utility.RandomMinMax(y += (distance - range), y += distance);
					z = map.GetAverageZ(x, y);
					break;
			}
