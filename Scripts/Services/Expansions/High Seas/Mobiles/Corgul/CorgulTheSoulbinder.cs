...
namespace Server.Mobiles
{
	public class CorgulTheSoulBinder : BaseSeaChampion
	{
		...
		{
			get { return TimeSpan.FromSeconds(Utility.RandomMinMax(10, 50)); }
		}
		...
		public override bool CanGivePowerscrolls
		{
			get { return false; }
		}
		...
		{
			get { return Map != null && Map.Rules == MapRules.FeluccaRules ? .12 : .08; }
		}
		public double DecorativeChance
		{
			get { return Map != null && Map.Rules == MapRules.FeluccaRules ? .40 : .25; }
		}
