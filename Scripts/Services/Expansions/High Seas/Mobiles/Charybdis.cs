...
namespace Server.Mobiles
{
	public class Charydbis : BaseSeaChampion
	{
		...
		{
			get { return TimeSpan.FromSeconds(Utility.RandomMinMax(45, 80)); }
		}
		...
		public override Type[] UniqueList
		{
			get
			{
				return new Type[]
				{
					typeof(FishermansHat),
					typeof(FishermansVest),
					typeof(FishermansEelskinGloves),
					typeof(FishermansTrousers),
				};
			}
		}
		...
		public void FinishTeleport(Mobile combatant)
		{
			...
			Timer.DelayCall(
				...
				new TimerStateCallback(TimedMoveToWorld),
				new object[] { newLoc, map, combatant }
			);
		}
	...
	public class GiantTentacle : BaseCreature
	{
		...
		public GiantTentacle(Mobile master)
