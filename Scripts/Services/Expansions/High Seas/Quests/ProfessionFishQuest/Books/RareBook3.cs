...
namespace Server.Items
{
	public class FishingGuideBook3 : BaseBook
	{
		...
		public static readonly BookContent Content = new BookContent(
			null,
			"Cpt. Piddlewash",
			new BookPageInfo("Crag Snapper:", "Crag Snapper be fine", "eating. Just mind yer", "fingers. "),
			new BookPageInfo(
				"Cutthrout Trout:",
				"This dungeon menace",
			...
			new BookPageInfo("Demon Trout:", "Beware, this big devil", "comes out of the water", "spicy. "),
			new BookPageInfo(
				"Drakefish:",
			...
			new BookPageInfo("Dungeon Chub:", "This be the only", "subterranean member", "o' the chub family. "),
			new BookPageInfo(
				"Grim Cisco:",
				"This fish is sought",
				"for medicinal",
		...
		public FishingGuideBook3(Serial serial)
			: base(serial) { }
