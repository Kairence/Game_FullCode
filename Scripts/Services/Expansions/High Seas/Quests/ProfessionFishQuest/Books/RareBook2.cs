...
namespace Server.Items
{
	public class FishingGuideBook2 : BaseBook
	{
		...
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("Bonito:", "Bonito be great when", "smoked and dried. Tis", "a favorite of Tokuno. "),
			new BookPageInfo(
				"Cape cod:",
			...
			new BookPageInfo("Shad:", "The shad be one o’", "me personal favorite", "deep sea uncommon fish."),
			new BookPageInfo(
				"Tarpon:",
		...
		public FishingGuideBook2(Serial serial)
			: base(serial) { }
