	...
	public class PlayerFishingEntry
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				"FishMongerStatus",
				AccessLevel.Player,
				new CommandEventHandler(FishMongerStatus_OnCommand)
			);
		}
		...
		public bool HasRecievedBritGal
		{
			get { return m_HasRecievedBritGal; }
			set { m_HasRecievedBritGal = value; }
		}
		public Dictionary<int, int> HaveFished
		{
			get { return m_HaveFished; }
		}
		public Dictionary<int, int> TimesFished
		{
			get { return m_TimesFished; }
		}

		private static Dictionary<Mobile, PlayerFishingEntry> m_FishingEntries =
			new Dictionary<Mobile, PlayerFishingEntry>();
		public static Dictionary<Mobile, PlayerFishingEntry> FishingEntries
		{
			get { return m_FishingEntries; }
		}
