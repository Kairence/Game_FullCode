...
namespace Server.Engines.Quests
{
	public class BountyQuestObjective : BaseObjective
	{
		...
		public Mobile CapturedCaptain
		{
			get { return m_CapturedCaptain; }
			set { m_CapturedCaptain = value; }
		}
		...
		{
			if (
				m_CapturedCaptain != null
				&& m_CapturedCaptain is PirateCaptain
				&& this.Quest is ProfessionalBountyQuest
			)
