...
namespace Server.Multis
{
	public class RowBoat : BaseBoat
	{
		...
		{
			get { return new DockedRowBoat(this); }
		}
		...
		public override bool IsRowBoat
		{
			get { return true; }
		}
		public override bool CanLinkToLighthouse
		{
			get { return false; }
		}
		...
		public override void OnLocationChange(Point3D old)
		{
			...
			if (Rudder != null && Rudder.Handle != null)
				Rudder.Handle.Location = new Point3D(
					X + (Rudder.Handle.X - old.X),
					Y + (Rudder.Handle.Y - old.Y),
					Z + (Rudder.Handle.Z - old.Z)
				);
		}
	...
	public class RudderHandle : Static
	{
		...
		public RudderHandle(Serial serial)
			: base(serial) { }
	...
	public class RowBoatDeed : BaseBoatDeed
	{
		...
		{
			get { return new RowBoat(BoatDirection); }
		}
