...
namespace Server.Items
{
	public class StoneFootwear : BaseShoes
	{
		...
		[Constructable]
		public StoneFootwear()
			: this(Utility.Random(5899, 8)) { }
		...
		public StoneFootwear(Serial serial)
			: base(serial) { }
	...
	public class CrackedLavaRockSouth : Item
	{
		...
		public virtual void OnCrack(Mobile from)
		{
			...
			switch (Utility.Random(5))
			{
				...
				case 1:
					...
					break;
				case 2:
					item = new GeodeShardEast();
					break;
				case 3:
					item = new GeodeShardSouth();
					break;
				case 4:
					item = new LavaRock();
					break;
		...
		public CrackedLavaRockSouth(Serial serial)
			: base(serial) { }
	...
	public class CrackedLavaRockEast : Item
	{
		...
		public CrackedLavaRockEast(Serial serial)
			: base(serial) { }
	...
	public class GeodeSouth : Item
	{
		...
		public GeodeSouth(Serial serial)
			: base(serial) { }
	...
	public class GeodeEast : Item
	{
		...
		public GeodeEast(Serial serial)
			: base(serial) { }
	...
	public class GeodeShardSouth : Item
	{
		...
		public GeodeShardSouth(Serial serial)
			: base(serial) { }
	...
	public class GeodeShardEast : Item
	{
		...
		public GeodeShardEast(Serial serial)
			: base(serial) { }
	...
	public class LavaRock : Item
	{
		...
		[Constructable]
		public LavaRock()
			: base(Utility.Random(4964, 6))
		{
			Hue = 1175;
		}

		public LavaRock(Serial serial)
			: base(serial) { }
	...
	public class StonePaver : Item
	{
		...
		public StonePaver(Serial serial)
			: base(serial) { }
