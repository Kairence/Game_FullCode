...
namespace Server.Items
{
	public class Cannonball : Item, ICommodity, ICannonAmmo
	{
		...
		public virtual AmmunitionType AmmoType
		{
			get { return AmmunitionType.Cannonball; }
		}
	...
	public class FrostCannonball : Cannonball, ICommodity
	{
		...
		public override AmmunitionType AmmoType
		{
			get { return AmmunitionType.FrostCannonball; }
		}

		[Constructable]
		public FrostCannonball()
			: this(1) { }

		[Constructable]
		public FrostCannonball(int amount)
			: this(amount, 16939) { }
		...
		public FrostCannonball(Serial serial)
			: base(serial) { }
	...
	public class FlameCannonball : Cannonball, ICommodity
	{
		...
		public override AmmunitionType AmmoType
		{
			get { return AmmunitionType.FlameCannonball; }
		}

		[Constructable]
		public FlameCannonball()
			: this(1) { }

		[Constructable]
		public FlameCannonball(int amount)
			: this(amount, 17601) { }
		...
		public FlameCannonball(Serial serial)
			: base(serial) { }
	...
	public class HeavyCannonball : Item, ICommodity, ICannonAmmo
	{
		...
		[Constructable]
		public HeavyCannonball()
			: this(1) { }

		[Constructable]
		public HeavyCannonball(int amount)
			: this(amount, 16932) { }

		public HeavyCannonball(int amount, int itemID)
			: base(itemID)
		{
			Stackable = true;
			Amount = amount;
		...
		public HeavyCannonball(Serial serial)
			: base(serial) { }
	...
	public class LightFlameCannonball : Cannonball, ICommodity
	{
		...
		[Constructable]
		public LightFlameCannonball()
			: this(1) { }

		[Constructable]
		public LightFlameCannonball(int amount)
			: base(amount, 17601) { }

		public LightFlameCannonball(Serial serial)
			: base(serial) { }
	...
	public class HeavyFlameCannonball : Cannonball, ICommodity
	{
		...
		public HeavyFlameCannonball(Serial serial)
			: base(serial) { }
	...
	public class LightFrostCannonball : Cannonball, ICommodity
	{
		...
		public LightFrostCannonball(Serial serial)
			: base(serial) { }
	...
	public class HeavyFrostCannonball : Cannonball, ICommodity
	{
		...
		public HeavyFrostCannonball(Serial serial)
			: base(serial) { }
