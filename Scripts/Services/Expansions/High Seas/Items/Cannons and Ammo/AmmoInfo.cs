...
namespace Server.Items
{
	...
	public class AmmoInfo
	{
		...
		public static void Initialize()
		{
			if (Core.EJ)
			{
				Infos[typeof(Cannonball)] = new AmmoInfo(
					typeof(HeavyCannonball),
					AmmunitionType.Cannonball,
					1095804,
					5000,
					5000,
					3
				);
				Infos[typeof(Grapeshot)] = new AmmoInfo(
				...
				Infos[typeof(FlameCannonball)] = new AmmoInfo(
					typeof(HeavyFlameCannonball),
					AmmunitionType.FlameCannonball,
					1149633,
					5000,
					5000,
					3,
				...
				Infos[typeof(FrostCannonball)] = new AmmoInfo(
					typeof(HeavyFrostCannonball),
					AmmunitionType.FrostCannonball,
					1149634,
					30,
					50,
					3,
			...
			{
				Infos[typeof(LightCannonball)] = new AmmoInfo(
				...
				Infos[typeof(HeavyCannonball)] = new AmmoInfo(
					typeof(HeavyCannonball),
					AmmunitionType.Cannonball,
					1095804,
					6500,
				...
				Infos[typeof(LightGrapeshot)] = new AmmoInfo(
				...
				Infos[typeof(HeavyGrapeshot)] = new AmmoInfo(
					typeof(HeavyGrapeshot),
					AmmunitionType.Grapeshot,
					1095741,
					50,
				...
				Infos[typeof(HeavyFlameCannonball)] = new AmmoInfo(
					typeof(HeavyFlameCannonball),
					AmmunitionType.FlameCannonball,
					1149633,
					5000,
				...
				Infos[typeof(LightFlameCannonball)] = new AmmoInfo(
				...
				Infos[typeof(HeavyFrostCannonball)] = new AmmoInfo(
					typeof(HeavyFrostCannonball),
					AmmunitionType.FrostCannonball,
					1149634,
					5000,
				...
				Infos[typeof(LightFrostCannonball)] = new AmmoInfo(
