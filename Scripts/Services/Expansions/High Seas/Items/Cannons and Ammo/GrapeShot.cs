...
namespace Server.Items
{
	public class Grapeshot : Item, ICommodity, ICannonAmmo
	{
		...
		{
			get { return AmmunitionType.Grapeshot; }
		}
	...
	public class LightGrapeshot : Item, ICommodity, ICannonAmmo
	{
		...
		[Constructable]
		public LightGrapeshot()
			: this(1) { }

		[Constructable]
		public LightGrapeshot(int amount)
			: base(16869)
		{
			Stackable = true;
			Amount = amount;
		...
		public LightGrapeshot(Serial serial)
			: base(serial) { }
	...
	public class HeavyGrapeshot : Item, ICommodity, ICannonAmmo
	{
		...
		[Constructable]
		public HeavyGrapeshot()
			: this(1) { }

		[Constructable]
		public HeavyGrapeshot(int amount)
			: base(16869)
		{
			Stackable = true;
			Amount = amount;
		...
		public HeavyGrapeshot(Serial serial)
			: base(serial) { }
