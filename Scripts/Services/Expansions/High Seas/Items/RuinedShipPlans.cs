...
namespace Server.Items
{
	public class RuinedShipPlans : Item
	{
		...
		[Constructable]
		public RuinedShipPlans()
			: this((PlanType)Utility.RandomMinMax(1, 8)) { }

		[Constructable]
		public RuinedShipPlans(PlanType type)
			: base(5360)
		{
			m_PlanType = type;
			m_Joined.Add(type);
		...
		private class InternalTarget : Target
		{
			...
			public InternalTarget(RuinedShipPlans plans)
		...
		public RuinedShipPlans(Serial serial)
			: base(serial) { }
