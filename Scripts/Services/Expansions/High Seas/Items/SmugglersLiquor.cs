...
namespace Server.Items
{
	public class SmugglersLiquor : BaseBeverage
	{
		...
		public SmugglersLiquorType LiquorType
		{
			get { return m_Type; }
			set
			{
		...
		[Constructable]
		public SmugglersLiquor()
			: this((SmugglersLiquorType)Utility.Random(26)) { }

		public SmugglersLiquor(SmugglersLiquorType type)
			: base(GetContents(type))
		{
		...
		public static BeverageType GetContents(SmugglersLiquorType type)
		{
			switch (type)
			{
				...
				case SmugglersLiquorType.AppleIsleWhiskey:
					return BeverageType.Liquor;
				case SmugglersLiquorType.ArabellasGargishStout:
					return BeverageType.Ale;
