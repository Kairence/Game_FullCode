...
namespace Server.Items
{
	public class BaseCrabAndLobster : BaseHighseasFish
	{
		...
		public BaseCrabAndLobster(int itemID)
			: base(itemID) { }

		public BaseCrabAndLobster(Serial serial)
			: base(serial) { }
	...
	public class RareCrabAndLobster : BaseCrabAndLobster
	{
		...
		{
			get { return m_CaughtBy; }
			set { m_CaughtBy = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public DateTime DateCaught
		{
			get { return m_DateCaught; }
			set { m_DateCaught = value; }
		}
	...
	public class AppleCrab : BaseCrabAndLobster
	{
		...
		public AppleCrab(Serial serial)
			: base(serial) { }
	...
	public class DungeonessCrab : BaseCrabAndLobster
	{
		...
		public DungeonessCrab(Serial serial)
			: base(serial) { }
	...
	public class StoneCrab : RareCrabAndLobster
	{
		...
		public StoneCrab(Serial serial)
			: base(serial) { }
	...
	public class SpiderCrab : RareCrabAndLobster
	{
		...
		public SpiderCrab(Serial serial)
			: base(serial) { }
	...
	public class TunnelCrab : RareCrabAndLobster
	{
		...
		public TunnelCrab(Serial serial)
			: base(serial) { }
	...
	public class CrustyLobster : BaseCrabAndLobster
	{
		...
		public CrustyLobster(Serial serial)
			: base(serial) { }
	...
	public class FredLobster : BaseCrabAndLobster
	{
		...
		public FredLobster(Serial serial)
			: base(serial) { }
	...
	public class HummerLobster : BaseCrabAndLobster
	{
		...
		public HummerLobster(Serial serial)
			: base(serial) { }
	...
	public class RockLobster : BaseCrabAndLobster
	{
		...
		public RockLobster(Serial serial)
			: base(serial) { }
	...
	public class ShovelNoseLobster : BaseCrabAndLobster
	{
		...
		public ShovelNoseLobster(Serial serial)
			: base(serial) { }
	...
	public class SpineyLobster : BaseCrabAndLobster
	{
		...
		public SpineyLobster(Serial serial)
			: base(serial) { }
	...
	public class BlueLobster : RareCrabAndLobster
	{
		...
		public BlueLobster(Serial serial)
			: base(serial) { }
	...
	public class BloodLobster : RareCrabAndLobster
	{
		...
		public BloodLobster(Serial serial)
			: base(serial) { }
	...
	public class DreadLobster : RareCrabAndLobster
	{
		...
		public DreadLobster(Serial serial)
			: base(serial) { }
	...
	public class VoidLobster : RareCrabAndLobster
	{
		...
		public VoidLobster(Serial serial)
			: base(serial) { }
	...
	public class StoneCrabMeat : Item
	{
		...
		[Constructable]
		public StoneCrabMeat()
			: base(4159)
		{
			Hue = FishInfo.GetFishHue(typeof(StoneCrab));
		}

		public StoneCrabMeat(Serial serial)
			: base(serial) { }
	...
	public class SpiderCrabMeat : Item
	{
		...
		public SpiderCrabMeat(Serial serial)
			: base(serial) { }
	...
	public class BlueLobsterMeat : Item
	{
		...
		public BlueLobsterMeat(Serial serial)
			: base(serial) { }
