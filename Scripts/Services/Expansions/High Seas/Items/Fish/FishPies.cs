...
namespace Server.Items
{
	...
	public class BaseFishPie : Item, IQuality
	{
		...
		public virtual int BuffName
		{
			get { return 0; }
		}
		public virtual int BuffAmount
		{
			get { return 0; }
		}
		public virtual FishPieEffect Effect
		{
			get { return FishPieEffect.None; }
		}

		public static Dictionary<Mobile, List<FishPieEffect>> m_EffectsList =
			new Dictionary<Mobile, List<FishPieEffect>>();
		...
		public static void ScaleDamage(
			Mobile from,
			Mobile to,
			ref int totalDamage,
			int phys,
		...
		private class InternalTimer : Timer
		{
			...
			public InternalTimer(TimeSpan duration, Mobile from, FishPieEffect type)
				: base(duration)
			{
				m_From = from;
				m_EffectType = type;
		...
		public BaseFishPie(Serial serial)
			: base(serial) { }
	...
	public class AutumnDragonfishPie : BaseFishPie
	{
		...
		public override int BuffName
		{
			get { return 1116280; }
		}
		public override int BuffAmount
		{
			get { return 10; }
		}
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.MedBoost; }
		}
		...
		public AutumnDragonfishPie(Serial serial)
			: base(serial) { }
	...
	public class BullFishPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.WeaponDam; }
		}
		...
		public BullFishPie(Serial serial)
			: base(serial) { }
	...
	public class CrystalFishPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.EnergySoak; }
		}
		...
		public CrystalFishPie(Serial serial)
			: base(serial) { }
	...
	public class FairySalmonPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.CastFocus; }
		}
		...
		public FairySalmonPie(Serial serial)
			: base(serial) { }
	...
	public class FireFishPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.FireSoak; }
		}
		...
		public FireFishPie(Serial serial)
			: base(serial) { }
	...
	public class GiantKoiPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.DefChance; }
		}
		...
		public GiantKoiPie(Serial serial)
			: base(serial) { }
	...
	public class GreatBarracudaPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.HitChance; }
		}
		...
		public GreatBarracudaPie(Serial serial)
			: base(serial) { }
	...
	public class HolyMackerelPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.ManaRegen; }
		}
		...
		public HolyMackerelPie(Serial serial)
			: base(serial) { }
	...
	public class LavaFishPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.SoulCharge; }
		}
		...
		public LavaFishPie(Serial serial)
			: base(serial) { }
	...
	public class ReaperFishPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.PoisonSoak; }
		}
		...
		public ReaperFishPie(Serial serial)
			: base(serial) { }
	...
	public class SummerDragonfishPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.SpellDamage; }
		}
		...
		public SummerDragonfishPie(Serial serial)
			: base(serial) { }
	...
	public class UnicornFishPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.StamRegen; }
		}
		...
		public UnicornFishPie(Serial serial)
			: base(serial) { }
	...
	public class YellowtailBarracudaPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.HitsRegen; }
		}
		...
		public YellowtailBarracudaPie(Serial serial)
			: base(serial) { }
	...
	public class StoneCrabPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.PhysicalSoak; }
		}
		...
		public StoneCrabPie(Serial serial)
			: base(serial) { }
	...
	public class SpiderCrabPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.FocusBoost; }
		}
		...
		public SpiderCrabPie(Serial serial)
			: base(serial) { }
	...
	public class BlueLobsterPie : BaseFishPie
	{
		...
		public override FishPieEffect Effect
		{
			get { return FishPieEffect.ColdSoak; }
		}
		...
		public BlueLobsterPie(Serial serial)
			: base(serial) { }
