...
namespace Server.Items
{
	...
	public class FishTrophyDeed : Item
	{
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public int TrophyName
		{
			get { return m_TrophyName; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int DeedName
		{
			get { return m_DeedName; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int TrophyID
		{
			get { return m_TrophyID; }
		}
		...
		public FishTrophyDeed(int weight, Mobile fisher, DateTime caught, int deedname, int trophyname, int id)
			: base(0x14F0)
		{
			m_Weight = weight;
			m_Fisher = fisher;
		...
		public BaseAddon ConstructTrophy(bool north)
		{
			...
			{
				case 0:
					addon = new FishTrophy(
						typeof(AutumnDragonfish),
						TrophyStyle.Dragonfish,
						north,
						m_TrophyName,
						m_Weight,
						m_Fisher,
		...
		public FishTrophyDeed(Serial serial)
			: base(serial) { }
	...
	public class FishTrophy : BaseAddon
	{
		...
		public override void OnComponentUsed(AddonComponent c, Mobile from)
		{
			...
			if (info != null)
			{
				...
				if (
					house != null
					&& (house.IsCoOwner(from) || (house.Addons.ContainsKey(this) && house.Addons[this] == from))
				)
				{
					from.AddToBackpack(
						new FishTrophyDeed(
	...
	public class TrophyComponent : LocalizedAddonComponent
	{
		...
		public TrophyComponent(int itemID, int label, int hue)
			: base(itemID, label)
		{
			Hue = hue;
		}
		...
		public TrophyComponent(Serial serial)
			: base(serial) { }
