...
namespace Server.Items
{
	...
	public class BaseFishingHook : Item
	{
		...
		public BaseFishingHook()
			: this(50) { }

		public BaseFishingHook(int uses)
			: base(19270)
		{
			m_Uses = uses;
		}
					...
					if (pole.HookType != HookType.None)
					{
						...
						switch (pole.HookType)
						{
							case HookType.None:
								break;
							case HookType.Lava:
								hook = new LavaHook(pole.HookUses);
								break;
							case HookType.Dredging:
								hook = new DredgingHook(pole.HookUses);
								break;
							case HookType.JunkProof:
								hook = new JunkProofHook(pole.HookUses);
								break;
						}
		...
		public BaseFishingHook(Serial serial)
			: base(serial) { }
	...
	public class DredgingHook : BaseFishingHook
	{
		...
		public DredgingHook(Serial serial)
			: base(serial) { }
	...
	public class JunkProofHook : BaseFishingHook
	{
		...
		public JunkProofHook(Serial serial)
			: base(serial) { }
