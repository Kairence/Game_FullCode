...
namespace Server.Items
{
    public class FishInfo
    {
        public static void Configure()
        {
            ...
            m_FishInfos.Add(new FishInfo(2579/*1287*/, typeof(GreatBarracuda),1116100, "Wrong",                true,  RareChance, 89.0)); //Confirmed
            ...
            m_FishInfos.Add(new FishInfo(2576, typeof(GiantSamuraiFish),    1116103, "Diceit",                   true,  LegendaryChance, 110.1)); //Confirmed
