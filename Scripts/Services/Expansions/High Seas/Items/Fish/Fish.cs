...
namespace Server.Items
{
	public class BaseHighseasFish : Item, ICommodity
	{
		...
		*/
		...
		public static Type[] DeepWaterFish
		{
			get { return m_DeepWaterFish; }
		}
		...
		public static Type[] ShoreFish
		{
			get { return m_ShoreFish; }
		}
		private static Type[] m_ShoreFish = new Type[]
		{
			typeof(PumpkinSeedSunfish),
			typeof(YellowPerch),
			typeof(PikeFish),
			typeof(BrookTrout),
			typeof(RainbowTrout),
			typeof(BluegillSunfish),
			typeof(RedbellyBream),
			typeof(SmallmouthBass),
			typeof(UncommonShiner),
			typeof(GreenCatfish),
			typeof(Walleye),
			typeof(KokaneeSalmon),
			typeof(Trout),
			typeof(Bass),
			typeof(Shiner),
			typeof(CrucianCarp),
		...
		public static Type[] DungeonFish
		{
			get { return m_DungeonFish; }
		}
		private static Type[] m_DungeonFish = new Type[]
		{
			typeof(DungeonChub),
			typeof(DemonTrout),
			typeof(SnaggletoothBass),
			typeof(CutThroatTrout),
			typeof(GrimCisco),
			typeof(DrakeFish),
			typeof(OrcBass),
			typeof(DarkFish),
			typeof(CragSnapper),
			typeof(InfernalTuna),
			typeof(TormentedPike),
			typeof(LurkerFish),
		};

		public static Type[] LobstersAndCrabs
		{
			get { return m_LobstersAndCrabs; }
		}
		private static Type[] m_LobstersAndCrabs = new Type[]
		{
			typeof(DungeonessCrab),
			typeof(BlueCrab),
			typeof(KingCrab),
			typeof(RockCrab),
			typeof(SnowCrab),
			typeof(AppleCrab),
			typeof(SpineyLobster),
			typeof(RockLobster),
			typeof(HummerLobster),
			typeof(FredLobster),
			typeof(CrustyLobster),
			typeof(ShovelNoseLobster),
		};

		public static Type[] Lobsters
		{
			get { return m_Lobsters; }
		}
		...
		public BaseHighseasFish(Serial serial)
			: base(serial) { }
	...
	public class CrucianCarp : BaseHighseasFish
	{
		...
		public CrucianCarp(Serial serial)
			: base(serial) { }
	...
	public class PerchFish : BaseHighseasFish
	{
		...
		public PerchFish(Serial serial)
			: base(serial) { }
