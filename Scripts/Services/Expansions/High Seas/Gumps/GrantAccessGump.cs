	...
	public class GrantAccessGump : BaseShipGump
	{
			...
			: base(galleon)
		{
			...
			AddHtmlLocalized(
				...
				18,
				1149726,
				level == SecurityLevel.Denied ? GetHue(level) : LabelColor,
				false,
				false
			); // DENY ACCESS
			...
			AddHtmlLocalized(
				...
				18,
				1149727,
				level == SecurityLevel.Passenger ? GetHue(level) : LabelColor,
				false,
				false
			); // PASSENGER
			...
			AddHtmlLocalized(
				...
				18,
				1149728,
				level == SecurityLevel.Crewman ? GetHue(level) : LabelColor,
				false,
				false
			); // CREW
			...
			AddHtmlLocalized(
				...
				18,
				1149729,
				level == SecurityLevel.Officer ? GetHue(level) : LabelColor,
				false,
				false
			); // OFFICER
			...
			AddHtmlLocalized(
				...
				18,
				1149730,
				level == SecurityLevel.Captain ? GetHue(level) : LabelColor,
				false,
				false
			); // CAPTAIN
