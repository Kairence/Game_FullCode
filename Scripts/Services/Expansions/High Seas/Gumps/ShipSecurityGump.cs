	...
	public class ShipSecurityGump : BaseShipGump
	{
			...
			: base(galleon)
		{
			...
			AddHtmlLocalized(
				...
				125,
				18,
				GetLevel(m_Entry.DefaultPublicAccess),
				GetHue(m_Entry.DefaultPublicAccess),
				false,
				false
			);
			...
			AddHtmlLocalized(
				...
				125,
				18,
				GetLevel(m_Entry.DefaultPartyAccess),
				GetHue(m_Entry.DefaultPartyAccess),
				false,
				false
			);
			...
			AddHtmlLocalized(
				...
				125,
				18,
				GetLevel(m_Entry.DefaultGuildAccess),
				GetHue(m_Entry.DefaultGuildAccess),
				false,
				false
			);
			...
			AddHtmlLocalized(
				...
				18,
				1149725,
				m_Entry.DefaultPublicAccess == SecurityLevel.NA ? NAHue : LabelColor,
				false,
				false
			); // N/A
			...
			AddHtmlLocalized(
				...
				18,
				1149727,
				m_Entry.DefaultPublicAccess == SecurityLevel.Passenger ? PassengerHue : LabelColor,
				false,
				false
			); // PASSENGER
			...
			AddHtmlLocalized(
				...
				18,
				1149728,
				m_Entry.DefaultPublicAccess == SecurityLevel.Crewman ? CrewHue : LabelColor,
				false,
				false
			); // CREW
			...
			AddHtmlLocalized(
				...
				18,
				1149729,
				m_Entry.DefaultPublicAccess == SecurityLevel.Officer ? OfficerHue : LabelColor,
				false,
				false
			); // OFFICER
			...
			AddHtmlLocalized(
				...
				18,
				1149726,
				m_Entry.DefaultPublicAccess == SecurityLevel.Denied ? DenyHue : LabelColor,
				false,
				false
			); // DENY ACCESS
			...
			AddHtmlLocalized(
				...
				18,
				1149725,
				m_Entry.DefaultPartyAccess == SecurityLevel.NA ? NAHue : LabelColor,
				false,
				false
			); // N/A
			...
			AddHtmlLocalized(
				...
				18,
				1149727,
				m_Entry.DefaultPartyAccess == SecurityLevel.Passenger ? PassengerHue : LabelColor,
				false,
				false
			); // PASSENGER
			...
			AddHtmlLocalized(
				...
				18,
				1149728,
				m_Entry.DefaultPartyAccess == SecurityLevel.Crewman ? CrewHue : LabelColor,
				false,
				false
			); // CREW
			...
			AddHtmlLocalized(
				...
				18,
				1149729,
				m_Entry.DefaultPartyAccess == SecurityLevel.Officer ? OfficerHue : LabelColor,
				false,
				false
			); // OFFICER
			...
			AddHtmlLocalized(
				...
				18,
				1149726,
				m_Entry.DefaultPartyAccess == SecurityLevel.Denied ? DenyHue : LabelColor,
				false,
				false
			); // DENY ACCESS
			...
			AddHtmlLocalized(
				...
				18,
				1149725,
				m_Entry.DefaultGuildAccess == SecurityLevel.NA ? NAHue : LabelColor,
				false,
				false
			); // N/A
			...
			AddHtmlLocalized(
				...
				18,
				1149727,
				m_Entry.DefaultGuildAccess == SecurityLevel.Passenger ? PassengerHue : LabelColor,
				false,
				false
			); // PASSENGER
			...
			AddHtmlLocalized(
				...
				18,
				1149728,
				m_Entry.DefaultGuildAccess == SecurityLevel.Crewman ? CrewHue : LabelColor,
				false,
				false
			); // CREW
			...
			AddHtmlLocalized(
				...
				18,
				1149729,
				m_Entry.DefaultGuildAccess == SecurityLevel.Officer ? OfficerHue : LabelColor,
				false,
				false
			); // OFFICER
			...
			AddHtmlLocalized(
				...
				18,
				1149726,
				m_Entry.DefaultGuildAccess == SecurityLevel.Denied ? DenyHue : LabelColor,
				false,
				false
			); // DENY ACCESS
		}
