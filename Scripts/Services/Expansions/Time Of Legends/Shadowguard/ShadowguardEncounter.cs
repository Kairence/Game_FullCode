...
namespace Server.Engines.Shadowguard
{
	...
	public abstract class ShadowguardEncounter
	{
		...
		public ShadowguardController Controller
		{
			get { return ShadowguardController.Instance; }
		}

		public Rectangle2D[] Bounds { get; set; }

		[CommandProperty(AccessLevel.GameMaster)]
		public ShadowguardRegion Region
		{
			get { return Instance.Region; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public Point3D StartLoc
		{
			get { return Def.StartLoc; }
		}

		public Point3D[] SpawnPoints
		{
			get { return Def.SpawnPoints; }
		}
		public Rectangle2D[] SpawnRecs
		{
			get { return Def.SpawnRecs; }
		}
		...
		{
			get { return Defs[Encounter]; }
		}

		public virtual TimeSpan EncounterDuration
		{
			get { return TimeSpan.FromMinutes(30); }
		}
		public virtual TimeSpan ResetDuration
		{
		...
		public bool Active
		{
			get { return Controller != null && Controller.Encounters.Contains(this); }
		}
		...
		{
			ColUtility.ForEach(
				this.Region.GetEnumeratedMobiles().Where(m => m is PlayerMobile),
				m =>
				{
		...
		public static void Configure()
		{
			...
			Defs[EncounterType.Armory] = new EncounterDef(
				...
				new Rectangle2D[]
				{
					new Rectangle2D(-25, -24, 18, 18),
					new Rectangle2D(-25, 4, 18, 18),
					new Rectangle2D(4, 20, 18, 18),
					new Rectangle2D(4, -6, 18, 18),
				}
			);
			...
			Defs[EncounterType.Fountain] = new EncounterDef(
				...
				new Rectangle2D[]
				{
					new Rectangle2D(-24, 8, 45, 17),
					new Rectangle2D(-24, -25, 45, 16),
					new Rectangle2D(-25, -8, 16, 15),
					new Rectangle2D(8, -8, 16, 15),
					new Rectangle2D(12, -4, 2, 6),
					new Rectangle2D(-4, 12, 6, 2),
				}
			);
		...
		public static ShadowguardEncounter ConstructEncounter(EncounterType type)
		{
			...
			{
				default:
				case EncounterType.Bar:
					return new BarEncounter();
				case EncounterType.Orchard:
					return new OrchardEncounter();
				case EncounterType.Armory:
					return new ArmoryEncounter();
				case EncounterType.Fountain:
					return new FountainEncounter();
				case EncounterType.Belfry:
					return new BelfryEncounter();
				case EncounterType.Roof:
					return new RoofEncounter();
			}
		}
	}
