...
namespace Server.Engines.Shadowguard
{
	public class ShadowguardPirate : BaseCreature
	{
		...
		public ShadowguardPirate(Serial serial)
			: base(serial) { }
	...
	public class ShantyThePirate : ShadowguardPirate
	{
		...
		public ShantyThePirate(Serial serial)
			: base(serial) { }
	...
	public class VileWaterElemental : WaterElemental
	{
		...
		public VileWaterElemental(Serial serial)
			: base(serial) { }
	...
	public class VileTreefellow : FeralTreefellow
	{
		...
		public VileTreefellow(Serial serial)
			: base(serial) { }
	...
	public class EnsorcelledArmor : BaseCreature
	{
		...
		[Constructable]
		public EnsorcelledArmor()
			: this(null) { }

		[Constructable]
		public EnsorcelledArmor(ArmoryEncounter encounter)
		...
		public EnsorcelledArmor(Serial serial)
			: base(serial) { }
	...
	public class VileDrake : Drake
	{
		...
		public VileDrake(Serial serial)
			: base(serial) { }
