...
namespace Server.Mobiles
{
	...
	public class DragonTurtle : BaseChampion
	{
		...
		public override int TeleportRange
		{
			get { return 10; }
		}
		...
		public override void OnMovement(Mobile m, Point3D oldLocation)
		{
			...
			List<Tuple<Point3D, int>> copy = new List<Tuple<Point3D, int>>(
				_BubbleLocs.Where(tup => tup.Item1 == m.Location)
			);
		...
		public void DoBubble()
		{
			...
			{
				Timer.DelayCall(
					TimeSpan.FromSeconds((double)i + 1.0),
					() =>
					{
		...
		private void DoAttack_Callback(object obj)
		{
			...
			switch (type)
			{
				...
				case ResistanceType.Poison:
					AOS.Damage(mob, this, damage, 0, 0, 0, 100, 0);
					break;
				case ResistanceType.Energy:
					AOS.Damage(mob, this, damage, 0, 0, 0, 0, 100);
					break;
			}
		}
