...
namespace Server.Mobiles
{
	...
	public abstract class BaseEodonTribesman : BaseCreature
	{
		...
		public BaseEodonTribesman(AIType ai, EodonTribe type)
			: base(ai, FightMode.Closest, 10, 1, .2, .4)
		{
			TribeType = type;
		...
		public override void AggressiveAction(Mobile aggressor, bool criminal)
		{
			...
			foreach (Mobile m in eable)
			{
				if (
					m != this
					&& m != aggressor
					&& m is BaseEodonTribesman
					&& ((BaseEodonTribesman)m).TribeType == this.TribeType
					&& m.Combatant == null
				)
				{
		...
		public BaseEodonTribesman(Serial serial)
			: base(serial) { }
	...
	{
		[Constructable]
		public TribeWarrior(EodonTribe type)
			: base(AIType.AI_Melee, type) { }
		...
		{
			get { return this.Region.IsPartOf<BattleRegion>(); }
		}
		...
		public TribeWarrior(Serial serial)
			: base(serial) { }
	...
	{
		public override bool ShowSpellMantra
		{
			get { return true; }
		}

		[Constructable]
		public TribeShaman(EodonTribe type)
			: base(AIType.AI_Mage, type)
		{
			RangeFight = 7;
		...
		public TribeShaman(Serial serial)
			: base(serial) { }
	...
	{
		[Constructable]
		public TribeChieftan(EodonTribe type)
			: base(AIType.AI_Melee, type) { }
		...
		public TribeChieftan(Serial serial)
			: base(serial) { }
