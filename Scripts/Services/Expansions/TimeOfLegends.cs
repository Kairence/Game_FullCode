	...
	public static class TimeOfLegends
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(DecorateTOL_OnCommand)
			);
		...
		public static Type[] ArmorDropTypes
		{
			get { return _ArmorDropTypes; }
		}
		private static Type[] _ArmorDropTypes =
		{
			typeof(AloronsBustier),
			typeof(AloronsGorget),
			typeof(AloronsHelm),
			typeof(AloronsLegs),
			typeof(AloronsLongSkirt),
			typeof(AloronsSkirt),
			typeof(AloronsTunic),
			typeof(DardensBustier),
			typeof(DardensHelm),
			typeof(DardensLegs),
			typeof(DardensSleeves),
			typeof(DardensTunic),
		};

		public static int[] RecipeTypes
		{
			get { return _RecipeTypes; }
		}
