...
namespace Server.Items
{
	...
	public class StarChart : Item, ICraftable
	{
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public DateTime ChartedOn
		{
			get { return _ChartedOn; }
			set { _ChartedOn = value; }
		}

		public override int LabelNumber
		{
			get { return _Constellation == -1 ? 1158743 : 1158493; }
		} // An Indecipherable Star Chart : Star Chart
		...
		public class InternalGump : BaseGump
		{
			...
			public override void AddGumpLayout()
			{
				...
				AddHtml(
					...
					50,
					36,
					Color("#0040FF", Chart.ChartedBy == null ? String.Empty : Chart.ChartedBy.Name),
					false,
					false
				);
				...
				AddHtmlLocalized(
					...
					60,
					36,
					AstronomySystem.TimeCoordinateLocalization(info.TimeCoordinate),
					0x1F,
					false,
					false
				);
