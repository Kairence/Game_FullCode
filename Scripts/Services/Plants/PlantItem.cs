...
namespace Server.Engines.Plants
{
	...
	public class PlantItem : Item, ISecurable
	{
		...
		public virtual bool RequiresUpkeep
		{
			get { return true; }
		}
		public virtual bool MaginciaPlant
		{
			get { return false; }
		}
		public virtual int BowlOfDirtID
		{
			get { return 0x1602; }
		}
		public virtual int GreenBowlID
		{
			get { return 0x1600; }
		}

		public virtual int ContainerLocalization
		{
			get { return 1150435; }
		}
		public virtual int OnPlantLocalization
		{
			get { return 1061922; }
		}
		public virtual int CantUseLocalization
		{
			get { return 1061921; }
		}
		#endregion
		...
		{
			get { return m_PlantStatus >= PlantStatus.BowlOfDirt && m_PlantStatus <= PlantStatus.Stage6; }
		}
		...
		[Constructable]
		public PlantItem(int itemID)
			: this(itemID, false) { }

		[Constructable]
		public PlantItem(bool fertileDirt)
			: this(0x1602, fertileDirt) { }

		[Constructable]
		public PlantItem(int itemID, bool fertileDirt)
			: base(itemID)
		{
			Weight = 1.0;
		...
		public override void AddNameProperty(ObjectPropertyList list)
		{
			...
			else
			{
				...
				{
					list.Add(
						typeInfo.GetPlantLabelDecorative(hueInfo),
						String.Format("#{0}\t#{1}", hueInfo.Name, typeInfo.Name)
					);
				}
				else if (m_PlantStatus >= PlantStatus.FullGrownPlant)
				{
				...
				else
				{
					...
					else
					{
						args += String.Format(
							"\t#{0}\t#{1}",
							(typeInfo.PlantCategory == PlantCategory.Default)
								? hueInfo.Name
								: (int)typeInfo.PlantCategory,
							GetLocalizedPlantStatus()
						);
