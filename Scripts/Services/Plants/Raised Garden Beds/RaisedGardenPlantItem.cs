...
namespace Server.Engines.Plants
{
	...
	{
		public override bool RequiresUpkeep
		{
			get { return false; }
		}
		public override int BowlOfDirtID
		{
			get { return 2323; }
		}
		...
		public override int ContainerLocalization
		{
			get { return 1150436; }
		} // mound
		public override int OnPlantLocalization
		{
			get { return 1150442; }
		} // You plant the seed in the mound of dirt.
		public override int CantUseLocalization
		{
			get { return 1150511; }
		} // That is not your gardening plot.
		...
		{
			get { return RootParent == null && Component != null && !Movable && !Deleted; }
		}
		...
		[Constructable]
		public RaisedGardenPlantItem()
			: this(false) { }

		[Constructable]
		public RaisedGardenPlantItem(bool fertileDirt)
		...
		public RaisedGardenPlantItem(Serial serial)
			: base(serial) { }
