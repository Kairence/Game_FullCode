...
namespace Server.Items
{
	...
	[TypeAlias(
		"Server.Items.RaisedGardenSmallAddon",
		"Server.Items.RaisedGardenSouthAddon",
		"Server.Items.RaisedGardenEastAddon",
		"Server.Items.RaisedGardenLargeAddon"
	)]
	public class RaisedGardenAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get { return new RaisedGardenDeed(); }
		}
	...
	[TypeAlias(
		"Server.Items.RaisedGardenSmallAddonDeed",
		"Server.Items.RaisedGardenEastAddonDeed",
		"Server.Items.RaisedGardenSouthAddonDeed",
		"Server.Items.RaisedGardenLargeAddonDeed"
	)]
	public class RaisedGardenDeed : BaseAddonDeed
	{
		...
		{
			get { return new RaisedGardenAddon(m_Direction); }
		}
		...
		private class InternalGump : Gump
		{
			...
			public InternalGump(RaisedGardenDeed deed)
				: base(60, 36)
			{
				m_Deed = deed;
	...
	public class GardenAddonComponent : AddonComponent
	{
		...
		public override void Deserialize(GenericReader reader)
		{
			...
			if (
				m_Plant != null
				&& m_Plant is RaisedGardenPlantItem
				&& ((RaisedGardenPlantItem)m_Plant).Component == null
			)
