        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch ( info.ButtonID )
            {
                ...
                case 7: // Poison potion
                    {
                        AddPotion(from, PotionEffect.PoisonMini, PotionEffect.PoisonLesser);

                        break;
                    }
                case 8: // Cure potion
                    {
                        AddPotion(from, PotionEffect.CureMini);

                        break;
                    }
                case 9: // Heal potion
                    {
                        AddPotion(from, PotionEffect.HealMini);

                        break;
                    }
                case 10: // Strength potion
                    {
                        AddPotion(from, PotionEffect.StrengthMini);
