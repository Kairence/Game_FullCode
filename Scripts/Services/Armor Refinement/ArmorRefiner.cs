...
namespace Server.Mobiles
{
	public class ArmorRefiner : BaseVendor
	{
		...
		public RefinementCraftType RefineType
		{
			get { return m_RefineType; }
			set { m_RefineType = value; }
		}
		...
		[Constructable]
		public ArmorRefiner(RefinementCraftType type)
			: base("the armor refiner")
		{
			m_RefineType = type;
		...
		public ArmorRefiner(Serial serial)
			: base(serial) { }
