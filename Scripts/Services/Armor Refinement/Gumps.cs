...
namespace Server.Gumps
{
	public class RefinementGump : Gump
	{
		...
		public RefinementGump(RefinementItem item)
			: base(50, 50)
		{
			m_Item = item;
			m_Entry = item.Entry;
			...
			for (int i = 0; i < m_Item.ModAmount; i++)
			{
				...
				AddHtmlLocalized(
					...
					150,
					16,
					GetResistanceLabel(m_Entry.Resists[i], m_Entry.Values[i]),
					WhiteLabel,
					false,
					false
				);
			...
			AddHtmlLocalized(
				...
				16,
				1114057,
				m_Item.GetBonusChance().ToString() + "%",
				WhiteLabel,
				false,
				false
			);
		...
		private class InternalTarget : Target
		{
			...
			public InternalTarget(RefinementItem item)
						...
						for (int i = 0; i < m_Item.ModAmount; i++)
						{
							...
							switch (m_Entry.Resists[i])
							{
								case ResistanceType.Physical:
									armor.RefinedPhysical += value;
									break;
								case ResistanceType.Fire:
									armor.RefinedFire += value;
									break;
								case ResistanceType.Cold:
									armor.RefinedCold += value;
									break;
								case ResistanceType.Poison:
									armor.RefinedPoison += value;
									break;
								case ResistanceType.Energy:
									armor.RefinedEnergy += value;
									break;
							}
						}
		...
		public static bool CanApplyToArmor(Mobile from, BaseArmor armor, RefinementItem item)
		{
			switch (item.SubCraftType)
			{
				case RefinementSubCraftType.StuddedLeather:
					return armor is StuddedBustierArms
						|| armor is StuddedArms
						|| armor is StuddedChest
						|| armor is StuddedGloves
						|| armor is StuddedGorget
						|| armor is StuddedLegs;
				case RefinementSubCraftType.StuddedSamurai:
					return armor is StuddedDo
						|| armor is StuddedHaidate
						|| armor is StuddedHiroSode
						|| armor is StuddedMempo
						|| armor is StuddedSuneate;
				case RefinementSubCraftType.Hide:
					return armor is HideChest
						|| armor is HideFemaleChest
						|| armor is HideGloves
						|| armor is HideGorget
						|| armor is HidePants
				...
				case RefinementSubCraftType.Ringmail:
					return armor is RingmailArms
						|| armor is RingmailChest
						|| armor is RingmailGloves
						|| armor is RingmailLegs;
				...
				case RefinementSubCraftType.Platemail:
					return armor is FemalePlateChest
						|| armor is PlateArms
						|| armor is PlateChest
						|| armor is PlateGloves
						|| armor is PlateGorget
						|| armor is PlateLegs
						|| armor is PlateHelm
						|| armor is Bascinet
						|| armor is CloseHelm
				...
				case RefinementSubCraftType.PlatemailSamurai:
					return armor is DecorativePlateKabuto
						|| armor is HeavyPlateJingasa
						|| armor is LightPlateJingasa
						|| armor is PlateBattleKabuto
						|| armor is PlateDo
						|| armor is PlateHaidate
						|| armor is PlateHatsuburi
						|| armor is PlateHiroSode
						|| armor is PlateMempo
						|| armor is PlateSuneate
						|| armor is SmallPlateJingasa
						|| armor is StandardPlateKabuto;
				case RefinementSubCraftType.GargishPlatemail:
					return armor is GargishPlateArms
						|| armor is GargishPlateChest
						|| armor is GargishPlateKilt
						|| armor is GargishPlateLegs
						|| armor is FemaleGargishPlateArms
						|| armor is FemaleGargishPlateLegs
						|| armor is FemaleGargishPlateChest
						|| armor is FemaleGargishPlateKilt;
				case RefinementSubCraftType.Dragon:
					return armor is DragonArms
						|| armor is DragonChest
						|| armor is DragonGloves
						|| armor is DragonHelm
						|| armor is DragonLegs;
				case RefinementSubCraftType.Woodland:
					return armor is WoodlandArms
				...
				case RefinementSubCraftType.GargishStone:
					return armor is GargishStoneArms
						|| armor is GargishStoneChest
						|| armor is GargishStoneLegs
						|| armor is GargishStoneKilt
						|| armor is FemaleGargishStoneArms
						|| armor is FemaleGargishStoneChest
						|| armor is FemaleGargishStoneLegs
						|| armor is FemaleGargishStoneKilt;
			}
