...
namespace Server.Engines.VeteranRewards
{
	...
	public class RewardSystem
	{
		...
		public static bool HasAccess(Mobile mob, RewardList list, out TimeSpan ts)
		{
			...
			TimeSpan totalTime =
				(DateTime.UtcNow - acct.Created) + TimeSpan.FromDays(RewardInterval.TotalDays * StartingLevel);
		...
		private static Type[] _AnyoneTypes = { typeof(DyeTub), typeof(MonsterStatuette) };
				...
				new RewardList(
					...
					new RewardEntry[]
					{
						...
						new RewardEntry(
							...
							1155746,
							typeof(MonsterStatuette),
							MonsterStatuetteType.FleshRenderer
						),
						new RewardEntry(
							monsterStatues,
							1156367,
							typeof(MonsterStatuette),
							Expansion.TOL,
							MonsterStatuetteType.DragonTurtle
						),
						new RewardEntry(
							monsterStatues,
							1158875,
				...
				new RewardList(
					...
					new RewardEntry[]
					{
						...
						new RewardEntry(
							...
							1155747,
							typeof(MonsterStatuette),
							MonsterStatuetteType.CrystalElemental
						),
						new RewardEntry(
							monsterStatues,
							1157078,
						...
						new RewardEntry(
							...
							typeof(MonsterStatuette),
							Expansion.EJ,
							MonsterStatuetteType.KhalAnkur
						),
						new RewardEntry(
							monsterStatues,
							1159418,
				...
				new RewardList(
					...
					new RewardEntry[]
					{
						...
						new RewardEntry(
							...
							1155748,
							typeof(MonsterStatuette),
							MonsterStatuetteType.DarkFather
						),
						new RewardEntry(
							monsterStatues,
							1157079,
							typeof(MonsterStatuette),
							Expansion.TOL,
							MonsterStatuetteType.Zipactriotal
						),
						new RewardEntry(
							monsterStatues,
							1158876,
							typeof(MonsterStatuette),
							Expansion.EJ,
							MonsterStatuetteType.KrampusMinion
						),
						new RewardEntry(
							monsterStatues,
							1159419,
				...
				new RewardList(
					...
					new RewardEntry[]
					{
						...
						new RewardEntry(
							...
							1155745,
							typeof(MonsterStatuette),
							MonsterStatuetteType.PlatinumDragon
						),
				...
				new RewardList(
					...
					new RewardEntry[]
					{
						...
						new RewardEntry(
							...
							typeof(MonsterStatuette),
							Expansion.TOL,
							MonsterStatuetteType.MyrmidexQueen
						),
				...
				new RewardList(
					...
					new RewardEntry[]
					{
						new RewardEntry(
							...
							typeof(MonsterStatuette),
							Expansion.TOL,
							MonsterStatuetteType.Virtuebane
						),
				...
				new RewardList(
					...
					new RewardEntry[]
					{
						...
						new RewardEntry(
							...
							1113800,
							typeof(MonsterStatuette),
							MonsterStatuetteType.TerathanMatriarch
						),
		...
		private static void EventSink_Login(LoginEventArgs e)
		{
			...
			if (
				Core.ML
				&& e.Mobile is PlayerMobile
				&& !((PlayerMobile)e.Mobile).HasStatReward
				&& HasHalfLevel(e.Mobile)
			)
			{
