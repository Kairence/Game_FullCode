...
namespace Server.Factions.AI
{
	...
	public class Orders
	{
		...
		{
			get { return this.m_Guard; }
		}
		public MovementType Movement
		{
			get { return this.m_Movement; }
			set { this.m_Movement = value; }
		}
		...
		public Reaction GetReaction(Faction faction)
		{
			...
			reaction = new Reaction(
				faction,
				(faction == null || faction == this.m_Guard.Faction) ? ReactionType.Ignore : ReactionType.Attack
			);
