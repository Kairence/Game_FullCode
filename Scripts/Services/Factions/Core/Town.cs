...
namespace Server.Factions
{
	...
	public abstract class Town : IComparable
	{
		...
		{
			get { return this.m_State.Owner; }
			set { this.Capture(value); }
		}
		public Mobile Sheriff
		{
			get { return this.m_State.Sheriff; }
			set { this.m_State.Sheriff = value; }
		}
		public Mobile Finance
		{
			get { return this.m_State.Finance; }
			set { this.m_State.Finance = value; }
		}
		public int Tax
		{
			get { return this.m_State.Tax; }
			set { this.m_State.Tax = value; }
		}
		public DateTime LastTaxChange
		{
			get { return this.m_State.LastTaxChange; }
			set { this.m_State.LastTaxChange = value; }
		}
		public bool TaxChangeReady
		{
			get { return (this.m_State.LastTaxChange + TaxChangePeriod) < DateTime.UtcNow; }
		}
		...
		{
			get { return this.m_State.LastIncome; }
			set { this.m_State.LastIncome = value; }
		}
		public List<VendorList> VendorLists
		{
			get { return this.m_VendorLists; }
			set { this.m_VendorLists = value; }
		}
		public List<GuardList> GuardLists
		{
			get { return this.m_GuardLists; }
			set { this.m_GuardLists = value; }
		}
		...
		public static void Initialize()
		{
			...
			CommandSystem.Register(
				...
				new CommandEventHandler(GrantTownSilver_OnCommand)
			);
		}
		...
		public void StartIncomeTimer()
		{
			...
			this.m_IncomeTimer = Timer.DelayCall(
				TimeSpan.FromMinutes(1.0),
				TimeSpan.FromMinutes(1.0),
				new TimerCallback(CheckIncome)
			);
		}
