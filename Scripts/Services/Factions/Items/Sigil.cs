...
namespace Server.Factions
{
	public class Sigil : BaseSystemController
	{
		...
		public static readonly TimeSpan CorruptionPeriod = (
			(Core.SE) ? TimeSpan.FromHours(10.0) : TimeSpan.FromHours(24.0)
		);
		...
		{
			get { return this.m_LastStolen; }
			set { this.m_LastStolen = value; }
		}

		[CommandProperty(AccessLevel.Counselor, AccessLevel.Administrator)]
		public DateTime GraceStart
		{
			get { return this.m_GraceStart; }
			set { this.m_GraceStart = value; }
		}

		[CommandProperty(AccessLevel.Counselor, AccessLevel.Administrator)]
		public DateTime CorruptionStart
		{
			get { return this.m_CorruptionStart; }
			set { this.m_CorruptionStart = value; }
		}

		[CommandProperty(AccessLevel.Counselor, AccessLevel.Administrator)]
		public DateTime PurificationStart
		{
			get { return this.m_PurificationStart; }
			set { this.m_PurificationStart = value; }
		}
		...
		{
			get { return this.m_LastMonolith; }
			set { this.m_LastMonolith = value; }
		}
		...
		public bool IsBeingCorrupted
		{
			...
			{
				return (
					this.m_LastMonolith is StrongholdMonolith
					&& this.m_LastMonolith.Faction == this.m_Corrupting
		...
		{
			get { return (this.m_Corrupted != null); }
		}

		[CommandProperty(AccessLevel.Counselor)]
		public bool IsPurifying
		{
			get { return (this.m_PurificationStart != DateTime.MinValue); }
		}

		[CommandProperty(AccessLevel.Counselor)]
		public bool IsCorrupting
		{
			get { return (this.m_Corrupting != null && this.m_Corrupting != this.m_Corrupted); }
		}
		...
		public static bool ExistsOn(Mobile mob, bool vvvOnly = false)
		{
			...
			if (
				Server.Engines.VvV.ViceVsVirtueSystem.Enabled
				&& vvvOnly
				&& pack.FindItemByType(typeof(Server.Engines.VvV.VvVSigil)) != null
			)
				return true;

			return (
				pack.FindItemByType(typeof(Sigil)) != null
				|| pack.FindItemByType(typeof(Server.Engines.VvV.VvVSigil)) != null
			);
		}
				...
				if (obj is StrongholdMonolith)
				{
					...
					else
					{
						...
						if (oldController == null)
						{
							...
							&& (this.m_GraceStart + CorruptionGrace) < DateTime.UtcNow
						)
						{
							if (this.m_Corrupted != newController)
