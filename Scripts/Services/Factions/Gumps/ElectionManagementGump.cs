			...
			: base(40, 40)
		{
			...
			if (candidate != null)
			{
				...
				this.AddHtml(
					...
					428,
					20,
					this.Color(this.Center("Candidate Management"), LabelColor),
					false,
					false
				);
				...
				this.AddHtml(
					...
					100,
					20,
					this.Color(candidate.Mobile == null ? "null" : candidate.Mobile.Name, LabelColor),
					false,
					false
				);
					...
					for (int j = 0; j < fields.Length; ++j)
					{
						...
						if (obj is Mobile)
						{
							this.AddHtml(
								...
								150,
								20,
								this.Color(((Mobile)obj).Name, LabelColor),
								false,
								false
							);
							x += 150;
						...
						else if (obj is System.Net.IPAddress)
						{
							this.AddHtml(
								...
								100,
								20,
								this.Color(this.Center(obj.ToString()), LabelColor),
								false,
								false
							);
							x += 100;
						...
						else if (obj is DateTime)
						{
							this.AddHtml(
								...
								20,
								this.Color(
									this.Center(FormatTimeSpan(((DateTime)obj) - election.LastStateTime)),
									LabelColor
								),
								false,
								false
						...
						else if (obj is int)
						{
							this.AddHtml(
								...
								60,
								20,
								this.Color(this.Center((int)obj + "%"), LabelColor),
								false,
								false
							);
							x += 60;
			...
			else
			{
				...
				this.AddHtml(
					...
					100,
					20,
					this.Color(FormatTimeSpan(election.NextStateTime), LabelColor),
					false,
					false
				);
				...
				for (int i = 0; i < election.Candidates.Count; ++i)
				{
					...
					this.AddHtml(
						...
						80,
						20,
						this.Color(this.Center(cd.Votes.ToString()), LabelColor),
						false,
						false
					);
				}
