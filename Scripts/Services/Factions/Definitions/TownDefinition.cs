...
namespace Server.Factions
{
	public class TownDefinition
	{
		...
		public TownDefinition(
			...
			string region,
			string friendlyName,
			TextDefinition townName,
			TextDefinition townStoneHeader,
			TextDefinition strongholdMonolithName,
			TextDefinition townMonolithName,
			TextDefinition townStoneName,
			TextDefinition sigilName,
			TextDefinition corruptedSigilName,
			Point3D monolith,
			Point3D townStone
		)
		{
		...
		{
			get { return this.m_TownStoneHeader; }
		}
		public TextDefinition StrongholdMonolithName
		{
			get { return this.m_StrongholdMonolithName; }
		}
		public TextDefinition TownMonolithName
		{
			get { return this.m_TownMonolithName; }
		}
		public TextDefinition TownStoneName
		{
			get { return this.m_TownStoneName; }
		}
		public TextDefinition SigilName
		{
			get { return this.m_SigilName; }
		}
		public TextDefinition CorruptedSigilName
		{
			get { return this.m_CorruptedSigilName; }
		}
		public Point3D Monolith
		{
			get { return this.m_Monolith; }
		}
		public Point3D TownStone
		{
			get { return this.m_TownStone; }
		}
	}
}
