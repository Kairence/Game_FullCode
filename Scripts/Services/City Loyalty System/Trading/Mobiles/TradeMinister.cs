...
namespace Server.Engines.CityLoyalty
{
	public class TradeMinister : BaseCreature
	{
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public CityLoyaltySystem CitySystem
		{
			get { return CityLoyaltySystem.GetCityInstance(City); }
			set { }
		}
		...
		[Constructable]
		public TradeMinister(City city)
			: base(AIType.AI_Vendor, FightMode.None, 10, 1, .4, .2)
		{
			City = city;
			SpeechHue = 0x3B2;
		...
		private class TradeOrderEntry : ContextMenuEntry
		{
			...
			public TradeOrderEntry(Mobile player, TradeMinister minister)
				: base(1114453, 5) // Get Trade Order
			{
				Player = player;
				Minister = minister;
		...
		private class TurnInEntry : ContextMenuEntry
		{
			...
			public TurnInEntry(Mobile player, TradeMinister minister)
				: base(1151729, 3) // Turn in a trade order
			{
				Player = player;
				Minister = minister;
			...
			private class InternalTarget : Target
			{
				...
				public InternalTarget(TradeMinister minister)
		...
		private Item GiveReward(TradeEntry entry)
		{
			if (0.01 > Utility.RandomDouble())
			{
				switch (Utility.Random(2))
				{
					default:
					case 0:
						return CityBook.GetRandom();
					case 1:
						return new RewardSign();
				}
			}
			else
			{
		...
		private Item RandomResource(TradeEntry entry)
		{
			...
			switch (Utility.Random(4))
			{
				case 0:
					...
					{
						case 0:
							return new IronIngot(amount);
						case 1:
							return new DullCopperIngot(amount);
						case 2:
							return new ShadowIronIngot(amount);
						case 3:
							return new CopperIngot(amount);
						case 4:
							return new BronzeIngot(amount);
						case 5:
							return new GoldIngot(amount);
						case 6:
							return new AgapiteIngot(amount);
						case 7:
							return new VeriteIngot(amount);
						case 8:
				...
				case 1:
					switch (Utility.Random(4))
					{
						...
						case 1:
							return new SpinedLeather(amount);
						case 2:
							return new HornedLeather(amount);
						case 3:
				...
				case 2:
					...
					{
						case 0:
							return new Board(amount);
						case 1:
							return new OakBoard(amount);
						case 2:
							return new AshBoard(amount);
						case 3:
							return new YewBoard(amount);
						case 4:
							return new BloodwoodBoard(amount);
						case 5:
							return new HeartwoodBoard(amount);
						case 6:
				...
				case 3:
					Item item = Loot.Construct(
						SkillHandlers.Imbuing.IngredTypes[Utility.Random(SkillHandlers.Imbuing.IngredTypes.Length)]
					);
		...
		public TradeMinister(Serial serial)
			: base(serial) { }
