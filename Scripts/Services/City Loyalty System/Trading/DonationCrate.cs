...
namespace Server.Engines.CityLoyalty
{
	public class CityDonationItem : Item
	{
		...
		public virtual bool Animals
		{
			get { return false; }
		}

		public CityDonationItem(City city, TradeMinister minister, int itemid)
			: base(itemid)
		{
			City = city;
			Minister = minister;
		...
		private class InternalTarget : Target
		{
			...
			public InternalTarget(CityDonationItem item)
		...
		public CityDonationItem(Serial serial)
			: base(serial) { }
	...
	{
		[Constructable]
		public CityItemDonation(City city, TradeMinister minister)
			: base(city, minister, 0xE3C)
		{
			Table = ItemTable;
		...
		public CityItemDonation(Serial serial)
			: base(serial) { }
	...
	{
		public override bool Animals
		{
			get { return true; }
		}

		[Constructable]
		public CityPetDonation(City city, TradeMinister minister)
			: base(city, minister, 0x14E7)
		{
			Table = PetTable;
		...
		public CityPetDonation(Serial serial)
			: base(serial) { }
