	...
	public abstract class CityBook : Item
	{
		...
		public static CityBook GetRandom()
		{
			switch (Utility.Random(9))
			{
				default:
				case 0:
					return new LoyaltyBookBritain();
				case 1:
					return new LoyaltyBookYew();
				case 2:
					return new LoyaltyBookMoonglow();
				case 3:
					return new LoyaltyBookNewMagincia();
				case 4:
					return new LoyaltyBookVesper();
				case 5:
					return new LoyaltyBookSkaraBrae();
				case 6:
					return new LoyaltyBookJhelom();
				case 7:
					return new LoyaltyBookMinoc();
				case 8:
					return new LoyaltyBookTrinsic();
			}
		}
