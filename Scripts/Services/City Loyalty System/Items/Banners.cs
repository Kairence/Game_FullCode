...
namespace Server.Engines.CityLoyalty
{
	public class CityBanner : InterchangeableAddon
	{
		...
		{
			get { return new CityBannerDeed(City); }
		}
		...
		{
			get { return SouthID + 9; }
		}
		public override int SouthID
		{
			get { return BannerInfo[City][0]; }
		}
		...
		public CityBanner(Serial serial)
			: base(serial) { }
	...
	public class CityBannerDeed : InterchangeableAddonDeed
	{
		...
		{
			get { return new CityBanner(City); }
		}

		public override int LabelNumber
		{
			get { return CityBanner.BannerInfo[City][1]; }
		}
		...
		public override int SouthID
		{
			get { return CityBanner.BannerInfo[City][0]; }
		}
		...
		public override void OnDoubleClick(Mobile from)
		{
			if (IsChildOf(from.Backpack))
			{
				...
				if (
					CityLoyaltySystem.HasCitizenship(from, this.City)
					&& sys.GetLoyaltyRating(from) >= LoyaltyRating.Commended
				)
				{
					...
					from.SendLocalizedMessage(
						1152361,
						String.Format("#{0}", CityLoyaltySystem.GetCityLocalization(this.City))
