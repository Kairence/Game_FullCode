...
namespace Server.Engines.CityLoyalty
{
	...
	public class CityLoyaltySystem : PointsSystem
	{
		...
		public static readonly int TradeDealUtilizationPeriod = Config.Get(
			"CityLoyalty.TradeDealUtilizationPeriod",
			24
		);
		...
		public static Map SystemMap
		{
			get { return Siege.SiegeShard ? Map.Felucca : Map.Trammel; }
		}

		public override TextDefinition Name
		{
			get { return new TextDefinition(String.Format("{0}", this.City.ToString())); }
		}
		...
		public int GetTitleCost(CityTitle title)
		{
			...
			{
				default:
				case CityTitle.Citizen:
					return 0;
				case CityTitle.Knight:
					return 10000;
				case CityTitle.Baronet:
					return 100000;
				case CityTitle.Baron:
					return 1000000;
				case CityTitle.Viscount:
					return 2000000;
				case CityTitle.Earl:
					return 5000000;
				case CityTitle.Marquis:
					return 10000000;
				case CityTitle.Duke:
					return 50000000;
			}
		...
		public LoyaltyRating GetMinimumRating(CityTitle title)
		{
			switch (title)
			{
				default:
				case CityTitle.Citizen:
					return LoyaltyRating.Disfavored;
				case CityTitle.Knight:
					return LoyaltyRating.Commended;
				case CityTitle.Baronet:
					return LoyaltyRating.Esteemed;
				case CityTitle.Baron:
					return LoyaltyRating.Respected;
				case CityTitle.Viscount:
					return LoyaltyRating.Admired;
				case CityTitle.Earl:
					return LoyaltyRating.Adored;
				case CityTitle.Marquis:
					return LoyaltyRating.Revered;
				case CityTitle.Duke:
					return LoyaltyRating.Venerated;
			}
		}
			...
			if (entry != null)
			{
				...
				else
				{
					...
					BuffInfo.AddBuff(
						m,
						new BuffInfo(
							BuffIcon.CityTradeDeal,
							1154168,
							1154169,
							new TextDefinition((int)ActiveTradeDeal),
							true
						)
					);
		...
		public static void Initialize()
		{
			...
			CommandSystem.Register(
				...
				e => Server.Gumps.BaseGump.SendGump(new ElectionStartTimeGump(e.Mobile as PlayerMobile))
			);
			CommandSystem.Register(
				"RemoveWait",
				AccessLevel.Administrator,
					...
					if (entry != null && entry.UtilizingTradeDeal)
					{
						BuffInfo.AddBuff(
							...
							new BuffInfo(
								...
								1154168,
								1154169,
								new TextDefinition((int)sys.ActiveTradeDeal),
								true
							)
						);
		...
		public static void ActivateTradeDeal(Mobile m, TradeDeal deal)
		{
			switch (deal)
			{
				case TradeDeal.OrderOfEngineers:
					m.AddStatMod(
						new StatMod(StatType.Dex, String.Format("TradeDeal_{0}", StatType.Dex), 3, TimeSpan.Zero)
					);
					break;
				case TradeDeal.MiningCooperative:
					m.AddStatMod(
						new StatMod(StatType.Str, String.Format("TradeDeal_{0}", StatType.Str), 3, TimeSpan.Zero)
					);
					break;
				case TradeDeal.LeagueOfRangers:
					m.AddStatMod(
						new StatMod(StatType.Int, String.Format("TradeDeal_{0}", StatType.Int), 3, TimeSpan.Zero)
					);
					break;
			}
		}
		...
		public static void OnBODTurnIn(Mobile from, int gold)
		{
			...
			CityLoyaltySystem city = Cities.FirstOrDefault(c =>
				c.Definition.Region != null && c.Definition.Region.IsPartOf(from.Region)
			);
		...
		public static City GetRandomCity()
		{
			switch (Utility.Random(11))
			{
				...
				case 5:
					return City.Trinsic;
				case 6:
					return City.SkaraBrae;
				case 7:
					return City.NewMagincia;
				case 10:
					return City.Vesper;
			}
		}
		...
		public static int RatingLocalization(LoyaltyRating rating)
		{
			...
			{
				default:
					return 1152115; // Unknown
				case LoyaltyRating.Disfavored:
					return 1152118;
				case LoyaltyRating.Disliked:
					return 1152122;
				case LoyaltyRating.Detested:
					return 1152123;
				case LoyaltyRating.Loathed:
					return 1152128;
				case LoyaltyRating.Despised:
					return 1152129;
				case LoyaltyRating.Reviled:
					return 1152130;
				case LoyaltyRating.Scorned:
					return 1152136;
				case LoyaltyRating.Shunned:
					return 1152137;
				case LoyaltyRating.Villified:
					return 1152138;
				case LoyaltyRating.Abhorred:
					return 1152139;
				case LoyaltyRating.Unknown:
					return 1152115;
				case LoyaltyRating.Doubted:
					return 1152117;
				case LoyaltyRating.Distrusted:
					return 1152121;
				case LoyaltyRating.Disgraced:
					return 1152127;
				case LoyaltyRating.Denigrated:
					return 1152135;
				case LoyaltyRating.Commended:
					return 1152116;
				case LoyaltyRating.Esteemed:
					return 1152120;
				case LoyaltyRating.Respected:
					return 1152119;
				case LoyaltyRating.Honored:
					return 1152126;
				case LoyaltyRating.Admired:
					return 1152125;
				case LoyaltyRating.Adored:
					return 1152124;
				case LoyaltyRating.Lauded:
					return 1152134;
				case LoyaltyRating.Exalted:
					return 1152133;
				case LoyaltyRating.Revered:
					return 1152132;
				case LoyaltyRating.Venerated:
					return 1152131;
			}
		}
		...
		public static LoyaltyRating[][] _LoveLoyaltyTable =
		{
			...
			new LoyaltyRating[]
			{
				LoyaltyRating.Lauded,
				LoyaltyRating.Exalted,
				LoyaltyRating.Revered,
				LoyaltyRating.Venerated,
			}, // Tier 4
		};
		...
		public static LoyaltyRating[][] _HateLoyaltyTable =
		{
			...
			new LoyaltyRating[]
			{
				LoyaltyRating.Scorned,
				LoyaltyRating.Shunned,
				LoyaltyRating.Villified,
				LoyaltyRating.Abhorred,
			}, // Tier 4
		};
		...
		public static void OnTradeComplete(Mobile from, TradeEntry entry)
		{
			...
			if (gold > 0)
			{
				...
				from.SendLocalizedMessage(
					...
					String.Format(
						"{0}\t{1}",
						gold.ToString("N0", CultureInfo.GetCultureInfo("en-US")),
						origin.Definition.Name
					)
				); // ~1_val~ gold has been deposited into the ~2_NAME~ City treasury for your efforts!
			}
	...
	public class Moonglow : CityLoyaltySystem
	{
		public override PointsType Loyalty
		{
			get { return PointsType.Moonglow; }
		}
	...
	public class SkaraBrae : CityLoyaltySystem
	{
		public override PointsType Loyalty
		{
			get { return PointsType.SkaraBrae; }
		}
	...
	public class NewMagincia : CityLoyaltySystem
	{
		public override PointsType Loyalty
		{
			get { return PointsType.NewMagincia; }
		}

		public NewMagincia()
			: base(City.NewMagincia)
		{
