    ...
    public class DefBlacksmithy : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            */
            ...
            {
                AddCraft(typeof(DragonBardingDeed), 1111704, 1053012, 172.5, 222.5, typeof(IronIngot), 1044036, 750, 1044037);
            }
            #endregion
            #endregion
            ...
            AddCraft(typeof(WoodenKiteShield), 1011080, 1027032, 2.2, 52.2, typeof(IronIngot), 1044036, 8, 1044037);
            ...
            index = AddCraft(typeof(LargeStoneShield), 1111705, 1095773, 55.0, 105.0, typeof(IronIngot), 1044036, 32, 1044037);             
			//AddRes(index, typeof(Granite), 1044514, 16, 1044513);
			*/
            #endregion
            #region Bladed
            ...
            AddCraft(typeof(Dagger), 1011081, 1023921, -0.4, 49.6, typeof(IronIngot), 1044036, 7, 1044037);
            ...
            AddCraft(typeof(ThinLongsword), 1011081, 1011412, 40.0, 90.0, typeof(IronIngot), 1044036, 12, 1044037);
			...
			*/
			...
			if (Core.ML)
			{
				...
				index = AddCraft(typeof(ColdForgedBlade), 1011081, 1072916, 220.0, 170.0, typeof(IronIngot), 1044036, 18, 1044037);
				...
				index = AddCraft(typeof(OverseerSunderedBlade), 1011081, 1072920, 220.0, 170.0, typeof(IronIngot), 1044036, 15, 1044037);
				AddRes(index, typeof(GrizzledBones), 1032684, 1, 1053098);
				AddRes(index, typeof(Blight), 1032675, 10, 1053098);
				...
				index = AddCraft(typeof(LuminousRuneBlade), 1011081, 1072922, 220.0, 170.0, typeof(IronIngot), 1044036, 15, 1044037);
				AddRes(index, typeof(GrizzledBones), 1032684, 1, 1053098);
				...
				//2티어
				index = AddCraft(typeof(OrcishMachete), 1011081, 1073534, 175.0, 225.0, typeof(IronIngot), 1044036, 14, 1044037);
				AddRes(index, typeof(Scourge), 1072136, 1, 1042081);
				AddRecipe(index, (int)SmithRecipes.OrcishMachete);

				index = AddCraft(typeof(CorruptedRuneBlade), 1011081, 1073540, 175.0, 225.0, typeof(IronIngot), 1044036, 15, 1044037);
				AddRes(index, typeof(Corruption), 1072135, 1, 1042081);
				AddRecipe(index, (int)SmithRecipes.CorruptedRuneBlade);
				
				index = AddCraft(typeof(DiseasedMachete), 1011081, 1073536, 175.0, 225.0, typeof(IronIngot), 1044036, 14, 1044037);
				AddRes(index, typeof(Blight), 1072134, 1, 1042081);
				AddRecipe(index, (int)SmithRecipes.DiseasedMachete);

				//1티어
				index = AddCraft(typeof(TrueSpellblade), 1011081, 1073513, 175.0, 225.0, typeof(IronIngot), 1044036, 14, 1044037);
				AddRes(index, typeof(BlueDiamond), 1032696, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.TrueSpellblade);

				index = AddCraft(typeof(IcySpellblade), 1011081, 1073514, 175.0, 225.0, typeof(IronIngot), 1044036, 14, 1044037);
				AddRes(index, typeof(Turquoise), 1032691, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.IcySpellblade);

				index = AddCraft(typeof(FierySpellblade), 1011081, 1073515, 175.0, 225.0, typeof(IronIngot), 1044036, 14, 1044037);
				AddRes(index, typeof(FireRuby), 1032695, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.FierySpellblade);

				index = AddCraft(typeof(SpellbladeOfDefense), 1011081, 1073516, 175.0, 225.0, typeof(IronIngot), 1044036, 18, 1044037);
				AddRes(index, typeof(WhitePearl), 1032694, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.SpellbladeOfDefense);

				index = AddCraft(typeof(TrueAssassinSpike), 1011081, 1073517, 175.0, 225.0, typeof(IronIngot), 1044036, 9, 1044037);
				AddRes(index, typeof(DarkSapphire), 1032690, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.TrueAssassinSpike);

				index = AddCraft(typeof(ChargedAssassinSpike), 1011081, 1073518, 175.0, 225.0, typeof(IronIngot), 1044036, 9, 1044037);
				AddRes(index, typeof(EcruCitrine), 1032693, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.ChargedAssassinSpike);

				index = AddCraft(typeof(MagekillerAssassinSpike), 1011081, 1073519, 175.0, 225.0, typeof(IronIngot), 1044036, 9, 1044037);
				AddRes(index, typeof(BrilliantAmber), 1032697, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.MagekillerAssassinSpike);

				index = AddCraft(typeof(WoundingAssassinSpike), 1011081, 1073520, 175.0, 225.0, typeof(IronIngot), 1044036, 9, 1044037);
				AddRes(index, typeof(PerfectEmerald), 1032692, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.WoundingAssassinSpike);

				index = AddCraft(typeof(TrueLeafblade), 1011081, 1073521, 175.0, 225.0, typeof(IronIngot), 1044036, 12, 1044037);
				AddRes(index, typeof(BlueDiamond), 1032696, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.TrueLeafblade);

				index = AddCraft(typeof(Luckblade), 1011081, 1073522, 175.0, 225.0, typeof(IronIngot), 1044036, 12, 1044037);
				AddRes(index, typeof(WhitePearl), 1032694, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.Luckblade);

				index = AddCraft(typeof(MagekillerLeafblade), 1011081, 1073523, 175.0, 225.0, typeof(IronIngot), 1044036, 12, 1044037);
				AddRes(index, typeof(FireRuby), 1032695, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.MagekillerLeafblade);

				index = AddCraft(typeof(LeafbladeOfEase), 1011081, 1073524, 175.0, 225.0, typeof(IronIngot), 1044036, 12, 1044037);
				AddRes(index, typeof(PerfectEmerald), 1032692, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.LeafbladeOfEase);

				index = AddCraft(typeof(KnightsWarCleaver), 1011081, 1073525, 175.0, 225.0, typeof(IronIngot), 1044036, 18, 1044037);
				AddRes(index, typeof(PerfectEmerald), 1032692, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.KnightsWarCleaver);

				index = AddCraft(typeof(ButchersWarCleaver), 1011081, 1073526, 175.0, 225.0, typeof(IronIngot), 1044036, 18, 1044037);
				AddRes(index, typeof(Turquoise), 1032691, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.ButchersWarCleaver);

				index = AddCraft(typeof(SerratedWarCleaver), 1011081, 1073527, 175.0, 225.0, typeof(IronIngot), 1044036, 18, 1044037);
				AddRes(index, typeof(EcruCitrine), 1032693, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.SerratedWarCleaver);

				index = AddCraft(typeof(TrueWarCleaver), 1011081, 1073528, 175.0, 225.0, typeof(IronIngot), 1044036, 18, 1044037);
				AddRes(index, typeof(BrilliantAmber), 1032697, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.TrueWarCleaver);

				index = AddCraft(typeof(AdventurersMachete), 1011081, 1073533, 175.0, 225.0, typeof(IronIngot), 1044036, 14, 1044037);
				AddRes(index, typeof(WhitePearl), 1032694, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.AdventurersMachete);

				index = AddCraft(typeof(MacheteOfDefense), 1011081, 1073535, 175.0, 225.0, typeof(IronIngot), 1044036, 14, 1044037);
				AddRes(index, typeof(BrilliantAmber), 1032697, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.MacheteOfDefense);

				index = AddCraft(typeof(Runesabre), 1011081, 1073537, 175.0, 225.0, typeof(IronIngot), 1044036, 15, 1044037);
				AddRes(index, typeof(Turquoise), 1032691, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.Runesabre);

				index = AddCraft(typeof(MagesRuneBlade), 1011081, 1073538, 175.0, 225.0, typeof(IronIngot), 1044036, 15, 1044037);
				AddRes(index, typeof(BlueDiamond), 1032696, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.MagesRuneBlade);

				index = AddCraft(typeof(RuneBladeOfKnowledge), 1011081, 1073539, 175.0, 225.0, typeof(IronIngot), 1044036, 15, 1044037);
				AddRes(index, typeof(EcruCitrine), 1032693, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.RuneBladeOfKnowledge);

				index = AddCraft(typeof(TrueRadiantScimitar), 1011081, 1073541, 175.0, 225.0, typeof(IronIngot), 1044036, 15, 1044037);
				AddRes(index, typeof(BrilliantAmber), 1032697, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.TrueRadiantScimitar);

				index = AddCraft(typeof(DarkglowScimitar), 1011081, 1073542, 175.0, 225.0, typeof(IronIngot), 1044036, 15, 1044037);
				AddRes(index, typeof(DarkSapphire), 1032690, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.DarkglowScimitar);

				index = AddCraft(typeof(IcyScimitar), 1011081, 1073543, 175.0, 225.0, typeof(IronIngot), 1044036, 15, 1044037);
				AddRes(index, typeof(DarkSapphire), 1032690, 1, 1044240);
				AddRecipe(index, (int)SmithRecipes.IcyScimitar);

				index = AddCraft(typeof(TwinklingScimitar), 1011081, 1073544, 175.0, 225.0, typeof(IronIngot), 1044036, 15, 1044037);
				AddRes(index, typeof(DarkSapphire), 1032690, 1, 1044240);
            ...
            if (Core.SA)
            {
                ...
                index = AddCraft(typeof(GargishDagger), 1011081, 1095362, 0.0, 100.0, typeof(IronIngot), 1044036, 7, 1044037);
			...
			*/
            ...
            AddCraft(typeof(ShortSpear), 1011083, 1025123, 45.3, 95.3, typeof(IronIngot), 1044036, 7, 1044037);
			...
			*/
            ...
            AddCraft(typeof(Mace), 1011084, 1023932, 14.5, 64.5, typeof(IronIngot), 1044036, 7, 1044037);
			...
			*/
            ...
            if (Core.SA)
            {
                index = AddCraft(typeof(Boomerang), 1079508, 1095359, 75.0, 125.0, typeof(IronIngot), 1044036, 7, 1044037);
