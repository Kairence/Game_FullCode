...
namespace Server.Engines.Craft
{
	...
	public class DefMasonry : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			{
				int index = AddCraft(
					typeof(LargeGargoyleBedSouthDeed),
					1044290,
					1111761,
					76.0,
					126.0,
				...
				index = AddCraft(
					typeof(LargeGargoyleBedEastDeed),
					1044290,
					1111762,
					76.0,
					126.0,
			...
			*/
			...
			if (Core.TOL)
			{
				...
				index = AddCraft(
					typeof(CraftableStoneHouseDoor),
					1155792,
					1156078,
					60.0,
					110.0,
			...
			MarkOption = true;
			Repair = false; //Core.SA;
			CanEnhance = false; //Core.SA;
