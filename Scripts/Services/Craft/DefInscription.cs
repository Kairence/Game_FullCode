...
namespace Server.Engines.Craft
{
	...
	public class DefInscription : CraftSystem
	{
		...
		private System.Collections.Generic.Dictionary<Type, int> _Buffer = new System.Collections.Generic.Dictionary<
			Type,
			int
		>();
		...
		private enum Reg
		{
			...
			SulfurousAsh,
			SpidersSilk,
		} //, BatWing, GraveDust, DaemonBlood, NoxCrystal, PigIron, Bone, DragonBlood, FertileDirt, DaemonBone }
