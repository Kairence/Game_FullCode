...
namespace Server.Engines.Craft
{
    ...
    public class DefInscription : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
			...
			*/
            // Runebook
            int index = AddCraft(typeof(Runebook), 1044294, 1041267, 45.0, 95.0, typeof(BlankScroll), 1044377, 20, 1044378);
            AddRes(index, typeof(RecallScroll), 1044445, 10, 1044253);
            AddRes(index, typeof(GateTravelScroll), 1044446, 10, 1044253);

            index = AddCraft(typeof(RecipeBook), 1044294, 1125598, 172.5, 222.5, typeof(BlankScroll), 1044377, 750, 1044378);
			/*
            #region TOL
            if (Core.TOL)
            {
                index = AddCraft(typeof(RunicAtlas), 1044294, 1156443, 145.0, 195.0, typeof(BlankScroll), 1044377, 24, 1044378);
                AddRes(index, typeof(Runebook), 1041267, 3, 1044253);
                AddRes(index, typeof(RecallScroll), 1044445, 100, 1044253);
                AddRes(index, typeof(GateTravelScroll), 1044446, 100, 1044253);
			...
			*/
            if (Core.SE)
            {
                index = AddCraft(typeof(Spellbook), 1044294, 1023834, 20.0, 70, typeof(BlankScroll), 1044377, 10, 1044378);
				AddRes( index, typeof(BlankScroll), 1044377, 10, 1044378);
				AddRes( index, typeof( Feather ), 1044562, 10, 1044563 );

                index = AddCraft(typeof(Magerybook), 1044294, 1039016, 30.0, 80, typeof( Leather ), 1044462, 7, 1044463 );
				/*
                index = AddCraft(typeof(NecromancerSpellbook), 1044294, "강령술 마법책", 30.0, 80, typeof( Leather ), 1044462, 7, 1044463 );
                index = AddCraft(typeof(SpellweavingBook), 1044294, "주문조합 마법책", 30.0, 80, typeof( Leather ), 1044462, 7, 1044463 );
                index = AddCraft(typeof(MysticBook), 1044294, "신비술 마법책", 30.0, 80, typeof( Leather ), 1044462, 7, 1044463 );
				*/
			}
			/*
			...
			*/
            ...
            AddSubRes(typeof(SernedLeather), "경화 가죽", 61.0, 1049311);
			...
			//AddSubRes( typeof( DranedLeather ),	"용 가죽", 50.0, 1044462, 1049311 );
			
			Repair = Core.AOS;
            MarkOption = true;
			this.CanEnhance = true;//Core.ML;
        }
    }
}
