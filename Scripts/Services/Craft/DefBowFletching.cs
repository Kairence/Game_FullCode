...
namespace Server.Engines.Craft
{
    ...
    public class DefBowFletching : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            // Ammunition
            index = this.AddCraft(typeof(Arrow), 1044565, 1023903, 0.0, 50.0, typeof(Shaft), 1044560, 1, 1044561);
            this.AddRes(index, typeof(Feather), 1044562, 1, 1044563);
            this.SetUseAllRes(index, true);

            index = this.AddCraft(typeof(Bolt), 1044565, 1027163, 0.0, 50.0, typeof(Shaft), 1044560, 1, 1044561);
            this.AddRes(index, typeof(Feather), 1044562, 1, 1044563);
            this.SetUseAllRes(index, true);
			
            AddCraft(typeof(AppleTrunkDeed), 1044565, 1076785, 72.5, 122.5, typeof(Board), 1044041, 750, 1044351);			
			
            AddCraft(typeof(PeachTrunkDeed), 1044565, 1076786, 72.5, 122.5, typeof(Board), 1044041, 750, 1044351);			

            AddCraft(typeof(CherryBlossomTrunkDeed), 1076784, 1053012, 172.5, 222.5, typeof(Board), 1044041, 750, 1044351);			
			/*
            if (Core.SE)
            {
			...
			*/
            // Weapons
            this.AddCraft(typeof(Bow), 1044566, 1025042, 10.0, 60.0, typeof(Board), 1044041, 7, 1044351);
            this.AddCraft(typeof(Crossbow), 1044566, 1023919, 20.0, 70.0, typeof(Board), 1044041, 7, 1044351);
            this.AddCraft(typeof(HeavyCrossbow), 1044566, 1025117, 70.0, 120.0, typeof(Board), 1044041, 10, 1044351);

            if (Core.AOS)
            {
                this.AddCraft(typeof(CompositeBow), 1044566, 1029922, 30.0, 80.0, typeof(Board), 1044041, 7, 1044351);
                this.AddCraft(typeof(RepeatingCrossbow), 1044566, 1029923, 40.0, 90.0, typeof(Board), 1044041, 10, 1044351);
            }
            ...
            if (Core.ML)
            {
                index = AddCraft(typeof(ElvenCompositeLongbow), 1044566, 1031562, 75.0, 125.0, typeof(Board), 1044041, 20, 1044351);

                index = AddCraft(typeof(MagicalShortbow), 1044566, 1031551, 50.0, 100.0, typeof(Board), 1044041, 15, 1044351);
            ...
            this.AddSubRes(typeof(OakBoard), 1072644, 20.0, 1044041, 1072652);
            this.AddSubRes(typeof(AshBoard), 1072645, 40.0, 1044041, 1072652);
            this.AddSubRes(typeof(YewBoard), 1072646, 60.0, 1044041, 1072652);
            this.AddSubRes(typeof(HeartwoodBoard), 1072647, 80.0, 1044041, 1072652);
            this.AddSubRes(typeof(BloodwoodBoard), 1072648, 100.0, 1044041, 1072652);
            this.AddSubRes(typeof(FrostwoodBoard), 1072649, 120.0, 1044041, 1072652);
            #endregion
