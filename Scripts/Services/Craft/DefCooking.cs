...
namespace Server.Engines.Craft
{
    ...
    public class DefCooking : CraftSystem
    {
		...
		private Type[,] FishSteakMake =
		{
			{ typeof(TroutFishSteak), typeof(TroutRawFishSteak) },
			{ typeof(BassFishSteak), typeof(BassRawFishSteak) },
			{ typeof(ShinerFishSteak), typeof(ShinerRawFishSteak) },
			{ typeof(CrucianCarpFishSteak), typeof(CrucianCarpRawFishSteak) },
			{ typeof(CatFishSteak), typeof(CatFishRawFishSteak) },
			{ typeof(CodFishSteak), typeof(CodFishRawFishSteak) },
			{ typeof(PerchFishSteak), typeof(PerchFishRawFishSteak) }
		};
		public void AddFishSteakSet()
		{
			for(int i = 0; i < 7; i++ )
			{
				int index = AddCraft(FishSteakMake[i, 0], 1044498, 1063667 + i, 25.0 + i * 20.0, 125.0 + i * 20.0, FishSteakMake[i, 1], 1063658 + i, 1, 1053098);
        ...
        public override void InitCraftList()
        {
            ...
            index = AddCraft(typeof(Dough), 1044495, 1024157, 10.0, 60.0, typeof(SackFlourOpen), 1044468, 1, 1151092);
            AddRes(index, typeof(BaseBeverage), 1046458, 1, 1044253);

            index = AddCraft(typeof(SweetDough), 1044495, 1041340, 30.0, 80.0, typeof(Dough), 1044469, 1, 1044253);
            AddRes(index, typeof(JarHoney), 1044472, 1, 1044253);

            index = AddCraft(typeof(CookieMix), 1044495, 1024159, 50.0, 100.0, typeof(JarHoney), 1044472, 1, 1044253);
            AddRes(index, typeof(SweetDough), 1044475, 1, 1044253);

            index = AddCraft(typeof(CakeMix), 1044495, 1041002, 75.0, 125.0, typeof(SackFlourOpen), 1044468, 1, 1151092);
            AddRes(index, typeof(SweetDough), 1044475, 1, 1044253);


            if (Core.ML)
            {
                index = AddCraft(typeof(CocoaButter), 1044495, 1079998, 50.0, 100.0, typeof(CocoaPulp), 1080530, 1, 1044253);
                SetItemHue(index, 0x457);
                SetNeedOven(index, true);

                index = AddCraft(typeof(CocoaLiquor), 1044495, 1079999, 50.0, 100.0, typeof(CocoaPulp), 1080530, 1, 1044253);
                AddRes(index, typeof(EmptyPewterBowl), 1025629, 1, 1044253);
                SetItemHue(index, 0x46A);
                SetNeedOven(index, true);
            }

            index = AddCraft(typeof(WheatWort), 1044495, 1150275, 80.0, 130.0, typeof(Bottle), 1023854, 1, 1044253);
            AddRes(index, typeof(BaseBeverage), 1046458, 1, 1044253);
            ...
            #region Preparations
            index = AddCraft(typeof(UnbakedQuiche), 1044496, 1041339, 60.0, 110.0, typeof(Dough), 1044469, 1, 1044253);
            AddRes(index, typeof(Eggs), 1044477, 1, 1044253);

            // TODO: This must also support chicken and lamb legs
            index = AddCraft(typeof(UnbakedMeatPie), 1044496, 1041338, 60.0, 110.0, typeof(Dough), 1044469, 1, 1044253);
            AddRes(index, typeof(RawRibs), 1044482, 1, 1044253);

            index = AddCraft(typeof(UncookedSausagePizza), 1044496, 1041337, 60.0, 110.0, typeof(Dough), 1044469, 1, 1044253);
            AddRes(index, typeof(Sausage), 1044483, 1, 1044253);

            index = AddCraft(typeof(UncookedCheesePizza), 1044496, 1041341, 60.0, 110.0, typeof(Dough), 1044469, 1, 1044253);
            AddRes(index, typeof(CheeseWheel), 1044486, 1, 1044253);

            index = AddCraft(typeof(UnbakedFruitPie), 1044496, 1041334, 60.0, 110.0, typeof(Dough), 1044469, 1, 1044253);
            AddRes(index, typeof(Pear), 1044481, 1, 1044253);

            index = AddCraft(typeof(UnbakedPeachCobbler), 1044496, 1041335, 60.0, 110.0, typeof(Dough), 1044469, 1, 1044253);
            AddRes(index, typeof(Peach), 1044480, 1, 1044253);

            index = AddCraft(typeof(UnbakedApplePie), 1044496, 1041336, 60.0, 110.0, typeof(Dough), 1044469, 1, 1044253);
            AddRes(index, typeof(Apple), 1044479, 1, 1044253);

            index = AddCraft(typeof(UnbakedPumpkinPie), 1044496, 1041342, 60.0, 110.0, typeof(Dough), 1044469, 1, 1044253);
            AddRes(index, typeof(Pumpkin), 1044484, 1, 1044253);

            if (Core.SE)
            {
                index = AddCraft(typeof(GreenTea), 1044496, 1030316, 40.0, 90.0, typeof(GreenTeaBasket), 1030316, 1, 1044253);
                AddRes(index, typeof(BaseBeverage), 1046458, 1, 1044253);
                SetNeedOven(index, true);

                index = AddCraft(typeof(WasabiClumps), 1044496, 1029451, 50.0, 100.0, typeof(WoodenBowlOfPeas), 1025633, 3, 1044253);
                AddRes(index, typeof(BaseBeverage), 1046458, 3, 1044253);

                index = AddCraft(typeof(SushiPlatter), 1044496, 1030305, 172.5, 222.5, typeof(TroutRawFishSteak), 1063658, 750, 1053098);
				
				/*
                index = AddCraft(typeof(SushiRolls), 1044496, 1030303, 70.0, 120.0, typeof(RawFishSteak), 1044476, 10, 1044253);
                AddRes(index, typeof(BaseBeverage), 1046458, 3, 1044253);

                index = AddCraft(typeof(SushiPlatter), 1044496, 1030305, 70.0, 120.0, typeof(RawFishSteak), 1044476, 10, 1044253);
                AddRes(index, typeof(BaseBeverage), 1046458, 3, 1044253);
				*/
            }
            ...
            if (Core.SE)
            {
                index = AddCraft(typeof(EggBomb), 1044496, 1030249, 80.0, 130.0, typeof(Eggs), 1044477, 10, 1044253);
            ...
            if (Core.ML)
            {
                index = AddCraft(typeof(ParrotWafer), 1044496, 1032246, 87.5, 137.5, typeof(RawFishSteak), 1044476, 10, 1044253);
                AddRes(index, typeof(JarHoney), 1044472, 1, 1044253);
            ...
            if (Core.SA)
            {
                index = AddCraft(typeof(PlantPigment), 1044496, 1112132, 75.0, 125.0, typeof(PlantClippings), 1112131, 1, 1044253);
                ...
                index = AddCraft(typeof(ColorFixative), 1044496, 1112135, 75.0, 125.0, typeof(BaseBeverage), 1022503, 1, 1044253);
                AddRes(index, typeof(SilverSerpentVenom), 1112173, 1, 1044253);
                SetBeverageType(index, BeverageType.Wine);

                index = AddCraft(typeof(WoodPulp), 1044496, 1113136, 60.0, 110.0, typeof(BarkFragment), 1032687, 1, 1044253);
                AddRes(index, typeof(BaseBeverage), 1046458, 1, 1044253);
            }
            #endregion
            ...
            #region Baking
            index = AddCraft(typeof(BreadLoaf), 1044497, 1024156, 20.0, 70.0, typeof(Dough), 1044469, 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(Cookies), 1044497, 1025643, 60.0, 110.0, typeof(CookieMix), 1044474, 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(Cake), 1044497, 1022537, 85.0, 135.0, typeof(CakeMix), 1044471, 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(Muffins), 1044497, 1022539, 30.0, 80.0, typeof(SweetDough), 1044475, 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(Quiche), 1044497, 1041345, 70.0, 120.0, typeof(UnbakedQuiche), 1044518, 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(MeatPie), 1044497, 1041347, 70.0, 120.0, typeof(UnbakedMeatPie), 1044519, 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(SausagePizza), 1044497, 1044517, 70.0, 120.0, typeof(UncookedSausagePizza), 1044520, 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(CheesePizza), 1044497, 1044516, 70.0, 120.0, typeof(UncookedCheesePizza), 1044521, 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(FruitPie), 1044497, 1041346, 70.0, 120.0, typeof(UnbakedFruitPie), 1044522, 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(PeachCobbler), 1044497, 1041344, 70.0, 120.0, typeof(UnbakedPeachCobbler), 1044523, 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(ApplePie), 1044497, 1041343, 70.0, 120.0, typeof(UnbakedApplePie), 1044524, 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(PumpkinPie), 1044497, 1041348, 70.0, 120.0, typeof(UnbakedPumpkinPie), 1046461, 1, 1044253);
            SetNeedOven(index, true);
			...
			*/
            ...
            if (Core.ML)
            {
                if (Core.TOL)
                {
                    index = AddCraft(typeof(SweetCocoaButter), 1080001, 1156401, 65.0, 115.0, typeof(SackOfSugar), 1079997, 1, 1044253);
                    AddRes(index, typeof(CocoaButter), 1079998, 1, 1044253);
                    SetItemHue(index, 0x457);
                    SetNeedOven(index, true);
                }

                index = AddCraft(typeof(DarkChocolate), 1080001, 1079994, 65.0, 115.0, typeof(SackOfSugar), 1079997, 1, 1044253);
                AddRes(index, typeof(CocoaButter), 1079998, 1, 1044253);
                AddRes(index, typeof(CocoaLiquor), 1079999, 1, 1044253);
                SetItemHue(index, 0x465);

                index = AddCraft(typeof(MilkChocolate), 1080001, 1079995, 82.5, 132.5, typeof(SackOfSugar), 1079997, 1, 1044253);
                AddRes(index, typeof(CocoaButter), 1079998, 1, 1044253);
                AddRes(index, typeof(CocoaLiquor), 1079999, 1, 1044253);
                ...
                index = AddCraft(typeof(WhiteChocolate), 1080001, 1079996, 92.5, 142.5, typeof(SackOfSugar), 1079997, 1, 1044253);
                AddRes(index, typeof(CocoaButter), 1079998, 1, 1044253);
                ...
                if (Core.TOL)
                {
                    index = AddCraft(typeof(ChocolateNutcracker), 1080001, 1156390, 65.0, 115.0, typeof(SweetCocoaButter), 1156401, 1, 1044253);
                    ...
                    index = AddCraft(typeof(ChocolateNutcracker), 1080001, 1156391, 92.5, 132.5, typeof(SweetCocoaButter), 1156401, 1, 1044253);
                    AddRes(index, typeof(SweetCocoaButter), 1124032, 1, 1156402);
                    AddRes(index, typeof(CocoaLiquor), 1079999, 1, 1044253);
                    AddRecipe(index, (int)CookRecipes.MilkChocolateNutcracker);
                    SetData(index, ChocolateNutcracker.ChocolateType.Milk);

                    index = AddCraft(typeof(ChocolateNutcracker), 1080001, 1156392, 92.5, 142.5, typeof(SweetCocoaButter), 1156401, 1, 1044253);
                    AddRes(index, typeof(SweetCocoaButter), 1124032, 1, 1156402);
                    AddRes(index, typeof(CocoaLiquor), 1079999, 1, 1044253);
			...
			*/
            ...
            #region Bevereages
            index = AddCraft(typeof(CoffeeMug), 1155736, 1155737, 30.0, 80.0, typeof(CoffeeGrounds), 1155735, 1, 1155734);
            AddRes(index, typeof(BaseBeverage), 1046458, 1, 1044253);
            SetBeverageType(index, BeverageType.Water);
            SetNeedMaker(index, true);
            ForceNonExceptional(index);

            index = AddCraft(typeof(BasketOfGreenTeaMug), 1155736, 1030315, 30.0, 80.0, typeof(GreenTeaBasket), 1155735, 1, 1044253);
            AddRes(index, typeof(BaseBeverage), 1046458, 1, 1044253);
            SetBeverageType(index, BeverageType.Water);
            SetNeedMaker(index, true);
            ForceNonExceptional(index);

            index = AddCraft(typeof(HotCocoaMug), 1155736, 1155738, 30.0, 80.0, typeof(CocoaLiquor), 1080007, 1, 1080006);
