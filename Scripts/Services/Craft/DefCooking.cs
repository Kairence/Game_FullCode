...
namespace Server.Engines.Craft
{
	...
	public class DefCooking : CraftSystem
	{
		...
		{
			if (item.ItemType == typeof(GrapesOfWrath) || item.ItemType == typeof(EnchantedApple))
			{
				return .5;
			}
		...
		public override void InitCraftList()
		{
			...
			{
				index = AddCraft(
					typeof(BowlOfRotwormStew),
					1044498,
					1031706,
					0.0,
					100.0,
					typeof(RawRotwormMeat),
					1031705,
					1,
					1044253
				);
