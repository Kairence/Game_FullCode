	...
	public class DefTinkering : CraftSystem
	{
		...
		public override int CanCraft(Mobile from, ITool tool, Type itemType)
		{
			...
			if (tool == null || tool.Deleted || tool.UsesRemaining <= 0)
				...
				itemType == typeof(ModifiedClockworkAssembly)
		...
		public override void InitCraftList()
		{
			...
			*/
			...
			AddCraft(
				Core.AOS ? typeof(SmithyHammer) : typeof(SmithHammer),
				1044046,
				1025091,
				40.0,
				90.0,
			...
			AddCraft(
				Core.AOS ? typeof(SledgeHammerWeapon) : typeof(SledgeHammer),
				1044046,
				1024021,
				40.0,
				90.0,
			...
			*/
			...
			if (Core.TOL)
			{
				...
				index = AddCraft(
					typeof(CraftableMetalHouseDoor),
					1044050,
					1156080,
					85.0,
					135.0,
				...
				index = AddCraft(
					typeof(KotlPowerCore),
					1044050,
					1124179,
					85.0,
					135.0,
					typeof(WorkableGlass),
					1154170,
					5,
					1154171
				);
			...
			index = AddCraft(
				typeof(WeatheredBronzeGlobeSculptureDeed),
				1044050,
				1156881,
				85.0,
				135.0,
			...
			index = AddCraft(
				typeof(WeatheredBronzeManOnABenchDeed),
				1044050,
				1156882,
				85.0,
				135.0,
			...
			index = AddCraft(
				typeof(WeatheredBronzeFairySculptureDeed),
				1044050,
				1156883,
				85.0,
				135.0,
			...
			index = AddCraft(
				typeof(WeatheredBronzeArcherDeed),
				1044050,
				1156884,
				85.0,
				135.0,
			...
			{
				index = AddCraft(
					typeof(ModifiedClockworkAssembly),
					1044051,
					1113031,
					65.0,
					115.0,
