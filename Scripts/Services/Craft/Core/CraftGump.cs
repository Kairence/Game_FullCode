...
namespace Server.Engines.Craft
{
	public class CraftGump : Gump
	{
		...
		public bool Locked
		{
			get { return AutoCraftTimer.HasTimer(m_From); }
		}
			...
			: base(40, 40)
		{
			...
			{
				AddButton(270, 382, 4005, 4007, GetButtonID(6, 8), GumpButtonType.Reply, 0); //1071570
			...
			if (Core.SA)
			{
				...
				AddHtmlLocalized(
					...
					150,
					18,
					context != null && context.QuestOption == CraftQuestOption.QuestItem ? 1112534 : 1112533,
					LabelColor,
					false,
					false
				); // QUEST ITEM
