...
namespace Server.Engines.Craft
{
    ...
    public class DefTailoring : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            #region Hats
            AddCraft(typeof(SkullCap), 1011375, 1025444, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(Bandana), 1011375, 1025440, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(FloppyHat), 1011375, 1025907, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(Cap), 1011375, 1025909, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(WideBrimHat), 1011375, 1025908, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(StrawHat), 1011375, 1025911, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(TallStrawHat), 1011375, 1025910, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(WizardsHat), 1011375, 1025912, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(Bonnet), 1011375, 1025913, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(FeatheredHat), 1011375, 1025914, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(TricorneHat), 1011375, 1025915, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(JesterHat), 1011375, 1025916, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );

            if (Core.AOS)
                AddCraft(typeof(FlowerGarland), 1011375, 1028965,20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
			...
			*/
            ...
            AddCraft(typeof(OrcMask), 1011375, 1025147, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(BearMask), 1011375, 1025445, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(DeerMask), 1011375, 1025447, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(TribalMask), 1011375, 1025449, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(HornedTribalMask), 1011375, 1025451, 20.0, 70.0, typeof( Leather ), 1044462, 7, 1044463 );
			...
			*/
            ...
            AddCraft(typeof(ShortPants), 1111747, 1025422, 35.0, 85.0, typeof( Leather ), 1044462, 7, 1044463 );
            AddCraft(typeof(LongPants), 1111747, 1025433, 35.0, 85.0, typeof( Leather ), 1044462, 7, 1044463 );
            ...
            if (Core.ML)
            {
                ...
                index = AddCraft(typeof(ElvenPants), 1111747, 1032665, 35.0, 85.0, typeof( Leather ), 1044462, 7, 1044463 );
            ...
            if (Core.SE)
            {
                index = AddCraft(typeof(Obi), 1015283, 1030219, 20.0, 45.0, typeof(Cloth), 1044455, 7, 1044287);
            }
            ...
            if (Core.SA)
            {
                AddCraft(typeof(GargoyleHalfApron), 1015283, 1099568, 20.7, 45.7, typeof(Cloth), 1044455, 7, 1044287);
                AddCraft(typeof(GargishSash), 1015283, 1115388, 4.1, 29.1, typeof(Cloth), 1044455, 7, 1044287);
            }
            #endregion
			*/
            ...
            if (Core.SE)
            {
                ...
                AddCraft(typeof(CurtainsDeed), 1015283, 1021074, 172.5, 222.5, typeof(Cloth), 1044455, 750, 1044287);
            }
            ...
            */
            ...
            if (Core.ML)
            {
                index = AddCraft(typeof(ElvenBoots), 1015288, 1072902, 80.0, 105.0, typeof(Cloth), 1044462, 15, 1044463);
            }
            #endregion
            ...
            if (Core.TOL)
            {
                index = AddCraft(typeof(JesterShoes), 1015288, 1109617, 20.0, 35.0, typeof(Cloth), 1044455, 7, 1044287);
                AddRecipe(index, (int)TailorRecipe.JesterShoes);
            }
            #endregion

            index = AddCraft(typeof(KrampusMinionBoots), 1015288, 1125637, 100.0, 500.0, typeof(Leather), 1044462, 7, 1044463);
            AddRes(index, typeof(Cloth), 1044455, 4, 1044287);
            AddRecipe(index, (int)TailorRecipe.KrampusMinionBoots);

            index = AddCraft(typeof(KrampusMinionTalons), 1015288, 1125644, 100.0, 500.0, typeof(Leather), 1044462, 7, 1044463);
            AddRes(index, typeof(Cloth), 1044455, 4, 1044287);
            ...
            #endregion
			*/
            AddCraft(typeof(LeatherGorget), 1015293, 1025063, 53.9, 78.9, typeof(Leather), 1044462, 7, 1044463);
            AddCraft(typeof(LeatherCap), 1015293, 1027609, 6.2, 31.2, typeof(Leather), 1044462, 7, 1044463);
            AddCraft(typeof(LeatherGloves), 1015293, 1025062, 51.8, 76.8, typeof(Leather), 1044462, 7, 1044463);
            AddCraft(typeof(LeatherArms), 1015293, 1025061, 53.9, 78.9, typeof(Leather), 1044462, 7, 1044463);
			...
			//나뭇잎 갑옷
			index = AddCraft(typeof(LeafChest), 1015293, 1032667, -5.0, 20.0, typeof(Leather), 1044462, 15, 1044463);
			AddRes(index, typeof(BarkFragment), 1032687, 2, 1044351);

			index = AddCraft(typeof(LeafArms), 1015293, 1032670, -20.0, 5.0, typeof(Leather), 1044462, 12, 1044463);
			AddRes(index, typeof(BarkFragment), 1032687, 2, 1044351);

			index = AddCraft(typeof(LeafGloves), 1015293, 1032668, -20.0, 5.0, typeof(Leather), 1044462, 10, 1044463);
			AddRes(index, typeof(BarkFragment), 1032687, 2, 1044351);

			index = AddCraft(typeof(LeafLegs), 1015293, 1032671, -5.0, 20.0, typeof(Leather), 1044462, 15, 1044463);
			AddRes(index, typeof(BarkFragment), 1032687, 2, 1044351);

			index = AddCraft(typeof(LeafGorget), 1015293, 1032669, -15.0, 10.0, typeof(Leather), 1044462, 12, 1044463);
			AddRes(index, typeof(BarkFragment), 1032687, 2, 1044351);

			index = AddCraft(typeof(LeafTonlet), 1015293, 1032672, -10.0, 15.0, typeof(Leather), 1044462, 12, 1044463);
			AddRes(index, typeof(BarkFragment), 1032687, 2, 1044351);

			index = AddCraft(typeof(WingedHelm), 1015293, 1031123, -10.4, 15.4, typeof(Leather), 1044462, 19, 1044463);
			AddRes(index, typeof(BarkFragment), 1032687, 2, 1044351);
           ...
           #region SA
            if (Core.SA)
            {
                ...
                index = AddCraft(typeof(GargishLeatherKilt), 1015293, 1095331, 58.0, 83.0, typeof(Leather), 1044462, 7, 1044463);
                ...
                index = AddCraft(typeof(FemaleGargishLeatherKilt), 1015293, 1095331, 58.0, 83.0, typeof(Leather), 1044462, 7, 1044463);

                index = AddCraft(typeof(GargishLeatherWingArmor), 1111747, 1096662, 65.0, 90.0, typeof(Cloth), 1044455, 12, 1044287);
            }
			...
			*/
            ...
            if (Core.TOL)
            {
                index = AddCraft(typeof(TigerPeltChest), 1015293, 1109626, 20.0, 45.0, typeof(Leather), 1044462, 12, 1044463);
                AddRes(index, typeof(TigerPelt), 1123908, 2, 1044253);

                index = AddCraft(typeof(TigerPeltLegs), 1015293, 1109628, 20.0, 45.0, typeof(Leather), 1044462, 12, 1044463);
                AddRes(index, typeof(TigerPelt), 1123908, 2, 1044253);

                index = AddCraft(typeof(TigerPeltShorts), 1015293, 1109629, 20.0, 45.0, typeof(Leather), 1044462, 7, 1044463);
                AddRes(index, typeof(TigerPelt), 1123908, 2, 1044253);

                index = AddCraft(typeof(TigerPeltHelm), 1015293, 1109632, 20.0, 45.0, typeof(Leather), 1044462, 7, 1044463);
                AddRes(index, typeof(TigerPelt), 1123908, 2, 1044253);

                index = AddCraft(typeof(TigerPeltCollar), 1015293, 1109633, 20.0, 45.0, typeof(Leather), 1044462, 7, 1044463);
                AddRes(index, typeof(TigerPelt), 1123908, 2, 1044253);

				//용거북
                index = AddCraft(typeof(DragonTurtleHideChest), 1015293, 1109634, 41.5, 66.5, typeof(Leather), 1044462, 10, 1044463);
                AddRes(index, typeof(DragonTurtleScute), 1123910, 2, 1044253);

                index = AddCraft(typeof(DragonTurtleHideLegs), 1015293, 1109636, 41.5, 66.5, typeof(Leather), 1044462, 12, 1044463);
                AddRes(index, typeof(DragonTurtleScute), 1123910, 2, 1044253);

                index = AddCraft(typeof(DragonTurtleHideHelm), 1015293, 1109637, 41.5, 66.5, typeof(Leather), 1044462, 7, 1044463);
                AddRes(index, typeof(DragonTurtleScute), 1123910, 2, 1044253);

                index = AddCraft(typeof(DragonTurtleHideArms), 1015293, 1109638, 41.5, 66.5, typeof(Leather), 1044462, 7, 1044463);
                AddRes(index, typeof(DragonTurtleScute), 1123910, 2, 1044253);
            }
            #endregion
            #endregion
            ...
            if (Core.SA)
            {
                index = AddCraft(typeof(GargishClothArmsArmor), 1111748, 1021027, 7.1, 32.1, typeof(Leather), 1044462, 8, 1044463);
                AddRes(index, typeof(Cloth), 1044455, 2, 1044287);

                index = AddCraft(typeof(GargishClothChestArmor), 1111748, 1021029, 14.0, 39.0, typeof(Leather), 1044462, 8, 1044463);
                AddRes(index, typeof(Cloth), 1044455, 2, 1044287);

                index = AddCraft(typeof(GargishClothLegsArmor), 1111748, 1021033, 11.2, 36.2, typeof(Leather), 1044462, 10, 1044463);
                AddRes(index, typeof(Cloth), 1044455, 2, 1044287);

                index = AddCraft(typeof(GargishClothKiltArmor), 1111748, 1021031, 2.9, 27.9, typeof(Leather), 1044462, 7, 1044463);
                AddRes(index, typeof(Cloth), 1044455, 2, 1044287);

                index = AddCraft(typeof(FemaleGargishClothArmsArmor), 1111748, 1021027, 7.1, 32.1, typeof(Leather), 1044462, 8, 1044463);
                AddRes(index, typeof(Cloth), 1044455, 2, 1044287);

                index = AddCraft(typeof(FemaleGargishClothChestArmor), 1111748, 1021029, 14.0, 39.0, typeof(Leather), 1044462, 8, 1044463);
                AddRes(index, typeof(Cloth), 1044455, 2, 1044287);

                index = AddCraft(typeof(FemaleGargishClothLegsArmor), 1111748, 1021033, 11.2, 36.2, typeof(Leather), 1044462, 10, 1044463);
                AddRes(index, typeof(Cloth), 1044455, 2, 1044287);

                index = AddCraft(typeof(FemaleGargishClothKiltArmor), 1111748, 1021031, 2.9, 27.9, typeof(Leather), 1044462, 7, 1044463);
                AddRes(index, typeof(Cloth), 1044455, 2, 1044287);

                index = AddCraft(typeof(GargishClothWingArmor), 1111748, 1115393, -15.0, 10.0, typeof(Leather), 1044462, 12, 1044463);
                AddRes(index, typeof(Cloth), 1044455, 2, 1044287);
            }
            #endregion
			*/
			...
			//나무 껍질 갑옷
			index = AddCraft(typeof(HideChest), 1015300, 1032651, 35.0, 60.0, typeof(Leather), 1044462, 15, 1044463);
			AddRes(index, typeof(BarkFragment), 1032687, 4, 1044351);

			index = AddCraft(typeof(HidePauldrons), 1015300, 1032654, 25.0, 50.0, typeof(Leather), 1044462, 12, 1044463);
			AddRes(index, typeof(BarkFragment), 1032687, 4, 1044351);

			index = AddCraft(typeof(HideGloves), 1015300, 1032652, 25.0, 50.0, typeof(Leather), 1044462, 10, 1044463);
			AddRes(index, typeof(BarkFragment), 1032687, 4, 1044351);

			index = AddCraft(typeof(HidePants), 1015300, 1032655, 42.0, 67.0, typeof(Leather), 1044462, 15, 1044463);
			AddRes(index, typeof(BarkFragment), 1032687, 4, 1044351);

			index = AddCraft(typeof(HideGorget), 1015300, 1032653, 40.0, 65.0, typeof(Leather), 1044462, 12, 1044463);
			AddRes(index, typeof(BarkFragment), 1032687, 4, 1044351);

			index = AddCraft(typeof(VultureHelm), 1015300, 1031122, 43.9, 68.9, typeof(Leather), 1044462, 19, 1044463);
			AddRes(index, typeof(BarkFragment), 1032687, 4, 1044351);					
			...
			*/
            ...
            AddCraft(typeof(LeatherSkirt), 1015306, 1027176, 58.0, 83.0, typeof(Leather), 1044462, 7, 1044463);
            AddCraft(typeof(LeatherBustierArms), 1015306, 1027178, 58.0, 83.0, typeof(Leather), 1044462, 7, 1044463);
            ...
            if (Core.TOL)
            {
                index = AddCraft(typeof(TigerPeltBustier), 1015306, 1109627, 25.0, 45.0, typeof(Leather), 1044462, 12, 1044463);
                AddRes(index, typeof(TigerPelt), 1123908, 2, 1044253);

                index = AddCraft(typeof(TigerPeltLongSkirt), 1015306, 1109630, 25.0, 45.0, typeof(Leather), 1044462, 8, 1044463);
                AddRes(index, typeof(TigerPelt), 1123908, 2, 1044253);

                index = AddCraft(typeof(TigerPeltSkirt), 1015306, 1109631, 25.0, 45.0, typeof(Leather), 1044462, 8, 1044463);
                AddRes(index, typeof(TigerPelt), 1123908, 2, 1044253);

                index = AddCraft(typeof(DragonTurtleHideBustier), 1015306, 1109635, 41.5, 66.5, typeof(Leather), 1044462, 12, 1044463);
                AddRes(index, typeof(DragonTurtleScute), 1123910, 2, 1044253);
            }
            #endregion
            ...
            #region Bone Armor
            index = AddCraft(typeof(BoneHelm), 1049149, 1025206, 5.0, 30.0, typeof(Leather), 1044462, 7, 1044463);
            AddRes(index, typeof(Bone), 1049064, 2, 1044463);
			
            index = AddCraft(typeof(BoneGloves), 1049149, 1025205, 9.0, 34.0, typeof(Leather), 1044462, 8, 1044463);
            AddRes(index, typeof(Bone), 1049064, 2, 1044463);

            index = AddCraft(typeof(BoneArms), 1049149, 1025203, 12.0, 37.0, typeof(Leather), 1044462, 12, 1044463);
            AddRes(index, typeof(Bone), 1049064, 2, 1044463);

            index = AddCraft(typeof(BoneLegs), 1049149, 1025202, 15.0, 40.0, typeof(Leather), 1044462, 16, 1044463);
            AddRes(index, typeof(Bone), 1049064, 2, 1044463);
		
            index = AddCraft(typeof(BoneChest), 1049149, 1025199, 16.0, 41.0, typeof(Leather), 1044462, 22, 1044463);
            AddRes(index, typeof(Bone), 1049064, 2, 1044463);

            index = AddCraft(typeof(OrcHelm), 1049149, 1027947, 10.0, 35.0, typeof(Leather), 1044462, 10, 1044463);
            AddRes(index, typeof(Bone), 1049064, 2, 1044463);
			...
			*/
            ...
            AddSubRes(typeof(DernedLeather), "질긴 가죽", 20.0, 1049311);
            AddSubRes(typeof(RatnedLeather), "거친 가죽", 40.0, 1049311);
            AddSubRes(typeof(SernedLeather), "경화 가죽", 60.0, 1049311);
            AddSubRes(typeof(SpinedLeather), 1049151, 80.0, 1044462, 1049311);
            AddSubRes(typeof(HornedLeather), 1049152, 100.0, 1044462, 1049311);
            AddSubRes(typeof(BarbedLeather), 1049153, 120.0, 1044462, 1049311);
