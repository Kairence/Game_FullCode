...
namespace Server.Items
{
	public class VesperDonationBox : BaseCollectionItem
	{
		...
		{
			get { return Collection.VesperMuseum; }
		}
		...
		public override void Init()
		{
			...
			this.Rewards.Add(
				new CollectionHuedItem(typeof(BaronLenshiresCloak), 0x1515, 1073252, 0x281, 100000.0, hues)
			);
			...
			this.Rewards.Add(
				new CollectionHuedItem(typeof(VesperCollectionRing), 0x108A, 1073234, 0x2A, 200000.0, hues)
			);
			this.Rewards.Add(
				new CollectionHuedItem(typeof(VesperCollectionNecklace), 0x1088, 1073234, 0x2A, 200000.0, hues)
			);
			this.Rewards.Add(
				new CollectionHuedItem(typeof(VesperCollectionBracelet), 0x1086, 1073234, 0x2A, 200000.0, hues)
			);
			this.Rewards.Add(
				new CollectionHuedItem(typeof(VesperCollectionEarrings), 0x1087, 1073234, 0x2A, 200000.0, hues)
			);
			...
			this.Rewards.Add(
				new CollectionHuedItem(typeof(JesterHatOfChuckles), 0x171C, 1073256, 0x453, 550000.0, hues)
			);
			...
			this.Rewards.Add(
				new CollectionItem(typeof(VesperSpecialAchievementReplica), 0x2D4E, 1073265, 0x0, 800000.0)
			);
