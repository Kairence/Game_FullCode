...
namespace Server.Engines.Points
{
	public class DoomGauntlet : PointsSystem
	{
		...
		{
			get { return PointsType.GauntletPoints; }
		}
		...
		public static Type[][] RewardTable
		{
			get { return m_RewardTable; }
		}
		private static Type[][] m_RewardTable = new Type[][]
		{
			new Type[] { typeof(HatOfTheMagi) },
			new Type[] { typeof(StaffOfTheMagi) },
			new Type[] { typeof(OrnamentOfTheMagician) },
			new Type[] { typeof(ShadowDancerLeggings) },
			new Type[] { typeof(RingOfTheElements) },
			new Type[] { typeof(GauntletsOfNobility) },
			new Type[] { typeof(LeggingsOfBane) },
			new Type[] { typeof(MidnightBracers) },
			new Type[] { typeof(Glenda) },
			new Type[] { typeof(BowOfTheInfiniteSwarm) },
			new Type[] { typeof(TheDeceiver) },
			new Type[] { typeof(TheScholarsHalo) },
