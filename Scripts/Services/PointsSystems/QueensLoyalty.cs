...
namespace Server.Engines.Points
{
	public class QueensLoyalty : PointsSystem
	{
		...
		{
			get { return PointsType.QueensLoyalty; }
		}
		...
		public override TextDefinition GetTitle(PlayerMobile from)
		{
			...
			{
				default:
				case QueensLoyaltyRating.Friend:
					return new TextDefinition(1095166);
				case QueensLoyaltyRating.Noble:
					return new TextDefinition(1095167);
				case QueensLoyaltyRating.Enemy:
					return new TextDefinition(1095164);
				case QueensLoyaltyRating.Citizen:
					return new TextDefinition(1095165);
			}
		}
