...
namespace Server.Engines.MiniChamps
{
	...
	public class MiniChampInfo
	{
		...
		public static MiniChampInfo[] Table
		{
			get { return m_Table; }
		}
		...
		private static readonly MiniChampInfo[] m_Table = new MiniChampInfo[]
		{
			...
			(
				...
				(new MiniChampTypeInfo(5, typeof(Efreet)), new MiniChampTypeInfo(5, typeof(FireGargoyle))),
				new MiniChampLevelInfo // Level 3
				(new MiniChampTypeInfo(10, typeof(LavaElemental)), new MiniChampTypeInfo(5, typeof(FireDaemon))),
			...
			(
				...
				new MiniChampLevelInfo // Level 1
				(new MiniChampTypeInfo(20, typeof(GreaterMongbat)), new MiniChampTypeInfo(20, typeof(Imp))),
				new MiniChampLevelInfo // Level 2
			...
			(
				...
				new MiniChampLevelInfo // Level 1
				(new MiniChampTypeInfo(10, typeof(ClanRibbonPlagueRat)), new MiniChampTypeInfo(10, typeof(ClanRS))),
				new MiniChampLevelInfo // Level 2
				(new MiniChampTypeInfo(10, typeof(ClanRibbonPlagueRat)), new MiniChampTypeInfo(10, typeof(ClanRC))),
				new MiniChampLevelInfo // Renowned
			...
			(
				typeof(EssenceBalance),
				new MiniChampLevelInfo // Level 1
				(new MiniChampTypeInfo(10, typeof(ClanSSW)), new MiniChampTypeInfo(10, typeof(ClanSS))),
				new MiniChampLevelInfo // Level 2
				(new MiniChampTypeInfo(10, typeof(ClanSSW)), new MiniChampTypeInfo(10, typeof(ClanSH))),
				new MiniChampLevelInfo // Renowned
			...
			(
				typeof(EssenceBalance),
				new MiniChampLevelInfo // Level 1
				(new MiniChampTypeInfo(10, typeof(ClockworkScorpion)), new MiniChampTypeInfo(10, typeof(ClanCA))),
				new MiniChampLevelInfo // Level 2
				(new MiniChampTypeInfo(10, typeof(ClockworkScorpion)), new MiniChampTypeInfo(10, typeof(ClanCT))),
				new MiniChampLevelInfo // Renowned
			...
			(
				...
				new MiniChampLevelInfo // Level 1
				(new MiniChampTypeInfo(10, typeof(AcidSlug)), new MiniChampTypeInfo(20, typeof(CorrosiveSlime))),
				new MiniChampLevelInfo // Level 2
			...
			(
				...
				new MiniChampLevelInfo // Level 3
				(new MiniChampTypeInfo(5, typeof(SkeletalLich)), new MiniChampTypeInfo(20, typeof(RottingCorpse))),
				new MiniChampLevelInfo // Renowned
			...
			(
				...
				new MiniChampLevelInfo // Level 3
				(new MiniChampTypeInfo(5, typeof(FireDaemon)), new MiniChampTypeInfo(10, typeof(LavaElemental))),
				new MiniChampLevelInfo // Renowned
			...
			(
				...
				new MiniChampLevelInfo // Level 1
				(new MiniChampTypeInfo(5, typeof(PatchworkSkeleton)), new MiniChampTypeInfo(15, typeof(Skeleton))),
				new MiniChampLevelInfo // Level 2
				(new MiniChampTypeInfo(5, typeof(BoneKnight)), new MiniChampTypeInfo(5, typeof(SkeletalKnight))),
				new MiniChampLevelInfo // Level 3
				(new MiniChampTypeInfo(5, typeof(BoneMagi)), new MiniChampTypeInfo(2, typeof(SkeletalMage))),
