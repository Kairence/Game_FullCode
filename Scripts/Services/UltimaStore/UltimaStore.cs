...
namespace Server.Engines.UOStore
{
	...
	public static class UltimaStore
	{
		...
		public static void Initialize()
		{
			...
			Register<MythicCharacterToken>(new TextDefinition[] { 1156614, 1156615 }, 1156679, 0x2AAA, 0, 0, 2500, cat);
			Register<CharacterReincarnationToken>(
				new TextDefinition[] { 1156612, 1156615 },
				1156677,
				0x2AAA,
				0,
				0,
			...
			Register<SpecialHairDye>(
				new TextDefinition[] { 1071387, 1071439 },
				1156676,
				0,
				0x9C78,
				0,
			...
			Register<SpecialHairDye>(
				new TextDefinition[] { 1071387, 1071470 },
				1156676,
				0,
				0x9C6D,
				0,
			...
			Register<SpecialHairDye>(
				new TextDefinition[] { 1071387, 1071471 },
				1156676,
				0,
				0x9C6E,
				0,
			...
			Register<SpecialHairDye>(
				new TextDefinition[] { 1071387, 1071438 },
				1156676,
				0,
				0x9C6F,
				0,
			...
			Register<SpecialHairDye>(
				new TextDefinition[] { 1071387, 1071469 },
				1156676,
				0,
				0x9C71,
				0,
			...
			Register<SpecialHairDye>(
				new TextDefinition[] { 1071387, 1071472 },
				1156676,
				0,
				0x9C72,
				0,
			...
			Register<SpecialHairDye>(
				new TextDefinition[] { 1071387, 1071474 },
				1156676,
				0,
				0x9C70,
				0,
			...
			Register<SpecialHairDye>(
				new TextDefinition[] { 1071387, 1071473 },
				1156676,
				0,
				0x9C73,
				0,
			...
			Register<SpecialHairDye>(
				new TextDefinition[] { 1071387, 1071440 },
				1156676,
				0,
				0x9C76,
				0,
			...
			Register<SpecialHairDye>(
				new TextDefinition[] { 1071387, 1071437 },
				1156676,
				0,
				0x9C77,
				0,
			...
			Register<SpecialHairDye>(
				new TextDefinition[] { 1071387, 1071442 },
				1156676,
				0,
				0x9C74,
				0,
			...
			Register<SpecialHairDye>(
				new TextDefinition[] { 1071387, 1071441 },
				1156676,
				0,
				0x9C75,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1157275 },
				1156671,
				0,
				0x9CBF,
				0,
				400,
				cat,
				ConstructHaochisPigment
			); // Heartwood Sienna
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1157274 },
				1156671,
				0,
				0x9CBD,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1157273 },
				1156671,
				0,
				0x9CC2,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1157272 },
				1156671,
				0,
				0x9CC0,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1157269 },
				1156671,
				0,
				0x9CC1,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1070994 },
				1156906,
				0,
				0x9CA8,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1079584 },
				1156906,
				0,
				0x9CAF,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1070995 },
				1156906,
				0,
				0x9CA5,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1079580 },
				1156906,
				0,
				0x9CA4,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1079582 },
				1156906,
				0,
				0x9CA3,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1079581 },
				1156906,
				0,
				0x9CA2,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1070988 },
				1156906,
				0,
				0x9CA1,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1079585 },
				1156906,
				0,
				0x9CA2,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1070996 },
				1156906,
				0,
				0x9C9F,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1079586 },
				1156906,
				0,
				0x9C9E,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1079583 },
				1156906,
				0,
				0x9CA7,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1079587 },
				1156906,
				0,
				0x9CA9,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1070990 },
				1156906,
				0,
				0x9CAA,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1070992 },
				1156906,
				0,
				0x9CAF,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1070989 },
				1156906,
				0,
				0x9CAE,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1070991 },
				1156906,
				0,
				0x9CAD,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1070993 },
				1156906,
				0,
				0x9CAC,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1079579 },
				1156906,
				0,
				0x9CAB,
				0,
			...
			Register<PigmentsOfTokuno>(
				new TextDefinition[] { 1070933, 1070987 },
				1156906,
				0,
				0x9C9D,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1071246 },
				1156671,
				0,
				0x9CAF,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1018352 },
				1156671,
				0,
				0x9C83,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1071247 },
				1156671,
				0,
				0x9C7D,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1071245 },
				1156671,
				0,
				0x9C85,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1071244 },
				1156671,
				0,
				0x9C80,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1071248 },
				1156671,
				0,
				0x9C81,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1023856 },
				1156671,
				0,
				0x9C7F,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1115467 },
				1156671,
				0,
				0x9C82,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1115468 },
				1156671,
				0,
				0x9C7E,
				0,
			...
			Register<HaochisPigment>(
				new TextDefinition[] { 1071249, 1115471 },
				1156671,
				0,
				0x9C84,
				0,
			...
			Register<EarringsOfProtection>(
				new TextDefinition[] { 1156821, 1156822 },
				1156659,
				0,
				0x9C66,
				0,
			...
			Register<MountedPixieOrangeDeed>(
				new TextDefinition[] { 1074482, 1156912 },
				1156974,
				0x2A73,
				0,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1157015 },
				1156916,
				0,
				0x9CB5,
				0,
				200,
				cat,
				ConstructMiniHouseDeed
			); // two story wood & plaster
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011317 },
				1156916,
				0x22F5,
				0,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011307 },
				1156916,
				0x22E0,
				0,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011308 },
				1156916,
				0x22E1,
				0,
				0,
				...
				cat,
				ConstructMiniHouseDeed
			); // thathed-roof cottage
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011312 },
				1156916,
				0,
				0x9CB2,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011313 },
				1156916,
				0,
				0x9CB1,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011314 },
				1156916,
				0,
				0x9CB0,
				0,
			...
			Register<TableWithOrangeClothDeed>(
				new TextDefinition[] { 1157012, 1157013 },
				1156933,
				0x118E,
				0,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011320 },
				1156916,
				0x22F3,
				0,
				0,
				...
				cat,
				ConstructMiniHouseDeed
			); // sanstone house with patio
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011316 },
				1156916,
				0,
				0x9CB3,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011319 },
				1156916,
				0x2300,
				0,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1157014 },
				1156916,
				0,
				0x9CB6,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011315 },
				1156916,
				0,
				0x9CB4,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011309 },
				1156916,
				0,
				0x9CB7,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011304 },
				1156916,
				0x22C9,
				0,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011306 },
				1156916,
				0x22DF,
				0,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011305 },
				1156916,
				0x22DE,
				0,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011303 },
				1156916,
				0x22E1,
				0,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011318 },
				1156916,
				0x22FB,
				0,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011321 },
				1156916,
				0x22F6,
				0,
				0,
			...
			Register<MiniHouseDeed>(
				new TextDefinition[] { 1062096, 1011322 },
				1156916,
				0x22F4,
				0,
				0,
			...
			Register<TableWithPurpleClothDeed>(
				new TextDefinition[] { 1157011, 1157013 },
				1156929,
				0x118B,
				0,
				0,
			...
			Register<RaisedGardenDeed>(
				new TextDefinition[] { 1150359, 1156688 },
				1156680,
				0,
				0x9C8B,
				0,
				2000,
				cat,
				ConstructRaisedGarden
			);
			Register<HouseTeleporterTileBag>(
				new TextDefinition[] { 1156683, 1156826 },
				1156668,
				0x40B9,
				0,
				1201,
			...
			Register<ForgedMetalOfArtifacts>(
				new TextDefinition[] { 1149868, 1156686 },
				1156674,
				0,
				0x9C65,
				0,
				1000,
				cat,
				ConstructForgedMetal
			);
			Register<ForgedMetalOfArtifacts>(
				new TextDefinition[] { 1149868, 1156687 },
				1156675,
				0,
				0x9C65,
				0,
			...
			Register<MerchantsTrinket>(
				new TextDefinition[] { 1156827, 1156681 },
				1156666,
				0,
				0x9C67,
				0,
				300,
				cat,
				ConstructMerchantsTrinket
			);
			Register<MerchantsTrinket>(
				new TextDefinition[] { 1156828, 1156682 },
				1156667,
				0,
				0x9C67,
				0,
		...
		public static void Register<T>(
			...
			int cost,
			StoreCategory cat,
			Func<Mobile, StoreEntry, Item> constructor = null
		)
			where T : Item
		{
		...
		public static Item ConstructEarrings(Mobile m, StoreEntry entry)
		{
			...
			{
				case 1071092:
					ele = AosElementAttribute.Fire;
					break;
				case 1071093:
					ele = AosElementAttribute.Cold;
					break;
				case 1071094:
					ele = AosElementAttribute.Poison;
					break;
				case 1071095:
					ele = AosElementAttribute.Energy;
					break;
			}
		...
		public static Item ConstructMiniHouseDeed(Mobile m, StoreEntry entry)
		{
			...
			switch (label)
			{
				default:
					...
					return null;
				case 1157015:
					return new MiniHouseDeed(MiniHouseType.TwoStoryWoodAndPlaster);
				case 1157014:
					return new MiniHouseDeed(MiniHouseType.TwoStoryStoneAndPlaster);
			}
		}
		...
		{
			var item = new LampPost2 { Movable = true, LootType = LootType.Blessed };
		...
		public static Item ConstructForgedMetal(Mobile m, StoreEntry entry)
		{
			...
			{
				case 1156686:
					return new ForgedMetalOfArtifacts(10);
				case 1156687:
					return new ForgedMetalOfArtifacts(5);
			}
		...
		public static Item ConstructSoulstone(Mobile m, StoreEntry entry)
		{
			...
			{
				case 1078835:
					return new SoulstoneToken(SoulstoneType.Blue);
				case 1078834:
					return new SoulstoneToken(SoulstoneType.Green);
				case 1158404:
					return new SoulstoneToken(SoulstoneType.Violet);
			}
		...
		public static Item ConstructMerchantsTrinket(Mobile m, StoreEntry entry)
		{
			...
			{
				case 1156827:
					return new MerchantsTrinket(false);
				case 1156828:
					return new MerchantsTrinket(true);
			}
							...
							try
							{
								using (var op = File.AppendText("UltimaStoreError.log"))
								{
									...
									Utility.WriteConsoleColor(
										ConsoleColor.Red,
										"[Ultima Store]: Bad Constructor: {0}",
										entry.Key.ItemType.Name
									);
								}
							}
							catch { }
	...
	public sealed class UltimaStoreContainer : Container
	{
		...
		{
			get { return "Ultima Store Display Container"; }
		}
