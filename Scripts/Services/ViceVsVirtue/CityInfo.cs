	...
	public class CityInfo
	{
		...
		public static void Configure()
		{
			...
			Infos[VvVCity.Britain] = new CityInfo(
				...
				new Point3D[]
				{
					new Point3D(1453, 1554, 30),
					new Point3D(1462, 1650, 10),
					new Point3D(1514, 1640, 20),
					new Point3D(1490, 1740, 0),
				},
			...
			Infos[VvVCity.Minoc] = new CityInfo(
				...
				new Point3D[]
				{
					new Point3D(2507, 475, 15),
					new Point3D(2418, 497, 15),
					new Point3D(2467, 535, 15),
					new Point3D(2507, 593, 0),
				},
			...
			Infos[VvVCity.Moonglow] = new CityInfo(
				...
				new Point3D[]
				{
					new Point3D(4479, 1122, 0),
					new Point3D(4413, 1136, 6),
					new Point3D(4419, 111, 0),
					new Point3D(4387, 1107, 0),
				},
			...
			Infos[VvVCity.SkaraBrae] = new CityInfo(
				...
				new Point3D[]
				{
					new Point3D(651, 2163, 6),
					new Point3D(624, 2142, 0),
					new Point3D(574, 2152, 0),
					new Point3D(640, 2247, -2),
				},
			...
			Infos[VvVCity.Trinsic] = new CityInfo(
				...
				new Point3D[]
				{
					new Point3D(1846, 2688, 0),
					new Point3D(1824, 2685, 0),
					new Point3D(1845, 2744, 0),
					new Point3D(1903, 2715, 20),
				},
			...
			Infos[VvVCity.Yew] = new CityInfo(
				...
				new Point3D[]
				{
					new Point3D(453, 963, 0),
					new Point3D(334, 965, 0),
					new Point3D(613, 880, 0),
					new Point3D(640, 938, 6),
				},
