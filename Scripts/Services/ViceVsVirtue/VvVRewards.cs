...
namespace Server.Engines.VvV
{
	...
	public static class VvVRewards
	{
		...
		public static void Initialize()
		{
			...
			Rewards.Add(
				new CollectionItem(typeof(VvVSteedStatuette), 8484, 1155545, ViceVsVirtueSystem.VirtueHue, 500)
			); // Virtue War Horse
			Rewards.Add(new CollectionItem(typeof(VvVSteedStatuette), 8484, 1155545, ViceVsVirtueSystem.ViceHue, 500)); // Vice War Horse
			Rewards.Add(
				new CollectionItem(typeof(VvVSteedStatuette), 8501, 1155546, ViceVsVirtueSystem.VirtueHue, 500)
			); // Virtue War Ostard
