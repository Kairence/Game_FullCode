	...
	public class VvVAltar : BaseAddon
	{
		...
		public class OccupyTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				Effects.SendLocationEffect(
					new Point3D(Altar.X + p.X, Altar.Y + p.Y, Altar.Z + p.Z),
					Altar.Map,
					0x3709,
					30,
					10
	...
	public class AltarArrow : QuestArrow
	{
		...
		public void OnTick()
		{
			if (!Running)
			{
				...
				this.Mobile.NetState == null
				|| this.Mobile.Deleted
				|| Altar.Deleted
				|| this.Mobile.Map != Altar.Map
				|| ViceVsVirtueSystem.Instance.Battle == null
				|| !ViceVsVirtueSystem.Instance.Battle.OnGoing
				|| !this.Mobile.Region.IsPartOf(ViceVsVirtueSystem.Instance.Battle.Region)
