...
namespace Server.Engines.VvV
{
	...
	public class VvVPotionKeg : Item
	{
			...
			: base(6870)
		{
			...
			{
				default:
				case PotionType.AntiParalysis:
					Hue = 2543;
					break;
				case PotionType.Supernova:
					Hue = 13;
					break;
				case PotionType.StatLossRemoval:
					Hue = 2500;
					break;
				case PotionType.GreaterStamina:
					Hue = 437;
					break;
			}
		}
		...
		public override void OnDoubleClick(Mobile m)
		{
			if (IsChildOf(m.Backpack))
			{
				...
				else
				{
					...
					{
						case PotionType.AntiParalysis:
							potion = new AntiParalysisPotion();
							break;
						case PotionType.Supernova:
							potion = new SupernovaPotion();
							break;
						case PotionType.StatLossRemoval:
							potion = new StatLossRemovalPotion();
							break;
						case PotionType.GreaterStamina:
							potion = new GreaterStaminaPotion();
							break;
					}
	...
	public abstract class VvVPotion : Item, IFactionItem
	{
		...
		public virtual PotionType CooldownType
		{
			get { return PotionType.None; }
		}

		public static Dictionary<Mobile, Dictionary<PotionType, DateTime>> _Cooldown =
			new Dictionary<Mobile, Dictionary<PotionType, DateTime>>();
	...
	{
		public override PotionType CooldownType
		{
			get { return PotionType.AntiParalysis; }
		}
	...
	public class SupernovaPotion : VvVPotion
	{
		...
		public override PotionType CooldownType
		{
			get { return PotionType.Supernova; }
		}
		...
		public override void Use(Mobile m)
		{
			Effects.SendMovingEffect(
				m,
				new Entity(Serial.Zero, new Point3D(m.X, m.Y, m.Z + 25), m.Map),
				this.ItemID,
				3,
				0,
				false,
			...
			Timer.DelayCall(
				...
				() =>
				{
					...
					foreach (Mobile mob in eable)
					{
						if (
							mob != m
							&& Server.Spells.SpellHelper.ValidIndirectTarget(m, mob)
							&& m.CanBeHarmful(mob, false)
						)
						{
							m.DoHarmful(mob);
	...
	public class StatLossRemovalPotion : VvVPotion
	{
		...
		public override PotionType CooldownType
		{
			get { return PotionType.StatLossRemoval; }
		}
	...
	public class GreaterStaminaPotion : VvVPotion
	{
		...
		public override PotionType CooldownType
		{
			get { return PotionType.GreaterStamina; }
		}
