...
namespace Server.Engines.VvV
{
	...
	public class VvVTrap : Item, IRevealableItem
	{
		...
		public virtual VvVTrapType TrapType
		{
			get { return VvVTrapType.Explosion; }
		}

		public static int HiddenID = 8600;
		public static int VisibleID = 39818;

		public VvVTrap(Mobile owner, DeploymentType type)
			: base(HiddenID)
		{
			Owner = owner;
			DeploymentType = type;
		...
		public override void OnMovement(Mobile m, Point3D oldLocation)
		{
			if (
				...
				&& m.InRange(this.Location, 3)
				&& ViceVsVirtueSystem.IsEnemy(m, Owner)
			)
			{
				Detonate(m);
			}
		...
		public bool IsEnemy(Mobile m)
		{
			...
			return ViceVsVirtueSystem.IsVvV(m)
				&& ViceVsVirtueSystem.IsVvV(Owner)
				&& ViceVsVirtueSystem.IsEnemy(m, Owner);
		}
	...
	public class VvVPoisonTrap : VvVTrap
	{
		...
		public override VvVTrapType TrapType
		{
			get { return VvVTrapType.Poison; }
		}
		...
		public VvVPoisonTrap(Serial serial)
			: base(serial) { }
	...
	public class VvVColdTrap : VvVTrap
	{
		...
		public VvVColdTrap(Serial serial)
			: base(serial) { }
	...
	public class VvVEnergyTrap : VvVTrap
	{
		...
		public VvVEnergyTrap(Serial serial)
			: base(serial) { }
	...
	public class VvVBladeTrap : VvVTrap
	{
		...
		public VvVBladeTrap(Serial serial)
			: base(serial) { }
