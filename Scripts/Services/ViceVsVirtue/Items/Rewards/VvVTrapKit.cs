...
namespace Server.Engines.VvV
{
	public class VvVTrapKit : Item
	{
		...
		[Constructable]
		public VvVTrapKit(VvVTrapType type)
			: base(7866)
		{
			TrapType = type;
							...
							else
							{
								...
								else
								{
									m.PrivateOverheadMessage(
										...
										1155411,
										m.NetState
									); // *You successfully lay the tripwire*
								}
							}
						}
						else
		...
		public VvVTrap ConstructTrap(Mobile m)
		{
			...
			{
				case VvVTrapType.Explosion:
					return new VvVExplosionTrap(m, this.DeploymentType);
				case VvVTrapType.Poison:
					return new VvVPoisonTrap(m, this.DeploymentType);
				case VvVTrapType.Cold:
					return new VvVColdTrap(m, this.DeploymentType);
				case VvVTrapType.Energy:
					return new VvVEnergyTrap(m, this.DeploymentType);
				case VvVTrapType.Blade:
					return new VvVBladeTrap(m, this.DeploymentType);
			}
		...
		public VvVTrapKit(Serial serial)
			: base(serial) { }
