	...
	public class BattleStatsGump : Gump
	{
			...
			: base(50, 50)
		{
			...
			AddHtml(
				...
				20,
				String.Format(
					"<basefont color=#B22222>{0} [{1}] has won the battle!",
					leader.Guild.Name,
					leader.Guild.Abbreviation
				),
				false,
				false
			);
			...
			if (leader.Guild.Alliance != null)
			{
				AddHtml(
					...
					20,
					String.Format(
						"<basefont color=#B22222>The {0} Alliance has won the battle!",
						leader.Guild.Alliance.Name
					),
					false,
					false
				);
			...
			AddHtmlLocalized(
				...
				20,
				1154947,
				team.Silver.ToString("N0", CultureInfo.GetCultureInfo("en-US")),
				Color16,
				false,
				false
			); // Total Silver Points: ~1_val~
			y += 25;
			...
			AddHtmlLocalized(
				...
				20,
				1154948,
				team.Score.ToString("N0", CultureInfo.GetCultureInfo("en-US")),
				Color16,
				false,
				false
			); // Total Score: ~1_val~
			...
			AddHtmlLocalized(
				...
				20,
				1154949,
				team.Kills.ToString("N0", CultureInfo.GetCultureInfo("en-US")),
				Color16,
				false,
				false
			);
			...
			AddHtmlLocalized(
				...
				20,
				1154950,
				team.Assists.ToString("N0", CultureInfo.GetCultureInfo("en-US")),
				Color16,
				false,
				false
			);
			...
			AddHtmlLocalized(
				...
				20,
				1154951,
				team.Deaths.ToString("N0", CultureInfo.GetCultureInfo("en-US")),
				Color16,
				false,
				false
			);
			...
			AddHtmlLocalized(
				...
				20,
				1154952,
				team.Stolen.ToString("N0", CultureInfo.GetCultureInfo("en-US")),
				Color16,
				false,
				false
			);
			...
			AddHtmlLocalized(
				...
				20,
				1154953,
				team.ReturnedSigils.ToString("N0", CultureInfo.GetCultureInfo("en-US")),
				Color16,
				false,
				false
			);
			...
			AddHtmlLocalized(
				...
				20,
				1154954,
				team.ViceReturned.ToString("N0", CultureInfo.GetCultureInfo("en-US")),
				Color16,
				false,
				false
			);
			...
			AddHtmlLocalized(
				...
				20,
				1154955,
				team.VirtueReturned.ToString("N0", CultureInfo.GetCultureInfo("en-US")),
				Color16,
				false,
				false
			);
			...
			AddHtmlLocalized(
				...
				20,
				1154956,
				team.Disarmed.ToString("N0", CultureInfo.GetCultureInfo("en-US")),
				Color16,
				false,
				false
			);
