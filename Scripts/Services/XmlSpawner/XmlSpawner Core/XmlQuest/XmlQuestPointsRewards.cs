...
namespace Server.Engines.XmlSpawner2
{
	public class XmlQuestPointsRewards
	{
		...
		public static List<XmlQuestPointsRewards> RewardsList
		{
		...
		public static void Initialize()
		{
			...
			PointsRewardList.Add(
				new XmlQuestPointsRewards(200, typeof(ColoredAnvil), "Colored Anvil", 400, 0xFAF, 0, 5, null)
			);
			PointsRewardList.Add(
				new XmlQuestPointsRewards(
					100,
			...
			PointsRewardList.Add(
				new XmlQuestPointsRewards(0, typeof(RidableLlama), "Ridable Llama", 1, 0x20f6, 0, -15, null)
			);
