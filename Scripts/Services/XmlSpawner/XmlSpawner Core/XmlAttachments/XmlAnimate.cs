...
namespace Server.Engines.XmlSpawner2
{
	public class XmlAnimate : XmlAttachment
	{
		...
		{
			get { return this.m_ProximityRange; }
			set { this.m_ProximityRange = value; }
		}
		...
		{
			get { return this.m_AnimationDelay; }
			set { this.m_AnimationDelay = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public bool Repeat
		{
			get { return this.m_Repeat; }
		...
		public bool Forward
		{
			get { return this.m_Forward; }
			set { this.m_Forward = value; }
		}
		...
		{
			get { return this.m_ActivationWord; }
			set { this.m_ActivationWord = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public TimeSpan Refractory
		{
			get { return this.m_Refractory; }
			set { this.m_Refractory = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int LoopCount
		{
			get { return this.m_LoopCount; }
			set { this.m_LoopCount = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int LoopDelay
		{
			get { return this.m_LoopDelay; }
			set { this.m_LoopDelay = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int CurrentCount
		{
			get { return this.m_CurrentCount; }
			set { this.m_CurrentCount = value; }
		}
		...
		{
			get { return (this.ActivationWord != null); }
		}
		public override bool HandlesOnMovement
		{
			get { return (this.ProximityRange >= 0 && this.ActivationWord == null); }
		}
		...
		public override string OnIdentify(Mobile from)
		{
			...
			string msg = String.Format(
				"Animation #{0},{1} : {2} secs between uses",
				this.AnimationValue,
				this.FrameCount,
				this.Refractory.TotalSeconds
			);
		...
		public override void OnMovement(MovementEventArgs e)
		{
			...
			if (
				this.AttachedTo is Item
				&& (((Item)this.AttachedTo).Parent == null)
		...
		public void Animate()
		{
			...
			{
				((Mobile)this.AttachedTo).Animate(
					this.AnimationValue,
					this.FrameCount,
					this.RepeatCount,
					this.Forward,
