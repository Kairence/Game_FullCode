	...
	public class SpawnerExporter
	{
		public static void Initialize()
		{
			...
			CommandSystem.Register(
				...
				new CommandEventHandler(ImportSpawners_OnCommand)
			);
		}
		...
		public class ExportSpawnerCommand : BaseCommand
		{
			public ExportSpawnerCommand()
			{
				...
				Supports =
					CommandSupport.Area
					| CommandSupport.Region
					| CommandSupport.Global
					| CommandSupport.Multi
			...
			public override void ExecuteList(CommandEventArgs e, ArrayList list)
			{
				...
				AddResponse(
					String.Format("{0} spawners exported to Saves/Spawners/{1}.", spawners.Count.ToString(), filename)
				);
