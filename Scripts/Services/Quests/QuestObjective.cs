...
namespace Server.Engines.Quests
{
	public abstract class QuestObjective
	{
		...
		{
			get { return this.m_HasBeenRead; }
			set { this.m_HasBeenRead = value; }
		}
		public int CurProgress
		{
			get { return this.m_CurProgress; }
			set
			{
		...
		{
			get { return this.m_HasCompleted; }
			set { this.m_HasCompleted = value; }
		}
		public virtual bool Completed
		{
			get { return this.m_CurProgress >= this.MaxProgress; }
		}
		public bool IsSingleObjective
		{
			get { return (this.MaxProgress == 1); }
		}
