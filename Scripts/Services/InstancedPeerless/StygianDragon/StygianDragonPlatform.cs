...
namespace Server.Engines.InstancedPeerless
{
	public class StygianDragonPlatform : PeerlessPlatform
	{
		...
		{
			get { return typeof(DraconicOrb); }
		}
		public override Type BossType
		{
			get { return typeof(StygianDragon); }
		}
		...
		public override void AddInstances()
		{
			AddInstance(
				...
				7,
				Map.TerMur,
				new Point3D(80, 366, 0),
				new Point3D(61, 366, 20),
				new Rectangle2D(0, 286, 136, 176)
			);
			AddInstance(
				-1,
				0,
				8,
				Map.TerMur,
				new Point3D(80, 564, 0),
				new Point3D(61, 564, 20),
				new Rectangle2D(0, 485, 136, 176)
			);
			AddInstance(
				0,
				1,
				7,
				Map.TerMur,
				new Point3D(80, 772, 0),
				new Point3D(61, 772, 20),
				new Rectangle2D(0, 684, 136, 176)
			);
		}
