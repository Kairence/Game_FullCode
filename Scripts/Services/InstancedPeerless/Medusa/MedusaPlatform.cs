...
namespace Server.Engines.InstancedPeerless
{
	public class MedusaPlatform : PeerlessPlatform
	{
		...
		{
			get { return typeof(RareSerpentEgg); }
		}
		public override Type BossType
		{
			get { return typeof(Medusa); }
		}
		...
		public override void AddInstances()
		{
			AddInstance(
				...
				7,
				Map.TerMur,
				new Point3D(776, 928, -5),
				new Point3D(818, 927, -15),
				new Rectangle2D(760, 887, 95, 81)
			);
			AddInstance(
				1,
				0,
				7,
				Map.TerMur,
				new Point3D(776, 1094, -5),
				new Point3D(818, 1093, -15),
				new Rectangle2D(760, 1057, 95, 81)
			);
			AddInstance(
				0,
				1,
				7,
				Map.TerMur,
				new Point3D(776, 1264, -5),
				new Point3D(818, 1263, -15),
				new Rectangle2D(760, 1230, 95, 81)
			);
		}
