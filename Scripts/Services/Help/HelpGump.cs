	...
	public class ContainedMenu : QuestionMenu
	{
		...
		public ContainedMenu(Mobile from)
			: base(
				...
				new string[] { "Leave my old help request like it is.", "Remove my help request from the queue." }
			)
		{
			this.m_From = from;
		}
			...
			: base(0, 0)
		{
			...
			if (isYoung)
			{
				...
				this.AddHtml(
					...
					450,
					58,
					@"<u>Another player is harassing me.</u> Another player is verbally harassing your character. When you select this option you will be sending a text log to Origin Systems. To see what constitutes harassment please visit "
						+ (SupportWebsite == null ? "http://support.uo.com/gm_9.html" : SupportWebsite)
						+ ".",
					true,
					true
				);
				...
				this.AddHtml(
					...
					450,
					58,
					@"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories or is not addressed on the Support web page (located at  "
						+ (SupportWebsite == null ? "http://support.uo.com" : SupportWebsite)
			...
			this.AddHtml(
				...
				@"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories or is not addressed on the Support web page (located at "
					+ (SupportWebsite == null ? "http://support.uo.com" : SupportWebsite)
					+ ", and requires in-game assistance, use this option. ",
				true,
				true
			);
