...
namespace Server.Items
{
	...
	public class ExperimentalGem : BaseDecayingItem
	{
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public bool IsExtremeHue
		{
			get { return m_IsExtremeHue; }
		}
		...
		{
			get { return m_ToComplete; }
			set { m_ToComplete = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int CurrentHue
		{
			get { return m_CurrentHue; }
		}
		...
		private void OnPuzzleFailed(Mobile m)
		{
			if (m != null)
			{
				...
				Effects.SendLocationParticles(
					EffectItem.Create(p, m.Map, EffectItem.DefaultDuration),
					0x3728,
					10,
					10,
					5023
		...
		private class InternalTimer : Timer
		{
			...
			public InternalTimer(ExperimentalGem gem)
		...
		public static int GetExtreme(int hue)
		{
			...
			{
				case 0x4B2:
					return Red; // Pink to Red
				case 0x481:
					return Blue; // White to Blue
				case 0x30:
					return Brown; // Orange to Brown
				case 0x3D:
					return DarkGreen; // LightGreen to DarkGreen
			}
		...
		public static int GetRegular(int hue)
		{
			...
			{
				case 0x26:
					return Pink; // Red to Pink
				case 0x4:
					return White; // Blue to White
				case 0x747:
					return Orange; // Brown to Orange
				case 0x557:
					return LightGreen; // DarkGreen to LightGreen
			}
		...
		public int[] RegularHues = new int[] { White, Pink, LightGreen, Orange };

		private int[] ExtremeHues = new int[] { Red, Blue, Brown, DarkGreen };
		...
		public ExperimentalGem(Serial serial)
			: base(serial) { }
		...
		private class InternalGump : Gump
		{
			...
			public InternalGump(ExperimentalGem gem)
				: base(50, 50)
			{
				m_Gem = gem;
