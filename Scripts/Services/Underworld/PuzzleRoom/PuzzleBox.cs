...
namespace Server.Items
{
	...
	public class PuzzleBox : Item
	{
		...
		{
			get { return m_PuzzleType; }
			set { m_PuzzleType = value; }
		}
		...
		[Constructable]
		public PuzzleBox(PuzzleType type)
			: base(2472)
		{
			m_PuzzleType = type;
			Movable = false;
		...
		public override void OnDoubleClick(Mobile from)
		{
			...
			else if (from.Backpack != null)
			{
				...
				if (key == null)
				{
					...
					Effects.SendLocationParticles(
						EffectItem.Create(p, from.Map, EffectItem.DefaultDuration),
						0x3728,
						10,
						10,
						5023
				...
				switch (m_PuzzleType)
				{
					...
					case PuzzleType.EastBox:
						needed = typeof(MagicKey);
						break;
					case PuzzleType.NorthBox:
						needed = typeof(GoldPuzzleKey);
						break;
				}
