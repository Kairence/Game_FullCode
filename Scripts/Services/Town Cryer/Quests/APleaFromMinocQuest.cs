...
namespace Server.Engines.Quests
{
	...
	public class ClearingCovetousQuest : BaseQuest
	{
		...
		{
			get { return 1158267; }
		} // You've cleared enough creatures to allow the miners of
	...
	public class SheriffOfMinoc : MondainQuester
	{
		...
		public override void OnDoubleClick(Mobile m)
		{
			if (m is PlayerMobile)
			{
				...
				if (QuestHelper.CheckDoneOnce(pm, typeof(APleaFromMinocQuest), this, false))
				{
					...
					BaseQuest q = QuestHelper.RandomQuest(
						pm,
						new Type[] { typeof(ClearingCovetousQuest) },
						this,
						false
					);
		...
		{
			typeof(ClearingCovetousQuest),
			typeof(AForcedSacraficeQuest),
			typeof(AForcedSacraficeQuest2),
		};
