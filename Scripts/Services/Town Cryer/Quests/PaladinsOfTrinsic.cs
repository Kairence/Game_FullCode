...
namespace Server.Engines.Quests
{
	public class PaladinsOfTrinsic : BaseQuest
	{
		...
		{
			get { return QuestChain.PaladinsOfTrinsic; }
		}
		public override Type NextQuest
		{
			get { return typeof(PaladinsOfTrinsic2); }
		}
	...
	public class Morz : MondainQuester
	{
		...
		{
			get { return new Type[] { typeof(PaladinsOfTrinsic) }; }
		}
		...
		public override void OnDoubleClick(Mobile m)
		{
			...
			{
				PaladinsOfTrinsic quest =
					QuestHelper.GetQuest((PlayerMobile)m, typeof(PaladinsOfTrinsic)) as PaladinsOfTrinsic;
				...
				{
					PaladinsOfTrinsic2 quest2 =
						QuestHelper.GetQuest((PlayerMobile)m, typeof(PaladinsOfTrinsic2)) as PaladinsOfTrinsic2;
