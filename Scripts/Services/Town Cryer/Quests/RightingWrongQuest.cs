...
namespace Server.Engines.Quests
{
	public class RightingWrongQuest : BaseQuest
	{
		...
		{
			get { return 1158291; }
		} // You've found the Royal Guard Captain! Speak to him to learn more!
	...
	public class RightingWrongQuest2 : BaseQuest
	{
		...
		{
			get { return QuestChain.RightingWrong; }
		}
		public override Type NextQuest
		{
			get { return typeof(RightingWrongQuest3); }
		}
	...
	public class RightingWrongQuest3 : BaseQuest
	{
		...
		public override Type NextQuest
		{
			get { return typeof(RightingWrongQuest4); }
		}
	...
	public class RightingWrongQuest4 : BaseQuest
	{
		...
		private class InternalObjective : BaseObjective
		{
			...
			{
				get { return 1158164; }
			} // Find the fallen Guard's corpse and escape the prison.
	...
	public class Arnold : MondainQuester
	{
		...
		{
			get { return new Type[] { typeof(RightingWrongQuest2) }; }
		}
