...
namespace Server.Engines.Quests
{
	public class BuriedRichesQuest : BaseQuest
	{
		...
		public override int CompleteMessage
		{
			get { return 1156585; }
		} // You've completed a quest!

		public override int AcceptSound
		{
			get { return 0x2E8; }
		}
		...
		private class InternalObjective : BaseObjective
		{
			...
			{
				get { return 1158231; }
			} // Visit the Legendary Cartographer at the The Majestic Boat in Vesper.
	...
	public class ToolsOfTheTradeQuest : BaseQuest
	{
		...
		private class InternalObjective : BaseObjective
		{
			...
			{
				get { return 1158228; }
			} // Visit the Adventurer's Supplies in Northern Vesper, just across the bridge, and speak to the Master Provisioner to get some basic treasure hunting equipment.
	...
	public class TheTreasureChaseQuest : BaseQuest
	{
		...
		{
			get { return 1158247; }
		} //You have found the final zealot treasure! There are no doubt riches to be had within! Your experience has earned you a
	...
	public class LegendaryCartographer : MondainQuester
	{
		...
		{
			get { return new Type[] { typeof(ToolsOfTheTradeQuest) }; }
		}
		...
		public override void OnDoubleClick(Mobile m)
		{
			if (
				m is PlayerMobile
				&& !QuestHelper.CheckDoneOnce((PlayerMobile)m, typeof(BuriedRichesQuest), this, false)
			)
			{
	...
	public class MasterProvisioner : MondainQuester
	{
		public override Type[] Quests
		{
			get { return new Type[] { typeof(TheTreasureChaseQuest) }; }
		}
