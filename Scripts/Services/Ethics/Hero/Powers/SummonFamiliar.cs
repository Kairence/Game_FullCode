...
namespace Server.Ethics.Hero
{
	public sealed class SummonFamiliar : Power
	{
		...
		{
			this.m_Definition = new PowerDefinition(5, "Summon Familiar", "Trubechs Vingir", "");
		}
		...
		public override void BeginInvoke(Player from)
		{
			...
			if (
				Mobiles.BaseCreature.Summon(familiar, from.Mobile, from.Mobile.Location, 0x217, TimeSpan.FromHours(1.0))
			)
			{
