...
namespace Server.Ethics
{
	public class EthicDefinition
	{
		...
		public EthicDefinition(
			...
			TextDefinition adjunct,
			TextDefinition joinPhrase,
			Power[] powers
		)
		{
		...
		{
			get { return this.m_Adjunct; }
		}
		public TextDefinition JoinPhrase
		{
			get { return this.m_JoinPhrase; }
		}
		public Power[] Powers
		{
			get { return this.m_Powers; }
		}
	}
}
