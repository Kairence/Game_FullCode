...
namespace Server.Engines.ArenaSystem
{
	...
	public class PVPArena
	{
		...
		public void ConfigureArena()
		{
			...
			if (GuardRegion == null)
			{
				GuardRegion = new GuardedArenaRegion(
					String.Format("{0}_Guarded", Definition.Name),
					Definition.Map,
					Definition.GuardBounds
				);
		...
		{
			return PendingDuels
				.Keys.Where(d => d.RoomType == RoomType.Public && d.ParticipantCount < d.Entries)
				.ToList();
		}
