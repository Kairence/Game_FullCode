...
namespace Server.Engines.ArenaSystem
{
	...
	public class ArenaDefinition
	{
		...
		public static ArenaDefinition[] Definitions
		{
		...
		{
			LostLandsTrammel = new ArenaDefinition(
				"Lostland (T)",
				1,
				...
				new Rectangle2D[] { new Rectangle2D(6070, 3713, 27, 16) },
				new Rectangle2D[] { new Rectangle2D(6059, 3697, 53, 56) },
				new Rectangle2D(6099, 3718, 5, 7),
				new Rectangle2D(6097, 3729, 2, 2)
			);

			LostLandsFelucca = new ArenaDefinition(
				"Lostland (F)",
				0,
				new Point3D(6102, 3721, 25),
				new Point3D(6097, 3730, 20),
			...
			HavenTrammel = new ArenaDefinition(
				"New Haven (T)",
				1,
				...
				new Rectangle2D[] { new Rectangle2D(3760, 2761, 25, 16) },
				new Rectangle2D[] { new Rectangle2D(3740, 2747, 63, 51) },
				new Rectangle2D(3791, 2766, 4, 9),
				new Rectangle2D(3790, 2781, 2, 5)
			);

			HavenFelucca = new ArenaDefinition(
				"New Haven (F)",
				0,
				...
				new Rectangle2D[] { new Rectangle2D(3749, 2757, 25, 16) },
				new Rectangle2D[] { new Rectangle2D(3735, 2747, 68, 51) },
