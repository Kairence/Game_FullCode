...
namespace Server.Items
{
	public class RefinementAmalgamator : Item
	{
		...
		public void CheckCombine(Mobile m, RefinementComponent component)
		{
			...
			{
				if (
					ToUpgrade.RefinementType != component.RefinementType
		...
		private int GetCombineTotal(ModType type)
		{
			...
			{
				default:
				case ModType.Defense:
					return 2;
				case ModType.Protection:
					return 3;
				case ModType.Hardening:
					return 4;
				case ModType.Fortification:
					return 5;
				case ModType.Invulnerability:
					return -1;
			}
		}
