	...
	public class SphynxFortune
	{
		...
		public static void ApplyFortune(Mobile from, Mobile m)
		{
			...
			switch (Utility.Random(20))
			{
				...
				{
					Fountains.Add(
						new SphynxFortuneArray
						{
							Mobile = from,
							Date = DateTime.UtcNow,
							Type = EnumType.ResistanceType,
							TypeValue = EnumTypeValue.Physical,
							Value = Utility.RandomMinMax(1, 10),
						}
					);
				...
				case 1:
				{
					Fountains.Add(
						new SphynxFortuneArray
						{
							...
							Type = EnumType.ResistanceType,
							TypeValue = EnumTypeValue.Physical,
							Value = Utility.RandomMinMax(-1, -15),
						}
					);
				...
				case 6:
				{
					Fountains.Add(
						new SphynxFortuneArray
						{
							...
							Date = DateTime.UtcNow,
							Type = EnumType.ResistanceType,
							TypeValue = EnumTypeValue.Poison,
							Value = Utility.RandomMinMax(1, 10),
						}
					);
				...
				case 8:
				{
					Fountains.Add(
						new SphynxFortuneArray
						{
							...
							Date = DateTime.UtcNow,
							Type = EnumType.ResistanceType,
							TypeValue = EnumTypeValue.Energy,
							Value = Utility.RandomMinMax(1, 10),
						}
					);
				...
				case 10:
				{
					Fountains.Add(
						new SphynxFortuneArray
						{
							Mobile = from,
							Date = DateTime.UtcNow,
							Type = EnumType.AosAttribute,
							TypeValue = EnumTypeValue.Luck,
							Value = Utility.RandomMinMax(10, 50),
						}
					);
				...
				case 12:
				{
					Fountains.Add(
						new SphynxFortuneArray
						{
							...
							Date = DateTime.UtcNow,
							Type = EnumType.AosAttribute,
							TypeValue = EnumTypeValue.EnhancePotions,
							Value = Utility.RandomMinMax(5, 25),
						}
					);
				...
				case 14:
				{
					Fountains.Add(
						new SphynxFortuneArray
						{
							...
							Type = EnumType.AosAttribute,
							TypeValue = EnumTypeValue.Luck,
							Value = Utility.RandomMinMax(10, 100),
						}
					);
				...
				case 16:
				{
					Fountains.Add(
						new SphynxFortuneArray
						{
							...
							Date = DateTime.UtcNow,
							Type = EnumType.AosAttribute,
							TypeValue = EnumTypeValue.DefendChance,
							Value = Utility.RandomMinMax(1, 10),
						}
					);
				...
				case 18:
				{
					Fountains.Add(
						new SphynxFortuneArray
						{
							...
							Date = DateTime.UtcNow,
							Type = EnumType.AosAttribute,
							TypeValue = EnumTypeValue.RegenMana,
							Value = Utility.RandomMinMax(1, 3),
						}
					);
		...
		public static int GetResistanceBonus(Mobile from, ResistanceType type)
		{
			return Fountains
				.Where(x =>
					x.Mobile == from
					&& (x.Type == EnumType.ResistanceType)
					&& Enum.GetName(typeof(ResistanceType), type) == x.TypeValue.ToString()
				)
				.Sum(y => y.Value);
		}
		...
		public static int GetAosAttributeBonus(Mobile from, AosAttribute type)
		{
			return Fountains
				.Where(x =>
					x.Mobile == from
					&& (x.Type == EnumType.AosAttribute)
					&& Enum.GetName(typeof(AosAttribute), type) == x.TypeValue.ToString()
				)
				.Sum(y => y.Value);
		}
		...
		public static void StartTimer()
		{
			...
			m_Timer = Timer.DelayCall(
				...
				TimeSpan.FromMinutes(1),
				new TimerCallback(DefragTables)
			);
			m_Timer.Start();
		}
