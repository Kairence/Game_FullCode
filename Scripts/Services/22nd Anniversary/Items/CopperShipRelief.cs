...
namespace Server.Items
{
	public class CopperShipReliefAddon : BaseAddon
	{
		...
		{
			get { return new CopperShipReliefAddonDeed(DisplayName); }
		}
		...
		public override void Deserialize(GenericReader reader)
		{
			...
			if (version == 0)
			{
				_DisplayName = CopperShipReliefAddonDeed._Names[
					Utility.Random(CopperShipReliefAddonDeed._Names.Length)
				];
			}
			else
			{
	...
	public class CopperShipReliefAddonDeed : BaseAddonDeed, IRewardOption
	{
		...
		{
			get { return new CopperShipReliefAddon(Facing, DisplayName); }
		}
