...
namespace Server.Items
{
	public class PowderOfFortKeg : Item
	{
		...
		{
			get { return 1157221; }
		} // A specially lined keg for powder of fortification.
		...
		public override void OnDoubleClick(Mobile from)
		{
			...
			{
				PowderOfTemperament powder =
					from.Backpack.FindItemByType(typeof(PowderOfTemperament)) as PowderOfTemperament;
