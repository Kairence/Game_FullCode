...
namespace Server.Engines.BulkOrders
{
	public class SmallFletchingBOD : SmallBOD
	{
		...
		public override List<Item> ComputeRewards(bool full)
		{
			...
			RewardGroup rewardGroup = FletchingRewardCalculator.Instance.LookupRewards(
				FletchingRewardCalculator.Instance.ComputePoints(this)
			);
