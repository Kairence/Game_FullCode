...
namespace Server.Engines.BulkOrders
{
	...
	public class BODCollectionItem : CollectionItem
	{
		...
		public BODCollectionItem(
			int itemID,
			int tooltip,
			int hue,
			double points,
			ConstructCallback constructor,
			int type = 0
		)
	...
	public abstract class RewardCalculator
	{
		...
		protected static Item NaturalDye(int type)
		{
			switch (type)
			{
				default:
				case 0:
					return new SpecialNaturalDye(DyeType.WindAzul);
				case 1:
					return new SpecialNaturalDye(DyeType.DullRuby);
				case 2:
					return new SpecialNaturalDye(DyeType.PoppieWhite);
				case 3:
					return new SpecialNaturalDye(DyeType.WindAzul, true);
				case 4:
					return new SpecialNaturalDye(DyeType.UmbranViolet, true);
				case 5:
					return new SpecialNaturalDye(DyeType.ZentoOrchid, true);
				case 6:
					return new SpecialNaturalDye(DyeType.DullRuby, true);
				case 7:
					return new SpecialNaturalDye(DyeType.PoppieWhite, true);
				case 8:
					return new SpecialNaturalDye(DyeType.UmbranViolet);
				case 9:
					return new SpecialNaturalDye(DyeType.ZentoOrchid);
			}
		}
		...
		protected static Item Recipe(int type)
		{
			...
			{
				case 0:
					return new RecipeScroll(170);
				case 1:
					return new RecipeScroll(457);
				case 2:
					return new RecipeScroll(458);
				case 3:
					return new RecipeScroll(800);
				case 4:
					return new RecipeScroll(599);
			}
	...
	public sealed class SmithRewardCalculator : RewardCalculator
	{
		public SmithRewardCalculator()
		{
			if (BulkOrderSystem.NewSystemEnabled)
			{
				...
				RewardCollection.Add(
					new BODCollectionItem(
						0x2F5B,
						1152674,
						CraftResources.GetHue(CraftResource.Gold),
						350,
						SmeltersTalisman,
						(int)CraftResource.Gold
					)
				);
				...
				RewardCollection.Add(
					new BODCollectionItem(
						0x2F5B,
						1152675,
						CraftResources.GetHue(CraftResource.Agapite),
						475,
						SmeltersTalisman,
						(int)CraftResource.Agapite
					)
				);
				...
				RewardCollection.Add(
					new BODCollectionItem(
						0x13E3,
						1157092,
						CraftResources.GetHue(CraftResource.DullCopper),
						500,
						RunicHammer,
						1
					)
				...
				RewardCollection.Add(
					new BODCollectionItem(
						0x2F5B,
						1152676,
						CraftResources.GetHue(CraftResource.Verite),
						525,
						SmeltersTalisman,
						(int)CraftResource.Verite
					)
				);
				RewardCollection.Add(
					new BODCollectionItem(
						0x13E3,
						1157093,
						CraftResources.GetHue(CraftResource.ShadowIron),
						550,
						RunicHammer,
						2
					)
				...
				RewardCollection.Add(
					new BODCollectionItem(
						0x2F5B,
						1152677,
						CraftResources.GetHue(CraftResource.Valorite),
						575,
						SmeltersTalisman,
						(int)CraftResource.Valorite
					)
				);
				RewardCollection.Add(
					new BODCollectionItem(
				...
				RewardCollection.Add(
					new BODCollectionItem(
						0x13E3,
						1157094,
						CraftResources.GetHue(CraftResource.Copper),
						650,
						RunicHammer,
						3
					)
				...
				RewardCollection.Add(
					new BODCollectionItem(
						0x13E3,
						1157095,
						CraftResources.GetHue(CraftResource.Bronze),
						700,
						RunicHammer,
						4
					)
		...
		)
		{
			...
			if (
				itemCount == 1
				&& BulkOrderSystem.NewSystemEnabled
				&& BulkOrderSystem.ComputeGold(type, quantity, out gold)
			)
			{
				return gold;
			}
	...
	public sealed class TailorRewardCalculator : RewardCalculator
	{
			...
			if (BulkOrderSystem.NewSystemEnabled)
			{
				...
				RewardCollection.Add(
					new BODCollectionItem(
						0xF9D,
						1157115,
						CraftResources.GetHue(CraftResource.SpinedLeather),
						350,
						RunicKit,
						1
					)
				...
				RewardCollection.Add(
					new BODCollectionItem(
						0xF9D,
						1157116,
						CraftResources.GetHue(CraftResource.HornedLeather),
						600,
						RunicKit,
						2
					)
				...
				RewardCollection.Add(
					new BODCollectionItem(
						0xF9D,
						1157117,
						CraftResources.GetHue(CraftResource.BarbedLeather),
						700,
						RunicKit,
						3
					)
		...
		)
		{
			...
			int mtrlIndex = (
				material == BulkMaterialType.Barbed ? 3
				: material == BulkMaterialType.Horned ? 2
				: material == BulkMaterialType.Spined ? 1
				: 0
			);
	...
	public sealed class TinkeringRewardCalculator : RewardCalculator
	{
		...
		public static Item CreateItem(int type)
		{
			...
			{
				case 0:
					return new PowderOfFortKeg();
				case 1:
					return new AutomatonActuator();
				case 2:
					return new BlackrockMoonstone();
				case 3:
					return new BlackrockAutomatonHead();
			}
	...
	public sealed class CarpentryRewardCalculator : RewardCalculator
	{
		public CarpentryRewardCalculator()
		{
			...
			RewardCollection.Add(
				new BODCollectionItem(
					0x2F5A,
					1152678,
					CraftResources.GetHue(CraftResource.YewWood),
					350,
					WoodsmansTalisman,
					(int)CraftResource.YewWood
				)
			);
			...
			RewardCollection.Add(
				new BODCollectionItem(
					0x1029,
					1157223,
					CraftResources.GetHue(CraftResource.OakWood),
					550,
					RunicDovetailSaw,
					0
				)
			...
			RewardCollection.Add(
				new BODCollectionItem(
					0x2F5A,
					1152679,
					CraftResources.GetHue(CraftResource.Heartwood),
					650,
					WoodsmansTalisman,
					(int)CraftResource.Heartwood
				)
			);
			RewardCollection.Add(
				new BODCollectionItem(
			...
			RewardCollection.Add(
				new BODCollectionItem(
					0x1029,
					1157224,
					CraftResources.GetHue(CraftResource.AshWood),
					750,
					RunicDovetailSaw,
					1
				)
			...
			RewardCollection.Add(
				new BODCollectionItem(
					0x2F5A,
					1152680,
					CraftResources.GetHue(CraftResource.Bloodwood),
					850,
					WoodsmansTalisman,
					(int)CraftResource.Bloodwood
				)
			);
			RewardCollection.Add(
				new BODCollectionItem(
			...
			RewardCollection.Add(
				new BODCollectionItem(
					0x2F5A,
					1152681,
					CraftResources.GetHue(CraftResource.Frostwood),
					1000,
					WoodsmansTalisman,
					(int)CraftResource.Frostwood
				)
			);
			RewardCollection.Add(
				new BODCollectionItem(
		...
		)
		{
			...
			int mtrlIndex = (
				material == BulkMaterialType.Frostwood ? 5
				: material == BulkMaterialType.Bloodwood ? 4
				: material == BulkMaterialType.Heartwood ? 3
				: material == BulkMaterialType.YewWood ? 2
				: material == BulkMaterialType.AshWood ? 1
				: 0
			);
	...
	public sealed class CookingRewardCalculator : RewardCalculator
	{
		...
		private static Item CreateItem(int type)
		{
			...
			{
				case 0:
					return new MasterChefsApron();
				case 1:
					return new PlumTreeAddonDeed();
				case 2:
					return new FermentationBarrel();
			}
	...
	public sealed class AlchemyRewardCalculator : RewardCalculator
	{
		public AlchemyRewardCalculator()
		{
			...
			RewardCollection.Add(
				new BODCollectionItem(0x975, 1152660, CraftResources.GetHue(CraftResource.AshWood), 250, Cauldron, 0)
			);
			RewardCollection.Add(
				new BODCollectionItem(0x975, 1152656, CraftResources.GetHue(CraftResource.Bronze), 260, Cauldron, 1)
			);
			RewardCollection.Add(new BODCollectionItem(0x9E26, 1157264, 0, 275, CraftsmanTalisman, 10)); // todo: Get id
			RewardCollection.Add(
				new BODCollectionItem(0x975, 1152661, CraftResources.GetHue(CraftResource.YewWood), 300, Cauldron, 2)
			);
			RewardCollection.Add(
				new BODCollectionItem(0x975, 1152657, CraftResources.GetHue(CraftResource.Gold), 310, Cauldron, 3)
			);
			RewardCollection.Add(new BODCollectionItem(0x9E26, 1157218, 0, 325, CraftsmanTalisman, 25)); // todo: Get id
			RewardCollection.Add(
				new BODCollectionItem(0x975, 1152658, CraftResources.GetHue(CraftResource.Agapite), 350, Cauldron, 4)
			);
			RewardCollection.Add(
				new BODCollectionItem(0x975, 1152662, CraftResources.GetHue(CraftResource.Heartwood), 360, Cauldron, 5)
			);
			...
			RewardCollection.Add(
				new BODCollectionItem(0x975, 1152663, CraftResources.GetHue(CraftResource.Bloodwood), 410, Cauldron, 6)
			);
			RewardCollection.Add(new BODCollectionItem(0x182B, 1157278, 2735, 425, NaturalDye, 2));
			RewardCollection.Add(
				new BODCollectionItem(0x975, 1152659, CraftResources.GetHue(CraftResource.Verite), 450, Cauldron, 7)
			);
		}
		...
		private static Item Cauldron(int type)
		{
			switch (type)
			{
				default:
				case 0:
					return new CauldronOfTransmutationDeed(CraftResource.AshWood);
				case 1:
					return new CauldronOfTransmutationDeed(CraftResource.Bronze);
				case 2:
					return new CauldronOfTransmutationDeed(CraftResource.YewWood);
				case 3:
					return new CauldronOfTransmutationDeed(CraftResource.Gold);
				case 4:
					return new CauldronOfTransmutationDeed(CraftResource.Agapite);
				case 5:
					return new CauldronOfTransmutationDeed(CraftResource.Heartwood);
				case 6:
					return new CauldronOfTransmutationDeed(CraftResource.Bloodwood);
				case 7:
					return new CauldronOfTransmutationDeed(CraftResource.Verite);
			}
		}
