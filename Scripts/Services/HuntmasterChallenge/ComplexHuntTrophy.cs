...
namespace Server.Items
{
	...
	public class HuntTrophyAddon : BaseAddon
	{
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public string DateKilled
		{
			get { return m_DateKilled; }
			set { m_DateKilled = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public TextDefinition Species
		{
			get { return Info.Species; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public MeasuredBy MeasuredBy
		{
			get { return Info.MeasuredBy; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public virtual int EastID
		{
			get { return Info.EastID; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public virtual int SouthID
		{
			get { return Info.SouthID; }
		}
		...
		{
			get { return HuntingTrophyInfo.Infos[Index]; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public bool Complex
		{
			get { return Info.Complex; }
		}

		public override BaseAddonDeed Deed
		{
			get { return new HuntTrophyAddonDeed(m_Owner, Index, m_Measurement, m_DateKilled, m_Location); }
		}
	...
	public class HuntTrophyAddonDeed : BaseAddonDeed
	{
		public override int LabelNumber
		{
			get { return 1084024 + SouthID; }
		}

		public override BaseAddon Addon
		{
			get { return new HuntTrophyAddon(m_Owner, Index, m_Measurement, m_DateKilled, m_Location); }
		}
