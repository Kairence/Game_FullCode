...
namespace Server.Items
{
	...
	public class MinersSatchel : BaseResourceSatchel
	{
		...
		public override Type[] HoldTypes
		{
			get { return new Type[] { typeof(BaseOre), typeof(BaseIngot), typeof(Granite), typeof(Saltpeter) }; }
		}
	...
	public class LumbjacksSatchel : BaseResourceSatchel
	{
		...
		public override Type[] HoldTypes
		{
			get { return new Type[] { typeof(BaseLog), typeof(Board) }; }
		}
