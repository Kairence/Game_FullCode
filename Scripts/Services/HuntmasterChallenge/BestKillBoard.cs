...
namespace Server.Items
{
	public class BestKillBoard : Item
	{
		...
		{
			get { return "Top 10 Kill Board"; }
		}

		[Constructable]
		public BestKillBoard()
			: base(7775)
		{
			Movable = false;
		}
		...
		public BestKillBoard(Serial serial)
			: base(serial) { }
		...
		private class BestKillGump : Gump
		{
			...
			public BestKillGump(int filter)
				: base(20, 20)
			{
				...
				for (int i = 0; i < useList.Count && i < 10; i++)
				{
					...
					AddHtml(
						...
						150,
						16,
						entry.Owner != null ? FormatFont(entry.Owner.Name, i) : FormatFont("Unknown", i),
						false,
						false
					);
					...
					AddHtml(
						...
						100,
						16,
						info.MeasuredBy == MeasuredBy.Weight
							? FormatFont(entry.Measurement.ToString() + " stones", i)
							: FormatFont(entry.Measurement.ToString() + " feet", i),
						false,
						false
					);
			...
			private string GetHuntTypeString(HuntType type)
			{
				...
				{
					default:
					case HuntType.GrizzlyBear:
						return "Grizzly Bear";
					case HuntType.GrayWolf:
						return "Grey Wolf";
					case HuntType.Cougar:
						return "Cougar";
					case HuntType.Turkey:
						return "Turkey";
					case HuntType.Bull:
						return "Bull";
					case HuntType.Boar:
						return "Boar";
					case HuntType.Walrus:
						return "Walrus";
					case HuntType.Alligator:
						return "Alligator";
					case HuntType.Eagle:
						return "Eagle";
					//Publish 91 added:
					case HuntType.MyrmidexLarvae:
						return "Myrmidex Larvae";
					case HuntType.Najasaurus:
						return "Najasaurus";
					case HuntType.Anchisaur:
						return "Anchisaur";
					case HuntType.Allosaurus:
						return "Allosaurus";
					case HuntType.Dimetrosaur:
						return "Dimetrosaur";
					case HuntType.Saurosaurus:
						return "Saurosaurus";
					//Publish 95 added:
					case HuntType.Tiger:
						return "Tiger";
					case HuntType.MyrmidexDrone:
						return "Myrmidex Drone";
					case HuntType.Triceratops:
						return "Triceratops";
					case HuntType.Lion:
						return "Lion";
					case HuntType.WhiteTiger:
						return "White Tiger";
					case HuntType.BlackTiger:
						return "Black Tiger";
					//Publish 102 added:
					case HuntType.Raptor:
						return "Raptor";
					case HuntType.SeaSerpent:
						return "Sea Serpent";
					case HuntType.Scorpion:
						return "Scorpion";
				}
			}
			...
			private string GetHuntTypeString()
			{
				switch (m_Filter)
				{
					default:
						return "No Filter";
					case (int)HuntType.GrizzlyBear:
						return "Grizzly Bear";
					case (int)HuntType.GrayWolf:
						return "Grey Wolf";
					case (int)HuntType.Cougar:
						return "Cougar";
					case (int)HuntType.Turkey:
						return "Turkey";
					case (int)HuntType.Bull:
						return "Bull";
					case (int)HuntType.Boar:
						return "Boar";
					case (int)HuntType.Walrus:
						return "Walrus";
					case (int)HuntType.Alligator:
						return "Alligator";
					case (int)HuntType.Eagle:
						return "Eagle";
					//Publish 91 added:
					case (int)HuntType.MyrmidexLarvae:
						return "Myrmidex Larvae";
					case (int)HuntType.Najasaurus:
						return "Najasaurus";
					case (int)HuntType.Anchisaur:
						return "Anchisaur";
					case (int)HuntType.Allosaurus:
						return "Allosaurus";
					case (int)HuntType.Dimetrosaur:
						return "Dimetrosaur";
					case (int)HuntType.Saurosaurus:
						return "Saurosaurus";
					//Publish 95 added:
					case (int)HuntType.Tiger:
						return "Tiger";
					case (int)HuntType.MyrmidexDrone:
						return "Myrmidex Drone";
					case (int)HuntType.Triceratops:
						return "Triceratops";
					case (int)HuntType.Lion:
						return "Lion";
					case (int)HuntType.WhiteTiger:
						return "White Tiger";
					case (int)HuntType.BlackTiger:
						return "Black Tiger";
					//Publish 102 added:
					case (int)HuntType.Raptor:
						return "Raptor";
					case (int)HuntType.SeaSerpent:
						return "Sea Serpent";
					case (int)HuntType.Scorpion:
						return "Scorpion";
				}
			}
		}
