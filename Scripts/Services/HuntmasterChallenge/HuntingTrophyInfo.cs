...
namespace Server.Engines.HuntsmasterChallenge
{
	...
	public class HuntingTrophyInfo
	{
		...
		public static List<HuntingTrophyInfo> Infos
		{
			get { return m_Infos; }
		}
		...
		{
			m_Infos.Add(
				new HuntingTrophyInfo(
					HuntType.GrizzlyBear,
					typeof(GrizzlyBear),
					0x9A26,
					1015242,
					1123486,
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public MeasuredBy MeasuredBy
		{
			get { return m_MeasuredBy; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SouthID
		{
			get { return m_SouthID; }
		}
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public TextDefinition Species
		{
			get { return m_Species; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public TextDefinition TrophyName
		{
			get { return m_TrophyName; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MinMeasurement
		{
			get { return m_MinMeasurement; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int MaxMeasurement
		{
			get { return m_MaxMeasurement; }
		}
		...
		public HuntingTrophyInfo(
			HuntType type,
			Type creatureType,
			int southID,
			TextDefinition species,
			TextDefinition trophyName,
			int minMeasurement,
			int maxMeasurement,
