...
namespace Server.Items
{
	public class HarvestersBlade : ElvenSpellblade
	{
		...
		public HarvestersBlade(Serial serial)
			: base(serial) { }
	...
	public class RangersGuildSash : BodySash
	{
		...
		{
			get { return 1155744; }
		} // Member of the Skara Brae Ranger's Guild
		...
		public RangersGuildSash(Serial serial)
			: base(serial) { }
	...
	public class HuntmastersRewardTitleDeed : BaseRewardTitleDeed
	{
		...
		{
			get { return new TextDefinition(1155727); }
	...
	public class HornOfPlenty : Item, IUsesRemaining
	{
		...
		public override void OnDoubleClick(Mobile from)
		{
			if (m_UsesRemaining > 0)
			{
				...
				{
					case 0:
						item = new SweetPotatoPie();
						break;
					case 1:
						item = new MashedSweetPotatoes();
						break;
					case 2:
						item = new BasketOfRolls();
						break;
					case 3:
						item = new TurkeyPlatter();
						break;
					case 4:
					...
					case 5:
						...
						break;
					case 6:
						item = new PottedCoffeePlant();
						break;
					case 7:
						item = new RoastingPigOnASpitDeed();
						break;
					case 8:
						item = new FormalDiningTableDeed();
						break;
					case 9:
						item = new BuffetTableDeed();
						break;
				}
