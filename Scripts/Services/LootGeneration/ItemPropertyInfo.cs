...
namespace Server.Items
{
	...
	public class ItemPropertyInfo
	{
				...
				foreach (var cat in categories)
				{
					...
					else
					{
						throw new ArgumentException(
							String.Format(
								"Property Category {0} already exists for {1}!",
								cat.ItemType.ToString(),
								attribute.ToString()
							)
						);
					}
		...
		static ItemPropertyInfo()
		{
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					15,
					1111947,
					new PropInfo(1, 15, 15, new int[] { 20 }),
					new PropInfo(2, 25, 25, new int[] { 30, 35 }),
					new PropInfo(3, 0, 5),
					new PropInfo(4, 15, 15, new int[] { 20 }),
					new PropInfo(5, 0, 5),
					new PropInfo(6, 15, 15, new int[] { 20 })
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					2,
					1111994,
					new PropInfo(1, 3, 0, 9),
					new PropInfo(2, 3, 0, 9),
					new PropInfo(3, 2, 2, new int[] { 4 }),
					new PropInfo(4, 0, 2, new int[] { 4 }),
					new PropInfo(5, 2, 2, new int[] { 4 })
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					new PropInfo(1, 3, 0, 9),
					new PropInfo(2, 3, 0, 9),
					new PropInfo(3, 3, 3, new int[] { 4 }),
					new PropInfo(4, 0, 3, new int[] { 4 }),
					new PropInfo(5, 3, 3, new int[] { 4 })
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					5,
					1111993,
					new PropInfo(1, 0, 5, new int[] { 6, 7 }),
					new PropInfo(2, 0, 5, new int[] { 6, 7 }),
					new PropInfo(3, 5, 5, new int[] { 6, 7 }),
					new PropInfo(4, 0, 5, new int[] { 6, 7 }),
					new PropInfo(5, 5, 5, new int[] { 6, 7 })
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					new PropInfo(1, 0, 5),
					new PropInfo(2, 0, 5),
					new PropInfo(3, 8, 8, new int[] { 9, 10 }),
					new PropInfo(4, 0, 5),
					new PropInfo(5, 8, 8, new int[] { 9, 10 }),
					new PropInfo(6, 0, 5)
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					50,
					1112005,
					new PropInfo(1, 50, 50, new int[] { 55, 60, 65, 70 }),
					new PropInfo(2, 50, 50, new int[] { 55, 60, 65, 70 }),
					new PropInfo(4, 0, 35),
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					30,
					1112045,
					new PropInfo(1, 30, 30, new int[] { 35, 40 }),
					new PropInfo(4, 0, 5, new int[] { 10 }),
					new PropInfo(6, 0, 5, new int[] { 10 })
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					new PropInfo(1, 0, 5),
					new PropInfo(2, 0, 5),
					new PropInfo(3, 8, 8, new int[] { 10 }),
					new PropInfo(4, 0, 5),
					new PropInfo(5, 8, 8, new int[] { 10 }),
					new PropInfo(6, 8, 8, new int[] { 10 })
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					20,
					1111997,
					new PropInfo(3, 20, 20, new int[] { 25 }),
					new PropInfo(5, 20, 20, new int[] { 25 }),
					new PropInfo(6, 20, 20, new int[] { 25 })
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					new PropInfo(1, 0, 15),
					new PropInfo(2, 0, 15),
					new PropInfo(3, 15, 15, new int[] { 20 }),
					new PropInfo(4, 15, 15, new int[] { 20 }),
					new PropInfo(5, 15, 15, new int[] { 20 })
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					100,
					1111999,
					new PropInfo(1, 100, 100, new int[] { 110, 120, 130, 140, 150 }),
					new PropInfo(2, 120, 120, new int[] { 130, 140, 150, 160, 170 }),
					new PropInfo(3, 100, 100, new int[] { 110, 120, 130, 140, 150 }),
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					50,
					1111964,
					new PropInfo(1, 10, 50, 50),
					new PropInfo(2, 10, 50, 50)
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					10,
					1112001,
					new PropInfo(1, 10, 10, new int[] { 11, 12, 13, 14, 15 }),
					new PropInfo(2, 10, 10, new int[] { 11, 12, 13, 14, 15 })
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					100,
					1111949,
					new PropInfo(1, 0, 100, new int[] { 110, 120, 130, 140, 150 }),
					new PropInfo(2, 0, 100, new int[] { 110, 120, 130, 140, 150 })
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					100,
					1111949,
					new PropInfo(3, 0, 100, new int[] { 110, 120, 130, 140, 150 }),
					new PropInfo(4, 100, 100, new int[] { 110, 120, 130, 140, 150 }),
					new PropInfo(5, 0, 100, new int[] { 110, 120, 130, 140, 150 })
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					100,
					1111998,
					new PropInfo(1, 0, 100),
					new PropInfo(2, 0, 100)
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					100,
					1111998,
					new PropInfo(3, 0, 100),
					new PropInfo(4, 0, 100),
					new PropInfo(5, 0, 100)
				)
			);
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					15,
					1112010,
					new PropInfo(1, 10, 100, 100),
					new PropInfo(2, 10, 100, 100),
					new PropInfo(3, 15, 15, new int[] { 20, 25, 30 }),
					new PropInfo(4, 15, 15),
					new PropInfo(5, 15, 15, new int[] { 20, 25, 30 }),
					new PropInfo(6, 15, 15, new int[] { 20 })
				)
			);
			...
			Register(
				200,
				new ItemPropertyInfo(
					AosWeaponAttribute.BloodDrinker,
					1017407,
					140,
					0,
					1,
			...
			Register(
				205,
				new ItemPropertyInfo(
					AosWeaponAttribute.SplinteringWeapon,
					1154670,
					140,
					5,
					5,
			...
			Register(
				206,
				new ItemPropertyInfo(
					AosWeaponAttribute.ReactiveParalyze,
					1154660,
					140,
					0,
					1,
			...
			Register(
				...
				new ItemPropertyInfo(
					...
					1112010,
					new PropInfo(1, 15, 15, new int[] { 20 }),
					new PropInfo(2, 15, 15, new int[] { 20 })
				)
			);
			...
			Register(
				208,
				new ItemPropertyInfo(
					SAAbsorptionAttribute.EaterFire,
					1154662,
					140,
					1,
					1,
			...
			Register(
				209,
				new ItemPropertyInfo(
					SAAbsorptionAttribute.EaterCold,
					1154663,
					140,
					1,
					1,
			...
			Register(
				210,
				new ItemPropertyInfo(
					SAAbsorptionAttribute.EaterPoison,
					1154664,
					140,
					1,
					1,
			...
			Register(
				211,
				new ItemPropertyInfo(
					SAAbsorptionAttribute.EaterEnergy,
					1154665,
					140,
					1,
					1,
			...
			Register(
				212,
				new ItemPropertyInfo(
					SAAbsorptionAttribute.EaterKinetic,
					1154666,
					140,
					1,
					1,
			...
			Register(
				213,
				new ItemPropertyInfo(
					SAAbsorptionAttribute.EaterDamage,
					1154667,
					140,
					1,
					1,
			...
			Register(
				218,
				new ItemPropertyInfo(SAAbsorptionAttribute.ResonanceKinetic, 1154659, 140, 1, 1, 20, 1152391)
			);

			Register(
				219,
				new ItemPropertyInfo(
					SAAbsorptionAttribute.CastingFocus,
					1116535,
					140,
					1,
					1,
			...
			Register(
				220,
				new ItemPropertyInfo(
					AosArmorAttribute.ReactiveParalyze,
					1154660,
					140,
					0,
					1,
					...
					switch (id)
					{
						case 200: // Blood Drinking
							return item is BaseWeapon
								&& (
									((BaseWeapon)item).PrimaryAbility == WeaponAbility.BleedAttack
									|| ((BaseWeapon)item).SecondaryAbility == WeaponAbility.BleedAttack
								);
						...
						case 49: // MageArmor cannot be applied if the armor is already meddable
							return item is BaseArmor
								&& ((BaseArmor)item).MeditationAllowance != ArmorMeditationAllowance.All;
						case 208:
						case 209:
						case 210:
						case 211:
		...
		{
			return wep.WeaponAttributes.HitFireball > 0
		...
		{
			return wep.WeaponAttributes.HitPhysicalArea > 0
