...
namespace Server.Items
{
	public class IngredientDropEntry
	{
		...
		public bool DropMultiples
		{
			get { return m_DropMultiples; }
		}
		...
		public static List<IngredientDropEntry> IngredientTable
		{
			get { return m_IngredientTable; }
		}
		...
		public static void Initialize()
		{
			...
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(Navrey), true, .5, typeof(BottleIchor), typeof(SpiderCarapace))
			);
			...
			//Silver snake skin
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(SilverSerpent), true, "TerMur", .10, typeof(SilverSnakeSkin))
			);

			//Harpsichord Roll
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(BaseCreature), true, "TerMur", .05, typeof(HarpsichordRoll))
			);

			//Void Orb/Vial of Vitriol
			m_IngredientTable.Add(new IngredientDropEntry(typeof(BaseVoidCreature), true, .05, typeof(VoidOrb)));
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(UnboundEnergyVortex), true, .25, typeof(VoidOrb), typeof(VialOfVitriol))
			);
			...
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(GreenGoblinAlchemist), true, .10, typeof(GoblinBlood))
			);
			...
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(EnslavedGoblinKeeper), true, .25, typeof(GoblinBlood))
			);
			...
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(EnslavedGreenGoblinAlchemist), true, .25, typeof(GoblinBlood))
			);

			//Lava Serpent Crust
			m_IngredientTable.Add(new IngredientDropEntry(typeof(LavaElemental), true, .25, typeof(LavaSerpentCrust)));
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(FireElementalRenowned), true, 1.0, typeof(LavaSerpentCrust))
			);
			...
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(AgapiteElemental), true, .25, typeof(CrystallineBlackrock))
			);
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(BronzeElemental), true, .25, typeof(CrystallineBlackrock))
			);
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(CopperElemental), true, .25, typeof(CrystallineBlackrock))
			);
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(GoldenElemental), true, .25, typeof(CrystallineBlackrock))
			);
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(ShadowIronElemental), true, .25, typeof(CrystallineBlackrock))
			);
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(ValoriteElemental), true, .25, typeof(CrystallineBlackrock))
			);
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(VeriteElemental), true, .25, typeof(CrystallineBlackrock))
			);

			m_IngredientTable.Add(new IngredientDropEntry(typeof(ChaosVortex), true, .25, typeof(ChagaMushroom)));

			m_IngredientTable.Add(
				new IngredientDropEntry(
					typeof(BaseCreature),
					false,
			...
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(BaseCreature), false, "Fairy Dragon Lair", .05, typeof(EssenceDiligence))
			);
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(BaseCreature), false, "Abyssal Lair", .05, typeof(EssenceAchievement))
			);
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(BaseCreature), false, "Crimson Veins", .05, typeof(EssencePrecision))
			);
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(BaseCreature), false, "Lava Caldera", .05, typeof(EssencePassion))
			);
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(BaseCreature), false, "Fire Temple Ruins", .05, typeof(EssenceOrder))
			);
			m_IngredientTable.Add(
				new IngredientDropEntry(
					typeof(BaseCreature),
			...
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(BaseCreature), false, "Lands of the Lich", .05, typeof(EssenceDirection))
			);
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(BaseCreature), false, "Secret Garden", .05, typeof(EssenceFeeling))
			);
			m_IngredientTable.Add(
				new IngredientDropEntry(typeof(BaseCreature), false, "Skeletal Dragon", .05, typeof(EssencePersistence))
			);
		}
				...
				foreach (IngredientDropEntry entry in m_IngredientTable)
				{
					...
					if (entry.Region != null)
					{
						...
						if (reg == "TerMur" && c.Map != Map.TerMur)
						{
							...
							reg == "Abyss"
							&& (c.Map != Map.TerMur || c.X < 235 || c.X > 1155 || c.Y < 40 || c.Y > 1040)
						)
						{
							continue;
						}
