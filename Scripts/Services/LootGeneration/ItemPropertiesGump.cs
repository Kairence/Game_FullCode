	...
	public class ItemPropertiesGump : BaseGump
	{
		...
		public override void AddGumpLayout()
		{
			...
			AddHtml(
				...
				625,
				20,
				Center("Item Description: (Imbuing/Runic Cap) - (Loot Cap) [Scale]"),
				false,
				false
			);
		...
		private void LoadTypeInfo(ItemType type, ItemPropertyInfo info, int scale, int x, int y)
		{
			...
			if (typeInfo != null)
			{
				AddLabel(
					x,
					y,
					TypeFilter == type ? 0x9E : 0,
					String.Format(
						"{0}-{1}[{2}]",
						typeInfo.StandardMax,
						typeInfo.LootMax,
						typeInfo.Scale > 1 ? typeInfo.Scale.ToString() : scale.ToString()
					)
				);
			}
			else
	...
	public class InfoSpecificGump : BaseGump
	{
		...
		public override void AddGumpLayout()
		{
			...
			AddHtmlLocalized(
				...
				20,
				1114057,
				Info.PrimaryName != null ? Info.PrimaryName.ToString() : "N/A",
				0x1,
				false,
				false
			);
			AddHtmlLocalized(
				...
				20,
				1114057,
				Info.GemName != null ? Info.GemName.ToString() : "N/A",
				0x1,
				false,
				false
			);
			AddHtmlLocalized(
				...
				20,
				1114057,
				Info.SpecialName != null ? Info.SpecialName.ToString() : "N/A",
				0x1,
				false,
				false
			);
