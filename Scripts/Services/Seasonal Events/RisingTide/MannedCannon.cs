...
namespace Server.Items
{
	...
	{
		public virtual TimeSpan ScanDelay
		{
			get { return TimeSpan.FromSeconds(Utility.RandomMinMax(5, 10)); }
		}
		...
		public virtual int LateralOffset
		{
			get { return 1; }
		}
					...
					if (t.Entity is BaseGalleon && AmmoType != AmmunitionType.Grapeshot)
					{
						if (shoot)
						{
							...
							Timer.DelayCall(
								...
								new object[] { (BaseGalleon)t.Entity, t.Location, AmmoType }
							);
						}
					...
					else
					{
						...
						foreach (
							var mob in target
								.GetMobilesOnBoard()
								.OfType<PlayerMobile>()
								.Where(pm => Operator.CanBeHarmful(pm, false))
						)
						{
		...
		public virtual void OnMobileHit(object obj)
		{
			...
			if (ammoInfo != null)
			{
				...
				AOS.Damage(
					...
					Operator,
					damage,
					ammoInfo.PhysicalDamage,
					ammoInfo.FireDamage,
					ammoInfo.ColdDamage,
					ammoInfo.PoisonDamage,
					ammoInfo.EnergyDamage
				);
		...
		public MannedCannon(Serial serial)
			: base(serial) { }
	...
	public class MannedCulverin : MannedCannon
	{
		...
		public MannedCulverin(Serial serial)
			: base(serial) { }
	...
	public class MannedCarronade : MannedCannon
	{
		...
		public MannedCarronade(Serial serial)
			: base(serial) { }
	...
	public class MannedBlundercannon : MannedCannon
	{
		...
		public MannedBlundercannon(Serial serial)
			: base(serial) { }
