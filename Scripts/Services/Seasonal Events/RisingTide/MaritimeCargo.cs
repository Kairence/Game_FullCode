	...
	public class MaritimeCargo : Item
	{
		...
		private static CargoType RandomType()
		{
			switch (Utility.Random(8))
			{
				default:
				case 0:
					return CargoType.Cloth;
				case 1:
					return CargoType.Jewelry;
				case 2:
					return CargoType.Wood;
				case 3:
					return CargoType.Metal;
				case 4:
					return CargoType.Munitions;
				case 5:
					return CargoType.Granite;
				case 6:
					return CargoType.Reagents;
				case 7:
					return CargoType.Glassware;
			}
		}
		...
		public int GetAwardAmount()
		{
			...
			{
				default:
				case CargoQuality.Grandmaster:
					amount = Utility.RandomMinMax(100, 200);
					break;
				case CargoQuality.Exalted:
					amount = Utility.RandomMinMax(500, 600);
					break;
				case CargoQuality.Legendary:
					amount = Utility.RandomMinMax(1000, 1100);
					break;
				case CargoQuality.Mythical:
					amount = Utility.RandomMinMax(10000, 15000);
					break;
			}
		...
		public override void AddWeightProperty(ObjectPropertyList list)
		{
			...
			list.Add(
				_CargoQuality < CargoQuality.Mythical ? 1158903 + (int)_CargoQuality : 1158969,
				String.Format("#{0}", TypeLabel(_CargoType))
			);
		}
		...
		public static int TypeLabel(CargoType type)
		{
			switch (type)
			{
				...
				case CargoType.Cloth:
					return 1044286;
				case CargoType.Jewelry:
					return 1011172;
				case CargoType.Wood:
					return 1079435;
				case CargoType.Metal:
					return 1049567;
				case CargoType.Munitions:
					return 1158902;
				case CargoType.Granite:
					return 1158900;
				case CargoType.Reagents:
					return 1002127;
				case CargoType.Glassware:
					return 1158901;
			}
		}

		public MaritimeCargo(Serial serial)
			: base(serial) { }
