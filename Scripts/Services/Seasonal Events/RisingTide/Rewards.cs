...
namespace Server.Items
{
	public class DragonCannon : BaseAddon
	{
		...
		{
			get { return new DragonCannonDeed(); }
		}
	...
	public class DragonCannonDeed : BaseAddonDeed, IRewardOption
	{
		...
		{
			get { return new DragonCannon(_Direction); }
		}
	...
	public class ShoulderParrot : BaseOuterTorso
	{
			...
			if (_MasterName != null)
			{
				list.Add(
					...
					String.Format(
						"{0}{1}",
						_MasterName,
						_MasterName.ToLower().EndsWith("s") || _MasterName.ToLower().EndsWith("z") ? "'" : "'s"
					)
				);
			}
			else
		...
		public ShoulderParrot(Serial serial)
			: base(serial) { }
	...
	public class PirateWallMap : Item
	{
		...
		public PirateWallMap(Serial serial)
			: base(serial) { }
	...
	public class MysteriousStatue : Item
	{
		...
		public MysteriousStatue(Serial serial)
			: base(serial) { }
	...
	public class DecorativeWoodCarving : Item
	{
		...
		public DecorativeWoodCarving(Serial serial)
			: base(serial) { }
