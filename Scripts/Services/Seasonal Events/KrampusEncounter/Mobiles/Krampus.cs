...
namespace Server.Mobiles
{
	...
	public class Krampus : BaseCreature
	{
		...
		public bool IsKrampusEncounter
		{
			get { return KrampusEncounter.Encounter != null && KrampusEncounter.Encounter.Krampus == this; }
		}
			...
			: base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
		{
			...
			switch (Utility.Random(3))
			{
				case 0:
					...
					break;
				case 1:
					SetMagicalAbility(MagicalAbility.Bashing);
					break;
				case 2:
		...
		public void Summon(Mobile target, bool initial = false)
		{
			...
			Timer.DelayCall(
				TimeSpan.FromSeconds(initial ? 0.25 : 1.0),
				com =>
				{
					if (!com.Alive)
						return;
					...
					for (int i = 0; i < count; i++)
					{
						...
						if (spawn != null)
						{
							...
							if (!initial)
							{
								...
								{
									if (
										!(spawn.Combatant is PlayerMobile)
										|| !((PlayerMobile)spawn.Combatant).HonorActive
									)
										spawn.Combatant = com;
								}
								else
