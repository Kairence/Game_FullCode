...
namespace Server.Engines.Fellowship
{
	public static class ForsakenFoesGeneration
	{
		...
		public static void OtherQuestContent(Map map)
		{
			...
			{
				Static st = new Static(0x42BF) { Hue = 1910, Name = "The Fellowship Tome" };
			...
			{
				Static st = new Static(0x2F60) { Hue = 1912, Name = "The Fellowship Coin" };
			...
			{
				Static st = new Static(0x3155) { Hue = 1912, Name = "The Fellowship Icon" };
			...
			{
				Candelabra st = new Candelabra() { Hue = 1105 };
		...
		{
			new Point3D(6408, 2667, 0),
			new Point3D(6409, 2667, 0),
			new Point3D(6410, 2667, 0),
			new Point3D(6411, 2667, 0),
			new Point3D(6412, 2667, 0),
			new Point3D(6396, 2677, 0),
			new Point3D(6396, 2678, 0),
			new Point3D(6396, 2679, 0),
			new Point3D(6396, 2680, 0),
			new Point3D(6396, 2681, 0),
			new Point3D(6407, 2692, 0),
			new Point3D(6408, 2692, 0),
			new Point3D(6409, 2692, 0),
			new Point3D(6410, 2692, 0),
			new Point3D(6370, 2744, 0),
			new Point3D(6371, 2744, 0),
			new Point3D(6372, 2744, 0),
			new Point3D(6373, 2744, 0),
			new Point3D(6374, 2744, 0),
			new Point3D(6375, 2744, 0),
			new Point3D(6331, 2653, 0),
			new Point3D(6332, 2653, 0),
			new Point3D(6333, 2653, 0),
			new Point3D(6410, 2783, 0),
			new Point3D(6305, 2678, 0),
			new Point3D(6305, 2679, 0),
			new Point3D(6305, 2680, 0),
			new Point3D(6411, 2783, 0),
			new Point3D(6422, 2708, 0),
			new Point3D(6422, 2709, 0),
			new Point3D(6422, 2710, 0),
			new Point3D(6422, 2711, 0),
			new Point3D(6406, 2783, 0),
			new Point3D(6407, 2783, 0),
			new Point3D(6408, 2783, 0),
			new Point3D(6409, 2783, 0),
			new Point3D(6442, 2744, 0),
			new Point3D(6443, 2744, 0),
			new Point3D(6444, 2744, 0),
			new Point3D(6445, 2744, 0),
			new Point3D(6446, 2744, 0),
			new Point3D(6390, 2617, 0),
			new Point3D(6390, 2618, 0),
			new Point3D(6390, 2619, 0),
			new Point3D(6390, 2620, 0),
			new Point3D(6390, 2621, 0),
			new Point3D(6390, 2622, 0),
			new Point3D(6390, 2623, 0),
			new Point3D(6390, 2624, 0),
			new Point3D(6390, 2625, 0),
			new Point3D(6434, 2708, 0),
			new Point3D(6434, 2709, 0),
			new Point3D(6434, 2710, 0),
			new Point3D(6434, 2711, 0),
		};

		private static readonly Point3D[] Workers = new Point3D[]
		{
			new Point3D(6406, 2680, 0),
			new Point3D(6386, 2621, 0),
			new Point3D(6444, 2738, 0),
			new Point3D(6371, 2742, 0),
			new Point3D(6332, 2650, 0),
			new Point3D(6299, 2679, 0),
			new Point3D(6428, 2709, 0),
			new Point3D(6409, 2787, 0),
		};
		...
		public static void GenerateMapDecoration(Map map)
		{
			...
			for (int t = 0; t < Teleporters.Length / 2; t++)
			{
				...
				if (map.FindItem<BlackthornDungeonTeleporter>(p) == null)
				{
					...
					if (t % 2 == 0)
					{
						bl = new BlackthornDungeonTeleporter(c) { Dest = Teleporters[t, 1] };

						c++;
					}
					else
					{
						bl = new BlackthornDungeonTeleporter() { Dest = Teleporters[t, 1] };
					}
