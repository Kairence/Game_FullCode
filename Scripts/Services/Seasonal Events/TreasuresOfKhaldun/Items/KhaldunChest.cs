	...
	public class KhaldunChest : LockableContainer, IRevealableItem
	{
		...
		public virtual void Fill()
		{
			...
			if (0.30 > Utility.RandomDouble())
			{
				...
				{
					case 0:
						item = new Bandage(Utility.Random(10, 30));
						break;
					case 1:
						item = new SmokeBomb();
					...
					case 2:
						...
						break;
					case 3:
						item = new Lockpick(Utility.Random(1, 10));
						break;
					case 4:
						item = new DreadHornMane(Utility.Random(1, 2));
						break;
					case 5:
						item = new Corruption(Utility.Random(1, 2));
						break;
					case 6:
						item = new Taint(Utility.Random(1, 2));
						break;
				}
			...
			if (0.2 > Utility.RandomDouble())
			{
				...
				{
					case 0:
						item = new ZombiePainting();
						break;
					case 1:
						item = new SkeletonPortrait();
						break;
					case 2:
						item = new LichPainting();
						break;
				}
		...
		public KhaldunChest(Serial serial)
			: base(serial) { }
