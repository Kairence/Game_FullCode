...
namespace Server.Mobiles
{
	...
	{
		public static readonly WarriorType[] Types = Enum.GetValues(typeof(WarriorType)).Cast<WarriorType>().ToArray();

		public static WarriorType RandomType
		{
			get { return Types[Utility.Random(Types.Length)]; }
		}
			...
			: base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
		{
			...
			switch (_Type)
			{
				case WarriorType.Scout:
					_title = "the Scout";
					break;
				case WarriorType.Corporal:
					_title = "the Corporal";
					break;
				case WarriorType.Lieutenant:
					_title = "the Lieutenant";
					break;
				case WarriorType.Captain:
					_title = "the Captain";
					SetHits(1000, 1500);
					break;
				case WarriorType.General:
					_title = "the General";
					SetHits(1000, 1500);
					break;
			}
