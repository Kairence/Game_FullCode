...
namespace Server.Engines.Khaldun
{
	public class DustPile : Item, IForensicTarget
	{
		...
		private void SetFoundClue(GoingGumshoeQuest2 quest)
		{
			...
			{
				case "boreas":
					quest.ClueDust1 = true;
					break;
				case "moriens":
					quest.ClueDust2 = true;
					break;
				case "carthax":
					quest.ClueDust3 = true;
					break;
				case "tenebrae":
					quest.ClueDust4 = true;
					break;
			}
		}
		...
		private bool HasFoundClue(GoingGumshoeQuest2 quest)
		{
			...
			{
				case "boreas":
					return quest.ClueDust1;
				case "moriens":
					return quest.ClueDust2;
				case "carthax":
					return quest.ClueDust3;
				case "tenebrae":
					return quest.ClueDust4;
			}
