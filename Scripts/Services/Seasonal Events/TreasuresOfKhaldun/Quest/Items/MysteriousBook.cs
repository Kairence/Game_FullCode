...
namespace Server.Engines.Khaldun
{
	public class MysteriousBook : Item, IForensicTarget
	{
		...
		private void SetFoundClue1(GoingGumshoeQuest2 quest)
		{
			...
			{
				case "boreas":
					quest.ClueBook1_1 = true;
					break;
				case "moriens":
					quest.ClueBook2_1 = true;
					break;
				case "carthax":
					quest.ClueBook3_1 = true;
					break;
				case "tenebrae":
					quest.ClueBook4_1 = true;
					break;
			}
		}
		...
		private void SetFoundClue2(GoingGumshoeQuest2 quest)
		{
			...
			{
				case "boreas":
					quest.ClueBook1_2 = true;
					break;
				case "moriens":
					quest.ClueBook2_2 = true;
					break;
				case "carthax":
					quest.ClueBook3_2 = true;
					break;
				case "tenebrae":
					quest.ClueBook4_2 = true;
					break;
			}
		}
		...
		private bool HasFoundClue1(GoingGumshoeQuest2 quest)
		{
			...
			{
				case "boreas":
					return quest.ClueBook1_1;
				case "moriens":
					return quest.ClueBook2_1;
				case "carthax":
					return quest.ClueBook3_1;
				case "tenebrae":
					return quest.ClueBook4_1;
			}
		...
		private bool HasFoundClue2(GoingGumshoeQuest2 quest)
		{
			...
			{
				case "boreas":
					return quest.ClueBook1_2;
				case "moriens":
					return quest.ClueBook2_2;
				case "carthax":
					return quest.ClueBook3_2;
				case "tenebrae":
					return quest.ClueBook4_2;
			}
