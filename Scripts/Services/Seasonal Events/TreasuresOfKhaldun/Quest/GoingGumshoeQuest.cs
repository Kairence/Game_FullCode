...
namespace Server.Engines.Khaldun
{
	public class GoingGumshoeQuest : BaseQuest
	{
		...
		{
			get { return 1158616; }
		} // // You've found Chief Inspector Jasper! Speak to him to learn more!
	...
	public class GoingGumshoeQuest3 : BaseQuest
	{
		...
		private LibraryBookcase GetBookcase()
		{
			...
			Console.WriteLine(
				"Error: GoingGumshoeQuest3 has no bookcases. setup LibraryBookcase per EA via [CreateWorld command."
			);
			return null;
		}
		...
		private class QuestRegion : Region
		{
			...
			public QuestRegion()
				: base("Going Gumshoe Quest Region", Map.Trammel, Region.DefaultPriority, GoingGumshoeQuest3.Bounds)
			{
				Register();
			}
