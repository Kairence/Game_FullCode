...
namespace Server.Engines.Points
{
	public class KhaldunData : PointsSystem
	{
		...
		{
			get { return SeasonalEventSystem.IsActive(EventType.TreasuresOfKhaldun); }
		}
		...
		public override void ProcessKill(Mobile victim, Mobile damager)
		{
			...
			if (damager is PlayerMobile && r.IsPartOf("Khaldun"))
			{
				...
				DungeonPoints[damager] +=
					(int)(fame * (1 + Math.Sqrt(luck) / 100)) * PotionOfGloriousFortune.GetBonus(damager);
