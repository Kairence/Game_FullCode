...
namespace Server.Engines.TreasuresOfKotlCity
{
	public class KotlBattleSimulator : Item, ISpawner
	{
		...
		public static TimeSpan NextSpawnDuration
		{
			get { return TimeSpan.FromSeconds(Utility.RandomMinMax(2, 25)); }
		}
		...
		{
			get { return Spawn != null ? Spawn.Count : 0; }
		}
		...
		{
			get { return new Point3D(544, 2303, 0); }
		}
		...
		{
			get { return 10 + (Level * 2); }
		}
		public int KillsPerWave
		{
			get { return 20 + (Level * 2); }
		}
		...
		public void EndSimulation()
		{
			...
			if (
				WheelsOfTime.Instance != null
				&& (WheelsOfTime.Instance.RockBarrier == null || WheelsOfTime.Instance.RockBarrier.Deleted)
			)
			{
		...
		private void DoSpawn()
		{
			...
			switch (Utility.Random(2))
			{
				default:
				case 0:
					bc = new SpectralKotlWarrior(strong);
					break;
				case 1:
					bc = new SpectralMyrmidexWarrior(strong);
					break;
			}
