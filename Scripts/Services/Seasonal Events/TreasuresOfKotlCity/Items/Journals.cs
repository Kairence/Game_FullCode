...
namespace Server.Engines.TreasuresOfKotlCity
{
    ...
    public class JournalDrSpector2 : BaseJournal
    {
         ...
         * attack, the tribe will also destroy the bridges across the rivers around their settlement. The tribe is the first I뭭e seen 
         ...
         * I have decided to meet with the next of Eodon뭩 tribes. The Sakkhra have warned me about the 뱒piritless tribe,?but I believe 
    ...
    public class JournalDrSpector3 : BaseJournal
    {
         ...
         * that one of their greatest chieftains walked into the mountains with a sacred hide that protected him from the volcano뭩 poisonous
         * gases. I don뭪 believe the answers I seek can be found within the volcano. That leaves only the pyramid at 20캳outh 58?West.
    ...
    public class JournalDrSpector4 : BaseJournal
    {
         ...
         * The tribes had a saying, 밙illing one Myrmidex brings the wrath of its thousand kin.?How much wrath have I earned by killing so
    ...
    public class HistoryOfTheGreatWok1 : BaseJournal
    {
         ...
         * In the frozen crater, each day of study claimed another life, but eventually, the Kotl learned to wield the moonstone뭩 power. 
         * They used it to grasp and manipulate frayed threads of existence. They knit together pieces from before the First Home뭩 destruction
    ...
    public class HistoryOfTheGreatWok2 : BaseJournal
    {
         ...
         * tap into the moonstone뭩 power and select distant future variations, the Kotl bred such servants from ants. The Myrmidex were this
    ...
    public class HistoryOfTheGreatWok3 : BaseJournal
    {
         ...
         * moonstone outward beyond Eodon. They constructed the Moon Chamber as a focal point for all of Eodon뭩 mana. The artificial origin 
         ...
         * intelligent, but less civilized, species called humans. With unrivalled magic and martial power, Katalkotl뭩 forces brought back
    ...
    public class HistoryOfTheGreatWok4 : BaseJournal
    {
         ...
         * civilization. The surface portions of Kotlan were destroyed, so the World-Builders barricaded themselves in the city뭩 tunnels. 
