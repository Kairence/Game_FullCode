...
namespace Server.Engines.Despise
{
	public class DespiseRegion : BaseRegion
	{
		...
		public DespiseRegion(string name, Rectangle2D[] bounds)
			: this(name, bounds, false) { }

		public DespiseRegion(string name, Rectangle2D[] bounds, bool lowerLevel)
			: base(name, Map.Trammel, Region.DefaultPriority, bounds)
		{
