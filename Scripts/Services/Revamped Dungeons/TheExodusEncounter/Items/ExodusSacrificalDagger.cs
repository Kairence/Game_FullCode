...
namespace Server.Items
{
	...
	public class ExodusSacrificalDagger : BaseKnife
	{
		...
		public class SacrificalTarget : Target
		{
			...
			public SacrificalTarget(Item dagger)
					...
					if (altar.CheckParty(altar.Owner, from))
					{
						...
						if (!SacrificalRitual)
						{
							...
							Effects.SendLocationParticles(
								EffectItem.Create(altar.Location, altar.Map, TimeSpan.FromSeconds(2)),
								0x373A,
								10,
								10,
								2023
	...
	public class ExodusSacrificalGargishDagger : ExodusSacrificalDagger
	{
		...
		public ExodusSacrificalGargishDagger(Serial serial)
			: base(serial) { }
