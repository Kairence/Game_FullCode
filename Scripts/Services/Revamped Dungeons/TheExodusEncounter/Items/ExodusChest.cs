...
namespace Server.Items
{
	public class ExodusChest : DecorativeBox, IRevealableItem
	{
		...
		public static Type[] RituelItem
		{
			get { return m_RituelItem; }
		}

		private static Type[] m_RituelItem = new Type[]
		{
			typeof(ExodusSummoningRite),
			typeof(ExodusSacrificalDagger),
			typeof(RobeofRite),
			typeof(ExodusSummoningAlter),
		};
		...
		public ExodusChest(Serial serial)
			: base(serial) { }
		...
		protected virtual void GenerateTreasure()
		{
			...
			if (0.25 > Utility.RandomDouble())
			{
				...
				{
					case 0:
						item = new ParasiticPotion(Utility.Random(1, 3));
						break;
					case 1:
						item = new InvisibilityPotion(Utility.Random(1, 3));
						break;
				}
	...
	public class ExodusChestRegion : BaseRegion
	{
		...
		public ExodusChest ExodusChest
		{
			get { return m_Chest; }
		}
		...
		public ExodusChestRegion(ExodusChest chest)
			: base(
				null,
				chest.Map,
				Region.Find(chest.Location, chest.Map),
