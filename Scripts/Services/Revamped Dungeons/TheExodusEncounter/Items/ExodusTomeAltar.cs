...
namespace Server.Items
{
	public class ExodusTomeAltar : BaseDecayingItem
	{
		...
		public List<RitualArray> Rituals
		{
			get { return m_Rituals; }
		}
		public Mobile Owner
		{
		...
		private class BeginTheRitual : ContextMenuEntry
		{
			...
			public BeginTheRitual(ExodusTomeAltar altar, Mobile from)
				: base(1153608, 2) // Begin the Ritual
			{
				m_Mobile = from;
				m_altar = altar;
		...
		public virtual void SendConfirmationsExodus(Mobile from)
		{
			...
			if (party != null)
			{
				...
				foreach (PartyMemberInfo info in party.Members)
				{
					...
					if (
						!m_Rituals.Where(z => z.RitualMobile == info.Mobile && z.Ritual1 && z.Ritual2).Any()
						|| robe == null
					)
					{
	...
	public class AltarGump : Gump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(TomeAltarGump_OnCommand)
			);
		}
