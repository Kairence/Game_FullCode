...
{    
    ...
    public class ExodusArchZealotGump : Gump
    {
        ...
        public ExodusArchZealotGump(Mobile owner) : base(50, 50)
        {
            ...
            AddPage(1);
            AddHtmlLocalized(107, 110, 300, 230, 1153671, White, false, true); // Greetings Traveler *sly grin* Can you feel it? Can you feel the awesome power that emanates from this place...surely Lord Exodus will join us again soon, why ?that뭩 why you뭨e here isn뭪 it? To perform the Ritual?
            ...
            AddPage(8);
            AddHtmlLocalized(107, 110, 300, 230, 1153685, White, false, true); // Deep within Exodus Dungeon, minions of Lord Exodus battle fiercely against Lord Dupre뭩 men...slay either one to collect the Keys.
