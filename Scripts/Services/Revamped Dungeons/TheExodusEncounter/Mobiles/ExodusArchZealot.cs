...
namespace Server.Mobiles
{
	public class ExodusArchZealot : Mobile
	{
		...
		public ExodusArchZealot(Serial serial)
			: base(serial) { }
		...
		public class ExodusArchZealotGumpEntry : ContextMenuEntry
		{
			...
			public ExodusArchZealotGumpEntry(Mobile from, Mobile giver)
				: base(6146, 3)
			{
				m_Mobile = from;
				m_Giver = giver;
	...
	public class ExodusArchZealotGump : Gump
	{
		...
		public static void Initialize()
		{
			CommandSystem.Register(
				"ExodusArchZealotGump",
				AccessLevel.GameMaster,
				new CommandEventHandler(ExodusArchZealotGump_OnCommand)
			);
		}
		...
		public ExodusArchZealotGump(Mobile owner)
			: base(50, 50)
		{
			//----------------------------------------------------------------------------------------------------
