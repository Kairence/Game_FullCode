		...
		private class LogoutGump : Gump
		{
			...
			public override void OnResponse(NetState sender, RelayInfo info)
			{
				...
				if (
					info.ButtonID == 1
					&& this.m_Entry.Safe
					&& this.m_BlanketOfDarkness.Parent == null
					&& this.m_BlanketOfDarkness.IsAccessibleTo(pm)
					&& this.m_BlanketOfDarkness.VerifyMove(pm)
					&& this.m_BlanketOfDarkness.Map == pm.Map
					&& pm.InRange(this.m_BlanketOfDarkness, 2)
				)
				{
