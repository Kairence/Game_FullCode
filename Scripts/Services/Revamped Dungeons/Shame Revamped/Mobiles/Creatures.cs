...
namespace Server.Mobiles
{
	...
	public class BurningMage : BaseCreature
	{
		...
		[Constructable]
		public BurningMage()
			: base(AIType.AI_Mage, FightMode.Weakest, 10, 1, 0.4, 0.2)
		{
		...
		public void DoEffects(Mobile from)
		{
			...
			{
				Table[from] = Timer.DelayCall(
					TimeSpan.FromSeconds(1.5),
					TimeSpan.FromSeconds(1.5),
					new TimerStateCallback(SapMana),
	...
	public class CrazedMage : BaseCreature
	{
		...
		[Constructable]
		public CrazedMage()
			: base(AIType.AI_Mystic, FightMode.Weakest, 10, 1, 0.4, 0.2)
		{
			Name = NameList.RandomName("male");
			Title = "the crazed";
