...
namespace Server.Mobiles
{
	...
	public class WarAlligator : CovetousCreature
	{
		...
		public WarAlligator(Serial serial)
			: base(serial) { }
	...
	public class MagmaLizard : CovetousCreature
	{
		...
		public MagmaLizard(Serial serial)
			: base(serial) { }
	...
	public class ViciousDrake : CovetousCreature
	{
		...
		public ViciousDrake(Serial serial)
			: base(serial) { }
	...
	public class CorruptedWyvern : CovetousCreature
	{
		...
		public CorruptedWyvern(Serial serial)
			: base(serial) { }
	...
	public class CovetousWyrm : CovetousCreature
	{
		...
		public CovetousWyrm(Serial serial)
			: base(serial) { }
