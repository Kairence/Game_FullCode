...
namespace Server.Mobiles
{
	...
	public class AngeredSpirit : CovetousCreature
	{
		...
		public AngeredSpirit(Serial serial)
			: base(serial) { }
	...
	public class BoneSwordSlinger : CovetousCreature
	{
		...
		public BoneSwordSlinger(Serial serial)
			: base(serial) { }
	...
	public class VileCadaver : CovetousCreature
	{
		...
		public VileCadaver(Serial serial)
			: base(serial) { }
	...
	public class DiseasedLich : CovetousCreature
	{
		...
		public DiseasedLich(Serial serial)
			: base(serial) { }
	...
	public class CovetousRevenant : CovetousCreature
	{
		...
		public CovetousRevenant(Serial serial)
			: base(serial) { }
