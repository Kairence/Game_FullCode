...
namespace Server.Mobiles
{
	...
	public class CovetousEarthElemental : CovetousCreature
	{
		...
		public CovetousEarthElemental(Serial serial)
			: base(serial) { }
	...
	public class CovetousWaterElemental : CovetousCreature
	{
		...
		public CovetousWaterElemental(Serial serial)
			: base(serial) { }
	...
	public class VortexElemental : CovetousCreature
	{
		...
		public VortexElemental(Serial serial)
			: base(serial) { }
	...
	public class SearingElemental : CovetousCreature
	{
		...
		public SearingElemental(Serial serial)
			: base(serial) { }
	...
	public class VenomElemental : CovetousCreature
	{
		...
		public VenomElemental(Serial serial)
			: base(serial) { }
