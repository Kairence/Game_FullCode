...
namespace Server.Mobiles
{
	public class CovetousCreature : BaseCreature
	{
		...
		{
			get { return Math.Max(1, Level / 5); }
		}
		public virtual int MaxStage
		{
			get { return 15; }
		}
		...
		{
			get { return Utility.RandomMinMax(35, 50); }
		}
		...
		{
			get { return IsMagical ? Utility.RandomMinMax(91, 100) : 1; }
		}
		...
		{
			get { return IsMagical ? 8500 : 1500; }
		}
		...
		public virtual int ResistStart
		{
			get { return 25; }
		}
		public virtual int ResistMax
		{
			get { return 95; }
		}
		...
		public override void OnThink()
		{
			...
			{
				TimeOnWayPoint = new Tuple<WayPoint, DateTime>(
					CurrentWayPoint,
				...
				TimeOnWayPoint != null
				&& TimeOnWayPoint.Item1 == CurrentWayPoint
				&& TimeOnWayPoint.Item2 < DateTime.UtcNow
			)
			{
				if (CheckCanTeleport())
		...
		protected virtual bool CheckCanTeleport()
		{
			if (
				...
				|| Frozen
				|| Paralyzed
				|| (Combatant is Mobile && ((Mobile)Combatant).InLOS(this))
			)
				return false;
		...
		public CovetousCreature(Serial serial)
			: base(serial) { }
