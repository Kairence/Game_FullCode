...
namespace Server.Engines.Blackthorn
{
	public class Invader : BaseCreature
	{
		...
		{
			get { return AI == AIType.AI_Melee || AI == AIType.AI_Paladin ? 1.0 : 0.0; }
		}
		public override double WeaponAbilityChance
		{
			get { return AI == AIType.AI_Melee || AI == AIType.AI_Paladin ? 0.4 : 0.1; }
		}
		public override bool CanStealth
		{
			get { return _Specialty == SkillName.Ninjitsu; }
		}
		...
		public virtual double MinSkill
		{
			get { return 100.0; }
		}
		public virtual double MaxSkill
		{
			get { return 120.0; }
		}
		public virtual int MinResist
		{
			get { return 10; }
		}
		public virtual int MaxResist
		{
			get { return 20; }
		}
		...
		private void StandardMeleeEquip()
		{
			SetWearable(
				Loot.Construct(
					new Type[] { typeof(Bascinet), typeof(Helmet), typeof(LeatherCap), typeof(RoyalCirclet) }
				)
			);
		...
		public static AIType GetAI(SkillName skill)
		{
			switch (skill)
			{
				...
				case SkillName.Ninjitsu:
					return AIType.AI_Ninja;
				case SkillName.Bushido:
					return AIType.AI_Samurai;
				case SkillName.Chivalry:
					return AIType.AI_Paladin;
				case SkillName.Magery:
					return AIType.AI_Mage;
				case SkillName.Necromancy:
					return AIType.AI_NecroMage;
				case SkillName.Spellweaving:
					return AIType.AI_Spellweaving;
				case SkillName.Mysticism:
					return AIType.AI_Mystic;
			}
		}
		...
		public Item RandomFencingWeapon()
		{
			...
			return Loot.Construct(
				new Type[] { typeof(Kryss), typeof(Spear), typeof(ShortSpear), typeof(Lance), typeof(Pike) }
			);
		}
		...
		public override void OnThink()
		{
			...
			else if (_Sampire)
			{
				if (
					...
					&& Weapon is BaseWeapon
					&& !CurseWeaponSpell.IsCursed(this, (BaseWeapon)Weapon)
				)
				{
				...
				() =>
				{
					if (m != null)
					{
						...
						foreach (Mobile mob in eable)
						{
							...
							if (
								mob is PlayerMobile
								|| (mob is BaseCreature && ((BaseCreature)mob).GetMaster() is PlayerMobile)
									&& CanBeHarmful(mob)
							)
								list.Add(mob);
						}
	...
	{
		public override double MinSkill
		{
			get { return 105.0; }
		}
		public override double MaxSkill
		{
			get { return 130.0; }
		}
		public override int MinResist
		{
			get { return 20; }
		}
		public override int MaxResist
		{
			get { return 30; }
		}

		[Constructable]
		public InvaderCaptain(InvasionType type)
			: base(type)
		{
			SetStr(250);
