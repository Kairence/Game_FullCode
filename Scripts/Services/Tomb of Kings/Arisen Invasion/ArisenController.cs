...
namespace Server.Items
{
	public class ArisenController : Item
	{
		...
		public class ArisenEntry
		{
			...
			public XmlSpawner CreateSpawner()
			{
				XmlSpawner spawner = new XmlSpawner(
					m_Amount,
					(int)m_MinDelay.TotalSeconds,
					(int)m_MaxDelay.TotalSeconds,
					0,
					20,
					10,
					m_Creature
		...
		public static ArisenEntry[] Entries
		{
		...
		public static ArisenController Instance
		{
		...
		public static void Initialize()
		{
			CommandSystem.Register(
				"ArisenGenerate",
				AccessLevel.Owner,
				new CommandEventHandler(ArisenGenerate_OnCommand)
			);
