...
namespace Server.Engines.Harvest
{
	public class HarvestDefinition
	{
		...
		{
			get { return this.m_BankWidth; }
			set { this.m_BankWidth = value; }
		}
		public int BankHeight
		{
			get { return this.m_BankHeight; }
			set { this.m_BankHeight = value; }
		}
		public int MinTotal
		{
			get { return this.m_MinTotal; }
			set { this.m_MinTotal = value; }
		}
		public int MaxTotal
		{
			get { return this.m_MaxTotal; }
			set { this.m_MaxTotal = value; }
		}
		public int[] Tiles
		{
		...
		{
			get { return m_SpecialTiles; }
			set { m_SpecialTiles = value; }
		}
		public bool RangedTiles
		{
			get { return this.m_RangedTiles; }
			set { this.m_RangedTiles = value; }
		}
		public TimeSpan MinRespawn
		{
			get { return this.m_MinRespawn; }
			set { this.m_MinRespawn = value; }
		}
		public TimeSpan MaxRespawn
		{
			get { return this.m_MaxRespawn; }
			set { this.m_MaxRespawn = value; }
		}
		public int MaxRange
		{
			get { return this.m_MaxRange; }
			set { this.m_MaxRange = value; }
		}
		public int ConsumedPerHarvest
		{
			get { return this.m_ConsumedPerHarvest; }
			set { this.m_ConsumedPerHarvest = value; }
		}
		public int ConsumedPerFeluccaHarvest
		{
			get { return this.m_ConsumedPerFeluccaHarvest; }
			set { this.m_ConsumedPerFeluccaHarvest = value; }
		}
		public bool PlaceAtFeetIfFull
		{
			get { return this.m_PlaceAtFeetIfFull; }
			set { this.m_PlaceAtFeetIfFull = value; }
		}
		public SkillName Skill
		{
			get { return this.m_Skill; }
			set { this.m_Skill = value; }
		}
		public int[] EffectActions
		{
			get { return this.m_EffectActions; }
			set { this.m_EffectActions = value; }
		}
		public int[] EffectCounts
		{
			get { return this.m_EffectCounts; }
			set { this.m_EffectCounts = value; }
		}
		public int[] EffectSounds
		{
			get { return this.m_EffectSounds; }
			set { this.m_EffectSounds = value; }
		}
		public TimeSpan EffectSoundDelay
		{
			get { return this.m_EffectSoundDelay; }
			set { this.m_EffectSoundDelay = value; }
		}
		public TimeSpan EffectDelay
		{
			get { return this.m_EffectDelay; }
			set { this.m_EffectDelay = value; }
		}
		public object NoResourcesMessage
		{
			get { return this.m_NoResourcesMessage; }
			set { this.m_NoResourcesMessage = value; }
		}
		public object OutOfRangeMessage
		{
			get { return this.m_OutOfRangeMessage; }
			set { this.m_OutOfRangeMessage = value; }
		}
		public object TimedOutOfRangeMessage
		{
			get { return this.m_TimedOutOfRangeMessage; }
			set { this.m_TimedOutOfRangeMessage = value; }
		}
		public object DoubleHarvestMessage
		{
			get { return this.m_DoubleHarvestMessage; }
			set { this.m_DoubleHarvestMessage = value; }
		}
		public object FailMessage
		{
			get { return this.m_FailMessage; }
			set { this.m_FailMessage = value; }
		}
		public object PackFullMessage
		{
			get { return this.m_PackFullMessage; }
			set { this.m_PackFullMessage = value; }
		}
		public object ToolBrokeMessage
		{
			get { return this.m_ToolBrokeMessage; }
			set { this.m_ToolBrokeMessage = value; }
		}
		...
		{
			get { return this.m_Veins; }
			set { this.m_Veins = value; }
		}
		public BonusHarvestResource[] BonusResources
		{
			get { return this.m_BonusResources; }
			set { this.m_BonusResources = value; }
		}
		public bool RaceBonus
		{
			get { return this.m_RaceBonus; }
			set { this.m_RaceBonus = value; }
		}
		public bool RandomizeVeins
		{
			get { return this.m_RandomizeVeins; }
			set { this.m_RandomizeVeins = value; }
		}
		public Dictionary<Map, Dictionary<Point2D, HarvestBank>> Banks
		{
			get { return this.m_BanksByMap; }
			set { this.m_BanksByMap = value; }
		}
