...
namespace Server.Items
{
	...
	public class PuzzleChestSolution
	{
		...
		public PuzzleChestSolution(
			PuzzleChestCylinder first,
			PuzzleChestCylinder second,
			PuzzleChestCylinder third,
			PuzzleChestCylinder fourth,
			PuzzleChestCylinder fifth
		)
		{
			this.First = first;
			this.Second = second;
		...
		{
			get { return this.m_Cylinders; }
		}
		public PuzzleChestCylinder First
		{
			get { return this.m_Cylinders[0]; }
			set { this.m_Cylinders[0] = value; }
		}
		public PuzzleChestCylinder Second
		{
			get { return this.m_Cylinders[1]; }
			set { this.m_Cylinders[1] = value; }
		}
		public PuzzleChestCylinder Third
		{
			get { return this.m_Cylinders[2]; }
			set { this.m_Cylinders[2] = value; }
		}
		public PuzzleChestCylinder Fourth
		{
			get { return this.m_Cylinders[3]; }
			set { this.m_Cylinders[3] = value; }
		}
		public PuzzleChestCylinder Fifth
		{
			get { return this.m_Cylinders[4]; }
			set { this.m_Cylinders[4] = value; }
		}
	...
	public abstract class PuzzleChest : BaseTreasureChest
	{
		...
		{
			get { return this.m_Hints; }
		}
		public PuzzleChestCylinder FirstHint
		{
			get { return this.m_Hints[0]; }
			set { this.m_Hints[0] = value; }
		}
		public PuzzleChestCylinder SecondHint
		{
			get { return this.m_Hints[1]; }
			set { this.m_Hints[1] = value; }
		}
		public PuzzleChestCylinder ThirdHint
		{
			get { return this.m_Hints[2]; }
			set { this.m_Hints[2] = value; }
		}
		...
		public class PuzzleGump : Gump
		{
			...
			public override void OnResponse(NetState sender, RelayInfo info)
			{
				...
				if (
					this.m_From.IsPlayer()
					&& (this.m_From.Map != this.m_Chest.Map || !this.m_From.InRange(this.m_Chest.GetWorldLocation(), 2))
				)
				{
