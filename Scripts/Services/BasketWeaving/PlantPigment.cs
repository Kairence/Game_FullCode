		...
		private class InternalTarget : Target
		{
			...
			protected override void OnTarget(Mobile from, object targeted)
			{
				...
				if (from.Skills[SkillName.Alchemy].Base < 75.0 && from.Skills[SkillName.Cooking].Base < 75.0)
				{
					...
					(
						PlantPigmentHue.White == pigment.PigmentHue
						|| PlantPigmentHue.Black == pigment.PigmentHue
						|| PlantPigmentHue.White == m_Item.PigmentHue
						|| PlantPigmentHue.Black == m_Item.PigmentHue
					)
				...
				else if (m_Item.PigmentHue == pigment.PigmentHue)
				{
					...
					(m_Item.PigmentHue & ~(PlantPigmentHue.Bright | PlantPigmentHue.Dark | PlantPigmentHue.Ice))
				...
				)
				{
					...
					(PlantPigmentHue.White == m_Item.PigmentHue && PlantPigmentHueInfo.IsBright(pigment.PigmentHue))
