...
namespace Server.Items
{
	public class PetTrainingGate : Item
	{
		...
		{
			get { return "Pet Training Gate - You Must Start Pet Training Before Bringing Your Pet Through The Gate!"; }
		}
		...
		public override bool OnMoveOver(Mobile m)
		{
			if (m is BaseCreature)
			{
				...
				if (
					...
					&& bc.ControlMaster.InRange(bc.Location, 25)
					&& profile != null
					&& profile.HasBegunTraining
	...
	public class PetBondRemoveGate : Item
	{
		...
		public override string DefaultName
		{
			get { return "Pet Bond Timer Remover"; }
		}
