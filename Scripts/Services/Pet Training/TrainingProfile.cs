...
namespace Server.Mobiles
{
	...
	public class TrainingProfile
	{
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public double TrainingProgressPercentile
		{
			get { return TrainingProgress / TrainingProgressMax; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ControlSlots
		{
			get { return Creature.ControlSlots; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ControlSlotsMin
		{
			get { return Creature.ControlSlotsMin; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ControlSlotsMax
		{
			get { return Creature.ControlSlotsMax; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public bool CanApplyOptions
		{
			get { return HasBegunTraining && TrainingProgressPercentile >= 1.0; }
		}
		...
		private int GetGainsPerCreature(double toGain)
		{
			...
			switch (ControlSlots)
			{
				...
				case 2:
					...
					break;
				case 3:
					gains = (int)(((double)MaxTrainingProgress / toGain) / 2.0);
					break;
				default:
					gains = (int)(((double)MaxTrainingProgress / toGain) / 4.0);
					break;
			}
		...
		{
			if (
				ControlSlots >= ControlSlotsMax
				|| !HasBegunTraining
				|| TrainingProgress >= TrainingProgressMax
