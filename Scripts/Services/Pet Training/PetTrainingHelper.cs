...
namespace Server.Mobiles
{
	...
	public enum MagicalAbility
	{
		...
		GrizzledMare =
			BattleDefense | Bashing | Necromage | Necromancy | Piercing | Poisoning | Slashing | WrestlingMastery,
	...
	public static class PetTrainingHelper
	{
		...
		public static List<TrainingPoint> TrainingPoints
		{
		...
		public static TrainingPoint GetTrainingPoint(object o)
		{
			foreach (var tp in _TrainingPoints)
			{
				...
				if (
					tp.TrainPoint is MagicalAbility
					&& o is MagicalAbility
					&& (MagicalAbility)tp.TrainPoint == (MagicalAbility)o
				)
					return tp;

				if (
					tp.TrainPoint is SpecialAbility
					&& o is SpecialAbility
					&& (SpecialAbility)tp.TrainPoint == (SpecialAbility)o
				)
					return tp;

				if (
					tp.TrainPoint is WeaponAbility
					&& o is WeaponAbility
					&& (WeaponAbility)tp.TrainPoint == (WeaponAbility)o
				)
					return tp;
				...
				if (
					tp.TrainPoint is ResistanceType
					&& o is ResistanceType
					&& (ResistanceType)tp.TrainPoint == (ResistanceType)o
				)
					return tp;
			}
		...
		public static void LoadDefinitions()
		{
			...
			SpecialAbilityBites = new SpecialAbility[] { SpecialAbility.VenomousBite, SpecialAbility.ViciousBite };
			...
			SpecialAbilitySabreTri = new SpecialAbility[] { SpecialAbility.SearingWounds, SpecialAbility.TailSwipe };
			...
			AreaEffectExplosiveGoo = new AreaEffect[] { AreaEffect.ExplosiveGoo };

			AreaEffectEarthen = new AreaEffect[] { AreaEffect.EssenceOfEarth, AreaEffect.ExplosiveGoo };

			AreaEffectDisease = new AreaEffect[] { AreaEffect.AuraOfNausea, AreaEffect.EssenceOfDisease };
			...
			Definitions = new TrainingDefinition[]
			{
				...
				new TrainingDefinition(
					typeof(BakeKitsune),
					Class.ClawedTailedAndTokuno,
					MagicalAbility.Tokuno1,
					SpecialAbilityClawedTailedAndMagical2,
					WepAbility2,
					AreaEffectArea1,
					3,
					5
				...
				new TrainingDefinition(
					typeof(ColdDrake),
					Class.None,
					MagicalAbility.ColdDrake,
					SpecialAbilityNone,
					WepAbility2,
					new AreaEffect[] { AreaEffect.AuraOfEnergy, AreaEffect.ExplosiveGoo, AreaEffect.EssenceOfEarth },
					3,
					5
				),
				new TrainingDefinition(
				...
				new TrainingDefinition(
					...
					2,
					5
				), // CrimsonDrake[Poison] = AreaEffectArea2
				new TrainingDefinition(
					typeof(CuSidhe),
					Class.MagicalClawedAndTailed,
				...
				new TrainingDefinition(
					...
					Class.Insectoid,
					MagicalAbility.Poisoning,
					SpecialAbilityMagicalInsectoid,
					WepAbility5,
					AreaEffectNone,
					1,
					4
				...
				new TrainingDefinition(
					typeof(DreadSpider),
					Class.MagicalNecromanticAndTokuno,
					MagicalAbility.DreadSpider,
					SpecialAbilityDreadSpider,
					WepAbility2,
					AreaEffectArea2,
					3,
					5
				...
				new TrainingDefinition(
					...
					MagicalAbility.DreadWarhorse,
					new SpecialAbility[] { SpecialAbility.DragonBreath },
					WepAbility2,
					AreaEffectArea2,
					3,
					5
				...
				new TrainingDefinition(
					typeof(FireBeetle),
					Class.MagicalAndInsectoid,
					MagicalAbility.StandardClawedOrTailed,
					SpecialAbilityMagicalInsectoid,
					WepAbility1,
					AreaEffectExplosiveGoo,
					1,
					5
				),
				new TrainingDefinition(
				...
				new TrainingDefinition(
					typeof(GiantIceWorm),
					Class.Tailed,
					MagicalAbility.Variety1,
					SpecialAbilityBitingTailed,
					WepAbility2,
					AreaEffectArea3,
					1,
					2
				...
				new TrainingDefinition(
					typeof(Imp),
					Class.MagicalClawedTailedAndNecromantic,
					MagicalAbility.Variety2,
					SpecialAbilityImp,
					WepAbility2,
					AreaEffectArea2,
					2,
				...
				new TrainingDefinition(
					...
					Class.ClawedAndTailed,
					MagicalAbility.Poisoning,
					SpecialAbilityBitingClawedAndTailed,
					WepAbility1,
					AreaEffectArea3,
					2,
					5
				...
				new TrainingDefinition(
					typeof(Najasaurus),
					Class.StickySkinAndTailed,
					MagicalAbility.Variety1,
					SpecialAbilityTailedAndStickySkin,
					WepAbility1,
					AreaEffectArea3,
					2,
					5
				...
				new TrainingDefinition(
					...
					Class.ClawedAndTailed,
					MagicalAbility.SabreToothedTiger,
					SpecialAbilitySabreTri,
					WepAbility1,
					AreaEffectNone,
					2,
					5
				...
				new TrainingDefinition(
					...
					Class.MagicalClawedAndTailed,
					MagicalAbility.Dragon2,
					SpecialAbilityClawedTailedAndMagical1,
					WepAbility2,
					AreaEffectArea1,
					3,
					5
				...
				new TrainingDefinition(
					typeof(CoconutCrab),
					Class.None,
					MagicalAbility.CoconutCrab,
					SpecialAbilityCoconutCrab,
					WepAbility2,
					AreaEffectArea2,
					1,
					3
		...
		public static void Configure()
		{
			...
			for (int i = 0; i < SpecialAbility.Abilities.Length; i++)
			{
				...
				_TrainingPoints.Add(
					new TrainingPoint(SpecialAbility.Abilities[i], 1.0, 100, 100, loc[i][0], loc[i][1])
				);
			}
		...
		{
			var projected = Math.Min(
				BaseCreature.MaxTameRequirement,
				bc.CurrentTameSkill + trainProfile.GetRequirementIncrease(!trainProfile.HasIncreasedControlSlot)
			);
		...
		public static int GetTotalStatWeight(BaseCreature bc)
		{
			...
			int v = (int)(
				Math.Min((double)bc.RawStr * str.Weight, str.GetMax(bc) * str.Weight)
		...
		public static int GetTotalAttributeWeight(BaseCreature bc)
		{
			...
			int v = (int)(
				Math.Min((double)bc.HitsMax * hits.Weight, hits.GetMax(bc) * hits.Weight)
		...
		public static int GetTotalResistWeight(BaseCreature bc)
		{
			...
			return (int)(
				((double)bc.PhysicalResistanceSeed * phys.Weight)
		...
		public static void GetStartValue(TrainingPoint tp, BaseCreature bc, ref int value)
		{
			if (tp.Start != tp.Max)
			{
				if (tp.TrainPoint is PetStat)
				{
					...
					{
						case PetStat.Str:
							value = Math.Max(bc.RawStr, value);
							break;
						case PetStat.Dex:
							value = Math.Max(bc.RawDex, value);
							break;
						case PetStat.Int:
							value = Math.Max(bc.RawInt, value);
							break;
						case PetStat.Hits:
							value = Math.Max(bc.HitsMax, value);
							break;
						case PetStat.Stam:
							value = Math.Max(bc.StamMax, value);
							break;
						case PetStat.Mana:
							value = Math.Max(bc.ManaMax, value);
							break;
						case PetStat.RegenHits:
							value = Math.Max(profile.RegenHits, value);
							break;
						case PetStat.RegenStam:
							value = Math.Max(profile.RegenStam, value);
							break;
						case PetStat.RegenMana:
							value = Math.Max(profile.RegenMana, value);
							break;
				...
				else if (tp.TrainPoint is ResistanceType)
				{
					switch ((ResistanceType)tp.TrainPoint)
					{
						case ResistanceType.Physical:
							value = Math.Max(bc.PhysicalResistanceSeed, value);
							break;
						case ResistanceType.Fire:
							value = Math.Max(bc.FireResistSeed, value);
							break;
						case ResistanceType.Cold:
							value = Math.Max(bc.ColdResistSeed, value);
							break;
						case ResistanceType.Poison:
							value = Math.Max(bc.PoisonResistSeed, value);
							break;
						case ResistanceType.Energy:
							value = Math.Max(bc.EnergyResistSeed, value);
							break;
					}
				}
		...
		public static bool ApplyTrainingPoint(BaseCreature bc, TrainingPoint trainingPoint, int value)
		{
			...
			if (trainingPoint.TrainPoint is PetStat)
			{
				...
				switch (stat)
				{
					...
					case PetStat.Mana:
						...
						break;
					case PetStat.RegenHits:
						profile.RegenHits = value;
						break;
					case PetStat.RegenStam:
						profile.RegenStam = value;
						break;
					case PetStat.RegenMana:
						profile.RegenMana = value;
						break;
					case PetStat.BaseDamage:
			...
			else if (trainingPoint.TrainPoint is ResistanceType)
			{
				...
				{
					case ResistanceType.Physical:
						bc.PhysicalResistanceSeed = value;
						break;
					case ResistanceType.Fire:
						bc.FireResistSeed = value;
						break;
					case ResistanceType.Cold:
						bc.ColdResistSeed = value;
						break;
					case ResistanceType.Poison:
						bc.PoisonResistSeed = value;
						break;
					case ResistanceType.Energy:
						bc.EnergyResistSeed = value;
						break;
				}
		...
		public static bool ValidateTrainingPoint(BaseCreature bc, SpecialAbility ability)
		{
			...
			return profile != null
				&& (ability == SpecialAbility.ViciousBite || ability == SpecialAbility.VenomousBite)
				&& profile.HasAbility(MagicalAbility.Poisoning);
		}
		...
		public static bool ValidateTrainingPoint(BaseCreature bc, AreaEffect ability)
		{
			...
			return profile != null
				&& ability == AreaEffect.PoisonBreath
				&& profile.HasAbility(MagicalAbility.Poisoning);
		}
		...
		public static void OnWeaponAbilityUsed(BaseCreature bc, SkillName skill)
		{
			if (Enabled && bc.Controlled)
			{
				...
				if (
					profile != null /* && profile.TokunoTame*/
				)
				{
		...
		public static TextDefinition[][] MagicalAbilityLocalizations
		{
			get { return _MagicalAbilityLocalizations; }
		}
		...
		public static TextDefinition[][] SpecialAbilityLocalizations
		{
			get { return _SpecialAbilityLocalizations; }
		}
		...
		public static TextDefinition[][] AreaEffectLocalizations
		{
			get { return _AreaEffectLocalizations; }
		}
		...
		public static TextDefinition[][] WeaponAbilityLocalizations
		{
			get { return _WeaponAbilityLocalizations; }
		}
