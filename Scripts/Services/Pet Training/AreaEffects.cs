...
namespace Server.Mobiles
{
	public abstract class AreaEffect
	{
		...
		public virtual int EffectRange
		{
			get { return 5; }
		}
		...
		public static AreaEffect[] Effects
		{
			get { return _Effects; }
		}
		...
		{
			get { return _Effects[5]; }
		}

		public static AreaEffect PoisonBreath
		{
			get { return _Effects[6]; }
		}
	}
	...
	public class AuraOfNausea : AreaEffect
	{
		...
		{
			get { return TimeSpan.FromSeconds(40 + Utility.RandomDouble() * 30); }
		}
		public override int MaxRange
		{
			get { return 4; }
		}
		public override int EffectRange
		{
			get { return 4; }
		}
	...
	public class ExplosiveGoo : AreaEffect
	{
		...
		public override void DoEffect(BaseCreature creature, Mobile defender)
		{
			Timer.DelayCall<Mobile>(
				TimeSpan.FromMilliseconds(Utility.RandomMinMax(10, 1000)),
				m =>
				{
					if (m.Alive && !m.Deleted && m.Map != null)
					{
						...
						for (int x = -1; x <= 1; x++)
						{
							for (int y = -1; y <= 1; y++)
							{
								Server.Effects.SendLocationEffect(
