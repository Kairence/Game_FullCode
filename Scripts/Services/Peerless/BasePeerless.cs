...
namespace Server.Mobiles
{
	public class BasePeerless : BaseCreature
	{
		...
		public virtual bool DropPrimer
		{
			get { return Core.TOL; }
		}
		public virtual bool GiveMLSpecial
		{
			get { return true; }
		}
				...
				if (0.05 > Utility.RandomDouble())
				{
					switch (Utility.Random(32))
					{
						...
						case 4:
							...
							break;
						case 5:
							c.DropItem(new DeathArms());
							break;
						case 6:
							c.DropItem(new DeathLegs());
							break;
						case 7:
							c.DropItem(new DeathBoneHelm());
							break;
						case 8:
						...
						case 18:
							...
							break;
						case 19:
							c.DropItem(new PaladinLegs());
							break;
						case 20:
							c.DropItem(new PaladinHelm());
							break;
						case 21:
							c.DropItem(new PaladinChest());
							break;
						case 22:
		...
		#region Fire Ring
		private static readonly int[] m_North = new int[] { -1, -1, 1, -1, -1, 2, 1, 2 };

		private static readonly int[] m_East = new int[] { -1, 0, 2, 0 };
