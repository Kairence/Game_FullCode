...
namespace Server.Engines.Plants
{
	...
	{
		public override bool MaginciaPlant
		{
			get { return true; }
		}
		...
		{
			get { return 501648; }
		} // You cannot use this unless you are the owner.
		...
		{
			get { return RootParent == null && !Movable; }
		}
		...
		public override void GetProperties(ObjectPropertyList list)
		{
			...
			if (Owner != null)
			{
				...
				if (IsContract)
				{
					DateTime easternTime = TimeZoneInfo.ConvertTimeFromUtc(
						ContractEndTime,
