...
namespace Server.Engines.NewMagincia
{
	...
	public class MaginciaHousingPlot
	{
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public MaginciaPlotStone Stone
		{
			get { return m_Stone; }
			set { m_Stone = value; }
		}
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public bool IsPrimeSpot
		{
			get { return m_IsPrimeSpot; }
		}
		...
		{
			get { return new Point3D(m_Bounds.X, m_Bounds.Y, m_Map.GetAverageZ(m_Bounds.X, m_Bounds.Y)); }
		}
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public DateTime LottoEnds
		{
			get { return m_LottoEnds; }
			set { m_LottoEnds = value; }
		}

		public Dictionary<Mobile, int> Participants
		{
		...
		{
			get { return m_IsPrimeSpot ? 10000 : 2000; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public bool LottoOngoing
		{
			get { return IsAvailable && m_LottoEnds > DateTime.UtcNow && m_LottoEnds != DateTime.MinValue; }
		}
		#endregion
