...
namespace Server.Engines.NewMagincia
{
	public class LottoTrackingGump : Gump
	{
			...
			: base(50, 50)
		{
			...
			AddHtml(
				...
				205,
				20,
				"<DIV ALIGN=RIGHT><Basefont Color=#FFFFFF>New Magincia Lotto Tracking</DIV>",
				false,
				false
			);
			AddHtml(
				...
				205,
				20,
				Color(String.Format("Gold Sink: {0}", MaginciaLottoSystem.GoldSink.ToString("###,###,###")), 0xFFFFFF),
				false,
				false
			);
	...
	{
		public PlotTrackingGump(MaginciaHousingPlot plot)
			: base(50, 50)
		{
			...
			AddHtml(
				...
				580,
				20,
				String.Format("<Center><Basefont Color=#FFFFFF>Plot {0}</Center>", plot.Identifier),
				false,
				false
			);
			...
			AddHtml(
				...
				150,
				20,
				Color(String.Format("Gold Sink: {0}", goldSink.ToString()), 0xFFFFFF),
				false,
				false
			);
