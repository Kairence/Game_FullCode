...
namespace Server.Engines.NewMagincia
{
	public abstract class BaseBazaarBroker : BaseCreature
	{
		...
		public virtual int ComissionFee
		{
			get { return MaginciaBazaar.DefaultComissionFee; }
		}
		...
		public BaseBazaarBroker(MaginciaBazaarPlot plot)
		...
		public virtual void InitOutfit()
		{
			switch (Utility.Random(3))
			{
				case 0:
					...
					break;
				case 1:
					EquipItem(new Doublet(GetRandomHue()));
					break;
				case 2:
					EquipItem(new Shirt(GetRandomHue()));
					break;
			}
			...
			if (Female)
			{
				...
				{
					case 0:
						EquipItem(new ShortPants(GetRandomHue()));
						break;
					case 1:
					case 2:
						EquipItem(new Kilt(GetRandomHue()));
						break;
					case 3:
					case 4:
					case 5:
						EquipItem(new Skirt(GetRandomHue()));
						break;
				}
			}
			else
			{
				...
				{
					case 0:
						EquipItem(new LongPants(GetRandomHue()));
						break;
					case 1:
						EquipItem(new ShortPants(GetRandomHue()));
						break;
		...
		public BaseBazaarBroker(Serial serial)
			: base(serial) { }
