...
namespace Server.Engines.NewMagincia
{
	public class PetBroker : BaseBazaarBroker
	{
		...
		public List<PetBrokerEntry> BrokerEntries
		{
			get { return m_BrokerEntries; }
		}

		public static readonly int MaxEntries = 10;

		public PetBroker(MaginciaBazaarPlot plot)
			: base(plot)
		{
			FollowersMax = 500;
		}
		...
		private class InternalTimer : Timer
		{
			...
			public InternalTimer(BaseCreature bc)
		...
		public PetBroker(Serial serial)
			: base(serial) { }
