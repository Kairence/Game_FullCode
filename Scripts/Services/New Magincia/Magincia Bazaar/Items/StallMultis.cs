...
namespace Server.Engines.NewMagincia
{
	public class BaseBazaarMulti : BaseMulti
	{
		...
		public BaseBazaarMulti(Serial serial)
			: base(serial) { }
	...
	public class CommodityStyle1 : BaseBazaarMulti
	{
		...
		public CommodityStyle1(Serial serial)
			: base(serial) { }
	...
	public class CommodityStyle2 : BaseBazaarMulti
	{
		...
		public CommodityStyle2(Serial serial)
			: base(serial) { }
	...
	public class CommodityStyle3 : BaseBazaarMulti
	{
		...
		public CommodityStyle3(Serial serial)
			: base(serial) { }
	...
	public class PetStyle1 : BaseBazaarMulti
	{
		...
		public PetStyle1(Serial serial)
			: base(serial) { }
	...
	public class PetStyle2 : BaseBazaarMulti
	{
		...
		public PetStyle2(Serial serial)
			: base(serial) { }
	...
	public class PetStyle3 : BaseBazaarMulti
	{
		...
		public PetStyle3(Serial serial)
			: base(serial) { }
