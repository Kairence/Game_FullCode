...
namespace Server.Engines.NewMagincia
{
	public class CommodityBrokerEntry
	{
		...
		{
			get { return m_CommodityType; }
		}
		public CommodityBroker Broker
		{
			get { return m_Broker; }
		}
		public int ItemID
		...
		public int SellPricePer
		{
			get { return m_SellPricePer; }
			set { m_SellPricePer = value; }
		}
		public int BuyPricePer
		{
			get { return m_BuyPricePer; }
			set { m_BuyPricePer = value; }
		}
		public int BuyLimit
		{
			get { return m_BuyLimit; }
			set { m_BuyLimit = value; }
		}
		public int SellLimit
		{
			get { return m_SellLimit; }
			set { m_SellLimit = value; }
		}
		public int Stock
		{
			get { return m_Stock; }
		...
		public bool PlayerCanSell(int amount)
		{
			...
			return (m_BuyLimit == 0 || amount <= ActualBuyLimit)
				&& m_Stock > 0
				&& m_BuyPricePer > 0
				&& m_BuyPricePer <= m_Broker.BankBalance;
		}
	...
	public class PetBrokerEntry
	{
		...
		public static Dictionary<Type, string> NameBuffer
		{
			get { return m_NameBuffer; }
		}

		public static readonly int DefaultPrice = 1000;

		public PetBrokerEntry(BaseCreature pet)
			: this(pet, DefaultPrice) { }
