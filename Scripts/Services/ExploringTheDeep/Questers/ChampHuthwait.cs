...
namespace Server.Mobiles
{
	public class ChampHuthwait : Mobile
	{
		...
		public ChampHuthwait(Serial serial)
			: base(serial) { }
...
namespace Server.Gumps
{
	public class ChampHuthwaitGump : Gump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(ChampHuthwaitGump_OnCommand)
			);
		}
		...
		public ChampHuthwaitGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = false;
	...
	public class ChampHuthwaitCompleteGump : Gump
	{
		...
		{
			CommandSystem.Register(
				"ChampHuthwaitComplete",
				AccessLevel.GameMaster,
				new CommandEventHandler(ChampHuthwaitCompleteGump_OnCommand)
			);
		}
		...
		public ChampHuthwaitCompleteGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = false;
			this.Disposable = true;
