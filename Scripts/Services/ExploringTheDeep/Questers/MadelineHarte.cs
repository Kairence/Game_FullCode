...
namespace Server.Mobiles
{
	public class MadelineHarte : Mobile
	{
		...
		public MadelineHarte(Serial serial)
			: base(serial) { }
...
public class MadelineHarteCompleteGump : Gump
{
	public static void Initialize()
	{
		CommandSystem.Register(
			"MadelineHarteComplete",
			AccessLevel.GameMaster,
			new CommandEventHandler(MadelineHarteCompleteGump_OnCommand)
		);
	}
	...
	public MadelineHarteCompleteGump(Mobile owner)
		: base(50, 50)
	{
		this.Closable = false;
...
public class MadelineHarteGump : Gump
{
	public static void Initialize()
	{
		CommandSystem.Register(
			"MadelineHarte",
			AccessLevel.GameMaster,
			new CommandEventHandler(MadelineHarteGump_OnCommand)
		);
	}
	...
	public MadelineHarteGump(Mobile owner)
		: base(50, 50)
	{
		this.Closable = false;
		this.Disposable = true;
