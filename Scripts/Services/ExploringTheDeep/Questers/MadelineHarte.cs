...
public class MadelineHarteCompleteGump : Gump
{
    ...
    public MadelineHarteCompleteGump(Mobile owner) : base(50, 50)
    {
        ...
        AddPage(1);
        AddHtmlLocalized(107, 140, 300, 150, 1154302, 0x7FFF, false, true); // Oh! You뭭e found his hat! Did you...*pauses and appears to begin to cry but regains her composure?Oh, I see.  At least he showed Valor...I thank you for give me closure.  I had a chance to read the note from Cousteau, this should be what you need.
...
public class MadelineHarteGump : Gump
{
    ...
    public MadelineHarteGump(Mobile owner) : base(50, 50)
    {
        ...
        AddPage(1);
        AddHtmlLocalized(107, 140, 300, 150, 1154300, 0x7FFF, false, true); // *You notice a woman whimpering as she struggles through manipulating the spinning wheel, you smile at her and hand her the note* Oh, hello, *wipes tear*...I뭢 sorry did you need something...It뭩 just that...*begins crying again*...my son Willem has been killed Destard! If only I had something to remember him by...
