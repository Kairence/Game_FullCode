...
namespace Server.Mobiles
{
	public class HeplerPaulson : BaseVendor
	{
		...
		public HeplerPaulson(Serial serial)
			: base(serial) { }
		...
		public override void OnDoubleClick(Mobile m)
		{
			...
			Item lens = m.Backpack.FindItemByType(
				m.Race == Race.Gargoyle ? typeof(GargishNictitatingLens) : typeof(NictitatingLens)
			);
	...
	public class HeplerPaulsonGump : StoryGump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(HeplerPaulsonGump_OnCommand)
			);
		}
	...
	public class HeplerPaulsonCompleteGump : StoryGump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				AccessLevel.GameMaster,
				new CommandEventHandler(HeplerPaulsonCompleteGump_OnCommand)
			);
		}
	...
	public class HeplerPaulsonCollectCompleteGump : StoryGump
	{
		...
		{
			CommandSystem.Register(
				"HeplerPaulsonCollectComplete",
				AccessLevel.GameMaster,
				new CommandEventHandler(HeplerPaulsonCollectCompleteGump_OnCommand)
			);
		}
		...
		private static PageData[] GumpInfo = { new PageData(1, 1154319) };
