...
namespace Server.Gumps
{
    ...
    public class CousteauPerronPlansGump : Gump
    {
        ...
        public CousteauPerronPlansGump(Mobile owner) : base(50, 50)
        {
            ...
            AddPage(1);
            AddHtmlLocalized(107, 140, 300, 150, 1154293, 0x7FFF, false, true); // This is exactly what I was talking about! How did you ever find such a thing! No matter! *reads the plans carefully*  It뭩 all here by golly, detailed instructions on how to craft each item.  There are a number of professionals throughout the realm who will be able to assist you in crafting such things ?I뭭e written them down on this list here *hands you a note* Simply seek the professionals I have listed and you should be well on your way!
