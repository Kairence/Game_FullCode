...
namespace Server.Mobiles
{
	public class CousteauPerron : Mobile
	{
		...
		public CousteauPerron(Serial serial)
			: base(serial) { }
...
namespace Server.Gumps
{
	public class CousteauPerronGump : Gump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(CousteauPerronGump_OnCommand)
			);
		}
		...
		public CousteauPerronGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = false;
	...
	public class CousteauPerronCompleteGump : Gump
	{
		...
		{
			CommandSystem.Register(
				"CousteauPerronComplete",
				AccessLevel.GameMaster,
				new CommandEventHandler(CousteauPerronCompleteGump_OnCommand)
			);
		}
		...
		public CousteauPerronCompleteGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = false;
			this.Disposable = true;
	...
	public class CousteauPerronPlansGump : Gump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				"CousteauPerronPlans",
				AccessLevel.GameMaster,
				new CommandEventHandler(CousteauPerronPlansGump_OnCommand)
			);
		}
		...
		public CousteauPerronPlansGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = false;
			this.Disposable = true;
