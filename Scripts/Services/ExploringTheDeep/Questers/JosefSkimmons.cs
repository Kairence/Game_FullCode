...
namespace Server.Gumps
{
    ...
    public class JosefSkimmonsGump : Gump
    {
        ...
        public JosefSkimmonsGump(Mobile owner) : base(50, 50)
        {
            ...
            AddPage(1);
            AddHtmlLocalized(107, 140, 300, 150, 1154294, 0x7FFF, false, true); // Hello there...what뭩 this? *reads the note* Look at these lenses! Cousteau drew these up did she...hrmm꿾ell in any case I might be able to craft these lenses if you would be willing to assist me...
            ...
            AddPage(2);
            AddHtmlLocalized(107, 140, 300, 150, 1154296, 0x7FFF, false, true); // I뭢 looking to expand my operation here, before I can do that though I need a more reliable source of raw ore.  Rumor has it the Orcs have a new machine they are using to drill huge quantities of ore!
            ...
            AddPage(3);
            AddHtmlLocalized(107, 140, 300, 150, 1154298, 0x7FFF, false, true); // Yes! That뭩 exactly what I뭢 talking about! Drill baby drill! You get me some schematics to make that machine and I뭠l strike your lenses for you...I bet those Orcs are holed up in their cave outside Yew.
