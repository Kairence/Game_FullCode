...
namespace Server.Mobiles
{
	public class JosefSkimmons : Mobile
	{
		...
		public JosefSkimmons(Serial serial)
			: base(serial) { }
	...
	public class JosefSkimmonsCompleteGump : Gump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				"JosefSkimmonsComplete",
				AccessLevel.GameMaster,
				new CommandEventHandler(JosefSkimmonsCompleteGump_OnCommand)
			);
		}
		...
		public JosefSkimmonsCompleteGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = false;
	...
	public class JosefSkimmonsGump : Gump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				"JosefSkimmons",
				AccessLevel.GameMaster,
				new CommandEventHandler(JosefSkimmonsGump_OnCommand)
			);
		}
		...
		public JosefSkimmonsGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = false;
			this.Disposable = true;
