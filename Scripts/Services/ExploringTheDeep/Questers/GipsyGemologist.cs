...
namespace Server.Mobiles
{
	public class GipsyGemologist : Mobile
	{
		...
		public GipsyGemologist(Serial serial)
			: base(serial) { }
	...
	public class ZaliaQuestGump : Gump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(ZaliaQuestGump_OnCommand)
			);
		}
		...
		public ZaliaQuestGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = false;
	...
	public class ZaliaQuestCompleteGump : Gump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				"ZaliaQuestComplete",
				AccessLevel.GameMaster,
				new CommandEventHandler(ZaliaQuestCompleteGump_OnCommand)
			);
		}
		...
		public ZaliaQuestCompleteGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = false;
			this.Disposable = true;
