	...
	public class MasterThinkerContoller : Item
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(GenMasterThinker_Command)
			);
		}
		...
		private MasterThinkerDecor m_Book,
			m_Pant,
			m_Tunic;

		public static List<MasterThinkerArray> m_Array;

		public List<MasterThinkerArray> Array
		{
			get { return m_Array; }
		}
	...
	public class MasterThinkerDecor : Item
	{
		...
		public override void OnDoubleClick(Mobile from)
		{
			if (this.m_Controller != null)
			{
				...
				{
					this.m_Controller.Array.Add(
						new MasterThinkerContoller.MasterThinkerArray
						{
							Mobile = from,
							Book = false,
							Pant = false,
		...
		{
			return this
				.m_Controller.Array.Where(s => s.Mobile == from && s.Pant == true && s.Book == true && s.Tunic == true)
				.Count();
		}
