...
namespace Server.Items
{
	public class SorcerersPlateController : Item
	{
		...
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(GenSorcerersPlate_Command)
			);
			CommandSystem.Register(
				"DelSorcerersPlate",
				AccessLevel.Developer,
				new CommandEventHandler(DelSorcerersPlate_Command)
			);
		}
		...
		private SorcerersPlate m_PerfectBlackPearl,
			m_BurstingBrimstone,
			m_BrightDaemonBlood,
			m_MightyMandrake,
			m_BurlyBone;
		...
		{
			if (
				this.Validate(this.m_PerfectBlackPearl)
				&& this.Validate(this.m_BurstingBrimstone)
				&& this.Validate(this.m_BrightDaemonBlood)
				&& this.Validate(this.m_MightyMandrake)
				&& this.Validate(this.m_BurlyBone)
			)
			{
	...
	public class SorcerersPlate : Item
	{
		...
		public class RegsTarget : Target
		{
			...
			public RegsTarget(Mobile from, SorcerersPlate plate)
			...
			{
				return item is PerfectBlackPearl
					|| item is BurstingBrimstone
					|| item is BrightDaemonBlood
					|| item is MightyMandrake
					|| item is BurlyBone;
			}
