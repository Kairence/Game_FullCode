...
namespace Server.Items
{
	...
	public class BarrelExplodeWrathTimer : Timer
	{
		...
		public BarrelExplodeWrathTimer(Map map, int x, int y, int mindamage, int maxdamage, Item sourceitem)
	...
	public class BarrelPoisonWrathTimer : Timer
	{
		...
		public BarrelPoisonWrathTimer(Map map, int x, int y, int mindamage, int maxdamage, Item sourceitem)
			: base(TimeSpan.FromSeconds(0))
		{
			n_Map = map;
			n_X = x;
