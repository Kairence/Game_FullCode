...
namespace Server.Items
{
	public class CalculationsScroll : Item
	{
		...
		public CalculationsScroll(Serial serial)
			: base(serial) { }
	...
	public class CalculationsGump : Gump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(CalculationsGump_OnCommand)
			);
		}
		...
		public CalculationsGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = true;
