...
namespace Server.Items
{
	public class CousteauPerronScroll : Item
	{
		...
		public CousteauPerronScroll(Serial serial)
			: base(serial) { }
	...
	public class CousteauPerronInformationGump : Gump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				"CousteauPerronScroll",
				AccessLevel.GameMaster,
				new CommandEventHandler(CousteauPerronInformationGump_OnCommand)
			);
		}
		...
		public CousteauPerronInformationGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = true;
