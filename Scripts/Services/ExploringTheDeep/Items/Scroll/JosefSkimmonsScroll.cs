...
namespace Server.Items
{
	public class JosefSkimmonsScroll : Item
	{
		...
		public JosefSkimmonsScroll(Serial serial)
			: base(serial) { }
	...
	public class JosefSkimmonsPrivateGump : Gump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(JosefSkimmonsPrivateGump_OnCommand)
			);
		}
		...
		public JosefSkimmonsPrivateGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = true;
