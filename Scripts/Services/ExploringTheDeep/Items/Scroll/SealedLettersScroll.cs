...
namespace Server.Items
{
	public class SealedLettersScroll : Item
	{
		...
		public SealedLettersScroll(Serial serial)
			: base(serial) { }
	...
	public class SealedLettersEntryGump : Gump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(SealedLettersEntryGump_OnCommand)
			);
		}
		...
		public SealedLettersEntryGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = true;
