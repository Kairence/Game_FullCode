...
namespace Server.Items
{
	public class MasterThinkerSchematics : Item
	{
		...
		[Constructable]
		public MasterThinkerSchematics()
			: base(0x46AF)
		{
			Movable = false;
		}
		...
		public MasterThinkerSchematics(Serial serial)
			: base(serial) { }
	...
	public class MTSchematicsGump : Gump
	{
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(MTSchematicsGump_OnCommand)
			);
		}
		...
		public MTSchematicsGump(Mobile owner)
			: base(50, 50)
		{
			this.Closable = true;
