...
namespace Server.Regions
{
	public class SpawnEntry : ISpawner
	{
		...
		{
			get { return this.m_SpawnedObjects; }
		}
		public int Max
		{
		...
		{
			get { return this.m_SpawnedObjects.Count >= this.m_Max; }
		}
		public bool Spawning
		{
			get { return this.m_Running && !this.Complete; }
		}
		...
		public void Deserialize(GenericReader reader, int version)
		{
			...
			if (reader.ReadBool())
			{
				...
				if (this.Spawning)
				{
					...
					this.m_SpawnTimer = Timer.DelayCall(
