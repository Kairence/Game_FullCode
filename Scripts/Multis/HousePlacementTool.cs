...
namespace Server.Items
{
    ...
    public class HousePlacementEntry
    {
        private static readonly HousePlacementEntry[] m_ClassicHouses = new HousePlacementEntry[]
        {
            ...
            new HousePlacementEntry(typeof(TwoStoryHouse),  1011310,	2119,	1059,	2437,	1218,	28,	162500, -3,	7,	0,	0x0076),
            new HousePlacementEntry(typeof(TwoStoryHouse),  1011311,	2119,	1059,	2437,	1218,	28,	162750, -3,	7,	0,	0x0078),
            new HousePlacementEntry(typeof(LargePatioHouse),1011315,	2119,	1059,	2437,	1218,	28,	129000, -4,	7,	0,	0x008C),
            new HousePlacementEntry(typeof(LargeMarbleHouse),1011316,	2119,	1059,	2437,	1218,	28,	160250, -4,	7,	0,	0x0096),
        ...
        {
            new HousePlacementEntry(typeof(HouseFoundation), 1158538,	2625,	1312,	3019,	1509,	78,	15250000, 0,	10,	0,	0x147C), // 23x23 3-Story Customizable Keep
            new HousePlacementEntry(typeof(HouseFoundation), 1158539,	4076,	2038,	4688,	2344,	78,	52500000, 0,	10,	0,	0x147D),  // 32x32 3-Story Customizable Castle
        };
