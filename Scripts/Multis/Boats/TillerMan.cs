	...
	public class TillerMan : Item
	{
		...
		public virtual void SetFacing(Direction dir)
		{
			switch (dir)
			{
				...
				case Direction.East:
					ItemID = 0x3E55;
					break; //Issue 99. Was Using Incorrect Graphic.
			}
		}
		...
		public Mobile Pilot
		{
			get { return Boat != null ? Boat.Pilot : null; }
		}
		...
		private string RandomBabbleArgs()
		{
			return string.Format(
				"#{0}\t#{1}\t#{2}",
				Utility.Random(1114138, 13).ToString(),
				...
				if (m_TillerMan != null && m_TillerMan.Boat != null)
				{
					...
					else if (g.IsUnderEmergencyRepairs())
					{
						...
						m_From.SendLocalizedMessage(
							...
							String.Format(
								"{0}\t{1}",
								BaseGalleon.EmergencyRepairClothCost.ToString(),
								BaseGalleon.EmergencyRepairWoodCost
							)
