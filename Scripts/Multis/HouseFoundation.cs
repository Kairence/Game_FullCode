...
namespace Server.Multis
{
	...
	public class HouseFoundation : BaseHouse
	{
		...
		public static void Designer_Commit(NetState state, IEntity e, EncodedReader pvSrc)
		{
			...
			if (context != null)
			{
				...
				from.SendGump(new ConfirmCommitGump(from, context.Foundation, bankBalance, oldPrice, oldPrice));
			}
		}
	...
	public class DesignContext
	{
		...
		public int MaxLevels
		{
			get { return Foundation.MaxLevels; }
		}
	...
	public sealed class DesignStateDetailed : Packet
	{
		...
		private static BufferPool m_StairBufferPool = new BufferPool(
			"Housing Stair Buffers",
			6,
			MaxItemsPerStairBuffer * 5
		);
