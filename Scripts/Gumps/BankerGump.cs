	...
	public class BankerGump : Gump
	{
		...
		public void AddGumpLayout()
		{
			...
			AddHtml(
				...
				200,
				16,
				acct != null ? acct.TotalGold.ToString("N0", CultureInfo.GetCultureInfo("en-US")) : "0",
				false,
				false
			);
			...
			AddHtml(
				...
				200,
				16,
				acct != null ? acct.TotalPlat.ToString("N0", CultureInfo.GetCultureInfo("en-US")) : "0",
				false,
				false
			);
