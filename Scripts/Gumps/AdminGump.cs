	...
	public class AdminGump : Gump
	{
		...
		public void AddSelectedButton(int x, int y, int buttonID, string text, bool isSelection)
		{
			...
			this.AddHtml(
				...
				200,
				20,
				this.Color(text, isSelection ? SelectedColor32 : LabelColor32),
				false,
				false
			);
		}
			...
			: base(50, 40)
		{
			...
			this.AddPageButton(
				...
				AdminGumpPage.Administer_Maintenance
			);
			this.AddPageButton(
				10,
				50,
				this.GetButtonID(0, 2),
				"CLIENT LIST",
			...
			switch (pageType)
			{
				...
				case AdminGumpPage.Administer_Access_Lockdown:
				{
					this.AddHtml(
						...
						400,
						20,
						this.Color(this.Center("Server Lockdown"), LabelColor32),
						false,
						false
					);
				...
				case AdminGumpPage.Administer_Maintenance:
				{
					...
					if (
						Ultima.Files.MulPath["artlegacymul.uop"] != null
						|| (Ultima.Files.MulPath["art.mul"] != null && Ultima.Files.MulPath["artidx.mul"] != null)
					)
					{
				...
				case AdminGumpPage.Clients:
				{
					...
					for (
						...
						i < 12 && index >= 0 && index < this.m_List.Count;
						++i, ++index
					)
					{
				...
				case AdminGumpPage.AccountDetails_ChangePassword:
				{
					...
					this.AddHtml(
						...
						400,
						20,
						this.Color(this.Center("Change Password"), LabelColor32),
						false,
						false
					);
				...
				case AdminGumpPage.AccountDetails_ChangeAccess:
				{
					...
					this.AddHtml(
						...
						400,
						20,
						this.Color(this.Center("Change Access Level"), LabelColor32),
						false,
						false
					);
					...
					if (a.Banned && a.GetBanTags(out banTime, out banDuration))
					{
						...
						else
						{
							...
							this.AddLabel(
								...
								190,
								LabelHue,
								String.Format("{0} [{1:F0}%]", FormatTimeSpan(banDuration), perc * 100)
							);
						}
					}
					else if (a.Banned)
				...
				case AdminGumpPage.AccountDetails_Access_ClientIPs:
				{
					...
					this.AddHtml(
						...
						400,
						20,
						this.Color(this.Center("Client Addresses"), LabelColor32),
						false,
						false
					);
					...
					this.AddHtml(
						...
						180,
						80,
						this.Color("List of IP addresses which have accessed this account.", LabelColor32),
						false,
						false
					);
					...
					if (this.m_List.Count == 0)
						this.AddHtml(
							...
							200,
							60,
							this.Color("This account has not yet been accessed.", LabelColor32),
							false,
							false
						);
					...
					for (
						...
						i < 6 && index >= 0 && index < this.m_List.Count;
						++i, ++index
					)
					{
						this.AddHtml(
							...
							114,
							20,
							this.Color(this.m_List[index].ToString(), LabelColor32),
							false,
							false
						);
						this.AddButton(
				...
				case AdminGumpPage.AccountDetails_Access_Restrictions:
				{
					...
					this.AddHtml(
						...
						400,
						20,
						this.Color(this.Center("Address Restrictions"), LabelColor32),
						false,
						false
					);
					...
					if (this.m_List.Count == 0)
						this.AddHtml(
							...
							200,
							60,
							this.Color("There are no addresses in this list.", LabelColor32),
							false,
							false
						);
				...
				case AdminGumpPage.FirewallInfo:
				{
					...
					this.AddHtml(
						...
						400,
						20,
						this.Color(this.Center(state.ToString()), LabelColor32),
						false,
						false
					);
					...
					this.AddHtml(
						...
						400,
						20,
						this.Color(this.Center("Potentially Affected Accounts"), LabelColor32),
						false,
						false
					);
					...
					for (
						...
						i < 9 && index >= 0 && index < this.m_List.Count;
						++i, ++index
					)
					{
						Account a = this.m_List[index] as Account;
			...
			switch (type)
			{
				...
				case 1:
				{
					switch (index)
					{
						...
						{
							if (
								this.m_List != null /*&& (m_ListPage + 1) * 12 < m_List.Count*/
							)
								from.SendGump(
									new AdminGump(
										from,
						...
						case 1:
						{
							...
							if (results.Count == 1)
							{
								...
								if (state is Mobile)
									...
									from.SendGump(
										new AdminGump(from, AdminGumpPage.Clients, 0, results, "One match found.", null)
									);
							}
							else
							{
						...
						default:
						{
							...
							if (this.m_List != null && index >= 0 && index < this.m_List.Count)
							{
								...
								if (m != null)
									...
									from.SendGump(
										new AdminGump(from, AdminGumpPage.AccountDetails_Information, 0, null, null, a)
									);
							}
				...
				case 5:
				{
					switch (index)
					{
						...
						case 2:
							from.SendGump(
								new AdminGump(from, AdminGumpPage.AccountDetails_Comments, 0, null, null, this.m_State)
							);
							break;
						case 3:
							from.SendGump(
								new AdminGump(from, AdminGumpPage.AccountDetails_Tags, 0, null, null, this.m_State)
							);
							break;
						case 13:
							from.SendGump(
								new AdminGump(from, AdminGumpPage.AccountDetails_Access, 0, null, null, this.m_State)
							);
							break;
						case 14:
							from.SendGump(
						...
						case 6:
						{
							...
							from.SendGump(
								new AdminGump(
									from,
									dispAccount != null ? AdminGumpPage.AccountDetails_Information : this.m_PageType,
									this.m_ListPage,
									this.m_List,
									notice,
									dispAccount != null ? dispAccount : this.m_State
								)
							);
							break;
						}
						...
						case 16: // view shared
						{
							...
							{
								from.SendGump(
									new AdminGump(from, AdminGumpPage.Accounts, 0, list, null, new ArrayList())
								);
							}
							...
							if (rads.Count > 0)
								from.SendGump(
									new WarningGump(
										...
										new object[] { true, list, rads, this.m_ListPage }
									)
								);
							else
								from.SendGump(
									new NoticeGump(
										...
										280,
										new NoticeGumpCallback(ResendGump_Callback),
										new object[] { list, rads, this.m_ListPage }
									)
								);
							...
							if (rads.Count > 0)
								from.SendGump(
									new WarningGump(
										...
										280,
										new WarningGumpCallback(Marked_Callback),
										new object[] { false, list, rads, this.m_ListPage }
									)
								);
							else
								from.SendGump(
						...
						case 35: // Unmark house owners
						{
							...
							from.SendGump(
								new AdminGump(from, AdminGumpPage.Accounts, this.m_ListPage, this.m_List, null, newRads)
							);
								...
								from.SendGump(
									new WarningGump(
										...
										String.Format(
											...
											a,
											ips.Length,
											(ips.Length == 1) ? "entry" : "entries"
										),
										0xFFC000,
										420,
										280,
										new WarningGumpCallback(RemoveLoginIPs_Callback),
										a
									)
								);
									...
									if (this.m_List[index] is Account)
										...
										from.SendGump(
											new AdminGump(
												...
												AdminGumpPage.Accounts,
												0,
												(ArrayList)(((DictionaryEntry)this.m_List[index]).Value),
												null,
												new ArrayList()
											)
										);
				...
				case 6:
				{
					switch (index)
					{
							...
							if (this.m_State is Firewall.IFirewallEntry)
							{
								...
								from.SendGump(
									new AdminGump(
										...
										0,
										null,
										String.Format("{0} : Removed from firewall.", this.m_State),
										null
									)
								);
							}
						...
						default:
						{
							...
							if (this.m_List != null && index >= 0 && index < this.m_List.Count)
								from.SendGump(
									new AdminGump(from, AdminGumpPage.FirewallInfo, 0, null, null, this.m_List[index])
								);
				...
				case 7:
				{
					...
					switch (index)
					{
						...
						{
							from.SendGump(
								new AdminGump(from, AdminGumpPage.AccountDetails_Information, 0, null, null, m.Account)
							);
							sendGump = false;
							break;
						}
						...
						if (this.m_PageType == AdminGumpPage.AccountDetails_Access_ClientIPs)
						{
							from.SendGump(
								new WarningGump(
									...
									new object[] { a, this.m_List[index] }
								)
							);
						}
						else if (this.m_PageType == AdminGumpPage.AccountDetails_Access_Restrictions)
						{
							...
							from.SendGump(
								new AdminGump(
									...
									0,
									null,
									String.Format("{0} : Removed from list.", this.m_List[index]),
									a
								)
							);
						}
						...
						if (this.m_PageType == AdminGumpPage.AccountDetails_Access_ClientIPs)
						{
							...
							from.SendGump(
								new WarningGump(
									...
									30720,
									String.Format(
										"You are about to remove address {0} from account {1}. Do you wish to continue?",
										ip,
										a
									),
									0xFFC000,
									420,
									280,
									new WarningGumpCallback(RemoveLoginIP_Callback),
									new object[] { a, ip }
								)
							);
						}
		...
		private void Shutdown(bool restart, bool save)
		{
			CommandLogging.WriteLine(
				...
				this.m_From.AccessLevel,
				CommandLogging.Format(this.m_From),
				restart,
				save
			);
		...
		private class AddTagValuePrompt : Prompt
		{
			...
			public override void OnResponse(Mobile from, string text)
			{
				if (this.m_Account != null)
				{
					...
					from.SendGump(
						new AdminGump(from, AdminGumpPage.AccountDetails_Tags, 0, null, "Tag added.", this.m_Account)
					);
				}
			}
		}
