	...
	public class ClientGump : Gump
	{
			...
			: base(30, 20)
		{
			...
			this.AddHtml(
				...
				200,
				20,
				this.Color(state.Version == null ? "(null)" : state.Version.ToString(), LabelColor32),
				false,
				false
			);
			...
			if (m != null)
			{
				...
				this.AddHtml(
					...
					200,
					20,
					this.Color(String.Format("{0} (0x{1:X})", m.Name, m.Serial.Value), LabelColor32),
					false,
					false
				);
				...
				this.AddHtml(
					...
					200,
					20,
					this.Color(String.Format("{0} [{1}]", m.Location, m.Map), LabelColor32),
					false,
					false
				);
				...
				if (BaseCommand.IsAccessible(from, m))
				{
					...
					this.AddHtml(
						...
						100,
						20,
						this.Color("Properties", LabelColor32),
						false,
						false
					);
				}
				...
				if (from != m)
				{
					...
					this.AddHtml(
						...
						100,
						20,
						this.Color("Go to them", LabelColor32),
						false,
						false
					);
					...
					this.AddHtml(
						...
						100,
						20,
						this.Color("Bring them here", LabelColor32),
						false,
						false
					);
				}
				...
				this.AddHtml(
					...
					100,
					20,
					this.Color("Move to target", LabelColor32),
					false,
					false
				);
				...
				if (from.AccessLevel >= AccessLevel.GameMaster && from.AccessLevel > m.AccessLevel)
				{
					...
					this.AddHtml(
						...
						100,
						20,
						this.Color("Disconnect", LabelColor32),
						false,
						false
					);
					...
					else
					{
						...
						this.AddHtml(
							...
							100,
							20,
							this.Color("Resurrect", LabelColor32),
							false,
							false
						);
					}
				...
				if (from.IsStaff() && from.AccessLevel > m.AccessLevel)
				{
					...
					this.AddHtml(
						...
						100,
						20,
						this.Color("Skills browser", LabelColor32),
						false,
						false
					);
				}
