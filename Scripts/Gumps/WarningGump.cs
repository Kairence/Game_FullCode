			...
			: base((640 - width) / 2, (480 - height) / 2)
		{
			...
			else if (header.String != null)
			{
				AddHtml(
					...
					width - 20,
					height - 80,
					String.Format("<BASEFONT COLOR=#{0:X6}>{1}</BASEFONT>", headerColor, header.String),
					false,
					true
				);
			}
			...
			else if (content.String != null)
			{
				AddHtml(
					...
					width - 20,
					height - 80,
					String.Format("<BASEFONT COLOR=#{0:X6}>{1}</BASEFONT>", contentColor, content.String),
					false,
					true
				);
			}
