				...
				case 1:
				{
					...
					else
					{
						...
						if (activeWar == null)
						{
							...
							{
								this.guild.PendingWars.Add(
									new WarDeclaration(this.guild, this.m_Other, maxKills, warLength, true)
								);
							}
							...
							{
								this.m_Other.PendingWars.Add(
									new WarDeclaration(this.m_Other, this.guild, maxKills, warLength, false)
								);
							}
							...
							pm.SendLocalizedMessage(
								1070751,
								((this.m_Other.Alliance != null) ? this.m_Other.Alliance.Name : this.m_Other.Name)
