...
namespace Server.Gumps
{
	...
	public class TitlesGump : Gump
	{
		...
		public TitlesGump(
			PlayerMobile pm,
			TitleType type = TitleType.None,
			TitleCategory cat = TitleCategory.None,
		...
		protected void AddGumpLayout()
		{
			...
			switch (TitleType)
			{
				case TitleType.None:
					break;
				case TitleType.PaperdollPrefix:
					BuildPaperdollPrefix();
					break;
				case TitleType.PaperdollSuffix:
					BuildPaperdollSuffix();
					break;
					...
					if (info.Harrower > 0)
					{
						AddHtml(
							...
							Color(
								...
								String.Format(
									": {0} of Evil",
									Titles.HarrowerTitles[Math.Min(Titles.HarrowerTitles.Length, info.Harrower) - 1]
								)
							),
							false,
							false
				...
				if (!ShowingDescription || TitleSelected == -1)
				{
					...
					foreach (Skill sk in User.Skills)
					{
						...
						AddHtml(
							...
							245,
							16,
							Color("#FFFFFF", "the " + sk.Info.Title),
							false,
							false
						);
						AddCallbackButton(
						...
						if (
							(SkillName)sk.Info.SkillID == User.Skills.CurrentMastery
						...
						)
						{
							AddHtml(
								...
								160,
								16,
								Color("#FFFFFF", MasteryInfo.GetTitle(User)),
								false,
								false
							);
							AddCallbackButton(
				...
				else
				{
					...
					AddCallbackButton(
						...
						b =>
						{
							...
							User.OverheadTitle =
								TitleSelected == 999999
									? MasteryInfo.GetTitle(User)
									: "the " + User.Skills[(SkillName)TitleSelected].Info.Title;
			...
			else if (Category == TitleCategory.Guild && guild != null && User.GuildTitle != null)
			{
				if (!ShowingDescription || TitleSelected == -1)
				{
					AddHtml(
						...
						Color(
							"#FFFFFF",
							String.Format("{0}, {1}", Utility.FixHtml(User.GuildTitle), Utility.FixHtml(guild.Name))
						),
						false,
						false
					);
		...
		private bool HasTitle()
		{
			switch (TitleType)
			{
				...
				case TitleType.SubTitles:
					return User.SubtitleSkillTitle != null
						|| User.SelectedTitle > -1
						|| User.CurrentVeteranTitle > 0
						|| User.DisplayGuildTitle;
			}
		...
		private object GetChampInfo()
		{
			...
			switch (index)
			{
				...
				case 0:
					return 1115047; // This title is gained from battling against the minions of Semidar.
				case 1:
					return 1115046; // This title is gained from battling against the minions of Mephitis.
				case 2:
					return 1115044; // This title is gained from battling against the minions of Rikktor.
				case 3:
					return 1115045; // This title is gained from battling against the minions of Lord Oaks.
				case 4:
					return 1115048; // This title is gained from battling against the minions of Barracoon the Piper.
				case 5:
					return 1115049; // This title is gained from battling against the minions of Neira the Necromancer.
				case 6:
					return 1115050; // This title is gained from battling against the minions of Serado the Awakened.
				case 7:
					return 1115052; // This title is gained from battling against the minions of Twaulo of the Glade.
				case 8:
					return 1115051; // This title is gained from battling against the minions of Ilhenir the Stained.
				case 12:
					return 1115054; // This title is gained from battling against the minions of the Abyssal Inferno.
				case 13:
					return 1115053; // This title is gained from battling against the minions of the Primeval Lich.
				case 14:
					return "This title is gained from battling against the minions of the Dragon Turtle."; // Dragon Turtle, no cliloc???
				case 295:
					return 1115055; // This title is gained from battling against the Harrower and the Champions.
			}
		}
		...
		private object GetRewardTitleInfo(object title)
		{
			...
			if (title is int)
			{
				...
				switch (id)
				{
					...
					case 1073238:
					case 1073239:
						return 1115115; // This is a reward title given for contributing to the Vesper Museum.
					case 1073201:
					case 1073202:
					case 1073203:
					case 1073204:
					case 1073205:
					case 1073206:
						return 1115116; // This is a reward title given for contributing to the Britannia Royal Zoo.
					case 1073341:
					case 1073342:
					case 1073343:
					case 1073344:
					case 1073345:
						return 1115117; // This is a reward title given for contributing to the Britain Public Library.
					case 1156477:
						return 1156476; // This title is obtained by completing the Valley of One Quest in the Valley of Eodon.
					case 1155727:
						return 1155728; // This title is obtained from the Huntmaster's Challenge at the Ranger's Guild in Skara Brae.
					case 1156318:
						return 1156319; // This is a reward title given for completing Shadowguard.
					case 1157594:
						return 1157595; // This title is obtained by completing the "Discovering Animal Training" quest.
					case 1158140:
						return 1158141; // This title is obtained by completing the Huntmaster's Challenge Quest.
					case 1158090:
						return 1158087; // This title is obtained by completing the Paladins of Trinsic Quest.
					case 1158161:
						return 1158162; // This title is obtained by completing the Righting Wrong Quest.
					case 1158389:
						return 1158248; // This title is obtained by completing the Treasure Chase Quest.
					case 1158278:
						return 1158279; // This title is obtained by completing the "A Forced Sacrifice" quest.
					case 1158303:
						return 1158324; // This title is obtained by completing the "Whispering with Wisps" quest.
					case 1154505:
						return 1154506; // This is a reward title given for completing the Exploring the Deep Quest.
					case 1158523:
						return 1158537; // This title is obtained by discovering a constellation using the telescope.
				}
			}
		...
		{
			return (id >= 1152739 && id <= 1152893)
				|| (id >= 1151739 && id <= 1151747)
				|| id == 1155481
				|| id == 1154017;
		}
