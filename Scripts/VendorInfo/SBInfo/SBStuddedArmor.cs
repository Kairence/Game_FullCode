...
namespace Server.Mobiles
{
    public class SBStuddedArmor : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            ...
            {
                Add(new GenericBuyInfo(typeof(StuddedArms), 100, 20, 0x13DC, 0));
                Add(new GenericBuyInfo(typeof(StuddedChest), 128, 20, 0x13DB, 0));
                Add(new GenericBuyInfo(typeof(StuddedGloves), 100, 20, 0x13D5, 0));
                Add(new GenericBuyInfo(typeof(StuddedGorget), 100, 20, 0x13D6, 0));
