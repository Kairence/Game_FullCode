...
namespace Server.Mobiles
{
    public class SBHolyMage : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            ...
            {
				Add(new IDWandBuyInfo(typeof(IDWand), 4, 100, 20, 0xDF5, 0));
				Add(new IDWandBuyInfo(typeof(IDWand), 5, 200, 20, 0xDF5, 0));
				Add(new IDWandBuyInfo(typeof(IDWand), 6, 300, 20, 0xDF5, 0));
				Add(new IDWandBuyInfo(typeof(IDWand), 7, 400, 20, 0xDF5, 0));
				Add(new IDWandBuyInfo(typeof(IDWand), 8, 500, 20, 0xDF5, 0));
