			...
			if (Enhancement.EnhancementList.ContainsKey(this.m_Mobile))
			{
				...
				for (int i = 0; i < this.AL.Count - 1; i += 2)
				{
					...
					if (this.AL[i] is AosAttribute)
					{
						...
						Enhancement.SetValue(
							this.m_Mobile,
							att,
							(Enhancement.GetValue(this.m_Mobile, att) - number),
							this.m_Title
						);
					}
					else if (this.AL[i] is AosWeaponAttribute)
					{
						...
						Enhancement.SetValue(
							this.m_Mobile,
							weapon,
							(Enhancement.GetValue(this.m_Mobile, weapon) - number),
							this.m_Title
						);
					}
					else if (this.AL[i] is AosArmorAttribute)
					{
						...
						Enhancement.SetValue(
							this.m_Mobile,
							armor,
							(Enhancement.GetValue(this.m_Mobile, armor) - number),
							this.m_Title
						);
					}
					else if (this.AL[i] is SAAbsorptionAttribute)
					{
						...
						Enhancement.SetValue(
							this.m_Mobile,
							absorb,
							(Enhancement.GetValue(this.m_Mobile, absorb) - number),
							this.m_Title
						);
					}
				}
