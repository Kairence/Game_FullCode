        ...
        static SlayerGroup()
        {
            ...
            humanoid.Super = new SlayerEntry
                (
					...
					typeof(HeadlessOne), typeof(Harpy), typeof(StoneHarpy)
                );
            ...
            undead.Super = new SlayerEntry
                (
					...
					typeof(SkeletalLich), typeof(PatchworkSkeleton)
                );
            ...
            if (Core.AOS)
            {
                abyss.Super = new SlayerEntry
                    (
                        ...
                        typeof(Lifestealer), typeof(Gazer), typeof(ElderGazer)
                    );
            ...
            wood.Super = new SlayerEntry(
                ...
                typeof(Bogling), typeof(Corpser), 
                typeof(Treefellow), typeof(BogThing), typeof(Reaper));
            ...
            water.Super = new SlayerEntry(
                ...
                typeof(WaterElemental), typeof(Kraken), 
                typeof(SeaSerpent), typeof(DeepSeaSerpent), typeof(Leviathan));
