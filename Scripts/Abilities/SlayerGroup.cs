...
namespace Server.Items
{
	public class SlayerGroup
	{
		...
		static SlayerGroup()
		{
			...
			SlayerGroup wood = new SlayerGroup();
			SlayerGroup water = new SlayerGroup();
			...
			humanoid.Super = new SlayerEntry(
				...
				typeof(Troll),
				typeof(Minotaur),
				typeof(MinotaurGeneral),
				typeof(RakktaviRenowned),
				typeof(TikitaviRenowned),
				typeof(VitaviRenowned),
				typeof(EnslavedGoblinScout),
				typeof(EnslavedGoblinKeeper),
				typeof(EnslavedGreenGoblin),
				typeof(EnslavedGreenGoblinAlchemist),
				typeof(EnslavedGoblinMage),
				typeof(EnslavedGrayGoblin),
			...
			undead.Super = new SlayerEntry(
				...
				typeof(PutridUndeadGargoyle),
				typeof(PutridUndeadGuardian),
				typeof(Juonar),
				typeof(Spellbinder),
				typeof(AngeredSpirit),
				typeof(BoneSwordSlinger),
				typeof(CovetousRevenant),
				typeof(DiseasedLich),
				typeof(VileCadaver),
				typeof(GrizzledMare),
				typeof(SkeletalCat),
			...
			elemental.Super = new SlayerEntry(
				...
				typeof(Mistral),
				typeof(Tempest),
				typeof(UnboundEnergyVortex),
				typeof(ChaosVortex),
				typeof(WindElemental),
				...
				typeof(SearingElemental),
				typeof(VortexElemental),
				typeof(CovetousWaterElemental)
			);

			elemental.Entries = new SlayerEntry[]
			{
				new SlayerEntry(SlayerName.BloodDrinking, typeof(BloodElemental), typeof(DemonKnight)),
				new SlayerEntry(
			...
			if (Core.AOS)
			{
				abyss.Super = new SlayerEntry(
					...
					typeof(Ballem),
					typeof(Betballem),
					typeof(UsagralemBallem),
					typeof(EffetePutridGargoyle),
					typeof(EffeteUndeadGargoyle),
					typeof(PitFiend),
					typeof(ArchDaemon),
					typeof(AbyssalAbomination),
					typeof(Virtuebane),
					typeof(LesserOni),
					typeof(Lifestealer),
					typeof(Gazer),
				...
				abyss.Entries = new SlayerEntry[]
				{
					...
					new SlayerEntry(
						...
						typeof(EffetePutridGargoyle),
						typeof(EffeteUndeadGargoyle),
						typeof(DaemonMongbat),
						typeof(CovetousDoppleganger),
						typeof(CovetousFireDaemon),
						typeof(GargoyleAssassin),
						typeof(LesserOni)
					),
				};
			}
			...
			{
				new SlayerEntry(SlayerName.ScorpionsBane, typeof(Scorpion), typeof(Miasma), typeof(SpeckledScorpion)),
				new SlayerEntry(
			...
			eodon.Super = new SlayerEntry(
				SlayerName.Eodon,
				typeof(Dimetrosaur),
				typeof(Gallusaurus),
				typeof(Archaeosaurus),
				typeof(Najasaurus),
				typeof(Saurosaurus),
				typeof(Allosaurus),
			...
			eodonTribe.Super = new SlayerEntry(
				SlayerName.EodonTribe,
				typeof(TribeWarrior),
				typeof(TribeShaman),
				typeof(TribeChieftan)
			);
			...
			wood.Opposition = new SlayerGroup[] { fey };
			wood.FoundOn = new Type[] { };
			wood.Super = new SlayerEntry(
				SlayerName.Wood,
				typeof(Bogling),
				typeof(Corpser),
				typeof(Treefellow),
			...
			wood.Entries = new SlayerEntry[] { };

			water.Opposition = new SlayerGroup[] { fey };
			water.FoundOn = new Type[] { };
			water.Super = new SlayerEntry(
				SlayerName.Water,
				typeof(WaterElemental),
				typeof(Kraken),
				typeof(SeaSerpent),
		...
		{
			get { return this.m_Opposition; }
			set { this.m_Opposition = value; }
		}
		...
		public Type[] FoundOn
		{
			get { return this.m_FoundOn; }
			set { this.m_FoundOn = value; }
		}
		...
		{
			SlayerEntry[] entries = new SlayerEntry[34];
