	...
	public class SignParser
	{
		...
		public static void Initialize()
		{
			...
			CommandSystem.Register(
				...
				new CommandEventHandler(SignRemove_OnCommand)
			);
		}
					...
					using (StreamReader ip = new StreamReader(cfg))
					{
						...
						while ((line = ip.ReadLine()) != null)
						{
							...
							SignEntry e = new SignEntry(
								...
								new Point3D(
									Utility.ToInt32(split[2]),
									Utility.ToInt32(split[3]),
		...
		private class SignSaveTarget : Target
		{
			...
			protected override void OnTarget(Mobile from, object o)
			{
				...
				if (m_Sign.Map == Map.Felucca || m_Sign.Map == Map.Trammel)
				{
			...
			public void DoSave()
			{
				...
				foreach (SignEntry sign in signs)
				{
					if (sign.m_Map == TargetMap && sign.m_Location.CompareTo(m_Sign.Location) == 0)
					{
