...
namespace Server.Commands.Generic
{
	public sealed class OrderInfo
	{
		...
		{
			get { return (this.m_Order > 0); }
			set { this.m_Order = (value ? +1 : -1); }
		}
		...
		public int Sign
		{
			get { return Math.Sign(this.m_Order); }
			set
			{
	...
	public static class SortCompiler
	{
		...
		{
			TypeBuilder typeBuilder = assembly.DefineType("__sort", TypeAttributes.Public, typeof(object));
