...
namespace Server.Commands.Generic
{
	public static class DistinctCompiler
	{
		...
		{
			TypeBuilder typeBuilder = assembly.DefineType("__distinct", TypeAttributes.Public, typeof(object));
			...
			#region Compare
			{
				...
				typeBuilder.DefineMethodOverride(
					emitter.Method,
					typeof(IComparer).GetMethod("Compare", new Type[] { typeof(object), typeof(object) })
				);
			...
			#region Equals
			{
				...
				typeBuilder.DefineMethodOverride(
					emitter.Method,
					typeof(IEqualityComparer<object>).GetMethod("Equals", new Type[] { typeof(object), typeof(object) })
				);
			}
			#endregion
			...
			#region GetHashCode
			{
				...
				typeBuilder.DefineMethodOverride(
					emitter.Method,
					typeof(IEqualityComparer<object>).GetMethod("GetHashCode", new Type[] { typeof(object) })
				);
			}
			#endregion
			#endregion
