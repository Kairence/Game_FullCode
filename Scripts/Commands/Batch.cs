...
namespace Server.Commands
{
	public class Batch : BaseCommand
	{
		...
		{
			get { return this.m_BatchCommands; }
		}
		...
		public void Render()
		{
			...
			for (int i = 0; i < this.m_Batch.BatchCommands.Count; ++i)
			{
				...
				this.AddImageTiled(
					...
					this.CurrentY + 2,
					2,
					this.EntryHeight + this.OffsetSize + this.EntryHeight - 4,
					0x24A8
				);
				this.AddImageTiled(
					this.CurrentX,
					this.CurrentY + this.EntryHeight + this.OffsetSize + this.EntryHeight - 2,
					9,
					2,
					0x24A8
				);
				this.AddImageTiled(
					...
					this.CurrentY + 3,
					6,
					this.EntryHeight + this.EntryHeight - 4 - this.OffsetSize,
					this.HeaderGumpID
				);
