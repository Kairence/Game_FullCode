		...
		public override void OnCast()
		{
				...
				*/
				if (this.CheckSequence())
				{
					...
					else
					{
						...
						Caster.FixedParticles(0x376A, 9, 32, 5008, EffectLayer.Waist);
						Caster.MeleeDamageAbsorb =
							20
							+ (int)(Caster.Skills.Magery.Value * 0.05 + Caster.Skills.Chivalry.Value * 0.05)
							+ level * 5;
						if (level >= 5)
						...
						BuffInfo.AddBuff(
							this.Caster,
							new BuffInfo(BuffIcon.ReactiveArmor, 1075812, 1075813, Caster.MeleeDamageAbsorb.ToString())
						);
					}
					...
					if (Caster.MeleeDamageAbsorb == 0 || Caster.MeleeDamageAbsorb == 2)
					{
						...
						*/
						...
						BuffInfo.AddBuff(
							this.Caster,
							new BuffInfo(BuffIcon.ReactiveArmor, 1075812, 1075813, args.ToString())
						);
					}
					else
					{
			...
			else
			{
				...
				else if (this.CheckSequence())
				{
					...
					{
						int value = (int)(
							this.Caster.Skills[SkillName.Magery].Value
							+ this.Caster.Skills[SkillName.Meditation].Value
							+ this.Caster.Skills[SkillName.Inscribe].Value
						);
						value /= 3;
