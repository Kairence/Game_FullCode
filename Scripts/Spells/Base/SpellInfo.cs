...
namespace Server.Spells
{
	public class SpellInfo
	{
		...
		{
			get { return this.m_AllowTown; }
			set { this.m_AllowTown = value; }
		}
		public int[] Amounts
		{
			get { return this.m_Amounts; }
			set { this.m_Amounts = value; }
		}
		public string Mantra
		{
			get { return this.m_Mantra; }
			set { this.m_Mantra = value; }
		}
		public string Name
		{
		...
		{
			get { return this.m_Reagents; }
			set { this.m_Reagents = value; }
		}
		public int LeftHandEffect
		{
			get { return this.m_LeftHandEffect; }
			set { this.m_LeftHandEffect = value; }
		}
		public int RightHandEffect
		{
			get { return this.m_RightHandEffect; }
			set { this.m_RightHandEffect = value; }
		}
	}
}
