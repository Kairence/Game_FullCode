...
namespace Server.Spells.SkillMasteries
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo("Rampage", "", -1, 9002);
		...
		public static int GetBonus(Mobile m, BonusType type)
		{
			...
			switch (type)
			{
				...
				case BonusType.HitPointRegen:
					return _Table[m].HitsRegen;
				case BonusType.StamRegen:
					return _Table[m].StamRegen;
				case BonusType.Focus:
					return _Table[m].Focus;
				case BonusType.SwingSpeed:
					return _Table[m].SwingSpeed;
			}
		}
