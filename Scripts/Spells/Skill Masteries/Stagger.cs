...
namespace Server.Spells.SkillMasteries
{
	public class StaggerSpell : SkillMasteryMove
	{
		...
		{
			get { return new TextDefinition(1155980); }
		} // *You ready yourself to stagger your opponent!*
		...
		public override void OnHit(Mobile attacker, Mobile defender, int damage)
		{
			...
			double skills =
				(
					attacker.Skills[MoveSkill].Value
					+ attacker.Skills[SkillName.Tactics].Value
					+ (MasteryInfo.GetMasteryLevel(attacker, MoveSkill) * 40)
				) / 3;
