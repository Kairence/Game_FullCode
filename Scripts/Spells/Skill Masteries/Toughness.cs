...
namespace Server.Spells.SkillMasteries
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo("Toughness", "", -1, 9002);
			...
			if (CheckSequence())
			{
				...
				BuffInfo.AddBuff(
					...
					new BuffInfo(
						...
						1155985,
						1155986,
						String.Format("{0}\t{1}", _HPBonus.ToString(), ScaleMana((int)UpKeep))
					)
				); // Hit Point Increase: ~1_VAL~.<br>Mana Upkeep Cost: ~2_VAL~.
			}
