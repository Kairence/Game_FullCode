...
namespace Server.Spells.SkillMasteries
{
	public abstract class BardSpell : SkillMasterySpell
	{
		...
		public virtual double SlayerBonus
		{
			get { return 1.5; }
		}
		...
		public override double BaseSkillBonus
		{
			...
			{
				return Math.Floor(
					2 + (((Caster.Skills[CastSkill].Base - 90) / 10) + ((Caster.Skills[DamageSkill].Base - 90) / 10))
				);
			}
		}
		...
		public override int OutOfRangeMessage
		{
			get { return 1115771; }
		} // Your target is no longer in range of your spellsong.
		...
		public static int GetMasteryBonus(PlayerMobile pm, SkillName useSkill)
		{
			...
			if (
				pm.Skills.CurrentMastery == SkillName.Provocation
