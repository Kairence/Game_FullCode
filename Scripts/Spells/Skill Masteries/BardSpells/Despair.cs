...
namespace Server.Spells.SkillMasteries
{
	public class DespairSpell : BardSpell
	{
		...
		private static SpellInfo m_Info = new SpellInfo("Despair", "Kal Des Mani Tym", -1, 9002);
		...
		public override double SlayerBonus
		{
			get { return 3.0; }
		}
		...
		public DespairSpell(Mobile caster, Item scroll)
		...
		private class InternalTarget : Target
		{
			...
			public InternalTarget(DespairSpell spell)
