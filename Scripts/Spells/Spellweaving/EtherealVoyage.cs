...
namespace Server.Spells.Spellweaving
{
	...
	{
		private static readonly SpellInfo m_Info = new SpellInfo("Ethereal Voyage", "Orlavdra", -1);
		...
		{
			get { return TimeSpan.FromSeconds(3.5); }
		}
		...
		public static void Initialize()
		{
			EventSink.AggressiveAction += new AggressiveActionEventHandler(
				delegate(AggressiveActionEventArgs e)
				{
		...
		public override void DoEffect(Mobile m)
		{
			...
			BuffInfo.AddBuff(
				this.Caster,
				new BuffInfo(BuffIcon.EtherealVoyage, 1031613, 1075805, duration, this.Caster)
			);
		}
