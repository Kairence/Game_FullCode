...
namespace Server.Spells.Spellweaving
{
	...
	{
		private static readonly SpellInfo m_Info = new SpellInfo("Arcane Circle", "Myrshalee", -1);
		...
		{
			return m.Skills.CurrentMastery == SkillName.Spellweaving
				? MasteryInfo.GetMasteryLevel(m, SkillName.Spellweaving)
				: 1;
		}
