...
namespace Server.Spells.Necromancy
{
	public class WraithFormSpell : TransformationSpell
	{
		...
		{
			get { return this.Caster.Female ? 747 : 748; }
		}
		public override int Hue
		{
			get { return this.Caster.Female ? 0 : 0x4001; }
		}
		...
		public override void DoEffect(Mobile m)
		{
			...
			BuffInfo.AddBuff(
				m,
				new BuffInfo(BuffIcon.WraithForm, 1060524, 1153829, String.Format("15\t5\t5\t{0}", manadrain))
			);
		}
