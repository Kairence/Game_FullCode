...
namespace Server.Items
{
	public class PowerScroll : SpecialScroll
	{
		...
		private static readonly SkillName[] m_SESkills = new SkillName[] { SkillName.Ninjitsu, SkillName.Bushido };
		private static readonly SkillName[] m_MLSkills = new SkillName[] { SkillName.Spellweaving };
        ...
        * You can view your maximum statistic value in your statistics window. */
		...
		{
			get { return String.Format("<basefont color=#FFFFFF>Power Scroll ({0} Skill):</basefont>", this.Value); }
		}
		...
		public static PowerScroll CreateRandomNoCraft(int min, int max)
		{
			...
			do
			{
				...
				skillName == SkillName.Blacksmith || skillName == SkillName.Tailoring || skillName == SkillName.Imbuing
			);
