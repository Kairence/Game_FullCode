...
namespace Server.Items
{
	...
	public abstract class BasePotion : Item, ICraftable, ICommodity
	{
		...
		{
			get { return this.m_PotionEffect; }
			set
			{
		...
		{
			get { return 1041314 + (int)this.m_PotionEffect; }
		}
		...
		public static int Scale(Mobile m, int v)
		{
			...
			int bonus = 0;
			return AOS.Scale(v, 100 + bonus);
		}

		public override bool WillStack(Mobile from, Item dropped)
		{
			return dropped is BasePotion
				&& ((BasePotion)dropped).m_PotionEffect == this.m_PotionEffect
