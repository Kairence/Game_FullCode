...
namespace Server.Items
{
	...
	public class ScrollBinderDeed : Item
	{
		...
		public override void OnDoubleClick(Mobile from)
		{
			if (IsChildOf(from.Backpack))
			{
				...
				switch (BinderType)
				{
					...
					case BinderType.None:
						cliloc = 1113141;
						break; // Target the scroll you wish to bind.
					case BinderType.PowerScroll:
						cliloc = 1113138;
						break; // Target the powerscroll you wish to bind.
					case BinderType.StatScroll:
						cliloc = 1113140;
						break; // Target the stats scroll you wish to bind.
					case BinderType.SOT:
						cliloc = 1113139;
						break; // Target the scroll of transcendence you wish to bind.
				}
		...
		private class InternalTarget : Target
		{
			...
			public InternalTarget(ScrollBinderDeed binder)
