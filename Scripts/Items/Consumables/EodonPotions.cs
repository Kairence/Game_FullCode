...
namespace Server.Items
{
	public class EodonPotionContext
	{
		...
		{
			get { return Potion.PotionEffect; }
		}
	...
	public class EodonianPotion : BasePotion
	{
		...
		public virtual void AddBuff(Mobile m)
		{
			switch (this.PotionEffect)
			{
				case PotionEffect.Barrab:
					BuffInfo.AddBuff(
						m,
						new BuffInfo(BuffIcon.BarrabHemolymphConcentrate, LabelNumber, 1156738, "100\t10\t10\t5")
					);
					break;
				case PotionEffect.Jukari:
					BuffInfo.AddBuff(
						m,
						new BuffInfo(BuffIcon.JukariBurnPoiltice, LabelNumber, 1156739, "10\t10\t10\t5")
					);
					break;
				case PotionEffect.Kurak:
					BuffInfo.AddBuff(m, new BuffInfo(BuffIcon.KurakAmbushersEssence, LabelNumber, 1156740, "200"));
					break;
				case PotionEffect.Barako:
					BuffInfo.AddBuff(
						m,
						new BuffInfo(BuffIcon.BarakoDraftOfMight, LabelNumber, 1156741, "10\t10\t5\t10")
					);
					break;
				case PotionEffect.Urali:
					BuffInfo.AddBuff(m, new BuffInfo(BuffIcon.UraliTranceTonic, LabelNumber, 1156742, "10\t10\t10\t5"));
					break;
				case PotionEffect.Sakkhra:
					BuffInfo.AddBuff(
						m,
						new BuffInfo(BuffIcon.SakkhraProphylaxis, LabelNumber, 1156743, "10\t10\t5\t10")
					);
					break;
			}
		}
		...
		public virtual void RemoveBuff(Mobile m)
		{
			...
			{
				case PotionEffect.Barrab:
					BuffInfo.RemoveBuff(m, BuffIcon.BarrabHemolymphConcentrate);
					break;
				case PotionEffect.Jukari:
					BuffInfo.RemoveBuff(m, BuffIcon.JukariBurnPoiltice);
					break;
				case PotionEffect.Kurak:
					BuffInfo.RemoveBuff(m, BuffIcon.KurakAmbushersEssence);
					break;
				case PotionEffect.Barako:
					BuffInfo.RemoveBuff(m, BuffIcon.BarakoDraftOfMight);
					break;
				case PotionEffect.Urali:
					BuffInfo.RemoveBuff(m, BuffIcon.UraliTranceTonic);
					break;
				case PotionEffect.Sakkhra:
					BuffInfo.RemoveBuff(m, BuffIcon.SakkhraProphylaxis);
					break;
			}
		}
	...
	{
		[Constructable]
		public BarrabHemolymphConcentrate()
			: this(1) { }
	...
	{
		[Constructable]
		public SakkhraProphylaxisPotion()
			: this(1) { }
