...
namespace Server.Items
{
	...
	public class BaseQuiver : Container, ICraftable, ISetItem, IVvVItem, IOwnerRestricted, IRangeDamage, IArtifact
	{
		...
		{
			get { return m_Attributes.LowerAmmoCost; }
			set
			{
		...
		private static readonly Type[] m_Ammo = new Type[] { typeof(Arrow), typeof(Bolt) };
		...
		{
			get { return BasePhysicalResistance + m_Resistances.Physical; }
		}
		public override int FireResistance
		{
			get { return BaseFireResistance + m_Resistances.Fire; }
		}
		public override int ColdResistance
		{
			get { return BaseColdResistance + m_Resistances.Cold; }
		}
		public override int PoisonResistance
		{
			get { return BasePoisonResistance + m_Resistances.Poison; }
		}
		public override int EnergyResistance
		{
			get { return BaseEnergyResistance + m_Resistances.Energy; }
		}
		...
		public virtual void AlterRangedDamage(
			ref int phys,
			ref int fire,
			ref int cold,
			ref int pois,
		...
		public class RefillQuiverEntry : ContextMenuEntry
		{
			...
			bool Refill<T>(Mobile m, Container c)
				where T : Item
			{
			...
			public override void OnClick()
			{
				if (
					(m_quiver == null)
					|| m_quiver.Deleted
					|| (m_quiver.Ammo != null && m_quiver.Ammo.Amount >= m_quiver.Capacity)
				)
					return;
