...
namespace Server.Items
{
	...
	{
		private static readonly Dictionary<TalismanSlayerName, Type[]> m_Table =
			new Dictionary<TalismanSlayerName, Type[]>();
		...
		public static void Initialize()
		{
			...
			m_Table[TalismanSlayerName.Bat] = new Type[] { typeof(Mongbat), typeof(StrongMongbat), typeof(VampireBat) };
			...
			m_Table[TalismanSlayerName.Wood] = new Type[]
			{
				typeof(Bogling),
				typeof(Corpser),
				typeof(Treefellow),
			...
			m_Table[TalismanSlayerName.Water] = new Type[]
			{
			...
			m_Table[TalismanSlayerName.Earth] = new Type[]
			{
