			...
			IArtifact
	{
		...
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(RandomTalisman_OnCommand)
			);
		}
		...
		{
			get { return m_AosAttributes.IncreasedKarmaLoss; }
			set
			{
		...
		{
			get { return NegativeAttributes.Antique < 4; }
		}
			...
			else
			{
				...
				if (type != null)
				{
					...
					if (obj is Item)
					{
						...
						if (
							from.Backpack == null
							|| count * item.Weight > from.Backpack.MaxWeight
					...
					else if (obj is BaseCreature)
					{
						...
						if (
							(m_Creature != null && !m_Creature.Deleted)
							|| from.Followers + mob.ControlSlots > from.FollowersMax
						)
						{
		...
		public override void GetProperties(ObjectPropertyList list)
		{
			...
			if (m_Killer != null && !m_Killer.IsEmpty && m_Killer.Amount > 0)
				list.Add(
					1072388,
					"{0}\t{1}",
					m_Killer.Name != null ? m_Killer.Name.ToString() : "Unknown",
					m_Killer.Amount
				); // ~1_NAME~ Killer: +~2_val~%
			...
			if (m_Protection != null && !m_Protection.IsEmpty && m_Protection.Amount > 0)
				list.Add(
					1072387,
					"{0}\t{1}",
					m_Protection.Name != null ? m_Protection.Name.ToString() : "Unknown",
					m_Protection.Amount
			...
			if (m_Slayer != TalismanSlayerName.None)
			{
				...
				else
				{
					switch (m_Slayer)
					{
						case TalismanSlayerName.Repond:
							list.Add(1079750);
							break;
						case TalismanSlayerName.Elemental:
							list.Add(1079749);
							break;
						case TalismanSlayerName.Demon:
							list.Add(1079748);
							break;
						case TalismanSlayerName.Arachnid:
							list.Add(1079747);
							break;
						case TalismanSlayerName.Reptile:
							list.Add(1079751);
							break;
						case TalismanSlayerName.Fey:
							list.Add(1154652);
							break;
					}
				}
		...
		#region Randomize
		private static readonly int[] m_ItemIDs = new int[] { 0x2F58, 0x2F59, 0x2F5A, 0x2F5B };

		//0x2F58 : 나무 동그라미 - 방어 계열 DefenseTalisman. 저항, 재생, 흡혈 위주
		//0x2F59 : 용 머리 - 테이머 계열 TamerTalisman. 테이밍 혹은 슬레잉 위주
		//0x2F5A : 나무 십자가처럼 생김 - 마법 계열 HealTalisman. 힐링 혹은 회복 위주
		//0x2F5B : 전사 부적처럼 생김 - 공격 계열 AttackerTalisman. 공격 마법 뎀 위주
		...
		public static Type[] Summons
		{
			get { return m_Summons; }
		}
		...
		public static int[] SummonLabels
		{
			get { return m_SummonLabels; }
		}
		...
		public static Type[] Killers
		{
			get { return m_Killers; }
		}
		private static readonly Type[] m_Killers = new Type[]
		{
			...
			typeof(Cow),
			typeof(Bull),
			typeof(Gaman), //,			typeof( Minotaur)
			// TODO Meraktus, Tormented Minotaur, Minotaur
		};

		public static int[] KillerLabels
		{
			get { return m_KillerLabels; }
		}
		...
		public static SkillName[] SkillsOld
		{
			get { return m_SkillsOld; }
		}
		...
		public static TalismanSkill[] Skills
		{
			get { return m_Skills; }
		}
		...
		public TalismanSkill GetTalismanSkill(SkillName skill)
		{
			switch (skill)
			{
				...
				case SkillName.Alchemy:
					return TalismanSkill.Alchemy;
				case SkillName.Blacksmith:
					return TalismanSkill.Blacksmithy;
				case SkillName.Carpentry:
					return TalismanSkill.Carpentry;
				case SkillName.Cartography:
					return TalismanSkill.Cartography;
				case SkillName.Cooking:
					return TalismanSkill.Cooking;
				case SkillName.Fletching:
					return TalismanSkill.Fletching;
				case SkillName.Inscribe:
					return TalismanSkill.Inscription;
				case SkillName.Tailoring:
					return TalismanSkill.Tailoring;
				case SkillName.Tinkering:
					return TalismanSkill.Tinkering;
			}
		}
		...
		public SkillName GetMainSkill()
		{
			...
			{
				default:
				case TalismanSkill.Alchemy:
					return SkillName.Alchemy;
				case TalismanSkill.Blacksmithy:
					return SkillName.Blacksmith;
				case TalismanSkill.Fletching:
					return SkillName.Fletching;
				case TalismanSkill.Carpentry:
					return SkillName.Carpentry;
				case TalismanSkill.Cartography:
					return SkillName.Cartography;
				case TalismanSkill.Cooking:
					return SkillName.Cooking;
				case TalismanSkill.Glassblowing:
					return SkillName.Alchemy;
				case TalismanSkill.Inscription:
					return SkillName.Inscribe;
				case TalismanSkill.Masonry:
					return SkillName.Carpentry;
				case TalismanSkill.Tailoring:
					return SkillName.Tailoring;
				case TalismanSkill.Tinkering:
		...
		public int GetSkillLabel()
		{
			switch (m_Skill)
			{
				...
				case TalismanSkill.Masonry:
					return 1072392;
				default:
					return AosSkillBonuses.GetLabel(GetMainSkill());
			}
		}
				...
				else
				{
					switch (m_Talisman.Removal)
					{
						case TalismanRemoval.Curse:
							...
							IEntity mto = new Entity(
								Serial.Zero,
								new Point3D(target.X, target.Y, target.Z + 50),
								from.Map
							);
