...
namespace Server.Items
{
    ...
    public abstract class BaseClothing : Item, IDyable, IScissorable, IFactionItem, ICraftable, IWearableDurability, IResource, ISetItem, IVvVItem, IOwnerRestricted, IArtifact, ICombatEquipment, IEngravable, IQuality, IEquipOption
    {
        ...
        public override int PhysicalResistance
        {
            get
            {
                return BasePhysicalResistance + m_AosResistances.Physical + m_AosWeaponAttributes.ResistPhysicalBonus / 10000 + m_AosClothingAttributes.AllResist / 10000;
            }
        }
        public override int FireResistance
        {
            get
            {
                return BaseFireResistance + m_AosResistances.Fire + m_AosWeaponAttributes.ResistFireBonus / 10000 + m_AosClothingAttributes.ElementalResist / 10000 + m_AosClothingAttributes.AllResist / 10000;
            }
        }
        public override int ColdResistance
        {
            get
            {
                return BaseColdResistance + m_AosResistances.Cold + m_AosWeaponAttributes.ResistColdBonus / 10000 + m_AosClothingAttributes.ElementalResist / 10000 + m_AosClothingAttributes.AllResist / 10000;
            }
        }
        public override int PoisonResistance
        {
            get
            {
                return BasePoisonResistance + m_AosResistances.Poison + m_AosWeaponAttributes.ResistPoisonBonus / 10000 + m_AosClothingAttributes.ElementalResist / 10000 + m_AosClothingAttributes.AllResist / 10000;
            }
        }
        public override int EnergyResistance
        {
            get
            {
                return BaseEnergyResistance + m_AosResistances.Energy+ m_AosWeaponAttributes.ResistEnergyBonus / 10000 + m_AosClothingAttributes.ElementalResist / 10000 + m_AosClothingAttributes.AllResist / 10000;
            }
        }
        #endregion
