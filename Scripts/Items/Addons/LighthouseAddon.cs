...
namespace Server.Items
{
	public class LighthouseAddon : BaseAddon
	{
		...
		{
			get { return Account == null ? null : Accounts.GetAccount(Account) as Account; }
		}

		public override BaseAddonDeed Deed
		{
			get { return new LighthouseAddonDeed(Account); }
		}
		...
		public void DockBoat(BaseBoat boat, BaseHouse house)
		{
			foreach (var entity in boat.GetEntitiesOnBoard())
			{
				if (
					!(entity is Item)
					|| entity == this
					|| boat.IsComponentItem(entity)
					|| entity is EffectItem
					|| entity == boat.TillerMan
				)
					continue;
	...
	public class LighthouseAddonDeed : BaseAddonDeed, IRewardItem
	{
		...
		{
			get { return new LighthouseAddon(Account); }
		}
