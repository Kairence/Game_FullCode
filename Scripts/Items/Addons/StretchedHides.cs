...
namespace Server.Items
{
    ...
    public class MediumStretchedHideEastAddon : BaseAddon
    {
        ...
        {
            this.AddComponent(new AddonComponent(0x106D), 0, 0, 0);
            this.AddComponent(new AddonComponent(0x106C), 0, 1, 0);
        }
    ...
    public class MediumStretchedHideSouthAddon : BaseAddon
    {
        ...
        {
            this.AddComponent(new AddonComponent(0x107D), 0, 0, 0);
            this.AddComponent(new AddonComponent(0x107E), 1, 0, 0);
        }
