...
namespace Server.Items
{
	...
	public class GardenShedAddon : BaseAddonContainer
	{
		...
		[Constructable]
		public GardenShedAddon(bool east)
			: base(east ? 0x4BEB : 0x4BE7)
		{
		...
		public GardenShedAddon(Serial serial)
			: base(serial) { }
	...
	public class GardenShedBarrel : BaseAddonContainer
	{
		...
		public override BaseAddonContainerDeed Deed
		{
			get { return m_MainContainer.Deed; }
		}
		public override int LabelNumber
		{
			get { return 1153492; }
		...
		public override void OnLocationChange(Point3D old)
		{
			m_MainContainer.Location = new Point3D(
				X - m_MainContainer.Offset.X,
				Y - m_MainContainer.Offset.Y,
				Z - m_MainContainer.Offset.Z
			);
		}
	...
	public class GardenShedDeed : BaseAddonContainerDeed, IRewardItem
	{
		...
		{
			get { return new GardenShedAddon(m_East); }
		}
		public override int LabelNumber
		{
			get { return 1153491; }
		...
		public GardenShedDeed(Serial serial)
			: base(serial) { }
		...
		private class InternalGump : Gump
		{
			...
			public InternalGump(GardenShedDeed deed)
				: base(60, 36)
			{
				m_Deed = deed;
