	...
	public class Guildstone : Item, IAddon, IChopable
	{
		...
		public override void GetProperties(ObjectPropertyList list)
		{
			...
			else if (this.m_GuildName != null && this.m_GuildAbbrev != null)
			{
				list.Add(
					1060802,
					String.Format("{0} [{1}]", Utility.FixHtml(this.m_GuildName), Utility.FixHtml(this.m_GuildAbbrev))
				);
			}
		}
		...
		public override void OnDoubleClick(Mobile from)
		{
			...
			{
				from.Send(
					new MessageLocalized(this.Serial, this.ItemID, MessageType.Regular, 0x3B2, 3, 501158, "", "")
		...
		public Item Deed
		{
			get { return new GuildstoneDeed(this.m_Guild, this.m_GuildName, this.m_GuildAbbrev); }
		}
		...
		public void OnChop(Mobile from)
		{
			...
			if (
				(house == null && this.m_BeforeChangeover)
				|| (house != null && house.IsOwner(from) && house.Addons.ContainsKey(this))
			)
			{
