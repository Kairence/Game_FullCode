...
namespace Server.Items
{
	public class FountainOfFortune : BaseAddon
	{
		...
		public Dictionary<Mobile, DateTime> ResCooldown
		{
			get { return m_ResCooldown; }
		}
		public Dictionary<Mobile, DateTime> RewardCooldown
		{
			get { return m_RewardCooldown; }
		}
		...
		public static Dictionary<Mobile, DateTime> SpecialProtection
		{
			get { return m_SpecialProtection; }
		}
		public static Dictionary<Mobile, DateTime> BalmBoost
		{
			get { return m_BalmBoost; }
		}
		...
		public bool OnTarget(Mobile from, Item coin)
		{
			...
			if (.20 >= Utility.RandomDouble())
			{
				...
				{
					case 0:
						item = new SolesOfProvidence();
						break;
					case 1:
						item = new GemologistsSatchel();
						break;
					case 2:
						item = new RelicFragment(5);
						break;
					case 3:
						item = new EnchantedEssence(5);
						break;
				}
		...
		public FountainOfFortune(Serial serial)
			: base(serial) { }
