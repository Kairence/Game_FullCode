...
namespace Server.Items
{
	...
	public class AdvancedTrainingDummy : TrainingDummy
	{
		...
		public override void BeginSwing(Mobile from)
		{
			ItemID = ItemID + 1;
			base.BeginSwing(from);
		}

		public override void EndSwing(Mobile from)
		{
			ItemID = ItemID - 1;
			base.EndSwing(from);
		}
	...
	public class AdvancedTrainingDummyEastAddon : BaseAddon
	{
		...
		{
			get { return new AdvancedTrainingDummyEastDeed(); }
		}
	...
	public class AdvancedTrainingDummyEastDeed : BaseAddonDeed
	{
		...
		{
			get { return new AdvancedTrainingDummyEastAddon(); }
		}
		public override int LabelNumber
		{
			get { return 1150596; }
		} // advanced training dummy (east)
	...
	public class AdvancedTrainingDummySouthAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get { return new AdvancedTrainingDummySouthDeed(); }
		}
	...
	public class AdvancedTrainingDummySouthDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get { return new AdvancedTrainingDummySouthAddon(); }
		}
		public override int LabelNumber
		{
			get { return 1150595; }
		} // advanced training dummy (south)
