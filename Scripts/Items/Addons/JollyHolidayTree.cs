...
namespace Server.Items
{
	public class JollyHolidayTreeAddon : BaseAddon
	{
		...
		{
			get { return new JollyHolidayTreeDeed(DisplayName); }
		}
	...
	public class JollyHolidayTreeDeed : BaseAddonDeed
	{
		...
		{
			get { return new JollyHolidayTreeAddon(DisplayName); }
		}
		...
		{
			"Cursed Powder Obsidian",
			"Lover Noggin Artemis",
			"Cursed Tooth Aeon",
			"Short Noggin Takako",
			"Stink Hook Ashmedia",
			"Iron Eye Greg",
			...
			"Bloody Ear Aumakua",
			"Long Powder Jim",
			"Lazy Tongue Silver Fox",
			"Lazy Pants Hanarin",
			"Fat Hook Bonnie",
			"Short Hook Michael",
			"Bonny Eye Elizabella",
			"Glass Blade Artemis",
			"Stink Strap Raine",
			"Bloody Tongue Aumakua",
			"Bloody Tooth Asiantam",
			"Short Blade Topaz",
			"Lazy Beard Raine",
			"Drunk Nail Takako",
			"Rude Powder Obsidian",
			"Peg Mouth Thrixx",
			"Iron Hook Stephen",
			"Lost Nail Tori",
			"Lone Patch Michael",
