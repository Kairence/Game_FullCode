		...
		public TinkerBenchAddon(DirectionType type, int uses)
		{
			switch (type)
			{
				case DirectionType.South:
					AddCraftComponent(
						new AddonToolComponent(CraftSystem, 0xA213, 0xA212, 1157072, 1157073, 1125529, uses, this),
						0,
						0,
						0
					);
				...
				case DirectionType.East:
					AddCraftComponent(
						new AddonToolComponent(CraftSystem, 0xA21B, 0xA21A, 1157072, 1157073, 1125529, uses, this),
						0,
						0,
						0
					);
