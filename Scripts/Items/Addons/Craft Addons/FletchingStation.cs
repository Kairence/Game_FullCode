...
namespace Server.Items
{
	public class FletchingStation : CraftAddon
	{
		...
		{
			get { return new FletchingStationDeed(Tools.Count > 0 ? Tools[0].UsesRemaining : 0); }
		}
	...
	public class FletchingStationDeed : CraftAddonDeed
	{
		...
		{
			get { return new FletchingStation(_South, UsesRemaining); }
		}

		private bool _South;

		[Constructable]
		public FletchingStationDeed()
			: this(0) { }

		[Constructable]
		public FletchingStationDeed(int uses)
			: base(uses) { }
