...
namespace Server.Items
{
	public class EnchantedSculptingToolAddon : CraftAddon
	{
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				EnchantedSculptingToolDeed deed = new EnchantedSculptingToolDeed(
					Tools.Count > 0 ? Tools[0].UsesRemaining : 0
				)
				{
		...
		public EnchantedSculptingToolAddon(DirectionType type, int uses)
		{
			switch (type)
			{
				case DirectionType.South:
					AddCraftComponent(
						new AddonToolComponent(CraftSystem, 0xA538, 0xA541, 1157988, 1157987, 1029241, uses, this),
						0,
						0,
						0
					);
				...
				case DirectionType.East:
					AddCraftComponent(
						new AddonToolComponent(CraftSystem, 0xA540, 0xA539, 1157988, 1157987, 1029241, uses, this),
						0,
						0,
						0
					);
