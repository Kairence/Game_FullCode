...
namespace Server.Items
{
		...
		public GlassKilnAddon(DirectionType type, int uses)
		{
			switch (type)
			{
				case DirectionType.South:
					AddCraftComponent(
						new AddonToolComponent(CraftSystem, 0xA530, 0xA531, 1157072, 1157073, 1126312, uses, this),
						0,
						0,
						0
					);
				...
				case DirectionType.East:
					AddCraftComponent(
						new AddonToolComponent(CraftSystem, 0xA534, 0xA535, 1157072, 1157073, 1126312, uses, this),
						0,
						0,
						0
					);
	...
	public class GlassKilnDeed : CraftAddonDeed, IRewardItem, IRewardOption
	{
		...
		public override BaseAddon Addon
		{
			get
			{
				GlassKilnAddon addon = new GlassKilnAddon(_Direction, UsesRemaining) { IsRewardItem = m_IsRewardItem };
