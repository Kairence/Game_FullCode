...
namespace Server.Items
{
	public class SewingMachine : CraftAddon
	{
		...
		{
			get { return new SewingMachineDeed(Tools.Count > 0 ? Tools[0].UsesRemaining : 0); }
		}
	...
	public class SewingMachineDeed : CraftAddonDeed
	{
		...
		{
			get { return new SewingMachine(_South, UsesRemaining); }
		}

		private bool _South;

		[Constructable]
		public SewingMachineDeed()
			: this(0) { }

		[Constructable]
		public SewingMachineDeed(int uses)
			: base(uses) { }
