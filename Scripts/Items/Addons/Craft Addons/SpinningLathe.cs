...
namespace Server.Items
{
	public class SpinningLathe : CraftAddon
	{
		...
		{
			get { return new SpinningLatheDeed(Tools.Count > 0 ? Tools[0].UsesRemaining : 0); }
		}
	...
	public class SpinningLatheDeed : CraftAddonDeed
	{
		...
		{
			get { return new SpinningLathe(_South, UsesRemaining); }
		}

		private bool _South;

		[Constructable]
		public SpinningLatheDeed()
			: this(0) { }

		[Constructable]
		public SpinningLatheDeed(int uses)
			: base(uses) { }
