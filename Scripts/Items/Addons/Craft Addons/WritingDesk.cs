...
namespace Server.Items
{
	public class WritingDesk : CraftAddon
	{
		...
		{
			get { return new WritingDeskDeed(Tools.Count > 0 ? Tools[0].UsesRemaining : 0); }
		}
	...
	public class WritingDeskDeed : CraftAddonDeed
	{
		...
		{
			get { return 1157989; }
		} // Enchanted Writing Desk
		public override BaseAddon Addon
		{
			get { return new WritingDesk(_South, UsesRemaining); }
		}

		private bool _South;

		[Constructable]
		public WritingDeskDeed()
			: this(0) { }

		[Constructable]
		public WritingDeskDeed(int uses)
			: base(uses) { }
