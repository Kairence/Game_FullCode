...
namespace Server.Items
{
	public class BBQSmoker : CraftAddon
	{
		...
		{
			get { return new BBQSmokerDeed(Tools.Count > 0 ? Tools[0].UsesRemaining : 0); }
		}
	...
	public class BBQSmokerDeed : CraftAddonDeed
	{
		...
		{
			get { return new BBQSmoker(_South, UsesRemaining); }
		}

		private bool _South;

		[Constructable]
		public BBQSmokerDeed()
			: this(0) { }

		[Constructable]
		public BBQSmokerDeed(int uses)
			: base(uses) { }
