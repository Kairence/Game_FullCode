...
namespace Server.Items
{
	public class SmithingPress : CraftAddon
	{
		...
		{
			get { return new SmithingPressDeed(Tools.Count > 0 ? Tools[0].UsesRemaining : 0); }
		}
	...
	public class SmithingPressDeed : CraftAddonDeed
	{
		...
		{
			get { return new SmithingPress(_South, UsesRemaining); }
		}

		private bool _South;

		[Constructable]
		public SmithingPressDeed()
			: this(0) { }

		[Constructable]
		public SmithingPressDeed(int uses)
			: base(uses) { }
