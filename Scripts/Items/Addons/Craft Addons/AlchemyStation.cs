...
namespace Server.Items
{
	public class AlchemyStation : CraftAddon
	{
		...
		{
			get { return new AlchemyStationDeed(Tools.Count > 0 ? Tools[0].UsesRemaining : 0); }
		}
	...
	public class AlchemyStationDeed : CraftAddonDeed
	{
		...
		{
			get { return new AlchemyStation(_South, UsesRemaining); }
		}

		private bool _South;

		[Constructable]
		public AlchemyStationDeed()
			: this(0) { }

		[Constructable]
		public AlchemyStationDeed(int uses)
			: base(uses) { }
