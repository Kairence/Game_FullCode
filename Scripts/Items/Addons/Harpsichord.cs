...
namespace Server.Items
{
		...
		public class InternalTarget : Target
		{
			...
			protected override void OnTarget(Mobile from, object targeted)
			{
				if (
					...
					&& ((AddonComponent)targeted).Addon != null
					&& ((AddonComponent)targeted).Addon is HarpsichordAddon
				)
				{
					...
					if (addon.List.Contains(Item.Music))
					{
						...
						); // The Harpsichord already has this song.
					}
					else
					{
						...
						); // You carefully feed the roll into the Harpsichord.
					}
				}
				else
				{
	...
	public class HarpsichordAddon : BaseAddon
	{
		...
		{
			get { return new HarpsichordAddonDeed((HarpsichordColor)Hue, List); }
		}
		...
		public override void OnComponentUsed(AddonComponent component, Mobile from)
		{
			...
			if (
				house != null
				&& (house.IsFriend(from) || (house.LockDowns.ContainsKey(this) && house.LockDowns[this] == from))
			)
			{
	...
	public class HarpsichordAddonDeed : BaseAddonDeed, IRewardOption
	{
		...
		{
			get { return new HarpsichordAddon((HarpsichordColor)Hue, _Direction, _List); }
		}
