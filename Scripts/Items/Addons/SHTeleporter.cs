...
namespace Server.Items
{
	public class SHTeleComponent : AddonComponent
	{
		...
		{
			get { return this.m_TeleOffset; }
			set { this.m_TeleOffset = value; }
		}
		...
		public Point3D TelePoint
		{
			...
			{
				return new Point3D(
					this.Location.X + this.TeleOffset.X,
					this.Location.Y + this.TeleOffset.Y,
					this.Location.Z + this.TeleOffset.Z
				);
			}
			set
			{
				this.m_TeleOffset = new Point3D(
					value.X - this.Location.X,
					value.Y - this.Location.Y,
					value.Z - this.Location.Z
				);
			}
		}
		...
		public override void OnDoubleClick(Mobile m)
		{
			if (
				!this.m_Active
				|| this.m_TeleDest == null
				|| this.m_TeleDest.Deleted
				|| this.m_TeleDest.Map == Map.Internal
			)
				return;
	...
	public class SHTeleporter : BaseAddon
	{
		...
		{
			get { return this.m_External; }
		}
		public SHTeleComponent UpTele
		{
			get { return this.m_UpTele; }
		}
		public SHTeleComponent RightTele
		{
			get { return this.m_RightTele; }
		}
		public SHTeleComponent DownTele
		{
			get { return this.m_DownTele; }
		}
		public SHTeleComponent LeftTele
		{
			get { return this.m_LeftTele; }
		}
