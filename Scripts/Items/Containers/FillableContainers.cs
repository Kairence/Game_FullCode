...
namespace Server.Items
{
	...
	public abstract class FillableContainer : LockableContainer
	{
		...
		public static void CheckFillables_OnCommand(CommandEventArgs e)
		{
			...
			List<FillableContainer> toCheck = new List<FillableContainer>(
				World
					.Items.Values.OfType<FillableContainer>()
					.Where(i =>
						i is FillableContainer && ((FillableContainer)i).ContentType == FillableContentType.None
					)
			);
		...
		{
			get { return MaxSpawnCount - 1; }
		}

		public virtual int AmountPerSpawn
		{
			get { return 1; }
		}
		...
		public virtual bool CanSpawnRefinement()
		{
			return Map == Map.Felucca
				&& (
					ContentType == FillableContentType.Clothier
					|| ContentType == FillableContentType.Blacksmith
					|| ContentType == FillableContentType.Carpenter
				);
		}
	...
	public class FillableContent
	{
		...
		public static FillableContent Weaponsmith = new FillableContent(
			...
			new FillableEntry[] { new FillableEntry(8, Loot.WeaponTypes), new FillableEntry(1, typeof(Arrow)) }
		);
