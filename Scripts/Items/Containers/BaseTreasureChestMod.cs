...
namespace Server.Items
{
	public abstract class BaseTreasureChestMod : LockableContainer
	{
		...
		public BaseTreasureChestMod(int itemID)
			: base(itemID)
		{
			Locked = true;
			Movable = false;
		...
		public BaseTreasureChestMod(Serial serial)
			: base(serial) { }
		...
		private class ChestTimer : Timer
		{
			...
			public ChestTimer(BaseTreasureChestMod chest)
				: base(TimeSpan.FromMinutes(Utility.Random(2, 5)))
			{
				m_Chest = chest;
