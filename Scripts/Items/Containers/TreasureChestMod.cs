...
namespace Server.Items
{
	...
	public class TreasureLevel1h : BaseTreasureChestMod
	{
		...
		public TreasureLevel1h(Serial serial)
			: base(serial) { }
	...
	public class TreasureLevel2 : BaseTreasureChestMod
	{
		...
		public TreasureLevel2()
			: base(Utility.RandomList(0xe3c, 0xE3E, 0x9a9, 0xe42, 0x9ab, 0xe40, 0xe7f, 0xe77))
		{
			RequiredSkill = 40;
			LockLevel = this.RequiredSkill - Utility.Random(0, 25);
			MaxLockLevel = this.RequiredSkill;
	...
	public class TreasureLevel3 : BaseTreasureChestMod
	{
		...
		public TreasureLevel3()
			: base(Utility.RandomList(0x9ab, 0xe40, 0xe42))
		{
			RequiredSkill = 60;
			LockLevel = this.RequiredSkill - Utility.Random(0, 25);
			MaxLockLevel = this.RequiredSkill;
	...
	public class TreasureLevel4 : BaseTreasureChestMod
	{
		...
		public TreasureLevel4()
			: base(Utility.RandomList(0xe40, 0xe42))
		{
			RequiredSkill = 80;
			LockLevel = this.RequiredSkill - Utility.Random(0, 25);
			MaxLockLevel = this.RequiredSkill;
	...
	public class TreasureLevel5 : BaseTreasureChestMod
	{
		...
		public TreasureLevel5(Serial serial)
			: base(serial) { }
