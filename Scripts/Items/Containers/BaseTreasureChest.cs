...
namespace Server.Items
{
	public class BaseTreasureChest : LockableContainer
	{
		...
		{
			get { return this.m_TreasureLevel; }
			set { this.m_TreasureLevel = value; }
		}
		...
		private void StartResetTimer()
		{
			if (this.m_ResetTimer == null)
				...
				this.m_ResetTimer.Delay = TimeSpan.FromMinutes(
					Utility.Random(this.m_MinSpawnTime, this.m_MaxSpawnTime)
				);
