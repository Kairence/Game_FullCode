...
namespace Server.Items
{
	public class CompassionsEye : SilverRing
	{
		...
		public CompassionsEye(Serial serial)
			: base(serial) { }
	...
	public class UnicornManeWovenSandals : Sandals
	{
		...
		public UnicornManeWovenSandals(Serial serial)
			: base(serial) { }
	...
	public class UnicornManeWovenTalons : LeatherTalons
	{
		...
		public UnicornManeWovenTalons()
		{
			...
			switch (Utility.Random(6))
			{
				case 0:
					...
					break;
				case 1:
					AbsorptionAttributes.EaterFire = 2;
					break;
				case 2:
					AbsorptionAttributes.EaterCold = 2;
					break;
				case 3:
					AbsorptionAttributes.EaterPoison = 2;
					break;
				case 4:
					AbsorptionAttributes.EaterEnergy = 2;
					break;
				case 5:
					AbsorptionAttributes.EaterDamage = 2;
					break;
			}
		...
		public UnicornManeWovenTalons(Serial serial)
			: base(serial) { }
	...
	public class DespicableQuiver : BodySash
	{
		...
		public DespicableQuiver(Serial serial)
			: base(serial) { }
	...
	public class UnforgivenVeil : Cloak
	{
		...
		public UnforgivenVeil(Serial serial)
			: base(serial) { }
	...
	public class HailstormHuman : RepeatingCrossbow //36. 난사의 연사 석궁
	{
		...
		public HailstormHuman(Serial serial)
			: base(serial) { }
	...
	public class HailstormGargoyle : GargishWarFork
	{
		...
		public HailstormGargoyle(Serial serial)
			: base(serial) { }
