...
namespace Server.Items
{
	...
	public class PigmentsOfTokuno : BasePigmentsOfTokuno
	{
		...
		private static readonly int[][] m_Table = new int[][]
		{
			...
			new int[]
			{ /*PigmentType.ParagonGold,*/
				0x501,
				1070987,
			},
			new int[]
			{ /*PigmentType.VioletCouragePurple,*/
				0x486,
				1070988,
			},
			new int[]
			{ /*PigmentType.InvulnerabilityBlue,*/
				0x4F2,
				1070989,
			},
			new int[]
			{ /*PigmentType.LunaWhite,*/
				0x47E,
				1070990,
			},
			new int[]
			{ /*PigmentType.DryadGreen,*/
				0x48F,
				1070991,
			},
			new int[]
			{ /*PigmentType.ShadowDancerBlack,*/
				0x455,
				1070992,
			},
			new int[]
			{ /*PigmentType.BerserkerRed,*/
				0x21,
				1070993,
			},
			new int[]
			{ /*PigmentType.NoxGreen,*/
				0x58C,
				1070994,
			},
			new int[]
			...
			new int[]
			{ /*PigmentType.FireOrange,*/
				0x54F,
				1070996,
			},
			new int[]
			{ /*PigmentType.Fadedcoal,*/
				0x96A,
				1079579,
			},
			new int[]
			...
			new int[]
			{ /*PigmentType.FadedGold,*/
				0x972,
				1079581,
			},
			new int[]
			{ /*PigmentType.StormBronze,*/
				0x977,
				1079582,
			},
			new int[]
			...
			new int[]
			{ /*PigmentType.MidnightCoal,*/
				0x96C,
				1079584,
			},
			new int[]
			{ /*PigmentType.FadedBronze,*/
				0x975,
				1079585,
			},
			new int[]
			{ /*PigmentType.FadedRose,*/
				0x97B,
				1079586,
			},
			new int[]
			{ /*PigmentType.DeepRose,*/
				0x97E,
				1079587,
			},
		};
