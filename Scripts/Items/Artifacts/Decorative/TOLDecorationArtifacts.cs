...
namespace Server.Items
{
	public class StretchedDinosaurHide : BaseDecorationArtifact
	{
		...
		public override bool ShowArtifactRarity
		{
			get { return false; }
		}
		...
		public StretchedDinosaurHide(Serial serial)
			: base(serial) { }
	...
	public class CarvedMyrmydexGlyph : BaseDecorationArtifact // Barrab
	{
		...
		public CarvedMyrmydexGlyph(Serial serial)
			: base(serial) { }
	...
	public class WakuOnASpit : BaseDecorationArtifact // Barako
	{
		...
		public WakuOnASpit(Serial serial)
			: base(serial) { }
	...
	public class SacredLavaRock : BaseDecorationArtifact // Jukari
	{
		...
		public SacredLavaRock(Serial serial)
			: base(serial) { }
	...
	public class WhiteTigerFigurine : BaseDecorationArtifact // Kurak
	{
		...
		public WhiteTigerFigurine(Serial serial)
			: base(serial) { }
	...
	public class DragonTurtleHatchlingNet : BaseDecorationArtifact // Urali
	{
		...
		[Constructable]
		public DragonTurtleHatchlingNet()
			: base(3574)
		{
			Name = "Dragon Turtle Hatchling Net";
		}

		public DragonTurtleHatchlingNet(Serial serial)
			: base(serial) { }
