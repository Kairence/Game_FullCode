...
namespace Server.Items
{
	...
	public class AnkhPendant : BaseNecklace
	{
		...
		public static Rectangle2D[] ShrineLocs
		{
			get { return m_ShrineLocs; }
		}
		...
		private static Dictionary<Mobile, AnkhPendantBonusContext> m_Table =
			new Dictionary<Mobile, AnkhPendantBonusContext>();
		...
		private class AnkhPendantBonusContext
		{
			...
			public bool DoBump2
			{
				get { return m_DoBump2; }
			}
			public bool DoBump3
			{
				get { return m_DoBump3; }
			}
			public int Random
			{
				get { return m_Random; }
