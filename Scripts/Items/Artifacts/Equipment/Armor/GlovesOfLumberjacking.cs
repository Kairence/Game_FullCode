...
namespace Server.Items
{
	...
	public class LeatherGlovesOfLumberjacking : GlovesOfLumberjacking
	{
	...
	public class StuddedGlovesOfLumberjacking : GlovesOfLumberjacking
	{
		public override int Lifespan
		{
			get { return 259200; }
	...
	public class RingmailGlovesOfLumberjacking : GlovesOfLumberjacking
	{
		public override int Lifespan
		{
			get { return 604800; }
	...
	public abstract class GlovesOfLumberjacking : BaseArmor
	{
		private int m_Bonus;
		...
		public GlovesOfLumberjacking(int bonus, int itemID)
			: base(itemID)
		{
			this.m_Bonus = bonus;

			this.Hue = Misc.Util.RandomColor_Green(true);
			if (Lifespan > 0)
			{
		...
		public GlovesOfLumberjacking(Serial serial)
			: base(serial) { }
		...
		public override void GetProperties(ObjectPropertyList list)
		{
			...
			if (this.m_Bonus != 0)
				list.Add(1063678, this.m_Bonus.ToString()); // mining bonus +~1_val~
