...
namespace Server.Items
{
	...
	public class LeatherGlovesOfFishing : GlovesOfFishing
	{
		...
		[Constructable]
		public LeatherGlovesOfFishing(int bonus)
			: base(bonus, 0x13C6)
		{
			Weight = 1;
		}

		public LeatherGlovesOfFishing(Serial serial)
			: base(serial) { }
	...
	public class StuddedGlovesOfFishing : GlovesOfFishing
	{
		public override int Lifespan
		{
			get { return 259200; }
		...
		[Constructable]
		public StuddedGlovesOfFishing(int bonus)
			: base(bonus, 0x13D5)
		{
			Weight = 2;
		}

		public StuddedGlovesOfFishing(Serial serial)
			: base(serial) { }
	...
	public class RingmailGlovesOfFishing : GlovesOfFishing
	{
		public override int Lifespan
		{
			get { return 604800; }
		...
		[Constructable]
		public RingmailGlovesOfFishing(int bonus)
			: base(bonus, 0x13EB)
		{
			Weight = 1;
		}

		public RingmailGlovesOfFishing(Serial serial)
			: base(serial) { }
	...
	public abstract class GlovesOfFishing : BaseArmor
	{
		private int m_Bonus;
		...
		public virtual bool UseSeconds
		{
			get { return true; }
		}
		...
		public GlovesOfFishing(int bonus, int itemID)
			: base(itemID)
		{
			this.m_Bonus = bonus;

			this.Hue = Misc.Util.RandomColor_Blue(true);
			if (Lifespan > 0)
			{
		...
		public GlovesOfFishing(Serial serial)
			: base(serial) { }
		...
		public int Bonus
		{
			...
			set
			{
				...
				{
					this.m_SkillMod = new DefaultSkillMod(SkillName.Fishing, true, this.m_Bonus);
		...
		public override void GetProperties(ObjectPropertyList list)
		{
			...
			if (this.m_Bonus != 0)
				list.Add(1063680, this.m_Bonus.ToString()); // mining bonus +~1_val~
		...
		public virtual void Decay()
		{
			if (RootParent is Mobile)
			{
				...
				Effects.SendLocationParticles(
					EffectItem.Create(parent.Location, parent.Map, EffectItem.DefaultDuration),
					0x3728,
					8,
					20,
					5042
