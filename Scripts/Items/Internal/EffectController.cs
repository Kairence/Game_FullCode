...
namespace Server.Items
{
	...
	public class EffectController : Item
	{
		...
		{
			get { return this.m_EffectType; }
			set { this.m_EffectType = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public EffectTriggerType TriggerType
		{
			get { return this.m_TriggerType; }
		...
		{
			get { return this.m_EffectLayer; }
			set { this.m_EffectLayer = value; }
		}
		...
		{
			get { return this.m_TriggerDelay; }
			set { this.m_TriggerDelay = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public TimeSpan SoundDelay
		{
			get { return this.m_SoundDelay; }
			set { this.m_SoundDelay = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public Item SourceItem
		{
			get { return this.m_Source as Item; }
		...
		{
			get { return this.m_Source as Mobile; }
			set { this.m_Source = value; }
		}
		...
		{
			get { return this.m_Target as Item; }
		...
		{
			get { return this.m_Target as Mobile; }
			set { this.m_Target = value; }
		}
		...
		{
			get { return this.m_ParticleEffect; }
			set { this.m_ParticleEffect = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ExplodeParticleEffect
		{
			get { return this.m_ExplodeParticleEffect; }
			set { this.m_ExplodeParticleEffect = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int ExplodeSound
		{
			get { return this.m_ExplodeSound; }
			set { this.m_ExplodeSound = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int Unknown
		{
			get { return this.m_Unknown; }
			set { this.m_Unknown = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int SoundID
		{
			get { return this.m_SoundID; }
		...
		{
			get { return this.m_TriggerRange; }
			set { this.m_TriggerRange = value; }
		}
		...
		{
			get { return (this.m_TriggerType == EffectTriggerType.InRange); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		private bool FixedDirection
		{
			get { return this.m_FixedDirection; }
			set { this.m_FixedDirection = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		private bool Explodes
		{
			get { return this.m_Explodes; }
			set { this.m_Explodes = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		private bool PlaySoundAtTrigger
		{
			get { return this.m_PlaySoundAtTrigger; }
			set { this.m_PlaySoundAtTrigger = value; }
		}
		...
		public override void OnMovement(Mobile m, Point3D oldLocation)
		{
			if (
				...
				&& this.m_TriggerType == EffectTriggerType.InRange
				&& Utility.InRange(this.GetWorldLocation(), m.Location, this.m_TriggerRange)
				&& !Utility.InRange(this.GetWorldLocation(), oldLocation, this.m_TriggerRange)
			)
				this.DoEffect(m);
		}
			...
			switch (this.m_EffectType)
			{
				...
				case ECEffectType.Moving:
				{
					...
					Effects.SendMovingParticles(
						...
						this.m_Speed,
						this.m_Duration,
						this.m_FixedDirection,
						this.m_Explodes,
						this.m_Hue,
						this.m_RenderMode,
						this.m_ParticleEffect,
						this.m_ExplodeParticleEffect,
						this.m_ExplodeSound,
						this.m_EffectLayer,
						this.m_Unknown
					);
