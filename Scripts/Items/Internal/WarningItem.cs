...
namespace Server.Items
{
	public class WarningItem : Item
	{
		...
		{
			get { return this.m_WarningString; }
			set { this.m_WarningString = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int WarningNumber
		{
			get { return this.m_WarningNumber; }
			set { this.m_WarningNumber = value; }
		}
		...
		{
			get { return this.m_ResetDelay; }
			set { this.m_ResetDelay = value; }
		}
		...
		public override void OnMovement(Mobile m, Point3D oldLocation)
		{
			if (
				m.Player
				&& Utility.InRange(m.Location, this.Location, this.m_Range)
				&& !Utility.InRange(oldLocation, this.Location, this.m_Range)
			)
				this.Broadcast(m);
		}
	...
	public class HintItem : WarningItem
	{
		...
		{
			get { return this.m_HintString; }
			set { this.m_HintString = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int HintNumber
		{
			get { return this.m_HintNumber; }
			set { this.m_HintNumber = value; }
		}
