...
namespace Server.Items
{
	public abstract class BaseRunicTool : BaseTool
	{
			...
			for (int i = 0; i < attributeCount; ++i)
			{
				...
				switch (random)
				{
					...
					case 1:
						...
						break;
					case 2:
						ApplyAttribute(primary, min, max, AosAttribute.CastRecovery, 1, 1);
						break;
					case 3:
					...
					case 8:
						...
						break;
					case 9:
						ApplyAttribute(primary, min, max, AosAttribute.BonusHits, 1, 8);
						break;
					case 10:
		...
		private static void ApplyAttribute(
			SAAbsorptionAttributes attrs,
			SAAbsorptionAttribute attr,
			int low,
			int high,
			int percent,
			int scale
