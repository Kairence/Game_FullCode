...
namespace Server.Items
{
	public class SmallWorldTreeRugAddon : BaseAddon
	{
		...
		{
			get { return new SmallWorldTreeRugAddonDeed(); }
		}
		...
		public SmallWorldTreeRugAddon(bool south)
		{
			if (south)
			{
				for (int i = 0; i < m_SouthInfo.Length / 4; i++)
					AddComponent(
						new AddonComponent(m_SouthInfo[i, 0]),
						m_SouthInfo[i, 1],
						m_SouthInfo[i, 2],
						m_SouthInfo[i, 3]
					);
			...
			else
			{
				for (int i = 0; i < m_EastInfo.Length / 4; i++)
					AddComponent(
						new AddonComponent(m_EastInfo[i, 0]),
						m_EastInfo[i, 1],
						m_EastInfo[i, 2],
						m_EastInfo[i, 3]
					);
	...
	public class SmallWorldTreeRugAddonDeed : BaseAddonDeed, IRewardOption
	{
		...
		{
			get { return new SmallWorldTreeRugAddon(m_South); }
		}
	...
	public class LargeWorldTreeRugAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get { return new LargeWorldTreeRugAddonDeed(); }
		}
	...
	public class LargeWorldTreeRugAddonDeed : BaseAddonDeed, IRewardOption
	{
		public override BaseAddon Addon
		{
			get { return new LargeWorldTreeRugAddon(m_South); }
		}
		public override int LabelNumber
		{
			get { return 1157207; }
