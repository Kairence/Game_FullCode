...
namespace Server.Engines.Quests.Necro
{
	public class MaabusCoffin : BaseAddon
	{
		...
		{
			get { return this.m_Maabus; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public Point3D SpawnLocation
		{
			get { return this.m_SpawnLocation; }
			set { this.m_SpawnLocation = value; }
		}
		...
		public void Sleep()
		{
			...
			Effects.SendLocationParticles(
				EffectItem.Create(this.m_Maabus.Location, this.m_Maabus.Map, EffectItem.DefaultDuration),
				0x3728,
				10,
				10,
				0x7E7
	...
	public class MaabusCoffinComponent : AddonComponent
	{
		...
		public Point3D SpawnLocation
		{
			get { return this.Addon is MaabusCoffin ? ((MaabusCoffin)this.Addon).SpawnLocation : Point3D.Zero; }
			set
			{
