...
namespace Server.Items
{
	public class PlagueBeastOrgan : PlagueBeastInnard
	{
		...
		public int BrainHue
		{
			get { return this.m_BrainHue; }
			set { this.m_BrainHue = value; }
		}
		public bool Opened
		{
			get { return this.m_Opened; }
			set { this.m_Opened = value; }
		}
	...
	{
		private static readonly int[] m_Hues = new int[] { 0xD, 0x17, 0x2B, 0x42, 0x54, 0x5D };
		private int m_Veins;
