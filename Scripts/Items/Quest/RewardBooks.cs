...
namespace Server.Items
{
	public class TerMurQuestRewardBook : BaseBook
	{
		...
		public static string[][] BookContents =
		{
			...
			new string[] { "Crossbow Marksmanship by Iolo Fitzowen", "Iolo Fitzowen", null },
			new string[] { "Dilzal's Almanac Of Good Advice", "Dilzal", null },
			new string[]
			{
			...
			new string[] { "Knights of Legend, Volume I", "Unknown", null },
			new string[] { "Kodeks Benmontas", "Unknown", null },
			new string[]
			{
				"Kodeks Benommani",
				"Unknown",
			...
			new string[] { "Kodeks Destermur", "Unknown", null },
			new string[]
			{
				"Kodeks Kir",
				"Unknown",
			...
			new string[] { "Tangled Tales", "Unknown", null },
			new string[]
			{
			...
			new string[] { "The Book of Prosperity", "Unknown", null },
			new string[] { "The Book of Ritual", "Unknown", null },
			new string[]
			{
			...
			new string[] { "The Caverns of Freitag", "Unknown", null },
			new string[] { "The Codex of Infinite Wisdom", "Unknown", null },
			new string[] { "The First Age of Darkness", "Unknown", null },
			new string[] { "The Lost Book Of Mantras", "Unknown", null },
			new string[] { "The Quest of the Avatar", "Unknown", null },
			new string[] { "The Second Age of Darkness", "Unknown", null },
			new string[] { "The Third Age of Darkness", "Unknown", null },
			new string[]
			{
				"The Wizard Of Oz",
				"Frank L. Baum",
			...
			new string[] { "Warriors Of Destiny", "Unknown", null },
			new string[] { "Windwalker", "Unknown", null },
			new string[] { "Ye Lost Art Of Ballooning", "Unknown", null },
		};
	}
}
