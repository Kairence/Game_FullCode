...
namespace Server.Items
{
	public class PlagueBeastInnard : Item, IScissorable, ICarvable
	{
		...
		{
			get { return this.RootParent as PlagueBeastLord; }
		}
	...
	public class PlagueBeastComponent : PlagueBeastInnard
	{
		...
		{
			get { return this.m_Organ; }
			set { this.m_Organ = value; }
		}
		public bool IsBrain
		{
			get { return this.ItemID == 0x1CF0; }
		}
		public bool IsGland
		{
			get { return this.ItemID == 0x1CEF; }
		}
		public bool IsReceptacle
		{
			get { return this.ItemID == 0x9DF; }
		}
