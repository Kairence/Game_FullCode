...
namespace Server.Items
{
		...
		private class InternalTarget : Target
		{
			...
			protected override void OnTarget(Mobile from, object targeted)
			{
				...
				if (targeted is AddonComponent)
				{
					...
					if (
						addoncomponent is MagicVinesComponent
						|| addoncomponent is StoneWallComponent
	...
	public class DuganMissingQuestCorpse : QuestHintItem
	{
		...
		{
			get { return typeof(Server.Engines.Quests.Missing); }
		}
	...
	public class FlintLostBarrelHint : QuestHintItem
	{
		public override Type QuestType
		{
			get { return typeof(Server.Engines.Quests.ThievesBeAfootQuest); }
		}
		public override Type QuestItemType
		{
			get { return typeof(BarrelOfBarley); }
		}
		public override int DefaultRange
		{
			get { return 5; }
		}
	...
	public class FlintLostLogbookHint : QuestHintItem
	{
		public override Type QuestType
		{
			get { return typeof(Server.Engines.Quests.BibliophileQuest); }
		}
		public override Type QuestItemType
		{
			get { return typeof(FlintsLogbook); }
		}
		public override int DefaultRange
		{
			get { return 5; }
