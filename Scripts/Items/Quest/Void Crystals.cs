...
namespace Server.Items
{
	public class VoidCrystalOfCorruptedArcaneEssence : Item
	{
		...
		[Constructable]
		public VoidCrystalOfCorruptedArcaneEssence()
			: base(0x1F19)
		{
			Hue = 1267;
		}

		public VoidCrystalOfCorruptedArcaneEssence(Serial serial)
			: base(serial) { }
	...
	public class VoidCrystalOfCorruptedMysticalEssence : Item
	{
		...
		[Constructable]
		public VoidCrystalOfCorruptedMysticalEssence()
			: base(0x1F19)
		{
			Hue = 2717;
		}

		public VoidCrystalOfCorruptedMysticalEssence(Serial serial)
			: base(serial) { }
