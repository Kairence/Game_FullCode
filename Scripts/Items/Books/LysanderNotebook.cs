...
namespace Server.Items
{
	public class LysanderNotebook1 : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("fortunes in the night.")
		);
	...
	public class LysanderNotebook7 : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("Thee with many", "sacrifices, soon", "enough.")
		);
	...
	public class LysanderNotebook8 : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("fulfilled their", "purpose and I kneel", "before Thee, covered", "in their blood.")
		);
	...
	public class LysanderNotebook11 : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("Khaldun at last!")
		);
