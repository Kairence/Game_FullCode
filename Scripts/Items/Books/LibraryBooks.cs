...
namespace Server.Items
{
	...
	public class CallToAnarchy : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("interest and that of", "Lord British for", "some time now.")
		);
	...
	public class ArmsAndWeaponsPrimer : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("be the possessions,", "which maketh looting", "difficult!")
		);
	...
	public class SongOfSamlethe : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("Samlethe's day.")
		);
	...
	public class GuideToGuilds : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("field.", "", "  Traders' Guild.", "White bar centered", "down green field.")
		);
	...
	public class BirdsOfBritannia : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("extraordinarily", "beautiful song.")
		);
	...
	public class TalesOfVesperVol1 : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("Go Not to the", "Snakehills", "Lest You Care to Die")
		);
	...
	public class DeceitDungeonOfHorror : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("for the bridge thus", "created doth burst", "into flame when one", "passeth across it!")
		);
	...
	public class EthicalHedonism : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("Hedonism, by", "Richard Garriott and", "Herman Miller.")
		);
	...
	public class TalkingToWisps : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("language, but this is", "of course unlikely.")
		);
	...
	public class TamingDragons : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("running away very", "very fast.")
		);
	...
	public class TheFight : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("like knights still in", "battle, shattered", "armor shining like", "newly born stars.")
		);
	...
	public class RankingsOfTrades : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("shown extreme", "mastery of their", "craft recently.")
		);
	...
	public class TreatiseOnAlchemy : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("truly. Not once.")
		);
