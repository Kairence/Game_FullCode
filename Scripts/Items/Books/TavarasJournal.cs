...
namespace Server.Items
{
	public class TavarasJournal1 : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("last ten years of my", "life.")
		);
	...
	public class TavarasJournal9 : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("must have fled the", "site altogether, as", "Bergen said.")
		);
	...
	public class TavarasJournal17 : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("away in this ocean of", "blood.")
		);
	...
	public class TavarasJournal19 : BaseBook
	{
		public static readonly BookContent Content = new BookContent(
			...
			new BookPageInfo("must be done. I must", "end this.")
		);
