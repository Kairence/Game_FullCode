...
namespace Server.Items
{
	...
	public abstract class BaseSpecialScrollBook : Container, ISecurable
	{
		...
		public override void OnDoubleClick(Mobile m)
		{
			...
			if (
				m is PlayerMobile
				&& m.InRange(GetWorldLocation(), 2) /*&& (house == null || house.HasSecureAccess(m, this))*/
			)
			{
		...
		public virtual Dictionary<SkillCat, List<SkillName>> SkillInfo
		{
			get { return null; }
		}
		public virtual Dictionary<int, double> ValueInfo
		{
			get { return null; }
		}
