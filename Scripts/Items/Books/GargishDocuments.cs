...
namespace Server.Items
{
	public class GargishDocumentBook : BaseLocalizedBook, ISecurable
	{
		...
		public GargishDocumentBook(Serial serial)
			: base(serial) { }
	...
	public class GargishDocumentNote : Note
	{
		...
		public GargishDocumentNote(int content)
			: base(content) { }
	...
	public class ChallengeRite : GargishDocumentBook
	{
		...
		public override int[] Contents
		{
			get { return new int[] { 1150915, 1150916, 1150917, 1150918, 1150919, 1150920, 1150921, 1150922 }; }
		}
	...
	public class OnTheVoid : GargishDocumentBook
	{
		...
		public override object Author
		{
			get { return "Prugyilonus"; }
		}
		public override int[] Contents
		{
			get { return new int[] { 1150894, 1150895, 1150896 }; }
		}
	...
	public class InMemory : GargishDocumentBook
	{
		...
		public override int[] Contents
		{
			get { return new int[] { 1151071, 1151072, 1151073 }; }
		}
