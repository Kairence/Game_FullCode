...
namespace Server.Engines.CannedEvil
{
	...
	public class PrimevalLichPuzzle : Item
	{
		...
		public bool Active
		{
			get { return (!Deleted && null != m_Altar && m_Altar.Active); }
		}
		...
		public static void Initialize()
		{
			CommandSystem.Register(
				...
				new CommandEventHandler(GenLichPuzzle_OnCommand)
			);
			CommandSystem.Register(
				"DeleteLichPuzzle",
				AccessLevel.Administrator,
				new CommandEventHandler(DeleteLichPuzzle_OnCommand)
			);
		}
		...
		public static void GenLichPuzzle(Mobile m)
		{
			if (null != m_Instance)
			{
				...
				{
					m.SendMessage(
						"Primeval Lich lever puzzle already exists: please delete the existing one first ..."
					);
				}
