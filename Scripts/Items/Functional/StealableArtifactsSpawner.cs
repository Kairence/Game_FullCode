...
namespace Server.Items
{
	public class StealableArtifactsSpawner : Item
	{
		private static readonly StealableEntry[] m_Entries = new StealableEntry[]
		{
			...
			new StealableEntry(
				Map.Malas,
				Core.TOL ? new Point3D(462, 17, -1) : new Point3D(489, 9, 0),
				144,
				216,
			...
			new StealableEntry(
				Map.Malas,
				Core.TOL ? new Point3D(485, 8, 6) : new Point3D(475, 23, 4),
				4608,
				6912,
			...
			new StealableEntry(
				Map.Malas,
				Core.TOL ? new Point3D(396, 8, 4) : new Point3D(257, 70, -2),
				36864,
				55296,
				typeof(ZyronicClaw)
			),
			new StealableEntry(
				Map.Malas,
				Core.TOL ? new Point3D(261, 97, -1) : new Point3D(354, 176, 7),
				36864,
				55296,
				typeof(TitansHammer)
			),
			...
			new StealableEntry(
				Map.Malas,
				Core.TOL ? new Point3D(263, 28, 0) : new Point3D(365, 7, -1),
				147456,
				221184,
				typeof(IncenseBurner)
			),
			#endregion
			...
			new StealableEntry(
				Map.TerMur,
				new Point3D(1015, 1013, -35),
				576,
				864,
				typeof(StolenBottlesOfLiquor1Artifact)
			), // [2a]
			new StealableEntry(
				Map.TerMur,
				new Point3D(1015, 1029, -35),
				576,
				864,
				typeof(StolenBottlesOfLiquor2Artifact)
			), // [2b]
			new StealableEntry(
				Map.TerMur,
				new Point3D(1210, 1035, -22),
				576,
				864,
				typeof(BottlesOfSpoiledWine1Artifact)
			), // [2]
			...
			: base(1)
		{
			...
			this.m_RespawnTimer = Timer.DelayCall(
				TimeSpan.Zero,
		...
		public static void Initialize()
		{
			...
			CommandSystem.Register(
				"StealArtiesForceRespawn",
				AccessLevel.GameMaster,
				new CommandEventHandler(StealArtiesForceRespawn_OnCommand)
			);
		}
		...
		public class StealableEntry
		{
			...
			public int MinDelay
			{
				get { return this.m_MinDelay; }
			}
			public int MaxDelay
			{
				get { return this.m_MaxDelay; }
			}
			public Type Type
			{
		...
		public class StealableInstance
		{
			...
			{
				get { return this.m_NextRespawn; }
				set { this.m_NextRespawn = value; }
			}
