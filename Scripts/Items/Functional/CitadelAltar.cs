...
namespace Server.Items
{
	public class CitadelAltar : PeerlessAltar
	{
		...
		{
			get { return new CitadelKey(); }
		}

		public override Type[] Keys
		{
			get { return new Type[] { typeof(TigerClawKey), typeof(SerpentFangKey), typeof(DragonFlameKey) }; }
		}

		public override BasePeerless Boss
		{
			get { return new Travesty(); }
		}
		...
		private Rectangle2D[] m_Bounds = new Rectangle2D[] { new Rectangle2D(66, 1936, 51, 39) };
