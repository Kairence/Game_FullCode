...
namespace Server.Items
{
	public class GoblinFloorTrap : BaseTrap, IRevealableItem
	{
		...
		[Constructable]
		public GoblinFloorTrap()
			: this(null) { }

		[Constructable]
		public GoblinFloorTrap(Mobile from)
			: base(0x4004)
		{
			m_Owner = from;
			Visible = false;
		...
		public GoblinFloorTrap(Serial serial)
			: base(serial) { }
	...
	public class GoblinFloorTrapKit : Item
	{
		...
		private class InternalTarget : Target
		{
			...
			public InternalTarget(GoblinFloorTrapKit kit)
		...
		public GoblinFloorTrapKit(Serial serial)
			: base(serial) { }
