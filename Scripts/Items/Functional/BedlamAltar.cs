...
namespace Server.Items
{
	public class BedlamAltar : PeerlessAltar
	{
		...
		{
			get { return new BedlamKey(); }
		}

		public override Type[] Keys
		{
			get { return new Type[] { typeof(LibrariansKey) }; }
		}

		public override BasePeerless Boss
		{
			get { return new MonstrousInterredGrizzle(); }
		}
		...
		private Rectangle2D[] m_Bounds = new Rectangle2D[] { new Rectangle2D(99, 1609, 14, 18) };
