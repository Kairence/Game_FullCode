...
namespace Server.Items
{
	public class FireColumnTrap : BaseTrap
	{
		...
		{
			get { return this.m_MinDamage; }
			set { this.m_MinDamage = value; }
		}
		...
		{
			get { return this.m_WarningFlame; }
			set { this.m_WarningFlame = value; }
		}
		...
		public override void OnTrigger(Mobile from)
		{
			...
			if (from.Alive && this.CheckRange(from.Location, 0))
			{
				Spells.SpellHelper.Damage(
					...
					from,
					from,
					Utility.RandomMinMax(this.MinDamage, this.MaxDamage),
					0,
					100,
					0,
					0,
