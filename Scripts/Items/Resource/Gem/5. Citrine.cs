...
namespace Server.Items
{
    public class Citrine : Item, IGem
    {
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060658, "무기\t{0}, 방패: 기력 증가, 천옷: 빠른 주문 회복", "기력 증가" );
			list.Add( 1060659, "가죽\t{0}, 스텃: 빠른 주문 회복, 뼈: 민첩 증가", "빠른 주문 회복");
			list.Add( 1060660, "링 갑옷\t{0}, 체인 갑옷: 피해 증가, 플렛 갑옷: 피해 증가", "피해 증가" );
			list.Add( 1060661, "반지&팔찌\t{0}, 귀걸이&목걸이: 기력 증가, 마법책: 기력 증가", "기력 증가" );	// F +5, E +10, D +15, C +20, B +30, A +40, S +50
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendMessage( "황수정을 어느 아이템에 사용하시겠습니까?" );
		...
		*/
		public class GemTarget : Target
		{
			Citrine m_Gem;
			int m_Amount;
			public GemTarget(Citrine diamond) : base(1, false, TargetFlags.None )
			{
				m_Gem = diamond;
			}
					...
					if( targeted is BaseWeapon )
					{
						...
						else
						{
							if( from is PlayerMobile )
							{
								...
								Misc.Util.ItemCreate( item, 0, false, pm, 4 );
