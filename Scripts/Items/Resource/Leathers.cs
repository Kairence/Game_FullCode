...
namespace Server.Items
{
	...
	public class DernedLeather : BaseLeather
	{
		...
		{
			get { return CraftResource.DernedLeather; }
		}

		[Constructable]
		public DernedLeather()
			: this(1) { }

		[Constructable]
		public DernedLeather(int amount)
			: base(CraftResource.DernedLeather, amount) { }

		public DernedLeather(Serial serial)
			: base(serial) { }
	...
	public class RatnedLeather : BaseLeather
	{
		protected override CraftResource DefaultResource
		{
			get { return CraftResource.RatnedLeather; }
		}

		[Constructable]
		public RatnedLeather()
			: this(1) { }

		[Constructable]
		public RatnedLeather(int amount)
			: base(CraftResource.RatnedLeather, amount) { }

		public RatnedLeather(Serial serial)
			: base(serial) { }
	...
	public class SernedLeather : BaseLeather
	{
		protected override CraftResource DefaultResource
		{
			get { return CraftResource.SernedLeather; }
		}

		[Constructable]
		public SernedLeather()
			: this(1) { }

		[Constructable]
		public SernedLeather(int amount)
			: base(CraftResource.SernedLeather, amount) { }

		public SernedLeather(Serial serial)
			: base(serial) { }
	...
	public class SpinedLeather : BaseLeather
	{
		protected override CraftResource DefaultResource
		{
			get { return CraftResource.SpinedLeather; }
		}
	...
	public class HornedLeather : BaseLeather
	{
		protected override CraftResource DefaultResource
		{
			get { return CraftResource.HornedLeather; }
		}
	...
	public class BarbedLeather : BaseLeather
	{
		protected override CraftResource DefaultResource
		{
			get { return CraftResource.BarbedLeather; }
		}
