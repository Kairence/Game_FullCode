...
namespace Server.Items
{
	...
	public class HolidayWallArt1 : BaseHolidayWallArt
	{
		...
		{
			get { return ItemID == 0xA4B3 ? 0xA4B4 : 0xA4B6; }
		}
		public override int UnlitItemID
		{
			get { return ItemID == 0xA4B4 ? 0xA4B3 : 0xA4B5; }
		}

		public override int NorthID
		{
			get { return Burning ? 0xA4B4 : 0xA4B3; }
		}
		public override int WestID
		{
			get { return Burning ? 0xA4B6 : 0xA4B5; }
		}
	...
	public class HolidayWallArt2 : BaseHolidayWallArt
	{
		public override int LitItemID
		{
			get { return ItemID == 0xA4B7 ? 0xA4B8 : 0xA4BA; }
		}
		public override int UnlitItemID
		{
			get { return ItemID == 0xA4B8 ? 0xA4B7 : 0xA4B9; }
		}

		public override int NorthID
		{
			get { return Burning ? 0xA4B8 : 0xA4B7; }
		}
		public override int WestID
		{
			get { return Burning ? 0xA4BA : 0xA4B9; }
		}
	...
	public class HolidayWallArt3 : BaseHolidayWallArt
	{
		public override int LitItemID
		{
			get { return ItemID == 0xA4AD ? 0xA4AE : 0xA4B0; }
		}
		public override int UnlitItemID
		{
			get { return ItemID == 0xA4AE ? 0xA4AD : 0xA4AF; }
		}

		public override int NorthID
		{
			get { return Burning ? 0xA4AE : 0xA4AD; }
		}
		public override int WestID
		{
			get { return Burning ? 0xA4B0 : 0xA4AF; }
		}
