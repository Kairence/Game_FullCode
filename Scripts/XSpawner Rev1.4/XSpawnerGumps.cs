	...
	public class GumpSaveRegion : Gump
	{
			...
			: base(50, 50)
		{
			...
			AddHtml(
				...
				140,
				110,
				"This will SAVE the spawners, in a specified region, to Data/Monsters /spawns.map. Type [where if you don't know the region you are. Copy to the text box the name of the region.<BR>Example: you type [where and appear 'your region is town of Britain'. Type 'Britain' in text box.<BR>You also can open Data/Regions.xml to a full list of regions.",
				true,
				true
			);
		}
	...
	public class GumpRemoveRegion : Gump
	{
			...
			: base(50, 50)
		{
			...
			AddHtml(
				...
				140,
				110,
				"This will REMOVE the spawners, in a specified region. Type [where if you don't know the region you are. Copy to the text box the name of the region.<BR>Example: you type [where and appear 'your region is town of Britain'. Type 'Britain' in text box.<BR>You also can open Data/Regions.xml to a full list of regions.",
				true,
				true
			);
		}
	...
	public class GumpRemoveID : Gump
	{
			...
			: base(50, 50)
		{
			...
			AddHtml(
				...
				140,
				110,
				"This command was made to UNLOAD your own custom maps. This will REMOVE the spawners with the specified ID. Type '[get spawnid' in a spawner to know your ID. Remember: 'By Hand' spawns, i.e., those done with '[add premiumspawner...', has ID = 1.",
				true,
				true
			);
		}
					...
					if (sX1 != "" && sY1 != "" && sX2 != "" && sY2 != "")
					{
						try
						{
							...
							CommandSystem.Handle(
								from,
								String.Format("{0}Spawngen save {1} {2} {3} {4}", prefix, iX1, iY1, iX2, iY2)
							);
						}
						catch
						{
				...
				case 101:
				{
					...
					if (sX1 != "" && sY1 != "" && sX2 != "" && sY2 != "")
					{
						try
						{
							...
							CommandSystem.Handle(
								from,
								String.Format("{0}Spawngen remove {1} {2} {3} {4}", prefix, iX1, iY1, iX2, iY2)
							);
						}
						catch
						{
