...
namespace Server
{
	...
	public class Skill
	{
		...
		[CommandProperty(AccessLevel.Counselor)]
		public int VolumeLearned { get; set; }

		[CommandProperty(AccessLevel.Counselor)]
		public DateTime NextGGSGain { get; set; }
	...
	public class Skills : IEnumerable<Skill>
	{
		...
		[CommandProperty(AccessLevel.Counselor, AccessLevel.GameMaster)]
		public SkillName CurrentMastery { get; set; }
