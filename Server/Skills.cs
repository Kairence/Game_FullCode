...
namespace Server
{
	...
	public class SkillInfo
	{
        ...
        private static SkillInfo[] m_Table = new SkillInfo[58]
		{
			...
			new SkillInfo(20, "Farming", 16.25, 6.25, 2.5, "Shepherd", null, 1.625, 0.625, 0.25, 1.0, StatCode.Int, StatCode.Dex),
			...
			new SkillInfo(36, "Tanning", 0.0, 0.0, 0.0, "Praegustator", null, 0.2, 0.0, 0.8, 1.0, StatCode.Int, StatCode.Str),
