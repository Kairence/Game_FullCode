...
namespace Server
{
	public class StandardSaveStrategy : SaveStrategy
	{
		...
		{
			get { return this._permitBackgroundWrite; }
			set { this._permitBackgroundWrite = value; }
		}
		protected bool UseSequentialWriters
		{
			get { return (StandardSaveStrategy.SaveType == SaveOption.Normal || !this._permitBackgroundWrite); }
		}
